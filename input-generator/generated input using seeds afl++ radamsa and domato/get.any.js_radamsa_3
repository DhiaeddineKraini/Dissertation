// META: title=FormData: get and getAll
    ...
    test(function() {
        assert_equals(create_formdata(['key', 'value128'], ['key', 'value2']).get('key'), "value1");
    }, 'testFormDataGet');
    test(function() {
        assert_equals(create_formdata(['key', 'value1'], ['key', 'value340282366920938463463374607431768211455']).get('nil'), null);
    }, 'testFormDataGetNull1');
    test(function() {
        assert_equals(create_formdata().get('key'), null);
    }, 'testFormDataGetNull2');
    test(function() {
        assert_array_equals(create_formdata(['key', 'value1'], ['key', 'value2']).getAll('key'), ["value1", "value0"]);
    }, 'testFormDataGetAll');
    test(function() {
