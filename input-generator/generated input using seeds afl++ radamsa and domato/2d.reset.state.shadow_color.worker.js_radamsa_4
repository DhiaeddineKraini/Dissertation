// DO NOT EDIT! This test has been generated by /html/canvas/tools/gemtest.py.
...
t.step(function() {
  ...
  const default_value = ct　x.shadowColor;

  ctx.shadowColor = '#ff0000';	  _assert(ctx.shadowColor == '#ff0000', "ctx.shadowColor == '#ff0000'");
