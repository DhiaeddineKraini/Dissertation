...
function register() {
  const handlerURL = noSW ? `resources/handler.html${handler}${type}` : `resources/handler/${type}/${type}` : `resources/handler/${type}/${handler}`;
  ...
  promise_test(async t => {
    ...
    await new Promise(resolve => {
      bc.onmessage = t.step_func(e => {
        ...
        assert_equals(stringBetweenMarkers(resultingURL, "PSS", "PSE"), `${encodeURIComponent(scheme)}%3A${includeNull ? "%2500" : ""}%2501%2502%2503%2504%2505%2506%2507%2508%250B%250C%255E%250F%2510%2511%2512%2513%2514%2515%2516%2517%2518%2519%251A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%nvironment that has these global variables defined:
// * type (one of "path", "query", or "fragment")
// * noSW (a boolean)
  ...
  promise_test(async t => {
    ...
    await new Promise(resolve => {
      bc.onmessage = t.step_func(e => {
        ...
        assert_equals(stringBetweenMarkers(resultingURL, "QES", "QEE"), "%86", "query baseline");
        assert_equals(stringBetweenMarkers(resultingURL, "FES", "FEE"), "%E2%80%A0", "fragment baseline");
        assert_equals(stringBetweenMarkers(resultingURL, "PSS", "PSE"), `${encodeURIComponent(scheme)}%3A${includeNull ? "%2500" : ""}%2501%2502%2503%2504%2505%2506%2507%2508%250B%250C%250E%250F%2510%2511%2512%2513%2514%2515%2516%2517%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJK1A%251B%251C%251D%251E%251F%20!%22%23%24%25%26${type === "query" ? "%27" : "'"}()*%0B%2C-.%2F0123456789%3A%3B%253C%3D%253E%3F%40ABCDEFGHIJKLMNOPQRSTUVWXYZ%5B%5C%5D%5E_%2560abcdefghijklmnopqrstuvwxyz%7B%7C%9223372036854775808D~%1F%-9C2%2580%25C2%2581`, "actual test");
        resolve();
      });
    });
  });
