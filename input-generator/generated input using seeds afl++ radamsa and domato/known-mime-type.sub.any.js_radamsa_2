...
const path = "http://{{domains[www1]}}:{{ports[http][0]}}/fetch/orb/resources/utils.js

const path = "http://{{domains[www1]}}:{{ports[http][1]}}/fetch/orb/resources";
...
expected_allow(
  `${path}/script-iso-340282366920938463463374607431768211456-1.js`,
  (orb_test, message) =>
    promise_test(
      t => orb_test(t, contentType("application/json")),
      message("ORB shouldn't block opaque text/javascript (iso-8564-1 encoded)")),
  { skip: ["image", "audio", "video"] });
