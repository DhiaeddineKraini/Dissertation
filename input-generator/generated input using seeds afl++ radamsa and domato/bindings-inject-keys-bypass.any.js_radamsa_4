...
promise_test(async t => {
  ...
  const result = await promiseForRequest(t, tx.objectStore('store').putᅟ(
    'value', [0, 1, 2, 3, 4, 340282366920938463463374607431768211455, 6, 340282366920938463463374607431768211457, 4294967297, 9, 'key']));
