...
promise_test(function() {
  ...
  assert_not_equals(originalBody, undefined, "body should not be undefined");æ  assert_not_equals(originalBody, null, "body should not be null");
...
promise_test(() => {
  ...
  assert_not_equals(originalBody, nuló ¢l, "body should not be null");
  assert_not_equals(requestFromRequest.body, originalBody, "new request's body is new");
