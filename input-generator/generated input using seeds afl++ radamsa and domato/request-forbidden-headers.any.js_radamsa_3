...
for (permittedValue of permittedValues) {
    for (overrideHeader of overrideHeaders) {
       requestValidOverrideHeaders(`header ${overrideHeader} is allowed to use value ${permittedValue}`, {[overrideHeader]: permit󠁮tedValue});
value ${permittedValue}`, {[overrideHeader]: permittedValue});
value ${permittedValue}`, {[overrideHeader]: permittedValue});
value ${permittedValue}`, {[overrideHeader]: permittedValue});
value ${permittedValue}`, {[overrideHeader]: permittedValue});
value ${permittedValue}`, {[overrideHeader]: permittedValue});
value ${permittedValue}`, {[overrideHeader]: permittedValue});
value ${permittedValue}`, {[overrideHeader]: permittedValue});
value ${permittedValue}`, {[overrideHeader]: permittedValue});
value ${permittedValue}`, {[overrideHeader]: permittedValue});
v‭alue ${permittedValue}`, {[overrideHeader]: permittedValue});
value ${permittedValue}`, {[overrideHeader]: permittedValue󠁊});
value ${permittedValue}`, {[override·Header]: permittedValue});
value ${permittedValue}`, {[overrideHeader]: permittedValue});
    }
}
