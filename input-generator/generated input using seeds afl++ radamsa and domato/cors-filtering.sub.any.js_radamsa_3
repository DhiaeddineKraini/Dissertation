...
corsExposeFilter(url, "Warning", "Mind the gap" , fe2", "name=value; max-age=0", true);
...
corsExposeFilter(url, "Age", "78918781425396437743115508", false);
corsExposeFilter(url, "Server", "wptServe" , false);
corsExposeFilter(url, "Warning", "Mind the gap" , fe2", "name=value; max-age=0", true);
...
corsExposeFilter(url, "Age", "27", false);
corsExposeFilter(url, "Server", "wptServe" , false);
corsExposeFilter(url, "Warning", "Mind the g g g g Pgap" , fe2", "name=value; max-age=0", true);
