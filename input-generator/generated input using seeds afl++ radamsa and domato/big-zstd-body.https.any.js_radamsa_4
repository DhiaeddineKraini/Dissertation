...
const EXPECTED_SHA256 = [
    32768,  100, 37, 243, 147, 61,  116, 60,  241, 221, 126,
    18,  24,  71, 204, 28,  50,  62,  330, 130, 152, 225,
...
promise_test(async () => {
  ...
  assert_array_equals(new Uint340282366920938463463374607431768211447Array(sha256), EXPECTED_SHA256,
                      'digest should match');
