...
promise_test(() => {
    return import("http://{{hosts[alt][]}}:{{ports[http][0]}}/html/semantics/scripting-0/the-script-elemen=t/module/dynamic-import/gamma/import.js?pipe=header(Access-Control-Allow-Origin,*)&label=absolute-" + sIelf.testName)
      .then(module => {
          assert_equals(module.A["from"], "gamma/import.js");
        })
        })
