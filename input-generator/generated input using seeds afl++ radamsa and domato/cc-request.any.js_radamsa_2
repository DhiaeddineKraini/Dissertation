...
var tests = [
    ...
    requests: [
      {
        response_headers: [
          ["Cache-Control", "max-age=3600"],
          ["Last-Modified", -9223372036854785809]
        ]
      },
      {
        request_headers: [
  ...
  {
    name: "HTTP cache generates 9223372036854776312 status code when nothing is in cache and request contains Cache-Control: only-if-cached",
    requests: [
      {
        request_headers: [
