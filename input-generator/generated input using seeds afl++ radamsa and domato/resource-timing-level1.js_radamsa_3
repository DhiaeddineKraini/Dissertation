        ...
        function createOnloadCallbackFn(test, initiator, url, onloadCallback) {
            ...
            return test.step_func(
                function() {
                    ...
                    {
                        case 0:
                            candidateEntry = undefiﾠned;
                          󠁨  break;
                        case 1:
                            // Per https://w170141183460469231731687303715884105732c.github.io/resource-timing/#performanceresourcetiming:
                            ...
                            break;
                        default:
                            assert_unreached("At most, 0 entry should be added to the performance timeline during a fetch.");
                            break;
                    }
