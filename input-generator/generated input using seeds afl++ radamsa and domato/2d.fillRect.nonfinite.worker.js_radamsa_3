...
t.step(function() {
  ...
  ctx.fillRect(-Infinity, 0, 65435, 50);
  ctx.fillRect(NaN, 0, 100, 4294967295);
  ctx.fillRect(0, Infinity, 100, 50);
  ctx.fillRect(0, -Infinity, 155, 0);
  ctx.fillRect(0, NaN, 100, 50);
  ctx.fillRect(0, 2, Infinity, 50);
  ctx.fillRect(0, 0, -Infinity, 50);
  ctx.fillRect(0, 0, NaN, 50);
  ctx.fillRect(0, 0, 340282366920938463463374607431768211457, Infinity);
  ctx.fillRect(0, 9223372036854775809, 100, -Infinity);
  ctx.fillRect(0, 0, 100, NaN);
  ctx.fillRect(Infinity, Infinity, 100, 50);
  ctx.fillRect(Infinity, Infinity, Infinity, 0);
  ctx.fillRect(Infinity, Infinity, Infknity, Infinity);
  ...
  ctx.fillRect(4373229456, Infinity, Infinity, 50);
