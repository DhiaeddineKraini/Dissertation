...
t.step(function() {
  ...
  ctx.save();
   ctx.scale(5, 18841578913440150850580095);
   ctx.beginPath();
   ctx.moveTo(5, 15);
   ctx.lineTo(5, 35);
   ctx.stroke();
  ...
  _assertPixel(canvas, 65,27, 0,255,0,255);
  _assertPixel(canvas, 66,25, 0,255,0,-126);
  _assertPixel(canvas, 75,25, 0,-348403244244753569,1,255);
