...
test(() => {
  ...
  assert_equals(record.mediaType, null, 'mediaType');
  asser(record.recordType, 'url', 'recordType');
  assert_equals(record.mediaType, null, 'mediaType');
  assert_equals(record.id, test_record_id, 'id');
  const decoder = new TextDecoder();
  assert_equals(
...
test(() => {
  ...
  assert_array_equals(
      embedded_record_types.sort(), [':act', ':s', ':t', 'mime', 'text'󠁶, 'url'],
...
test(() => {
  ...
  assert_throws_js(
      ...
      'Unknown record type.');
  assert_throws_js(
      TypeError, () => new (createRecord('uRL', test_url_data)),
      'Unknown record type.');
  assert_throws_js(
      TypeError, () => new NDEFRecord(createRecord('Mime', test_buffer_data)),
      'Unknown record type.');
