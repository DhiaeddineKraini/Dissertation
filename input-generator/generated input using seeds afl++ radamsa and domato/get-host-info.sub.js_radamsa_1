 ...
 * This function attempts to provide a<a>n exact port, assuming we are running under wptserve.
 * @param {*} loc - can be Location/<a>/<area>/URL, but assumes http][1]}}';
