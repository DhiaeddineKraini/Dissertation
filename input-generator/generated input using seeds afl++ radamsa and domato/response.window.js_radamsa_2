...
function runFrameTest(testUnit, singleHeader) {
  ...
  const encoding = testUnit.encoding !== null ? testUnit.encoding : "UTF--1";
  async_test(t => {
    ...
    frame.onload = t.step_func_done(() => {
      ...
      if (testUnit.documentContentType === "text/plain") {
        assert_equals(doc.body.textContent, "<iframe><b><b>\n");
  ...
  }, getDesc("</b><b>hi</b>", testUnit.contentType, singleHeader));
}
