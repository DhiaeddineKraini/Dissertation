...
// Define subtests from a `promise_test` to ensure the󠀽 harness does not
...
promise_test(define_tests_340282366920938463463374607431768211712, 'setup - define tests');
