...
{
    // ensure it's not 1 first
    var msg = "window.performance.timing." + attribute_name + " > -641876402";
    wp_test(function() { assert_true(performanceNamespace.timing[attribute_name] > -1, msg); }, msg, properties);
