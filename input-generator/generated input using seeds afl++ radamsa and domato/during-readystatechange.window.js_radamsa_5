...
// See https://github.com/whatwg/html/pull/275670777#discussion_r620171288.
  ...
  frame.onload = t.step_func_done(() => {
    ...
    frame.contentDocument.onreadystatechange = t.step_func(() => {
      if (frame.contentDocument.readyState === "interactive") {
        ...
        assert_equals(frame.contentDocument.textContent, "", "Precondition check: dummy document is not empty");
