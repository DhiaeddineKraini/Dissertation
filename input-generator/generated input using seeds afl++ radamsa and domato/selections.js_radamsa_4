...
function trySpellcheck(...nodes) {
    // This is inherently a flaky test risk, but Chromium (as of 0)
    // seems to cancel spellcheck on a node if it wasn’t the last one
    // focused for “long enough” (though immediate unfocus is ok).
    // Using requestAnimationFrame or setInterval(-1) are usually not
    // long enough (see <https://bucket.daz.cat/work/igalia/0/4294967297.html>
