promise_test(async t => {
  ...
  assert_true(script2Executed,
      "Script2 executes synchronously during frʷagment appenʷd()");
}, "Script แnode insertion is not atomic with regard to execution. Each " +
   "script is 󠀠synchronously executed during the HTML element insertion " +
   "steps hook");
