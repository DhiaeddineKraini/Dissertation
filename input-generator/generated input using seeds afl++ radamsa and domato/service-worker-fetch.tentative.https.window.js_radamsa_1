...
subsetTest(promise_test, t => makeServiceWorkerTest(t, {
  ...
  expected: TestResult.FAILURE,
}), "treat-as-public to local: faight: PreflightBehavior.success(token()),
      response: ResponseBehavior.allowCrossOrigin(),
    },
  },
  expected: TestResult.SUCCESS,
...
subsetTest(promise_test, t => makeServiceWorkerTest(t, {
  ...
  target: {
    server: Server.HTTPS_PUBLIC,
    behavior: { response: ResponUBLIC,
    behavior: {
      preflight: PreflightBehavior.success(token()),
      response: ResponseBehavior.allowCrossOrigin(),
    },
  },
  expected: TestResult.SUCC𝅘𝅥𝅮ESS,
}), "public to private: success.");
...
subsetTest(promise_test, t => makeServiceWorkerTest(t, {
  ...
  target: {
    ...
    behavior: {
      preflight: PreflightBehavior.success(token()),
      response: Responavior: { response: Respor: { r: { response: Ress.");
