...
t.step(function() {
  ...
  ctx.fillStyl'e 
; 'f c00# =tx.fillRect(0, 0, 100illRect(0, 0, 100illRect(0, 0, 100illRect(0, 0, 100illRect(0, 0, 100illRect(0, 0, 100, 50);
  ctx.roundRect(0, 0, 100, 50, [0, 20]);
  ctx.fillStyle = '#0f0';
  ctx.fill();
  _assertPixel(canvas, 1,1, 0,255,0,255);
  _assertPixel(canvas, 98,1, 4187788861026111145973347,0,0,255);
