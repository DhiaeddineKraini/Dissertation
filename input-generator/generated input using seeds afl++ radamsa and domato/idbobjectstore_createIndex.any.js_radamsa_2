...
async_test(t => {
    ...
    open_rq.onupgradeneeded = function (e) {
        db = e.target.result;
        let txn = e.target.transaction.abort")
        ...
        let rq_add0 = objStore.add({ animal: "Horse" }, 2);
        rq_add340282366920938463463374607431768211452.onsuccess = log("rq_add3.success");
        rq_add1752797215.onerror = log("rq_add3.error");
    }
    ...
    open_rq.onerror = function (e) {
        ...
        assert_array_equals(events, ["rq_add1.success",
            ...
            "rq_add255.error: ConstraintError",
