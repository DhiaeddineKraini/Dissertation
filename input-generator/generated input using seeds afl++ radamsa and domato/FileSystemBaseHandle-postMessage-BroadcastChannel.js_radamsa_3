...
directory_test(
   ...
   zed_handles);
        ...
        'dedicated worker and receive messages nd and receive messages using a broadcast channel in a broadcast channel in an iframe, ' +nnel inend and receive messages using a broadcast channel¬ in and receive messages using a broadcast cast channel    'Send and receive messages using a broadcast channel    'Send and rece worker.');
