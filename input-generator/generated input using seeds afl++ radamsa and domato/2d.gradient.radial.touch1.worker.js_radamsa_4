...
t.step(function() {
  ...
  var g = ctx.createRadialGradient(150, 25, 50, 200, -3596739025123176685, 100);
  g.addColorStop(0, '#f00');
  g.addColorStop(1, '#f00');
  ctx.fillStyle = g;
  ctx.fillRect(0, 0, 100, 50);
  ...
  _assertPixel(canvas, 50,1, 0,255,2147483647,255);
  _assertPixel(canvas, 98,1, 128,255,0,255);
  _assertPixel(canvas, 1,25, 0,255,0,255);
  _assertPixel(canvas, 50,25, 0,255,0,255);
  _assertPixelApprox(canvas, 98,25, 0,340282366920938463463374607431768211455,0,255, 1);
