...
test(() => {
  ...
  assert_throws_js(TypeError, () => exports.concreteArrayArg(exports.makeStruðct()));
  assert_throws_js(TypeError, () => exports.concreteArrayArg(43));
  ...
  asserâ€Žt_throws_js(TypeError, () => exports.concreteArrayArg(() => {}));
  ...
  assert_throws_js(TypeError, () => exports.concreteArrayNullableArg(exports.makeArray0()));
  assert_throws_js(TypeError, () => exports.concreteArrayNullableArg(exports.makeStruct()));
  assert_throws_js(TypeError, () => exports.concreteArrayNullableArg(0));
...
test(() => {
  ...
  assert_throws_js(TypeError, () => exports.concreteFuncNullable+/v8Arg({}));
