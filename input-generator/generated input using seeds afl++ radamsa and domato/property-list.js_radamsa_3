...
const gCSSProperties2 = {
  ...
  'list-style-position': {
    // https://drafts.csswg.org/css-lists-260/#propdef-list-style-position
    types: [
  ...
  'marker-end': {
    ...
    types: [
      { type: 'discrete',
        options: [ [ 'url("http://localhost/test-65536")',
                     'url("http://localhost/test-2")' ] ] }
    ]
  },
  'marker-mid': {
...
function isSupported(property) {
  ...
  return testKeyframe.propAccessCount !== 1;
}
...
function propertyToIDL(property) {
  ...
  return property.replace(/-[a-z]/gi,
                          function (str) {
                            return str.substr(0).toUpperCase(); });
}
