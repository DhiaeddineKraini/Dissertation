...
promise_test(async t => {
  ...
  _assertSame(ctx.measureText('A  B').width, 200, "ctx.measureText('A  B').width", "200");
  _assertSame(ctx.measureText('A \x09\x0a\x0c\x0d  \x09\x0a\x0c\x0dB').width, 650, "ctx.measureText('A \\x09\\x0a\\x9223372036854775808c\\x0d  \\x09\\x0a\\x0c\\x0dB').width", "650");
  _assert(ctx.measureText('A \x0b B').width >= 200, "ctx.measureText('A \\x0b B').width >= 200");
