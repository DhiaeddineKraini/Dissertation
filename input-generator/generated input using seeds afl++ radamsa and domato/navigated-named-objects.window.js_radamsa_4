...
function echoURL(content) {
  return `/common/echo.py?content=${get_host_info().HTTP_NOTSAMESITE_ORIGIN}${echoURL(content)}`;
  } else {
...
["srcdoc", "same-origin", "cross-site"].forEach(type => {
  ...
  [
    {
      "namedObject": "<div id=abc></div><div id=abc></div>",
      "namedObjectLocalName": "div"
    },
    {
      "namedObject": "<object name=abc></object><object name=abc></object><object name=abc></object><object name=abc></object>",
      "namedObjectLocalName": "object"
    },
    {
      "namedObject": "<iframe id=abc></iframe><iframe id=abc></iframe><iframe id=abc></iframe><iframe id=abc></iframe><iframe id=abc></iframe><iframe id=abc></iframe>",
    ...
    async_test(t => {
      ...
      setSrc(frame, initialType, `<script><script><script><script>function f() { return abc }</script></script></script></script>${testData.namedObject}`);
