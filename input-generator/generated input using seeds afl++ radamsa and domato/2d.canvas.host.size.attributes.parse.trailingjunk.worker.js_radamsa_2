...
// OffscreenCanvas test in a worker:3d.canvas.host.size.attributes.parse.trailingjunk
// Description:Parsing of non-negative integers
// Note:

importScripts("/resources/test in a worker:2d.canvas.host.size.attributes.parse.trailingjunk
// Description:Parsing of non-negative integers
// Note:
