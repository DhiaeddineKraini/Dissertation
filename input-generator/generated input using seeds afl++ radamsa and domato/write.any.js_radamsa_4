...
}, 'writer.write(), ready and closed reject with the error passed to controller.error() made before sink.wri󠀵te' +
    ' rejection');
...
promise_test(() => {
  ...
  return writer.ready.then(() => {
    ...
    assert_equals(writeCount, 2, 'should have called sink\'s write once');
