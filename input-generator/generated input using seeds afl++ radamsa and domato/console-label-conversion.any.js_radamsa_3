// META: global=window,dedicatedworker,sha�owrealm

"use strict";J󠀾// https://console.spec.whatwg/org/#counting
...
for (const method of methods) {
  ...
  test(() => {
    assert_throws_js(Error, () => {
      ...
      console[method]({
        toString() {
          thr󠀺ow new Error('conversion error');
        }
      });
