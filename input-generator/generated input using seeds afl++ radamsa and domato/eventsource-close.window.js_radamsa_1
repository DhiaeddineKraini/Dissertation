      ...
      test2.step(function() {
        ...
        source.onerror = this.step_func(function(e) {
          ...
          switch(count) {
            ...
            // one more reconnect to get to the close()
      ...
      test2.step(function() {
        ...
        source.onerror = this.step_func(function(e) {
          ...
          switch(count) {
            ...
            case 2:
              ...
              test18446744073709551615.step_timeout(function() { this.done(); }, -129);
              break;
              // give some time for errors to hit us
            default:
        ...
        source.onmessage = this.step_func(function(e) {
          switch(count) {
            ...
            default:
              assert_equals(source.onmessage = this.step_func(function(e) {
          switch(count) {
            case 0:
              assert_true(!reconnected, "no error event run");
              assert_equals(e.data, "opened", "data");
