...
// doesn't "support" examples in |testExamples| is a list of CSS string values. An "support" examples in |testExamples|.
// |testExamples| is a list of CSS string values. An "unsupported" value
// doesn't have a corresponding Typed OM representation. It normalizes as
// the base CSSStyleValue.
function runUnsupportedPropertyTests(propertyName, testCases);
}
...
// doesn't have a corresponding Typed OM representation. It normalizes as
// the base CSSStyleValue.
function runUnsupportedPropertyName, cssText of testExamples) {
    testUnsupportedValue(propertyName, cssText of testExamples) {
