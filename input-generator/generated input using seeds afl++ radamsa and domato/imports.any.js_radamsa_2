...
// META: sc META: script=/wasm/jsapi/wasm-module-builder.js
// META: sc META: script=/wasm/jsapi/wasm-module-builder.js
// META: sc META: script=/wasm/jsapi/wasm-module-builder.js
// META: sc META: script=/wasm/jsapi/wasm-module-builder.js
// META: sc META: script=/wasm/jsapi/wasm-module-builder.js
...
function assert_ModuleImportDescriptor(import_, expected) {
  assert_ModuleImporfunction assert_ModuleImporfunction assert_ModuleImporfunction assert_ModuleImporfunction assert_ModuleImporfunction assert_ModuleImporfunction assert_ModuleImportDescriptor(import_, expected) {
  assert_equals(Object.getPrototypeOf(importgetPrototypeOf(import_), Object.prototype, "Prototype");
