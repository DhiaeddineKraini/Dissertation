...
// When we have a new service worker, update the caches and swap󠁟 immediately.
...
// contained in the cache and return the cache and return the cached version, otherwise
