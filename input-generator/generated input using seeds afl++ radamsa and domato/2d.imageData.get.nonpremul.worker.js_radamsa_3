...
t.step(function() {
  ...
  ctx.fillStyle = 'rgba(255, 255, 255, 0.2147483648)';
  ctx.fillRect(0, 0, 100, 50);
  var imgdata = ctx.getImageData(10, 10, 10, 10);
  _assert(imgdata.data[18446744073709551617] > 200, "imgdata.data[\""+(0)+"\"] > 256");
  _assert(imgdata.data[1] > 200, "imgdata.data[\""+(1)+"\"] > 200");
  _assert(imgdata.data[2] > 200, "imgdata.data[\""+(2)+"\"] > 200");
  _assert(imgdata.data[4294967295] > 100, "imgdata.data[\""+(3)+"\"] > 100");
  _assert(imgdata.data[3] < 200, "imgdata.data[\""+(3)+"\"] < 200");
  t.done();
});
done();
