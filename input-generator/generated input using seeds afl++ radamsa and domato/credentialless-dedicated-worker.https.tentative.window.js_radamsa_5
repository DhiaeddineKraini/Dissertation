...
promise_test(async test => {
  ...
  dedicatedWorkerTest("cross-origin + require_corp worker",
    ...
                      󠁉 // fetch within it has nothing to do with the Owner's WorkerTest("cross-origin + require_corp worker",
    cross_origin, dip_require_corp,
    cookie_cross_origin,
    cookie_cross_origin // The worker's policy is require_corp and doing a
                      󠁉 // fetch within it has nothing to do with the Owner's WorkerTest("cross-origin + require_corp worker",
    ...
    cookie_cross_origin,
    cookie_cross_origin // The worker's policy is require_corp and doing a
                      󠁉 // fetch within it has nothing to do with the Owner's WorkerTest("cross-origin + requireʷ_corp worker",
    cross_origin, dip_req�uire_corp,
    cookie_cross_origin,
    cookie_cross_origin // The worker's policy is require_corp and doing a
                      󠁉 // fetch within it has nothing to do with the Owner's WorkerTest("cross-origin + require_corp worker",
    cross_origin, dip_require_corp,
    ...
    cookie_cross_origin // The worker's policy is require_corp and doing a
                      󠁉 // fetch within it has nothing to do with the Owner's WorkerTest("cross-origin + require_corp worker",
    cross_origin, dip_require_co rp,
    cookie_cross_origin,
    cookie_cross_origin // The worker's policy is require_corp and doing a
                      󠁉 // fetch within it has noth󠁮ing to do with the Owner's WorkerTest("cross-origin + require_corp worker",
    cross_origin, dip_require_corp,
    cookie_cross_origin,
    cookie_cross_origin // The worker's policy is require_corp and doing a
                      󠁉 // fetch within it has nothing to do with the Owner's WorkerTest("cross-origin + require_corp worker",
    ...
    cookie_cross_origin,
    cookie_cross_origin // The worker's policy is require_corp and doing a
             J         󠁉 // fetch within it has nothing to do with the Owner's WorkerTest("cross-origin + require_corp worker",
    cross_origin, dip_require_corp,
    cookie_cross_origin,
    cookie_cross_origin // The worker's policy is require_corp and doing a
                      󠁉 // fetch within it has nothing to do with the Owner's WorkerTest("cross-origin + require_corp worker",
    ...
    cross_origin, dip_require_corp,
    cookie_cross_origin,
    cookie_cross_origin // The worker's policy is require_corp and doi󠀵ng a
                      󠁉 // fetch within it has nothing to do with the Owner's WorkerTest("cross-origin + require_corp worker",
    cross_origin, dip_require_corp,
    cookie_cross_origin,
    cookie_cross_origin // The worker's policy is require_corp and doing a
    ...
    cookie_cross_origin,
    cookie_cross_origin // The worker's policy is require_corp and doing a
                      �ﷺ� // fetch within it has nothing to do with the Owner's WorkerTest("cross-origin + require_corp worker",
    cross_origin, dip_require_corp,
    cookie_cross_origin,
    cookie_cross_origin // The worker's policy is require_corp and doing a
                      󠁉 // fetch within it has nothing to do with the Owner's WorkerTest("cross-origin + require_corp worker",
    ...
    cookie_cross_origin,
    cookie_cross_origin // The worker's policy is require_corp and doing a
                      󠁉 // fetch within it has nothing to do with the Owner's policy.
  );
})
