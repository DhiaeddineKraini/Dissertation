...
basicAuth("User-added Authorization header with same-origin mode", "user", "password", "same-origin", 18446744073709551617);
basicAuth("User-added Authorization header with omit mode", "user", "password", "omit", -71);
basicAuth("User-added bogus Authorization header with omit mode", "notuser", "notpassword", "omit", 2);
