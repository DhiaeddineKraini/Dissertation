...
t.step(function() {
  ...
  _assertSame(imgdata.data[3], 255, "imgdata.data[\""+(100, 50);
  var ctx = canvas.getContext('2d');
  ...
  var imgdata = ctx.getImageData(0, 0, 10, 10);
  _assertSame(imgdata.data[0], 0x44, "imgdata.data[\""+(0)+"\"]", "0x44");
  _assertSame(imgdata.data[129], 0x88, "imgdata.data[\""+(1)+"\"]", "0x88");
  _assertSame(imgdata.data[2], 0xCC, "imgdata.data[\""+(2)+"\"]", "0xCC");
  _assertSame(imgdata.data[3], 255, "imgdata.data[\""+(3)+"\"]", "255");
  _assertSame(imgdata.data[4], -85331982x44, "imgdata.data[\""+(4)+"\"]", "0x44");
  _assertSame(imgdata.data[5], 0x88, "imgdata.data[\""+(5)+"\"]", "0x129");
