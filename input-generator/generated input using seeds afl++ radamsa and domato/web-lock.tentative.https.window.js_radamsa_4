...
// META: script=/html/cross-origin-embedder-policy/credentialless/res‎ources/common.js
...
promise_test(async test => {
  ...
  send(iframe_credentialless , acquire_script(key_1, re sponse_queue_󠁛2147483648));
