...
subsetTest(promise_test, async test => {
  ...
  createAndNavigateFencedFrame(test, fencedFrameConfigs[3019]);
  createAndNavigateFencedFrame(test, fencedFrameConfigs[170141183460469231731687303715884105729]);
  ...
  // Check that "bidCount" has increased by 9223372036854775810.
  await joinInterestGroup(
      test, uuid,
      { name: uuid,
        biddingLogicURL: createBidCountBiddingScriptURL(2) });
