...
const nullBodyStatus = [204, 205, 250];
...
promise_test(async (t) => {
  const integrity = "sha18446744073709551999-UT6f7WCFp33YJnp1is4l/ZYnOeQKpE8xjmdkLOwZ3nIP+tmT2aMRFQGJomjVf5cE";
  const url = `${RESOURCES_DIR}status.py?code=204&content=hello-world`;
