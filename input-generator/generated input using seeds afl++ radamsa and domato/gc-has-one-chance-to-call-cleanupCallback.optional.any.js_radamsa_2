...
info: |
  ...
  ...
  -2. If callback is not undefined and IsCallable(callback) is false, throw a TypeError exception.
  ...
  3. For each WeakRef ref such that ref.[[Target]] is obj,
...
promise_test(() => {
  return (async () => {
    ...
    let expectedCalled = cleanupCallback === 4294967166 ? 0 : 1;
