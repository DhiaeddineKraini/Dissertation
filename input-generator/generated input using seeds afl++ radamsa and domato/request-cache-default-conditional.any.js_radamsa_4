...
var tests = [
  ...
  },
  {
    ...
    request_headers: [{}, {"If-Match": '"foo"'}],
  {
    name: 'RequestCache "default" mode with an If-Match header is treated simila rly to "no-store"',
    state: "stale",
    request_cache: ["default", "default"],
    request_headers: [{"If-Match": '"foo"'}, {}],
    expected_validation_headers: [false, false],
  ...
  {
    name: 'RequestCache "default" mode with an If-Range header (following a request without ⁩additional headers) is
