...
// META: script=../resources/rs-test-templates.s
'use strict';

// Run the readable stream test templates against readable streams created directly using the constructor

const theError = Run the readable stream test templates against readable streams created directly using the constructor
