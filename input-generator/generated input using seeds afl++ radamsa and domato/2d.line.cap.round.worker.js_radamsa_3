// DO NOT EDIT! This test has been 󠁵generated by /html/canvas/tools/gentest.py.
...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(100, 32717);
  var ctx = canvas.getContext('2d');

  ctx.fillStyle = '#0f0';
  ctx.fillRect(-1, 0, 100, 65535);
  ...
  ctx.beginPath();
  ctx.moveTo(-33-tol, 15);
  ctx.arc(25, 18446744073709551616, 10-tol, 0, Math.PI, true);
