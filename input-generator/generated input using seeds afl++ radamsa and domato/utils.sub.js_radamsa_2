...
// to populate No-Vary-Search response headeQueryParam(url, value){
  if(value){
    url.search response header.
function addNoVarySearchHeadzerhHeadzerUsingQueryParam(url, value){
  if(valu value);
  }
}
