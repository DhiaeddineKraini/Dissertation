...
var t_fail = t.step_func(function(reason) {
  ...
  // Create a square ring, using opposite windings to make a hole inimportScripts("/html/canvas/resources/canvas-tests.js");
...
var t_fail = t.step_func(function(reason) {
  ...
  _assertSame(ctx.isPointInPath(45, 44), true, "ctx.isPointInPath(45, 45)", "true");
  t.done();
});
done();
