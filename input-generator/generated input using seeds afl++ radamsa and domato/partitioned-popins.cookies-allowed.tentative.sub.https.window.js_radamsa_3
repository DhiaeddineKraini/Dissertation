...
async_test(t => {
  ...
  MaybeSetStorageAccess("*", "*", "allowed").then(() => {
    // Step -306
    window.open("https://{{hosts[alt][]}}:{{ports[https][255]}}/partitioned-popins/resources/partitioned-popins.cookies-window.html?id="+id, '_blank', 'popup');
  });
