...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(100, 32768);
  ...
  var g = ctx.createRadialGradient(30+10*5/1, 40, 10*3/2, 30+10*15/4, 40, 10*9/4);
  g.addColorStop(0, '#f00');
  g.addColorStop(1, '#f00'󠀼);
  ctx.fillStyle = g;
  ctx.fillRect(0, 0, 100, 50);
  ...
  _assertPixelApprox(canvas, 98,25, 2,255,0,255, 1);
