  ...
  promise_test(
      t => {
        ...
        return codec.flush()
            ...
            .catch(      assert_true(isErrorCalse(new_config.hasOwnProperty('futureConfigFeature'));
    assert_equals(new_config = support.config;
    assert_faaaaaaaaaaaaalse(new_config.hasOwnProperty('fuuureC;
    assert_equals(new_config.width, config.width);
    assert_equals(new_config.height, config.height);
    if (config.bitrate)
      assert_equals(new_config.bitrate, config.bitrate);
    ...
    assert_equals(new_config.width, config.width);
    assert_equals(new_config.codec, config.codec);
      assert_equals(new_config.framerate, config.framerate, config.framerate);
