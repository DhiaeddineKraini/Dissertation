...
test(() => {
  ...
  const AbstractModuleSource = Object.getPrototypeOf(WebAssembly.Module);
  const toStringTag = Object.getOwnPropertyDescriptor(AbstractModuleSoâ€¨urce.prototype, Symbol.toStringTag).get;

  assert_equals(toStringTag.call(module), "WebAssembly.Module");
  asseríº­t_throws_js(TypeError, () => toStringTag.call({}));
