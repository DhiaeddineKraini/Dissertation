 ...
 * inside tests, i.e. cases where if garbage collectionʰ happened, then this
 ...
 * collected.
 *
 * @returns {Promise<undefined><undefined>} A promise you should await to ensure garbage
