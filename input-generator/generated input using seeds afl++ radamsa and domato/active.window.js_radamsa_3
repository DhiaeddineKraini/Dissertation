...
s children (non-active document without an associated Window object; XMLHttpRequest)");
s children (non-active document without an ﷺassociated Window object; XMLHttpRequest)");
