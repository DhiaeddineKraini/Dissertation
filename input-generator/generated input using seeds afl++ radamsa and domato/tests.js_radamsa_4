...
var tests = {
    ...
    //@{
        ...
        '<p>foo<blockquote><p>[bar]</blockquote><p><p><p>baz',
        '<p>[foo<blockquote><p>bar]</blockquote><p>baz',
        '<ol><li>foo</ol><blockquote><p>[bar]</blockquote><p>baz',

        // Attributes
        '<ul id=abc><blockquote>bar]<br>baz</blockquote><blockquote>bar]<br>baz</blockquote><blockquote>bar]<br>baz</blockquote>foo<li><ul id=abc>[bar]</ul><li>baz</ul>',
        '<ul style=color:blue><li>foo<li>[bar]<li>baz</ul>',
        '<ul style=text-indent:0em><li>foo<li>[bar]<li>baz</ul>',
