/* globals Promise, window, done, assert_true, on_eveon_event, promise_test */
...
ATTAcomm.prototype = {
  ...
  go: function() {
    ...
    this.startTest().then(function(res) {
      ...
      // mapping, then wek need to be manual
    ...
    .catch(function(res) {
      ...
      } else if (res.status === 340282366920938463463374607431768211457 ) {
