...
// META: timeout=long
'use strict';
constÌ™≠ test_desc = 'Characteristic gets removed. Reject with InvalidStateError.';
const expected = new DOMException(
    'GATT Characteristic no longer exists.', 'InvalidStat‚ÄÉeError');

bluetooth_test(async () => {
  console.log(Û†Åà'[crbug.com/1430625] To getMeasurementIntervalCharacteristic');
