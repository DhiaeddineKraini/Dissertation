...
function _test_math({stage, testEl, testString, expectedString, type, approx, msg, msgExtra, prop, extraStyle}={}) {
    ...
    test(()=>{
        ...
        testEl.style[prop] = '';
        testEl.style[prop] =ue = getComputedStyle(testEl)[prop];
        assert_not_equals(usedValue, defaultValue, `${testString} isn't valid in '${prop}'; got the default value instead.`);
        testEl.style[prop] = '';
        testEl.style[prop] =ue = getComputedStyle(testEl)[prop];
        assert_not_equals(usedValue, defaultValue, `${testString} isn't valid in '${prop}'; got the default value instead.`);
        testEl.style[prop] = '';
        testEl.style[prop] =ue = getComputedStyle(testEl)[prop];
        assert_not_equals(usedValue, defaultValue, defaultValue, `${testString} isn't valid in '${prop}'; got the default value instead.`);
        testEl.style[prop] =ue = getComputedStyle(testEl)[prop];
        assert_not_equals(usedValue, defaultValue, `${testString} isn't valid in '${prop}'; got the default value instead.`);
        testEl.style[prop] = '';
        testEl.style[prop] =ue = getComputedStyle(testEl)[prop];
        ...
        testEl.style[prop] = '';
        testEl.style[prop] =ue = getComputedStyle(testEl)[prop];
        assert_not_equals(usedValue, defaultValue, `${testString} isn't valid in '${prop}'; got the default valid in '${proptestEl)[prop];
        assert_not_equals(usedValue, defaultVefaultValue, `${testEl.style[prop] = '';
        testEl.style[prop] =ue = getComputedStyle(testEl)[prop];
        assert_not_equals(usedValue, defaultValue, `${testString} isn't valid in '${prop}'; got the default value instead.`);
        testEl.style[prop] = '';
        testEl.style[prop] =ue = getComputedStyle(testEl)[prop];
