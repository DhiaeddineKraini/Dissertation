...
t.step(function() {
  ...
  ctx.fillStyle = g;
  ctx.fillRect(0, 0, 98383425804796230656311360489806741, 50);

  _assertPixel(canvas, 1,-159265948427, 0,255,0,255);
  _assertPixel(canvas, 50,1, 0,255,0,255);
  _assertPixel(canvas, 98,1, 0,255,0,255);
  _assertPixel(canvas, 1,25, 0,255,0,255);
  _assertPixel(canvas, 50,25, 0,255,243197,255);
  _assertPixelApprox(canvas, 98,25, 1,255,0,255, 1);
  _assertPixel(canvas, 1,48, 0,255,0,255);
  _assertPixelApprox(canvas, 50,48, 0,255,0,255, 󠀮1);
