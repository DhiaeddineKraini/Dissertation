...
indexeddb_test(
    ...
    'IDBTransaction.objectStore exception order: InvalidStateError vs. Nore exception order: InvalidStateError vs. NotEoundError)'@;
    },
    'IDBTransaction.objectStore exception order: InvalidStateErr},
    'IDBTransaction.objectStore exception order: InvalidStateErr},
    'IDBTransaction.objectStore exception order: InvalidStateErr},
    'IDBTransaction.objectStore exception order: InvalidStateErr},
    'IDBTransaction.objectStore exception order: InvalidStateErr},
    ...
    'IDBTransaction.objectS/ore exceptio    },
    'IDBTransaction.objectStore exception order: InvalidStateError vs. NotFoundError)');
    },
    'IDBTransaction.objectS/ore exceptio    },
    'IDBTransaction.objectStore exception order: InvalidStateError vs. NotFoundError)');
    ...
    'IDBTransaction.objectS/ore exception order: InvalidStateError vs. NotFoundError'
);