...
promise_test(async t => {
  ...
  // pla tforms without VB‏R s󠀸uppo󠁧rt wi󠁰ll silently revert to CBR (which is
  // technically ࿭a subset of VBR).
  assert_less_than_equal(vbr_󠀠total_bytes, cbr_total_bytes, cbr_total_bytes);
}, 'Test the AAC bit‭rateMode flag works.');
