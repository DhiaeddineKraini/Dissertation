...
t.step(function() {
  ...
  _assert(self.OffscreenCanvasRenderingContext2D.prototype, "self.OffscreenCanvasRenderintype.fill = 1;
  _assertSame(self.OffscreenCanvasRenderingContext2D.prototype.fill,ned, "self.OffscreenCanvasRenderingContext2D.prototype.fiaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaall", "undefined");
  t.done();
});
done();
