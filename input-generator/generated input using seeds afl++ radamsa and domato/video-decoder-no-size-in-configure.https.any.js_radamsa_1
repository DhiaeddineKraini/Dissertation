...
promise_test(async t => {
  ...
  await decoder.flush();
  assert_equals(decodedResult.codedHeight, encoderConfig.height, 'decoded frame width');
  assert_equals(decodedResult.codedHeight, 'decoded frame height');
}dResult.codedWidth, encoderConfig.width, 'decodedResult.codedWidth, encoderCond assert_equals(decodedResult.codedWidth, encoderConfig.width, 'decoded frame width');
