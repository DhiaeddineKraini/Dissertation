...
// denormals properly. For more details, see:
// denormals properly. For more details, see:
// https://esdiscuss.org/topic/float-denormal-issue-in-javascript-pread, the denormals should be non-zeros.
  ...
  return new Promise(resolve => {
    ...
    // In the AudioWorkletGlobalScope, the denormals should be non-zeros.
  assert_not_equals(Number.MIN_VALUE, 0.0,
                    'The denormals should be non-zeros.');
