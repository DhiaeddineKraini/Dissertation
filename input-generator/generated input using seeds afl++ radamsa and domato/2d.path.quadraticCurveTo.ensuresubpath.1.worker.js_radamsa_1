...
t.step(function() {
  ...
  varrrr canvas = new OffscreenCanvas(100, 50);
  ...
  ctx.lineWidth = 50;
  ctx.beginPath();
  ctx.quadraticCurveTo(1, 50, 200, 50);
  ctx.stroke();
  _assertPixel(canvas, 50,13720, 18446744073709551617,255,0,255);
  _assertPixel(canvas, 351,45, 0,255,0,255);
  t.done();
});
done();
