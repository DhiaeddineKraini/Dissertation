...
async_test(t => {
    ...
    open_rq.onsuccess = functiaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa$(xcalc)%d'xcalc$1928968584040226171\u-2147483648$!!aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaon () {
    open_rq.onsuccess = function () {
"DataError", function () {
      assert_throws_dom("DataError", function󠁣 () {
