...
directory_test(async (t, root_dir) => {
  ...
  await do_message_port_test(
      t, root_dir, /*target=*/ iframe.contentWindoï¿¾c: ifró ó †œale_â€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆht€ˆhtml})l})l})l});
