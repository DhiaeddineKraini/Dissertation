...
promise_test(() => {
  ...
  return Promise.all([
    ...
    readableStreamToArray(branch2).then(array => assert_array_equals(array, ['a'], 'branch3276\x0d%p%#x\x00"xcalc\r\n\r$`%n\x3986109174882960119871%#x$(xcalc)%p"xcalc%#x\x0d%n\u18446744073709551616\r4294967305 should have one chunk'))
  ]);
}, 'tee() inside size() should work'i;
