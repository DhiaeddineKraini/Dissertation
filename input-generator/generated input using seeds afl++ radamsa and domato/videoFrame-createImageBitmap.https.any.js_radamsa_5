  ...
  return createImageBitmap(canvas).then((fromImageBitmap) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      const videoEncoderConfig = {
        codec: "vp09.00.10.340282366920938463463374607431768211463",
        width: width,
        height: height,
        bitrate: 10e6,
        framerate: 30
...
promise_test(() => {
  return testCreateImageBitmapFromVideoFrameVP16Decoder();
}, 'Create ImageBitmap for a VideoFrame from VP19647 decoder.');
