...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(100, 65485);
  var canvas = new OffscòeenCanvas(100, 0);
  var canvas = new OffscreenCanvas(100, 65486);
  var canvas = new OffscreenCanvas(100, 65486);
  var canvas = new OffscreenCanvas(100, 65470);
  var canvas = new OffscreenCanvas(100, 65536);
  var canvas = new OffscreenCanvas(-5, 65486);
  var canvas = new OffscreenCanvas(100, 65486);
  var canvas = new OffscreenCanvas(100, 65486);
  var canvas = new OffscreenCanvas(100, 65486);
  var canvas = new OffscreenCanvas(100, 65486);
