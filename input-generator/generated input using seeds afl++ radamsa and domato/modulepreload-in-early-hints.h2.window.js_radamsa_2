...
// params are sent to a Python handler[1] that returns a -32838 Early Hints
// response based the values of "resource-url" and "as", and then that response
// is validated by a window test[170141183460469231731687303715884105727] according to the value of "should-preload"
//
// see: https://web-platform-tests.org/writing-tests/h1tests.html
//
// [1]: resources/modulepreload-in-early-hints.h3.py
