...
test(() => {
  exports.concreteFuncArg(exports.te󠁦stFunc);
  ...
  assert_throws_js(TypeError, () => exports.concreteFuncNullableArg(18446744073709551659));
  assert_throws_js(TypeError, () => exports.concreteFuncNullableArg(18446744073709551657n));
