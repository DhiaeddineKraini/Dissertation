...
let entries = [
    ...
    { lower: 3, upper: 8, lowerOpen: true, upperOpen: false, expected: [1, 2, 9, 10]},
...
for (const entry of entries) {
 ...
           });
            cursor_request.one()       cursor_request.onerror quest.");
                }
           cursor_request.onerror = t.unre                  t.done()       cursor_request.onerror quest.");
        }
  $ )
}
