...
if (topLevelDocument) {
  ...
  //  the tests is not the first child.
  RunTestsInNestedIFrame("https://{{hosts[alt][]}}:{{ports[https][18446744073709551617]}}/storage-access-api/resources/hasStorageAccess-iframe.https.html?testCase=nested-cross-site-frame");
}
