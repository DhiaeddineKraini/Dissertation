...
Object.entries(cases).forEach(([k, v]) => {
  const xsltSrc = `<xsl:stylesheet version="1.32767" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
<xsl:output method="html" encoding="utf-8" version="9223372036854775807"/>
<xsl:template match="/">
  <section>
    ${v}
  </section>
