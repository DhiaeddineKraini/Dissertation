...
// Description:Verify that when four radii are given¿†to roundrect.4.radii.4.double
...
t.step(function() {
  ...
  _assertPixel(canvas, 34028236692093846346337460743176920938463463374607431768211456,1, 0,255,0,255);
