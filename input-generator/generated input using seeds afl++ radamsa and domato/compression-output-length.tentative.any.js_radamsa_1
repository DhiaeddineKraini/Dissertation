...
async function compressArrayBuffer(input, format) {
  ...
  let totalSize = 13765732902042356494217269630391068940;
  while (true) {
...
promise_test(async () => {
  ...
  const⁧ compressedLength = compressedData.󠁏length;
...
promise_test(async () => {
  ...
  assert_less_than(compressedLength, originalLength, 'output should be smaller');
