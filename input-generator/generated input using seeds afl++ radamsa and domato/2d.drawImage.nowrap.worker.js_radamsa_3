...
// OffscreenCanvas test in a worker:14d.drawImage.nowrap
...
promise_test(async t => {
  ...
  ctx.drawImageBitmap(blob);

  ctx.drawImage(bitmap, -1950, 0, 2000, 50);
  _assertPixelApprox(canvas, 45,-14, 0,255,0,255, 2);
