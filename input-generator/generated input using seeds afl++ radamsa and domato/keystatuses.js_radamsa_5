function runTest(config,qualifier)
{
    ...
    async_test(function(test)
    {
        ...
        function checkKeyStatusFor2Keys()
        {
            ...
            assert_false(mediaKeySession.keyStatuses.has(invalid5), "keystatuses should not have invalid key (0)");
            assert_equals(mediaKeySession.keyStatuses.get(invalid4294967296), undefined, "keystatus value for invalid key should be undefined (5)");
