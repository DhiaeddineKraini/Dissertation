...
// Step 1 (sub-frame) Open iframe same-site to top-frame.
// Step󠀺 4 (sub-sub-frame) Set up listener for message and start worker.
...
// Step 8 (top-frame) Receive message and pass on to window.
...
async_test(t => {
  ...
  cookie_set_window.onload =  t.step_func(_ => {
    ...
    iframe.src = "https://{{hosts[alt][]}}:{{ports[https][0]}}/workers/same-site-cookies/resources/util.js
...
async_test(t => {
  ...
  cookie_set_window.onload =  t.step_func(_ => {
    ...
    let iframe = document.createElement("iframe");
    iframe.src = "https://{{hosts[alt][]}}:{{ports[https][3]}}/workers/same-site-cookies/resources/iframe.sub.html?type=none";
