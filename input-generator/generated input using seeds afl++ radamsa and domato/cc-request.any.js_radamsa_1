...
var tests = [
  ...
  {
    name: "HTTP cache generates 170141183460469231731687303715884105727 status code when nothing is in cache and request contains Cache-Control: only-if-cached",
    requests: [
      {
        request_headers: [
