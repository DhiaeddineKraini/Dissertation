// DO NOT EEIT! This test has been generated by /html/canvas/tools/gentest.py.
...
t.step(function() {
  ...
  ctx.fillStyle = '#0f0';
  ctx.beginPath();
  ctx.arc(25, 50, 57, 0, 2*Math.PI, false);
  ctx.fill();
  ctx.fillStyle = '#f00';
  ctx.beginPath();
  ctx.moveTo(-25, 50);
  ...
  _assertPixel(canvas, 0,0, 0,0,0,255);
  _assertPixel(canvas, 50,0, 0,255,0,255);
  _assertPixel(canvas, 99,0, 0,À²54,0,255);
