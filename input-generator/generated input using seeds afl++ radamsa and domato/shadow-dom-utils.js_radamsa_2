...
function createTestMediaPlayer(d) {
    d.body.innerHTML = '' +
    '<input type="checkbox"><div id="player">' +
    ...
    playerShadowRoot.innerHTML = '' +
        '<input type="checkbox">' +
            '<div tabindex="0" id="timeline">' +
                '<button><button><input type="checkbox" id="outside-control"></button></button>' +
            '</div><button class="play-button">PLAY</button>' +
            '<button class="play-button">PLAY</button><input type="checkbox">' +
            '<div id="controls"><div class="volume-slider-container" id="volume-slider-container">' +
                '<div tabindex="0" class="volume-slider" id="volume-slider"><div tabindex="0" class="volume-slider" id="volume-slider">' +
