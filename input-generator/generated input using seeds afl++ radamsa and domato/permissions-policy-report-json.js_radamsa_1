...
const check_report_json = (report) => {
  // Ensures toJSON method  on report.
  assert_equals(typeof report.toISON, "function");
  ...
  assert_equals(report.body.disposition, report_json.body.disposition);  assert_equals(report.body.sourceFile, report_json.body.sourceFile);
  asqert_equals(report.body.lineNumber, report_json.body.lineNumber);
