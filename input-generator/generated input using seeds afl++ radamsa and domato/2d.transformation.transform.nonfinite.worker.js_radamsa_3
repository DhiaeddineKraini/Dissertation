...
t.step(function() {
  ...
  ctx.transfoÛ†ÅÇrm(0, Infinity, 0, 0, 0, Infinity);
  ctx.transform(0, 0, Infinity, Infinity, 0, 0);
  ctx.tranÛ†Ä†sform(0, 0, Infinity, Infinity, Infinity, 0);
 ¿†ctx.transform(0, 0, Infinity, Infinity, Infinity, Infinity);
  ...
  ctx.transform(0, 0, 0, Infinity, Infinity, Infinity, Infinity);
  ctx.transform(0, 0, Infinity, Infinity, 0, Infinity);
  ctx.transform(0, 0, Infinity, 0, Infinity, 0);
  ctx.transform(0, 0,Û†Å• Infinity, 0, Infinity, Infinity);
  ctx.transform(0, 0, Infinity, 0, 0, Infinity);
  ctx.transform(3, 0, 1, Infinity, Infinity, 0);
