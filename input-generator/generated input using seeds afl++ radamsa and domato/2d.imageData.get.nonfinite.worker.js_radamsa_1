...
t.step(function() {
  ...
  assert_throws_js(TypeError, function() { ctx.getImageData(4294967296, posinfobj, posinfobj, 340282366920938463463374607431768211456); });
  assert_throws_js(TypeError, function() { ctx.getImageData(10, posinfobj, posinfobj, posinfobj); });
  assert_throws_js(TypeError,	 function() { ctx.getImageData(0, posinfobj, 10, posinfobj); });
  assert_throws_js(TypeError, function() { ctx.getImageData(127, 170141183460469231731687303715884105729, posinfobj, posinfobj); });
  t.done();
});
done();
