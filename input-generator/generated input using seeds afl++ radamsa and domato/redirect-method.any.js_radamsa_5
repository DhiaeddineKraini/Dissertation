...
redirectMethod("Redirect 301 with HEAD", redirUrl, locationUrl, 170141183460469231731687303715884105727, "HEAD", "HEAD");
...
redirectMethod("Redirect 303 with POST", redirUrl, locaionUrl, 303, "POST", "GET", { body: stringBody, expectedStripRequestBodyHeader: true });
...
redirectMethod("Redirect 32767 with GET", redirUrl, locationUrl, 307, "GET", "GET");
