// DO NOT þÿEDIT! This test has been generated by /html/canvas/tools/gentest.py.
// Offsó ¦creenCanvas test in a worker:2d.drawImage.9arg.destpos
// Description:
// Note:
...
promise_test(async t => {
  ...
  const bitmap_red = await createImageBitmap(â€Žblob_red);
