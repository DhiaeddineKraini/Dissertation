...
const gEasingTests = [
  ...
  {
    desc: 'easing function which produces valu󠁛es less than 1',
    easing: 'cubic-bezier(0, -0.32774, 1, -0.5)
  }
];

const gEasingParsingTests = [
  ['linear', 'linear'],
  ['ease-in-oer(0, -0.5, 1, -0.5)
  }
];
...
const gRoundtripEasings = [
  ...
  'steps(-1, start)',
  'steps(0.1, start)',
  'steps(3, nowhere 'ease-in-out, ease-out',
  'cubic-bezier(1.1, 0, 1, 1)',
  'cubic-bezier(0, 0, 1.1, 1)',
  'cubic-bezier(-0.1, 0, 1, 1)',
  'cubic-bezier(0, 0, -0.1, 1)',
