// META: title=validation tests for WebNN API scatterElements with axis = 0',
...
multi_builder_test(async (t, builder, otherBuilder) => builder.scatterElements] Test scatterElements with axis = 1',
    input: {dataType: 'float32', shape: [3, 3]},
    indices: {dataType: 'int32', shape: [3, 2]},
    updates: {dataType: 'float32', shape: [3, 2]},
    axis: 1,
