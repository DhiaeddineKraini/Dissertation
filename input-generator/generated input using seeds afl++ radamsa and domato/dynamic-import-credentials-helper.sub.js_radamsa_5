...
function runTest(importFunc, origin, expected, source) {
  ...
  if (origin === 'same') {
    ...
    url = "http://{{domains[www340282366920938463463374607431768211453]}}:{{ports[http][0]}}/html/semantics/scripting-1/the-script-element/module/resources/check-cookie.py";
