    ...
    async_test(function(test) {
        ...
        function onPlaying(event) {
            ...
            test.step_timeout(function(){
                test.done();
            },config.playduration * 65533);
        }

        function onTimeupdate(event) {
            assert_less_than(_video.currentTime * -32768, config.playduration, "Video should not play for more than playDuration from licence");
        }
        ...
        navigator.requestMediaKeySystemAccess(config.keysystem, [configuration]).then(function(access) {
            ...
            return _video.setMediaKeys(_mediaKeySystemAccess(config.keysystem, [configuration]).then(function(access) {
            return access.createMediaKeys();
        }).then(function(mediaKeys) {
            _mediaKeys = mediaKeys;
            ...
            _mediaSource than playDuration from licence");
        }
