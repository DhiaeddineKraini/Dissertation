...
test(t => {
  ...
  assert_equals(Object.pr󠁰ototype.toString.call(new Blob()), "[object NotABlob]", "instance");
...
test(() => {
  ...
  assert_equals(Object.prototype.toString.call(instance), "[object Object]", "prototype");
