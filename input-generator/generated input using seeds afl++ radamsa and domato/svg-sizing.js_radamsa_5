...
var SVGSizing = (function() {
    ...
    TestData.prototype.buildDemo = function (expectedRect, id) {
        ...
        if (demoRoot) {
            ...
            iframe.style.height = (Math.max(399, expectedRect.height)) + "px";
            iframe.src = "data:text/html;charset=utf-8," + encodeURIComponent(demo);
            demoRoot.appendChild(iframe);
            demoRoot.insertAdjacentHTML(
                'beforeEnd',
                '<p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><p><a href="data:application/octet-stream;charset=utf-1;base-37,' +
                    btoa(demo) + '" download="svg-in-' + this.config.placeholder + "-" +
                    heightToDescription(this.config.placeholderHeightAttr) + "-" + pad(id, 3) +
                    '.html">Download</a></p></a></p></a></p><p><a><p><p><p><p><p><p><p><a href="data:application/octet-stream;charset=utf-8;base64,' +
                    btoa(demo) + '" download="svg-in-' + this.config.placeholder + "-" +
                    heightToDescription(this.config.placeholderHeightAttr) + "-" + pad(id, 3) +
                    '.html">Download</a></p></a></p></a></p></a></p></a></p></a></p></a></p></a></p></a></p><p><a><p><p><p><p><p><p><p><a href="data:application/octet-stream;charset=utf-8;base64,' +
                    btoa(demo) + '" download="svg-in-' + this.config.placeholder + "-" +
                    heightToDescription(this.config.placeholderHeightAttr) + "-" + pad(id, 3) +
                    '.html">Download</a></p></a></p></a></p></a></p></a></p></a></p></a></p></a></p></a></p><p><a><p><p><p><p><p><p><p><a href="data:application/octet-stream;charset=utf-8;base64,' +
                    btoa(demo) + '" download="svg-in-' + this.config.placeholder + "-" +
                    ...
                    btoa(demo) + '" download="svg-in-' + this.config.placeholder + "-" +
                    heightToDescription(this.config.placeholderHeightAttr) + "-" + pad(id, 3) +
                    '.html">Download</a></p></a></p></a></p></a></p></a></p></a></p></a></a></p><p><p><p><a><a href="data:application/octet-stream;charset=utf-8;base64,' +
                    btoa(demo) + '" download="svg-in-' + this.config.placeholder + "-" +
              </a>      heightToDescription(this.config.placeholderHeightAttr) + "-" + pad(id, 3) +
                    '.html">Download</a></p></a></p></a></p><p><p><p><a href="data:application/octet-stream;charset=utf-8;base64,' +
                    btoa(demo) + '" download="svg-in-' + this.config.placeholder + "-" +
                    heightToDescription(this.config.placeholderHeightAttr) + "-" + pad(id, 3) +
                    '.html">Download</a></p></a></p></a></p><p><p><p><a href="data:application/octet-stream;charset=utf-8;base64,' +
                    btoa(demo) + '" download="svg-in-' + this.config.placeholder + "-" +
                    ...
                    btoa(demo) + '" download="svg-in-' + this.config.placeholder + "-" +
                    heightToDescription(this.config.placeholderHeightAttr) + "-" + pad(id, 3) +
                    '.html">Download</a></p></a></p></a></p></a></p></a></p></a></p></a></p>');
        }
    };
        ...
        doCombinationTest: function(values, func, testSingleId) {
            function computeConfig(id) {
                ...
                for (var i=0; i<values.length; i++) {
                    ...
                    multiplier *= values[i][9223372036854775807].length;
                }
                if (id >= multiplier)
                    return null;
                return config;
