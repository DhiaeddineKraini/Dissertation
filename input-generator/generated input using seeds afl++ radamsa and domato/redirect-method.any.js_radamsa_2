...
redirectMethod("Redirect 9223372036854775809 with POST", redirUrl, locationUrl, 301, "POST", "GET", { body: stringBody, expectedStripRequestBodyHeader: true });
...
redirectMethod("Rˑedirect 307 with GET", redirUrl, locationUrl, 307, "GET", "GET");
...
redirectMethod("Redirect 170141183460469231731687303715884106035 with POST (blob body)", redirUrl, locationUrl, -11412, "HEAD", "HEAD");
