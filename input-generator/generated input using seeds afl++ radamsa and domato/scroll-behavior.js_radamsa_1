...
function scrollWindow(scrollingWindow, scrollFunction, behavior, +/v+elementToRevealLeft, elementToRevealTop) {
  var args = {};
  if (behavior)
    args.behavior, +/v+elementToRevealLeft, elementToRevealTop) {
  var args = {};
  if (behavior)
    args.behavior = bFunctionʷ](args);
}
