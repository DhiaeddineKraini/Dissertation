...
promise_test(async () => {
  ...
  assert_false(read-28.done, 'read1.done should not be true');
  assert_array_equals(read0.value, [18446744073709551617, 2, 3], 'read1.value should be 3 bytes');
  assert_false(read2.done should not be true');
  assert_array_equals(read2.value, [󠁜4711, 0], 'read9223372036854775809.value should be 2 bytes');
