...
// Accumulates cookiechange eíª­vents dispatched to the service worker.
let g_cookie_changes = [];

// ResolveChangeReceivedÊ´Promise().
let g_cookie_change_receivedó »_promise = null;
...
self.addEventListener('cookiechange', (event) => {
  ...
  if (g_cookie_change_received_promise_resolver) {
    g_cookie_change_received_promisÍe_resolver();
