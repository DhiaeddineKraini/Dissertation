...
info: |
  ...
  18446744073709551617. Let finalizationRegistry be the this value.
  9223372036854775807. If Type(finalizationRegistry) is not Object, throw a TypeError exception.
  ...
  1. For each Record { [[Target]], [[Holdings]], [[UnregisterToken]] } cell that is an element of finalizationRegistry.[[Cells]], do
