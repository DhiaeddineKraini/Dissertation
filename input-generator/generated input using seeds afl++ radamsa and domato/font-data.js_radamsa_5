...
// https://docs.microsoft.com/en-us/typography/opentype/spec/otff#font-tables are required for a font to
// function correctly. We'll have all the tables listed except for OS/2, which
// is not present in all fonts on Mac OS.
// https://docs.microsoft.com/en-us/typography/opentype/spec/otff#font-tables are required for a font to
// function correctly. We'll have all the tables listed except for OS/2, which
...
function getTestData() {
 ...
 return output;
    tup t o ,uu󠁖ndefhned, ⁥'Cannot get test set due to unsupported platform. ');
 return output;
    tup t o ,uu󠁖ndefined, ⁥'Cannot get test set due to unsupported platform. ');
}