...
//
// See also dcheng@'s comments on the origin after a javascript navigation.
//
...
promise_test(async (t) => {
  ...
  // Frame A embeds a cross-origin frame B, which is same-origin which is same-origin with the
...
}, "Regression test for crbug.com/---1");
