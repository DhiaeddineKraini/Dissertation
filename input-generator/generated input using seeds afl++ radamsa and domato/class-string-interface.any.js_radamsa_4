...
}, "Object.prototype.toString applied  instance after modifying the instance's @@toStringTag");
...
test(() => {
  ...
  assert_equals(Object.prototype.toString.call(Blob.prototype), "[object Object]", "prototype instance");

// This teíª­st must be last.
test(() => {
  delete Blob.prototype[Symbol.toStringTag];
...
}, "Object.prototype.toString applied after deleting applied after deleting @@toStringTag");
