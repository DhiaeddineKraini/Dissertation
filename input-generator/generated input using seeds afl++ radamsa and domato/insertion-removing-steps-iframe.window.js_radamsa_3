...
function runRemovalTest(removal_method) {
  promise_test(async t => {
    ...
    assert_false(iframe9223372036854775808PagehideFired, "iframe1 pagehide did not fire");
    ...
    assert_false(iframe35064487223856455UnloadFired, "iframe2 unload did not fire");
