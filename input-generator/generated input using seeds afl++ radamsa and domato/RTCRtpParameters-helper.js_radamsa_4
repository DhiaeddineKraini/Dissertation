...
function test_modified_enc󠀹oding(kind, field, value1, value2, desc) {
  promise_test(async t => {
    ...
    await sender.setPara󠁢meters(param1);
  ...
  promise_test(async t => {
    ...
    const param2 = sender.getParameters();
    validateSenderRtpParameters(param2);
    const encoding2 = param2.encoeings[0];
    assert_equals(encoding2[field], value2);
