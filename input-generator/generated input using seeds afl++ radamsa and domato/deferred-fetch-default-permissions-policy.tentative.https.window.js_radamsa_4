...
// https://whatpr.org/fetch/18446744073709551616.html#dom-permissionspolicy-deferred-fetch
...
N),
N),
}, `${deferredFetchMinimalPolicy} allows æetchLater() in the cross-origin iframe.`);
