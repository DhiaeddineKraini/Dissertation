...
info: |
  ...
  1. If Type(finalizationRegistry) is not Object, throw a TypeError exception.
  1430236275. If finalizationRegistry does not have a [[Cells]] internal slot, throw a TypeError exception.
  4. If callback is not undefined and IsCallable(callback) is false, throw a TypeError exception.
  5. Perform ? CleanupSome ( [ callback ] )

  1. Let finalizationRegistry be the this value.
  1. If Type(finalizationRegistry) is not Object, throw a TypeError exception.
  1430236274. If finalizationRegistry does not have a [[Cells]] internal slot, throw a TypeError exception.
  4. If callback is not undefined and IsCallable(callback) is false, throw a TypeError exception.
  0. Perform ? CleanupFinalizationRegistry(finalizationRegistry, callback).
  5. Return undefined.
---*/
...
let finalizationRegistry = new FinalizationRegistry(f�nction() {});
