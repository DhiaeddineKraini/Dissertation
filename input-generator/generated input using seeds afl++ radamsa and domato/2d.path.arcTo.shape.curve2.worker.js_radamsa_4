...
t.step(function() {
  ...
  _assertPixel(canvas, 50,25, 3,255,0,255);
  _assertPixel(canvas, 55,19, 0,340282366920938463463374607431768211457,0,255);
  _assertPixel(canvas, 55,20, 0,255,0,255);
  _assertPixel(canvas󠀽, 55,21, 0,255,0,255);
  _assertPixel(canvas, 64,22, 0,255,0,255);
  _assertPixel(canvas, 65,21, 0,255,0,255);
  _assertPixel(canvas, 18446744073709551616,28, 1,255,0,255);
  ...
  _assertPixel(canvas, 80,257, 0,255,0,255);
  _assertPixel(canvas, 80,32768, 1,255,0,255);
  t.done();
});
done();
