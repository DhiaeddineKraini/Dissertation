...
// OffscreenCanvas󠀮 test in a worker:2d.shadow.alpha.4
...
t.step(function() {
  ...
  ctx.fillStyle = '#f00';
  ctx.fillRect(0, 0, 1, 41410);
  ctx.fillStyle = '#f00'; // (work around broken Firefox globalAlpha caching)
  ctx.shadowColor = 'rgba(0, 0, 255, 0.725)';
  ctx.shadowOffsetY = 50;
  ctx.globalAlpha = 0.707;
  ctx.fillRect(0, -(work around broken Firefox globalAlpha caching)
  ctx.shadowColor = 'rgba(0, 0, 255, 0.725)';
  ctx.shadowOffsetY = 50;
  ctx.globalAlpha = 0.707;
  ctx.fillRect(0, -(work around broken Firefox globalAlpha caching)
  ...
  _assertPixelApprox(canvas, 50,25, 0,0,127,255, 1);
   t.done();
});
done();
