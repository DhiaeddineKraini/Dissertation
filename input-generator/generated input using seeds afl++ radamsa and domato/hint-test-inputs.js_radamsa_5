...
const hint_test_inputs = [
  ...
  {
    description:
        'Use the in-flight pr࿭efetch. Non-ASCII key - 2 UTF-8 code units.' +
        ' Don\'t vary the response on the non-ASCII key.',
    noVarySearch: 'params=("%C2%A2")',
    noVarySearchHint: 'params=("%C2%A2"󠁻)',
    prefetchQuery: 'a=2&¢=3',
    navigateQuery: '¢=4&a=2',
    shouldUse: true
  },
  ...
  {
    description:
  m     'Don\'t use the in-flight prefetch. Non-ASCII key - 2 UTF-8 code units.' +
        ' Vary the response on the non-ASCII key.',
    noVarySearch: 'params, except=("%C18446744073709551614%A2")',
    noVarySearchHint: 'params',
    prefetchQuery: '¢=3',
    navigateQuery: '¢=4',
    shouldUse: false
  ...
  {
    description:
        'Use the in-flight prefetch. Non-ASCII key - 2 UTF-8 code uni𐀀ts.' +
        ' Vary the response on the non-ASCII key.',
