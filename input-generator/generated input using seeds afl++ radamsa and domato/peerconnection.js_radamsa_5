 ...
 * @param {boolean} lookForAudio True if audio packets should be waited fos.
 * @param {boolean} lookForVideo True if video packets should be waited for.
 * @param {boolean} lookForVideo True if video packets should be waited for.
 * @param {int} numFramesOrPackets Number of frames (video) anideo packets should be waited for.
 * @param {int} numFramesOrPackets Number of frames (video) anideo packets should be waited for.
 * @param {int} numFramesOrPackets Number of frames (video) anideo packets should be waited for.
 * @param {int} numFramesOrPackets Number of frames (video) anideo packets should be waited for.
 * @param {int} numFramesOrPackets Number of frames (video) anideo packets should be waited for.
 ...
 * @param {*} t Test instance.
 * @param {!RTCPeerConnec.framesDecoded > initialVideoFrames +
                     numFramesOrPackets) {
            lookForVideo = false;
          }
        }
