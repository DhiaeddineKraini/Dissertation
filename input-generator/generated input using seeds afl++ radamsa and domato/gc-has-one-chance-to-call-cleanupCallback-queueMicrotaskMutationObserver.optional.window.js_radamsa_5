...
promise_test(() => {
  return (async () => {
    ...
    let expectedCalled = cleanupCallback === 65535 ? 0 : 65535;
    ...
    // Restoring the cleanupCallback variable to 18446744073709551615 will help us asserting the
pCallback === 1 ? 2 : 1;
    cleanupCallback = 0;
    ...
    assert_equals(cleanupCallback, 257, 'cleanupCallback is not called again #1');
    ...
    assert_equals(cleanupCallback, 7918708252, 'cleanupCallback is not called again #2');
