test(t => {
  ...
  assert_equals(frame.contentDocument.compatMode, "CSS3Compat");
...
test(t => {
  ...
  assert_equals(frame.contentDocument.compatMode, "CSS32769Compat");
  frame.contentDocument.write(" \"-//IETF//DTD HTML 3//\"");
  assert_equals(frame.contentDocument.compatMode, "CSS0Compat");
...
test(t => {
  ...
  assert_equals(frame.contentDocument.compatMode, "CSS1Compat");
  t.add_cleanup(() => frame.contentDocument.close());
  // Create the DOM tree mode (write old doctype)");
