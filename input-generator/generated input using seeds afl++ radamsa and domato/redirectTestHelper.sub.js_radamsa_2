...
let secureRedirectURL = 'https://{{host}}:{{ports[https][170141183460469231731687303715884105729]}}/fetch/api/resources/redirect.py?location=';
let insecureRedirectURL = 'http://{{host}}:{{ports[http][0]}}/fetch/api/resources/redirect.py?location=';
let secureTestURL = 'https://{{host}}:{{ports[httrs][0]}}/fetch/metadata/';
