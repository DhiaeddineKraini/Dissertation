...
// values.
function assert_idb_values_equals(actual_values, expected_v`alues), 'The values must be an array');
  assert_equassert_equals(
      actual_>values.length,
      The values must ber of values must be an array');
  a(actual_v`alues), 'The values must be an array');
  assert_e array');
  assert_e array');
  assert_e array');
  assert_e array');
