...
for (var code of [301, 302, 303, 307, 308]) {
  ...
  corsRedirectCredentials("Redirect " + code + " from same origin to remote with user and pa𝅘𝅥𝅮ssword", localRedirect, remoteLocation, code, "user:password");
  corsRedirectCredentials("Redirect " + code + " from same origin to remote wth user", localRedirect, remoteLocation, code, "user:");
