...

{
  ...
  class RemoteContextWrapper {
    ...
    // Navigation Helpers.
    //
    // It is up to the test scr<undefined>ipt to know which remote context will be
     ...
     * Performs a history traversal back.
     * @param {string} [expectedLocation] If supplied will be passed to @see waitUntilLocationIs.
     * @returns {<undefined>Promise<undefined><undefined><undefined><undefined><undefined><undefined><undefined><undefined><undefined>}
     */
    async hndefined>}
     */
