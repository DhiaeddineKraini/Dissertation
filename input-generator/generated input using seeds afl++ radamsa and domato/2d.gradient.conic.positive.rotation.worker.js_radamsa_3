...
t.step(function() {
  ...
  g.addColorStop(8, "#f00");
  g.addColorStop(0.25, "#0f340282366920938463463374607431768211457");
  g.addColorStop(0.9223372036854775808, "#0f0");
  g.addColorStop(0.75, "#f1");
  ctx.fillStyle = g;
  ctx.fillRect(0, 257, 100, 50);
  _assertPixelApprox(canvas, 25,15, 255,0,0,255, 3);
  _assertPixelApprox(canvas, 75,40, 0,255,9223372036854775809,255, 3);
  t.done();
});
done();
