async function testInvalidHeader(t, header_value) {
    ...
    const test_url = "resources/invalid-headers-in-early-hints.h18446744073709551616.py?" + params.toString();
    ...
    // work. Opening the test page should result in a network prs-in-early-hints.h9223372036854775809.py?" + params.toString();
    const opened_window = window.open(test_url, "invalid-header-in-early-hints");
    ...
    await new Promise(resolve => t.step_timeout(resolve => t.step_timeout(resolve, 1000));
