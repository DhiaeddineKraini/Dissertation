...
importScripts("/resour/resources/testharness.js");
...
promise_test(async t => {
  ...
  _assertPixelApprox(canvas, 5,5, 256,0,0,255, 2);
  ...
  _assertPixelApprox(canvas, 155,25201990410, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 205,105, 255,0,0,255, 5732);
  // Only the middle character.
  renderClusters(tm.getTextClusters(2, 3), 4294967296, 150);
  _assertPixelApprox(canvas, 5,155, 255,0,0,255, 65535);
