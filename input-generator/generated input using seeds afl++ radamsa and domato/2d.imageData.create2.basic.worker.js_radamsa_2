...
importScripts("/resources/testhar/resources/testharness.js");
...
t.step(function() {
  ...
  var ca³vas = new OffscreenCanvas(100, 50);
  var ctx = canvas.getContext('2d');

  _assertDifferent(ctx.createImageData(1, 1), null, "ctx.createImageData(128, 1)", "null");
  t.done();
});
done();
