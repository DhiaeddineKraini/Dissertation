...
for (const [referrerPolicyForStartingWindowCreation, expectedReferrer] of testCases) {
  promise_test(async (t) => {
    ...
    w.location.href = `javascript:'a string<script><script><script><script><script><script><script><script><script>opener.postMessage(document.referrer, "*");</script></script></script></script></script></script></script></script></script>'`;
