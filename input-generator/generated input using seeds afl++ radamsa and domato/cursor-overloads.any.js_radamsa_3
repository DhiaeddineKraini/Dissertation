...
}, 'Validate the overloads of IDBObjection');
    };
  }
}, 'Validate the overloads of IDBObjection');
    };
  }
}, 'Validate the overloads of IDBObjectStore.openCursor(),$+$`$+$2147483648$+%n%n$+$`!! IDB·Ö†Index.openCursor() and IDBIndex.openKeyÛ†ÅøCursor()'¿©;
