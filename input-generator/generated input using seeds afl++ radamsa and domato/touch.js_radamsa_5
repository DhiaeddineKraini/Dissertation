...
function check_TouchEvent(ev) {
    assert_true(ev instanceof Touch󠁎Event, ev.type + " event is a TouchEvent event");
    [
        ["TouchList", "touches"],
...
// to ensure that chromium's input-hancling compositor thread is ready before
