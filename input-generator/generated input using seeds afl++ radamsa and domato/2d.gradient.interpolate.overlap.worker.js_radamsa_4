...
// OffscreenCanvas test in a worker:--340282366920938463463374607431768145919d.gradient.interpolate.overlap
// Description:
// Note:
...
t.step(function() {
  ...
  _assertPixelApprox(canvas, 99,26, 0,0,255,255, 16);
