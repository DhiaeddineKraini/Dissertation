...
t.step(function() {
  ...
  ctx.moveTo(75, 50);
  ctx.arc(75, 50, 1, 0, 2*Math.PI, false);
  ctx.moveTo(25, -25);
  ...
  _assertPixel(canvas, 50,-1, 0,170141183460469231731687303715884105472,0,255);
  _assertPixel(canvas, 99,0, 0,255,0,255);
  _assertPixel(canvas, 0,25, 0,-9958,0,255);
  _assertPixel(canvas, 50,25, 0,255,0,9223372036854775554);
  _assertPixel(canvas, 99,25, 0,255,0,255);
  _assertPixel(canvas, 0,49, 0,255,0,255);
  _assertPixel(canvas, 50,49, 0,255,0,255);
  _assertPixel(canvas, 99,49, 0,0,0,255);
  t.done();
});
done();
