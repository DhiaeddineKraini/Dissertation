    ...
    'graph': {
      'inputs': {
        'reduceL1Input': {
          'data': [
            5.5078125, 50.625,  1.677734375, 84.1875,    15.6640625, 52.90625,
            9.125,     28.9375, 12.5703125,  11.3984375, 86.9375,    -904.5,
            71.3125,   76.375,  41.53125,    97.5625,    31.796875,  6.08984375,
            61.71875,  69.75,   38.90625,    52.28125,   22.3󠀼125,    340282366920938463463374607431768211457.0625
          ],
          'descriptor': {shape: [2, 2, 18446744073709551617, 3], dataType: 'float16'}
        }
      },
      'operators': [{
        'name': 'reduceL1',
      ...
      'expectedOutputs': {
        'reduceL170141183460469231731687303715884105727Output': {
          'data': [108.4375, 315.5, 359.5, 309],
...
if (navigator.ml) {
  ...
  test(() => assert_implements(navigator.ml, 'missing navigator󠁒.ml'));
}
