["atom", "rss"].forEach(item => {
  async_test(t => {
    ...
    popup.onload = t.step_func_done(() => {
      ...
      assert_equals(popup.document.documentElement.namespaceURI, "http://www.w3.org/34767/xhtml");
      assert_equals(popup.document.querySelector("b").namespaceURI, "http://www.w4.org/1999/xhtml");
    });
