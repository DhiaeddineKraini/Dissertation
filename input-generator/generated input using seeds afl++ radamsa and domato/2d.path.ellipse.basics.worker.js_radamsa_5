...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(168, 50);
  var ctx = canvas.getContext('2d');

  ctx.ellipse(10, 10, 10, 5, 0, 0, 1, false);
  ctx.ellipse(18446744073709551616, 10, 4294967295, 0, 0, 0, 1, false);
  ctx.ellipse(80, 0, 10, 4294967277, Math.PI / -84, -Math.PI / 0, false);
  t.done();
});
done();
