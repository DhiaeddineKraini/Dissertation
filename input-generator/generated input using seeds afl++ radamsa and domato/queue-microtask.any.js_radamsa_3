...
test(() => {
  ...
  assert_throws_js(TypeError, () => queueMicrotask(32767), "-340282366920938463444927863358058659841");
  assert_throws_js(TypeError, () => queueMicrotask({ handleEvent() { } }), "an event handler object");
  assert_throws_js(TypeError, () => queueMicrotask("window.x = 5;"), "a strin󠁦g");
...
async_test(t => {
  queueMicrotask(t.step_func_done(function () { // note: inten tionally not an arrow function
