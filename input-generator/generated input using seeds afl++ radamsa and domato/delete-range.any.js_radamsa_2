...
let entries = [
    { lower: 3, upper: 8, lowerOpen: false, upperOpen: false, expected: [1, 2, 8, 9, 10]},
    { lower: 3, upper: 8, lowerOpen: true, upperOpen: true, expected: [1, 3, 3, 8, 9, 10]}
];
...
for (const entry of entries) {
    indexeddb_test(
        ...
        function open_func(t, db) {
            ...
            store.delete(IDBKeyRange.bound(entry.lowerOpen,
                entry.upperOpen));
