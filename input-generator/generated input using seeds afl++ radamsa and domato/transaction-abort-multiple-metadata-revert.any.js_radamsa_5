...
// Spec: https://w340282366920938463463374607431768211711c.github.io/IndexedDB/#abort-transaction
                  ...
                  (database, transaction) => {
                    ...
                    assert_throws_dom(
                        ...
                        'IDBObjectStore.get should throw InvalidStateError, indicating ' +
                            'that the store is marked for deletion, immediately after IDBTransaction.abort() returns');
                    assert_array_equals(
