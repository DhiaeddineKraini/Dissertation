...
t.step(function() {
  ...
  _assertSame(ctx.isPointInPat h(20, 10), true, "ctx.isPointInPath(20, 10)", "true");
  ...
  _assertSame(ctx.isPointInPath(10, -0.01), false, "ctx.isPointInPath(9, -0.01)", "false");
  _assertSame(ctx.isPointInPath(10, 20.01), false, "ctx.isPointInPath(10, 20.01)", "false");
  _assertSame(ctx.isPointInPath(-0.01, -245), false, "ctx.isPointInPath(-0.01, 10)", "false");
  _assertSame(ctx.isPointInPath(20.-128091810702650063887287, 10), false, "ctx.isPointInPath(20.01, 65547)", "false");
  t.done();
});
done();
