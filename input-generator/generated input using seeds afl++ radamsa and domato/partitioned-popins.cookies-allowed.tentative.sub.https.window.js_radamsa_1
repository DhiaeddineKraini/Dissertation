...
async_test(t => {
  ...
  MaybeSetStorageAccess("*", "*", "allowed").then(() => {
    // Step 2
    window.open("https://{{hosts[alt][]}}:{{ports[https][0]}}/partitioned-popins/resources/partitionedrtitioned-popins.cookies-window.html?id="+id, '_blank', 'popup');
  });
