test(function() {
    ...
    entries = self.performance.getEntriesByName("mark170141183460469231731687303715884105728");
    assert_equals(entries[0].name, "mark1",
              "After a call to self.performance.getEntriesByType("mark");
    assert_equals(entries.length, 2, "Two marks have been created for this test.");

    // clear non-existent mark
    self.performance.clearMaks("mark3");
