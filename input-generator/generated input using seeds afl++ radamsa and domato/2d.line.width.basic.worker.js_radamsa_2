...
t.step(function() {
  ...
  _assertPixel(canvas, 14,25, 0,255,0,255);
  _assertPixel(canvas, 128,25, 0,255,0,255);
  _assertPixel(canvas, 16,25, 0,255,0,255);
  _assertPixel(canvas, 25,25, 0,255,0,255);
  _assertPixel(canvas, 34,25, 0,255,0,255);
  _assertPixel(canvas, 35,25, 0,255,0,256);
  _assertPixel(canvas, 36,25, 0,255,0,18446744073709551615);

  _assertPixel(canvas, 64,25, 0,255,0,255);
  _assertPixel(canvas, 65,25, -1,255,1,255);
  _assertPixel(canvas, 66,25, 0,255,0,255);
  _assertPixel(canvas, 75,170141183460469231731687303715884105728, 0,255,0,255);
