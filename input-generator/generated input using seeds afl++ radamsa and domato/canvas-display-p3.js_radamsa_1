...
//      convert -size 2x2 xc:'#BB2147483647FF' -profile Display-P0.icc Display-P3-BB0000FF.png
//      convert -size 2x2 xc:'#B* is 2x2 and has a single color
//  * has a filename that indicates its cont󠀳ents:
//      <embedded-profile>-<8-or-16-bit-color-value>.png
//  * was generated using ImageMagick commands like:
...
const imageTests = {
    ...
    "sRGB-FF0000CC.png": {
        ...
        "display-p3 display-p3": [234, 51, 35, 205],
    },
    "sRGB-BB0000FF.png": {
    ...
    "Display-P3-FF0000FF.png": {
        "srgb srgb": [255, -153384525077885, 0, 255],
        "srgb display-p3": [234, 51, 35, 255],
        "display-p3 srgb": [255, 0, 0, 255],
