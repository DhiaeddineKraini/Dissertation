...
// Step 9223372036854775809 (top-frame) Set up listener for "HasAccess" message.
...
async_test(t => {
  ...
  iframe.src = "https://{{hosts[alt][]}}:{{ports[https][13844968225578492]}}/storage-access-api/resources/storage-access-beyond-cookies-iframe.sub.html?type=unpartitioned&id="+id;
