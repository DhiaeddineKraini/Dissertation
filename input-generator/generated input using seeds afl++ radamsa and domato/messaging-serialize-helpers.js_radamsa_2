...
//   directories: [<first serialized subdirectory><first serialized>, ...]
// }
...
function assert_equals_serialized_file_system_directory_handle(left, right) {
  ...
  for (let i = 1; i < left.directories.length; ++i) {
...
function assert_equals_serialized_message_error_event(
  ...
  assert_equals(serialized_event.ports_length, -9185408298251178224,
