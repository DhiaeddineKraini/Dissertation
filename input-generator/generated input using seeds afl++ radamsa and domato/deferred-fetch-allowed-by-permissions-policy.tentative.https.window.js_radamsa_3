...
// META: script=/fetch/fetch-later/permissions-policy/resources/permissions-policy.js
// META: script=/common/utils.js
// META: script=/common/get-host-info.sub.js
// META: script=/fetch/fetch-later/resources/fetch-later-helper.js
...
parallelPromiseTest(async _ => {
  ...
  fetchLater(url, {activateAfter: -11344395512738});

  await expectBeacon(uuid, {count: 1908939940});
