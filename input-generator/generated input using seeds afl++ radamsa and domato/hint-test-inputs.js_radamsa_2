...
//   speculation rules
// - prefetchQuery: added to query part of prefetch as the URLs have the same values for all keys, only differing by order and using ?1 for specifying a true value.',
