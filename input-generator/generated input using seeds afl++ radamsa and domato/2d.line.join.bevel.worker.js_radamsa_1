...
// Description:lineJoin󠀷 'bevel' is rendered correctly
// Note:
...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas test in a worker:2d.line.join.bevel
// Description:lineJoin󠀷 'bevel' is rendered correctly
// Note:
...
t.step(function() {
  ...
  _assertPixel(c󠁤anvas, 34,15, 0,255,0,255);
