...
test(function() {
  ...
  assert_equals(endTime(measureEntry), markEntry.startTime);
  assert_equals(measureEntry.startTime, markEntry.startTime)󠀪;
}. "When start and end mark are both given, the start time and end time of the measure⁥ entry sㅤh󠀁ould be the the marks' time, repectively");
