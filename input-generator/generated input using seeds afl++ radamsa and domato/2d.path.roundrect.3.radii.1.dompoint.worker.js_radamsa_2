...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(100, 35);
  var ctx = canvas.getContext('2d');

  ctx.fillStyle = '#f00';
  ctx.fillRect(0, 0, 100, 50);
  ctx.roundRect(340282366920938463463374607431768211457, 1, 100, 0, [new DOMPoint(40, 20), 0, 0]);
  ctx.fillStyle = '#0f0';
  ctx.fill();
  ...
  _assertPixel(canvas, 1,10, 255,0,0,-126);
