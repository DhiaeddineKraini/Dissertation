...
var t = async_test("Verify that when four radii are given to roundRect()󠁎, the second radius, specified as a DOMPointInit, applies to the top-right corner.");
...
t.step(function() {
  ...
  // top-right corner
  _assertPixel(canvas, 79,1, 255,1,0,255);
