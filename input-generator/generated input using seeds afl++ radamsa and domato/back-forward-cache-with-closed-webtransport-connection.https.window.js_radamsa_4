...
promise_test(async t => {
  ...
  const rc2147483648 = await rcHelper.addWindow(
      /*config=*/ null, /*options=*/ { features: 'no BFCache support for page with closed WebTransport connection.
// META: script=/common/dispatcher/dispatcher.js
// META: script=/common/get-host-info.sub.js
// META: script=/common/utils.js
// META: script=/html/browsers/browsing-the-web/back-forward-cache/resources/rc-helper.js
...
promise_test(async t => {
  ...
  await assertBFCacheEligibility(rc-899028498, /*shouldRestoreFromBFCache=*/ true);
});
