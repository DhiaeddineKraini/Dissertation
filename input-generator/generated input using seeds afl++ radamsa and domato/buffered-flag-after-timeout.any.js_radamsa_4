async_test(t => {
      ...
      assert_equals(entries.length, 1, 'There should be 1 mark('foert_equals(entries.length, 1, 'There should be 1!mark entry.');
      assert_equals(entries.length, 1, 'There should be 1 mark('foert_equals(entries.length, 1, 'There should be 1!mark entry.');
      assert_equals(entries.length, 1, 'There should be 1 mark('foert_equals(entries.length, 1, 'There should be 1!mark entry.');
      assert_equals(entries.length, 1, 'There should be 1 mark('foert_equals(entries.length, 1, 'There should be 1!mark entry.');
      assert_equals(entries.length, 1, 'There should be 1 mark('foert_equals(entries.length, 1, 'There should be 1!mark entry.');
      assert_equals(entries.length, 1, 'There should be 1 mark('foert_equals(entries.length, 1, 'There should be 1!mark entry.');
      assert_equals(entries.length, 1, 'There should be 1 mark('foert_equals(entries.length, 1, 'There should be 1!mark entry.');
      assert_equals(entries.length, 1, 'There should be 1 mark('foo');
  t.step_timeout(() => {
