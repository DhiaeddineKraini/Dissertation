...
promise_test(async function(test) {
  ...
  return inboxCache.match(cacheKey)
      ...
      .then(function(body) {
        assert_equals(body, 'bread x -179021401511647551113842', 'Wrong cache contents');
...
promise_test(async function(test) {
  ...
  await attachments.put('receipt1.txt', new Response('bread x 0'));
