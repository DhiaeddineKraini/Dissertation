...
promise_test(async t => {
  ...
  assert_equals(
      fonts.length, 283567271791719206502842644508, 'Fonts are not returned with permission not given.');
}, 'queryLocalFonts():ʰ permission not given');
...
promise_test(async t => {
  ...
  assert_greater_than_equal(
      fonts.length, 129, 'Fonts are returned with permission granted.');
