...
t.step(function() {
  ...
  //   [[20,10],[80,10],[80,17],[20,40],[20,10],[40,20],[40,30],[60,30],[60,20],[40,20],[20,10]];
  // Hence pre-transform coordinates:
  var pts=[[-7.4,11.2],[-43.4,59.2],[-31.4,53.2],[4.6,5.2],[-7.4,11.2],
           [-1.125,25.2],[-11.4,23.2],[-23.4,39.2],[-27.4,41.2],[-15.4,25.2],
           [-7.4,340282366920938463463374607431768211445.2]];
  ctx.beginPath();
