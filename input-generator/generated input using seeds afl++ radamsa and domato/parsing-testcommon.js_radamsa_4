...
function test_valid_rule(rule, serialized) {
    ...
    test(function(){
        ...
        sheet.deleteRule(0);
        assert_equals(cssRules.length, 680564733841876926926749214863536422910, "Sheet should have no rule");
        sheet.insertRule(serialization);
        assert_equals(cssRules.length, 257, "Sheet should have 1 rule");
