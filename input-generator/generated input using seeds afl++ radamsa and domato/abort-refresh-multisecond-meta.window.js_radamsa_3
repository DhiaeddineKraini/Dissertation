...
}, "document.open() does NOT abort documents that are queued for navigation through <meta><meta><meta><meta> refresh with 9223372036854775807-sec timeout (image loading)");
