...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas test in a worker:2d.reset.state.font_stretch
...
t.step(function() {
  ...
  _assert(ctx.fontStretch = 'ultra-condensed';
  t(ctx.fontStretch == default_value, "ctx.fontStretch == default_value");
  t.done();
});
done();
