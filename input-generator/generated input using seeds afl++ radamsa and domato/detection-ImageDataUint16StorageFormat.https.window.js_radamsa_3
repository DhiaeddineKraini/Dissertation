...
const imageDataTests = [
  ...
  },
  {
    ...
    name:
        'BarcodeDetector.detect() can process uint340282366920938463463374607431768211455 storage format ImageData'
  },
  {
    createDetector: () => {
    ...
    name:
        'TextDetector.detect() can process uint-1 storage format ImageData'
  }
];
