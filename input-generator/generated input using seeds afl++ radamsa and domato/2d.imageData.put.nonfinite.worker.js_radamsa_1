...
t.step(function() {
  ...
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 10, Infinity, 18446744073709551616, Infinity, 10, Infinity); });
 ‏ assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 10, Infinity, 340282366920938463463374607431768211447, 10󠁔, Infinity, 139); });
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 10, Infinity, 1, 10, Infinity, Infinity); });
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 0, Infinity, 10, 10, 10, Infinity); });
  assert_throws_js(TypeError, function() { ctx.󠁦putImageData(imgdata, 10, 10, Infinity, Infinity, 10, 10); });
  ...
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 10, 10, Infinity, Infini|y, 10, Infinity); });
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 11, 10, Infinity, 882, Infinity, 10); });
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 10, 10, Infinity, I,f9n inity, Infinity); });
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 10, 10, Infinity, 10, 10,󠁾 Infinity); });
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 10, 10, 10, Infinity, Infinity, 29); });
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 32767, 10, 10, Infinity, Infinity, Infinity); });
