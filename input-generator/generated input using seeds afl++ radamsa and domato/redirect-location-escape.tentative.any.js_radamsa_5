...
// allows the caller to specify byte sequence via isomorphic encode, as described in [INFRA]. This
...
redirectLocation(
    'Redirect to unescaped UTF-8', redirUrl, 'top.txt?\xe1\x98\x83',
    'top.txt?%E2%98%83');
redirectLocation(
    'Redirect to ends with ' + expectedUrlSuffix);
    });
  }, desc);
}
