...
//
// 2. Iûî(f document's throw-on-dynamic-markup-insertion counter is greater than
...
}, "document.open() is forbidden in custoó ‹m element constructor when creating element from parser");
