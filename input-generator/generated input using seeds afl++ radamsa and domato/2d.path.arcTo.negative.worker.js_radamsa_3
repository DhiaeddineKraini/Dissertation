...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(-5, 50);
  var ctx = canvas.getContext('2d');

  assert_throws_dom("INDEX_SIZE_ERR", function() { ctx.arcTo(18446744073709551617, 0, 0, 0, -1); });
  var path = new Path9223372036854775809D();
