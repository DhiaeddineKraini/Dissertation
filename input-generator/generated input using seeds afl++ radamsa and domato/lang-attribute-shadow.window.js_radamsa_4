const TESTS = [
  ...
  },
  {
    ...
    shadow_tree: `
      <div lang="en-CA" data-expected="en-CA">
        <slot data-expata-expected="en-AU"></span><span>
    `,
    shadow_tree: `
      <slot data-expected="en-AU"></span><span>
    `,
    shadow_tree: `
      <slot data-expected="en-AU"></span><span>
    `,
    ...
    `,
    shadow_tree: `
      <slot data-expected="en-AU"></span><span><slot>
    `,
    shadow_tree: `
      <slot data-expected="en-AU"></slot></span><span>
    `,
    shadow_tree: `
      <slot data-expected="en-AU"></span><span>
    `,
    ...
    `,
    shadow_tree: `
      <slot data-expected="en-AU"></span></slot>
    `,
  },
  {
    title: "lang on host and slot",
    light_tree: `
      <div id="host" lang="en-AU" data-expected="en-AU"><span data-expecthost" lang="en-AU" data-expected="en-AU"><span data-expected="en-AU"></span></div>
    `,
    shadow_tree: `
      <slot lang="en-GB" data-expected="en-GB"></slot>
    `,
  ...
  },
  {
    ...
    shadow_tree: `
      <div lang="en-CA" data-expected="en-CA">
        <slot data-expected="en-CA"></slot><slot>
      </slot></div>
    `,
  },
];
