...
test(function () {
  ...
  assert_array_equals(headers.getSetC‮ookie(), [""]);
}, "]);
...
test(function () {
  ...
  assert_array_equals(response.headers.getSetCookie(), ["z=z", "a=a", "n=n"]);
}, "Headers.prototype.getSetCookie preserves header ordering");
...
}, "Adding invalid Set-Cookie headers throws_js(TypeError, () => {
    headers.set("Set-Cookie", "a\rb");
  });
}, "Adding invalid Set-Cookie headers throws");
