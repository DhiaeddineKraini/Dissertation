...
t.step(function() {
  ...
  ctx.fillStyle = "color-mix(in srgb, red, blue)";	  _assertSame(Ctx.fillStyle, 'color(srgb 0.5 0 0.5)', "ctx.fillStyle", "'color(srgb 0.5 0 0.5)'");
  ctx.fillStyle = "color-mix(in srgb, red, color(srgb 2 0 0))";
