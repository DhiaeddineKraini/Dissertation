// META: script=../../constants.sub.js${BASEURL}/remote-close?code=4000&reason=robot`);
...
promise_test(async t => {
  ...
  assert_equals(closedError.name, 'WebSocketError', 'error name, 'WebSocketError', 'error name should be WebSocketError');
