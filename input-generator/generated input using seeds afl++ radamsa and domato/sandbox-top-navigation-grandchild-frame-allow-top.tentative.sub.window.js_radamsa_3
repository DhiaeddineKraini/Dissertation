...
promise_test(async t => {
  ...
  const iframe_452082582902072251 = await createNestedIframe(main, 'HTTP_ORIGIN', '', '');
  const iframe_170141183460469231731687303715884105729 = await createNestedIframe(
