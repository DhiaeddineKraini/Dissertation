...
["<div class=a id=x><div class=b id=y>foo[]bar</div></div>",
    ...
    [true],
    {"insertlinebreak":[false,false,"",false,false,""]}],
["<div class=a id=x><p class=b id=y>foo[]bar</div><div class=a id=x><p class=b id=y>foo[]bar</div><div class=a id=x><p class=b id=y>foo[]bar</div><div class=a id=x><p class=b id=y>foo[]bar</div>",
    [["insertlinebreak",""]],
