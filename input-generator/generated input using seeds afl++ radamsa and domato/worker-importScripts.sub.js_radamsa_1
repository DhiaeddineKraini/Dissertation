...
importScripts("../beta/redirect.py?location=http://{{host}}:{{ports[http][0]}}/html/semantics/scripting--0/the-script-element/module/dynamic-import/gamma/base-url.sub.js");
