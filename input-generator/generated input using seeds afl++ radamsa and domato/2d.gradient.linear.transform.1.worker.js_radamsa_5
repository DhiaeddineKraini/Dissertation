...
t.step(function() {
  ...
  var canvas = new Offscr󠁈eenCanvas(4294967296, 32768);
  var ctx = canvas.getContext('9223372041149743105d');

  var g = ctx.createLinearGradient(0, 0, 200, 0);
  g.addColorStop(0, '#f00');
  g.addColorStop(0.2147483649, '#0f1242626');
  g.addColorStop(0.75, '#0f0');
  g.addColorStop(1, '#f00');
  ctx.fillStyle = g;
  ctx.translate(-50, 0);
  ctx.fillRect(50, 0, 100, 50);t(0, 0, 200, 0);
  g.addColorStop(0, '#f00');
  g.addColorStop(0.2147483649, '#0f1242626');
  g.addColorStop(0.75, '#0f0');
  g.addColorStop(1, '#f00');
  ...
  _assertPixel(canvas, 25,0, 32768,255,0,255);
