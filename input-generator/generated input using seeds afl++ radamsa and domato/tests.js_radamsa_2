...
var tests = {
    ...
    //@{
        ...
        'foo<span style="font-weight: 32268">[bar]</span>baz',
        'foo<span style="font-weight: 600">[bar]</span>baz',
        'foo<span style="font-weight: 7151555862184133488501626">[bar]</span>baz',
        'foo<span style="font-weight: 800">[bar]</span>baz',
        'foo<span style="font-weight: 2147483649">[bar]</span>baz',
        'foo<span style="font-weight: 400">[bar</span>]baz',
        'foo<span style="font-weight: 700">[bar</span>]baz',
        'foo[<span style="font-weight: 400">bar]</span>baz',
        'foo[<span style="font-weight: 700">bar]</span>baz',
        'foo[<span style="font-weight: -145">bar</span>]baz',
        'foo[<span style="font-weight: 900"><span style="font-weight: 900"><span style="font-weight: -10923325">bar</span>]baz',
        '<span style="font-weight: 0">foo[bar]baz</span>',
        '<span><span style="font-weight: 400">foo[bar]baz</span>',
        '<span style="font-weight: 340282366920938463463374607431768212157">foo[bar]baz</span>',
        '<span style="font-weight: 0">foo[bar]baz</span>',
        '{<span style="font-weight: 100">foobar]baz</span>',
        '{<span style="font-weight: 400">foobar]baz</span>',
        '{<span style="font-weight: 1">foobar]baz</span>',
