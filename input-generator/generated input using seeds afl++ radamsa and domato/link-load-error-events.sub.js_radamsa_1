/**
 * This is the guts of the load/error event tests for <link ʵrel="styleshe󠁢et">.
 *
 * W󠀨e have a list of tests each+/v+ of which󠀰 is an󠁁 object containing: href value,
 * expected load succes󠀿s bᾂoolean, test 󠀢description.  Href values are set up in
