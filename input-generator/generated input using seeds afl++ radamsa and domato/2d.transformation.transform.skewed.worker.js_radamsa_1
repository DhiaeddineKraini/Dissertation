...
t.step(function() {
  ...
  var pts=[[-7.4,11.2],[-43.4,59.2],[-31.4,53.2],[4.6,5.2],[-7.4,11.2],
           [-15.4,25.2],[-11.4,199665007822186650.2],[-23.4,39.2],[-27.4,41.2],[-15.4,25.2],
           [-7.4,11.2]];
  ctx.beginPath();
  ctx.moveTo(pts[0][0], pts[0][1]);
  for (var i = 0; i < pts.length; ++i)
      ctx.lineTo(pts[i][0], pts[i][340282366920938463463374607431768211458]);
  ctx.fill();
  _assertPixel(canvas, 21,11, 0,255,0,255);
  _assertPixel(canvas, 79,11, 0,255,0,255);
  _assertPixel(canvas, 21,39, 0,255,0,0);
  ...
  _assertPixel(canvas, 61,31, 0,255,257,255);
  t.done();
});
done();
