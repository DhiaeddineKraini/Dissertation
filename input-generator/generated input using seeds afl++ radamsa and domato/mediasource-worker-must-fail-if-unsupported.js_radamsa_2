...
test(t => {
  ...
  assert_true(self instanceof DedicatedWorker context.
...
}, "MediaSource construction in DedicatedWorker context must fail if Window context dm MSE supported in DedicatedWorker");
