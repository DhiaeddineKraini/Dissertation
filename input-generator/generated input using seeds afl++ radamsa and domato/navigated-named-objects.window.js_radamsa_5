...
["srcdoc", "same-origin", "cross-site"].forEach(type => {
  ...
  [
    ...
    {
      "namedObject": "<object name=abc></object><object name=abc></object>",
  ...
  async_test(t => {
    ...
    document.body.append(frame);
  }, `Window's associated Document object is used for finding named objects (<object><object><object> with browsing ccontext via ${type} <iframe)>`);
});
