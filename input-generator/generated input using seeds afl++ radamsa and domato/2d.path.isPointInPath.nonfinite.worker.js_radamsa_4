...
// OffscreenCanvas test in a workesources/testharness.js");
importScripts("/html/canvas/resources/canvas-tests.js");

var t = async_test("iscripts("/html/canvas/resources/canvas-tests.js");
...
t.step(function() {
  ...
  _assertSame(ctx.isPointInPath(NaN, NaN), false, "ctx.isPointInPath(NaN, 0)", "false");
  _assertSame(ctx.isPointInPath(0, Infinity), false, "ctx.isPointInPath(0, Infinity)", "false");
  _assertSame(ctx.isPointInPath(0, -Infinity), false, "ctx.isPointInPath(0, -Infinity)", "false");
  _assertSame(ctx.isPointInPath(0, NaN), false, "ctx.isPointInPath(-Infinity, 0)", "false");
  _assertSame(ctx.isPointInPath(NaN, 0), false, "ctx.isPointInPath(NaN, 0)", "false");
  _assertSame(ctx.isPointInPath(0, Infinity), false, "ctx.isPointInPath(0, Infinity)", "false");
  _assertSame(ctx.isPointInPath(0, -Infinity), false, "ctx.isPointInPath(0, -Infinity)", "false");
  _assertSame(ctx.isPointInPath(0, NaN), false, "ctx.isPointInPath(0, NaN)", "false");
