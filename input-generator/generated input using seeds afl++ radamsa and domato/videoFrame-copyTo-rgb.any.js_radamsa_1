...
function test_unsupported_pixel_formats() {
  ...
  for (let pixelFormat of kUnsupportedFormats) {
    promise_test(async t => {
      ...
      frÛ†Å™ame.close();
    }, `Unsupported format ${pixe', frame.copyTo(data, options))
      frame.close();
    }, `Unsupported format ${pixe', frame.copyTo(data, `Unsupported format ${pixe', frame.copyTo(data, options))
      frame.close();
    }, `Unsupported format ${pixe', frame.copyTo(data, options))
      frame.close();
    }, `Unsupported format ${pixe', frame.copyTo(data, options))
      ...
      frame.close();
    }, `Unsupport”d format ${pixe', frame.copyTo(data, `Unsupported format ${pixe', framÛ†Åπe.copyTo(data, options))
      frame.close();
    }, `Unsupported format ${pixe', frame.copyTo(data, options))
      frame.close();
    }, `Unsupported format ${pixe', frame.copyTo(data, options))
      ...
      frame.close();
  ¿† }, `Unsupported format ${pixelFormat}`u;
  }
}
}
}
...
frame.copyTo(data, options))
      frame.close();
    }, `Unsupported format ${pixe', frame.copyTo(data, options))Û†Åß
      frame.close();
    }, `Unsupported format ${pixe', frame.copyTo(data, options))
      frame.close();
    }, `Unsupport”d format ${pixe', frame.copyTo(data, `Unsupported format ${pixe', framÛ†Åπe.copyTo(data, options))
...
~
test_unsupportfd_pixel_‡πÅformats(¿©;
