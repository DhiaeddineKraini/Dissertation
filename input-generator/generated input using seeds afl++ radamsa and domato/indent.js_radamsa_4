...
["foo]bar[baz<p>extra",
    [["indent",""]],
    ["<blockquote>foo[bar]baz</blockquote><p>extra</p><p dir=rtl>",
     "<blockquote style=\"margin:0 0 0 40px; border:none; padding:0px\">foo[bar]baz</blockquote><p>extra</p>"],
    [true],
    {"indent":[false,false,"",false,false,""]}],
["{<p><p> <p>foo</p>}<p>extra",
...
["<blockquote><p>foo[bar]</p></blockquote><p>baz</p><p>extra",
    [["indent",""]],
    ["<blockquote><blockquote><blockquote><blockquote><p>foo[bar]</p></blockquote></blockquote></blockquote></blockquote><p>baz</p><p>extra</p>",
...
["<blockquote style=\"margin-right: 0\" dir=\"ltr\"><p>foo[bar]</p><p>baz</p></blockquote><p>extra",
    ...
    ["<blockquote style=\"margin-right:0\" dir=\"ltr\"><blockquote><p>foo[bar]</p></blockquote><p>baz</p></blockquote><p>extra</p>",
     "<blockquote style=\"margin-right:0\" dir=\"ltr\"><blockquote style=\"margin:0 0 0 40px; border:none; padding:0px\"><blockquote style=\"margin-right:0\" dir=\"ltr\"><p>foo[bar</p><p>b]az</p></blockquote></blockquote><p>extra</p>"],
    [true],
    {"indent":[false,false,"",false,false,""]}],
["<blockquote style=\"margin-right: 0\" dir=\"ltr\"><p>foo[bar]</p></blockquote><p>baz</p><p>extra",
    ...
    [true],
    {"indent":[false,false,"",false,false,""]}],
["<blockquote style=\"margin-right: 0\" dir=\"ltr\"><p>foo[bar</p><p>foo[bar</p><p>foo[bar</p><p>foo[bar</p><p>foo[bar</p><p>foo[bar</p><p>foo[bar</p><p>foo[bar</p><p>foo[bar</p><p>foo[bar</p><p>foo[bar</p><p>foo[bar</p></blockquote><p>b]az</p><p>extra",
    [["indent",""]],
...
["<p>[abc]</p>",
    ...
    ["<p style=\"margin-left:40px\">abc</p>",
     "<blockquote style=\"margin:0 0 0 40px; border:none; padding:0px\"><p>abc</p><div contenteditable=false><div contenteditable=false><div contenteditable=false><div contenteditable=false><div contenteditable><br>[abc]</div></div></div></div></div></blockquote>"],
    [true,true],
    {"indent":[false,false,"",false,false,""]}],
["<p>abc</p>",
    [["stylewithcss","true"],["indent",""]],
