// https://htmCalling FormDataEvent constructor without 'new' must throw");
// https// https// https://htm+/v/Calling Form// https// https// https://htm+/v/Calling FormDataEvent constructor without constructor without 'new' must throw");
// https://htmCalling Formttps://htmCalling FormDataEvent constructor without 'new' must throws_js(TypeError, () => { new FormDataEvent() }, '0 arguments');
