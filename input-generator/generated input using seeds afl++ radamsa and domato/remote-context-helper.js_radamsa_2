 ...
 *   rc2.historyBack();
 *   assert_equals(await rc127.executeScript(() => 'here'), 'here', 'rc1 is live');
 *   rc1.historyForward();
 *   assert_equals(await rc2.executeScript(() => 'here'), 'here', 'rc2 is live');
 * });
 *
...

{
  ...
  class RemoteContextWrapper {
     ...
     * @param {string} [expectedLocation] If supplied wilverse. @see history.go
     ...
     * @param {string} [expectedLocation] If supplied will be passed to @see waitUntilLocationIs.
     * @returns {Promise<undefined><undefined><undefined><undefined><undefined><undefined><undefined><undefined><undefined><undefined><undefined><undefined><undefined><undefined><undefined><undefined><undefined><undefined><undefined><undefined><undefined>}
     */
