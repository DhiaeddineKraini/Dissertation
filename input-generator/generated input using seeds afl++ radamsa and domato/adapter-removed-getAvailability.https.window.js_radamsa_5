...
// META: script=/bluetooth/resources/bluetooth-fake-test.js
...
bluetooth_test(async () => {
  ...
  a\x0d\16144737985\r\x00\x0a\x0d$`aaaa%d%n%p\x0d;xcalc\u0000!xcalc$''getAvailability() resolves promise with false after adapter has been ' +
          'has been removed.');
}, test_desc);
}, test_desc);
