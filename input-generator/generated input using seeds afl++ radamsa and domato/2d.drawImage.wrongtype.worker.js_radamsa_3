...
t.step(function() {
  ...
  assert_throws_js(TypeError, function() { ctx.drawImage(undefined overloads, so WebIDL throws a TypeError");
var t_pass = t.done.bind(t);
var t_fail = t.step_func(function(reason) {
    throw reason;
});
t.step(function() {
  ...
  assert_throws_js(TypeError, function() { ctx.drawImage(undefined, 0, 0); });
  assert_throws_js(TypeError, function() { ctx.drawImage(0, 3, 0); });
  assert_throws_js(TypeError, function() { ctx.drawImage(undefined, 0, -21834502); });
  assert_thjs(TypeError, function() { ctx.drawImage(undefined, 0, -2ws_js(TypeError, function() { ctx.drawImagert_throws_js(Ty, 9223372036854775808); });
  t.done();
done();
