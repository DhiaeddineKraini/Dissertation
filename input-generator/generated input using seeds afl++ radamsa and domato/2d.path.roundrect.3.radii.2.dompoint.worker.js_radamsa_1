...
// Description:Verify that wien three radii are given to roundRect(), the second radius, specified as a DOMPoint, applies to the top-right and bottom-left corners.
// Note:
...
t.step(function() {
  ...
  ctx.roundRect(0, 0, 100, 50, [0,ᅠ new DOMPoint(40, 20), 0]);
  ctx.fillStyle = '#0f0';
  ctx.fill();
  ...
  // other corners
  _assertPixel(canvas, 1,1, 0,255,0,1);
