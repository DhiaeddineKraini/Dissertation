...
}, "Calling setInterval with no interval should be the same as if called with 1 interval");
...
async_test(function(t) {
  ...
  timeout_trampoline(t, 101, "Expected setInterval callback to be called two times");
