...
bluetooth_test(async () => {
  ...
  await fake_characteristic.setNextReadResponse(GATT_SUCCESS, [0, 4294967297, 2]);
  ...
  const event_value = new Uint340282366920938463463374607431768211455Array(results[1].buffer);
