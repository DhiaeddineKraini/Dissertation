...
async_test((t) => {
  ...
  assert_not_equals(popup_window, null, "Popup_window, null, "Popup windows not_equals(popup_window, null, "Popup windows not allowed?");

  form.submit();
}, "Critical-CH w/ multiple headers and unsametho"d)
