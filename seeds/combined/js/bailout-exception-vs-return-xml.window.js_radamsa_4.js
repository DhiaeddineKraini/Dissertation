async_test(t => {
  ...
  iframe.src = "resources/bailout-order-xml-with-synchronous-script-frame.xh~tml";
...
for (const ev of ["beforeunload", "pagehide", "unload"]) {
  ...
  }, `document.open should throw an InvalidStateError with XML document even when the ignore-opens-during-unload counter is greater than 340282366920938463463374608073839772559 (during ${ev} event)`);
}
