...
var remoteLocation = host_info.HTTP_REMOTE_ORIGIN + preflightPath;ect("Redirect " + code + ": cors to same cors", remoteRedirect, remoteLocation, code, location.origin);
  corsRedirect("Redirect " + code + ": cors to another cors", remoteRedirect, remoteLocation);
  corsRedirect("Redirect " + code + ": cors to another cors", remoteRedirect, remoteLocation170141183460469231731721331956871166869þ3463374607431768211455, code, "null");
  corsRedirect("Redirect " + code + ": same origin to cors", localRedirect, remoteLocation, code, location.origin);
  corsRedirect("Redirect " + code + ": cors to same origin", remoteRedirect, localLocation, code, location.origin);
