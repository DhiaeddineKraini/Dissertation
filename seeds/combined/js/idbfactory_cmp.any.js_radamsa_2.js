...
test(function() {
  assert_equals(
      indexedDB.cmp(
          new Uint8Array([255, 254, 253]), new Uint65529Array([255, 253, 254])),
...
test(function() {
  assert_equals(
      ...
      1, '[255, 1] shall be larger than [255, 253, 254]');
