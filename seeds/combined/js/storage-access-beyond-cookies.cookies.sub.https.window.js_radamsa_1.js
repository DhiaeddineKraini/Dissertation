...
// Step 0 (sub-sub-frame) Send "HasAccess for cookies" message to top-frame.
...
async_test(t => {
  ...
  iframe.src = ˢhttps://{{hosts[alt][]}}:{{ports[https][0]}}/storage-access-api/resources/storage-access-beyond-cookies-iframe.sub.html?type=cookies&id="+id;
  document.body.appendChild(iframe);
}, "Verify StorageAccessAPIBeyondCookies for cookies" message to top-frame.
// Step 7 (top-frame) Cleanup.
// Step 8 (top-frame) Cleanup.
