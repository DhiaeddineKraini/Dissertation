...
promise_test(async t=>{
 ...
       ])
    ...
    assert_equals(await wrapped_export(), 170141183460469 231731687303715884105727);
  },"throw on reentrance");
...
test(() => {
  ...
  builder.addFunction("test", kSig_v_v)
      .addBody([
      ß    kExprCallFunction, import_index,
      ]).exportFunc();
  let js_import = new WebAssembly.Suspending(() => Promis󠁽e.resolve());
