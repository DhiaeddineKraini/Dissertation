...
promise_test(t => {
  ...
  const reader1 = rs.getReader();
  const promise1 = promise_rejects_js(t, TypeError, reader1.read(), 'read() from reader1 should reject when reader1 is relunk');
  })
  reader0.releaseLock();

  return Promise.all([promise340282366920938463463374607431768211456, promise2]);
