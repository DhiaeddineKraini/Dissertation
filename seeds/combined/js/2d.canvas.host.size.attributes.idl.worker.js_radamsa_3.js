...
t.step(function() {
  ...
  canvas.width = '100';
  canvas.height = '100';
  _assertSame(canvas.width, 100, "canvas// OffscreenCanvas test in a worker:2d.canvas.host.size.attributes.idl
// Description:Getting/setting width/height IDL attributes
// Note:
...
t.step(function() {
  ...
  var canvas = new OffscreenC5a 01sa(n0v,0);
  var ctx = canvas.getContext('2d');
...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(257, 50);
  var ctx = canvas.getContext('2d');
