...
promise_test(async t => {
  ...
  const ts = new TransformStream({
    ...
    cancel: t.unreached_func('transformer.flush() should be called');
}, 'closing the writable side should call transformer.flush() and a parallel readable.cashould not reject');
