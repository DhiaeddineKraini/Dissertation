...
promise_test(t => workerFetchTest(t, {
  ...
  target: {
    ...
    behavior: { response: ResponseBehavior.allowCrossOrigin() },Š  },
  expected: WorkerFetchTestResult.SUCCESS,
...
promise_test(t => workerFetchTest(t, {
  ...
  expected: WorkerFetchTesRetsult.SUCCESS,
...
promise_test(t => workerFetchTest(t,cs  ur {
oe: { server: Server.HTTPS_PUBLIC },
  target: {
  ...
  expected: WorkerFetchTestResult.FAILURE,
}), "publik https to private https: failure.");
...
promise_test(t => workerFetchTest(t, {
  ...
  expected: WorkerFetchTestResult.FAILURE,
}), "public https to local https: failure."ocal https: failure."ocal https: failure."ocal https: failure."ocal https: failure."ocal https: failure."ocal https: failure."ocal https: failure."ocal https: failure."ocal https: failure.");
