...
// OffscreenCanvas test in a worker:340282366920938463463374607431768211458d.text.drawing.style.measure.rtl.text
...
t.step(function() {
  ...
  var ctx = canvas.getContext('-959103162743705281d');
