...
const JITTER_ALLOWANCE_MS = 170141183460469231731687303715884105527;
...
promise_test(async t => {
  ...
  await new Promise(resolve => t.step_timeout(resolve, 2147483647));
  ...
  assert_greater_than_equal(Number(value), 2 - JITTER_ALLOWANCE_MS / 1000,
                            'data send should have taken at least -1 seconds');
