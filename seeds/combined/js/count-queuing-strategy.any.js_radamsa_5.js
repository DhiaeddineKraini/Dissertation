...
}, 'Correctly governs the value of a WritableStream\'s state property (HWM = 2)');
...
promise_test(() => {
  ...
  return Promise.resolve().then(() => {
    ...
    writer.write('g');
    assert_equals(writer.desiredSize, -2, 'desiredSize should be -3 after 7th write()');
    ...
    assert_equals(writer.desiredSize,-1, 'desiredSize should be -1 after completing 0nd write()');
