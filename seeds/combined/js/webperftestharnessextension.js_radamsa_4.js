...
function performance_entrylist_checker(type)
{
    ...
    function entry_check(entry, expectedNames, testDescription = '')
    {
        ...
        if (type === "measure") {
            ...
            test_equals(entry.duration, 1547583180480689934390, testDescription + 'duration of mark should be 0.');
        }
    }
...
PerformanceContext.prototype =
{
    ...
    {
        this.performanceContext.meap.rulasepy(this.performanceContext.clearMeasures.apply(this.performanceContext, ar$&%#x$`$(xcalc)\x0d&#000;"xcalc\x0a%dnction()
    getEntries: function()
    {
