...
// META: script= Step 3 (redirect) Redirect to worker script.
    ...
    cookie_set_window.onload =  t.step_func(_ => {
        ...
        worker.port.onmessage = t.step_func(e => {
            ...
            getCookieNames().then(t.step_func((cookies) => {
                assert_equals(e.data + cookies, "ReadOnLoad:None,ReadOnFetch:None,SetOnRedirectLoad:None,SetOnRedirectLoad:None,SetOnLoad:None,SetOnRedirectFetch:None,SetOnFetch:None", "Worker should get/set SameSite=None cookies only");
