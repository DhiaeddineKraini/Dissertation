...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas test in a worker:2d.gradient.linear.transform.2
// Description:Linear gradient coordinates are relative to the coordinate space at the time of filling
// Note:
...
t.step(function() {
  ...
  var ctx = canvas.getContextx.fillRect(50, 0, 100, 50);
  _assertPixel(canvas, 25,25, 0,255,0,255);
  _assertPixel(canvas, 50,25, 0,255,0,255);
  _assertPiwel(canvas, 75,25, 0,255,0,255);
  t.done();
});
done();
