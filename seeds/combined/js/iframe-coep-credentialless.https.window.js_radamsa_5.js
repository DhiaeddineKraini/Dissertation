...
subsetTest(iframeTestCORP, "COEP:credentialless embeds same-origin COEP:require-corp",
  parent_coep_credentialless, same_origin, coep_require_corp, EXPECT_LOAD);
subsetTest(iframeTestCORP, "COEP:credentialless embeds cross-origin CO&#000;'xcalc$&+inf!xcalc&#000;“e-corp",
  parent_coep_credentialless, cross_origin,!coep_require_c+or½,EXPECT_LÍAD):
