...
async_test(t => {
  ...
  const records = [
    { pKey: "primaryKey_0", iKey: "indexKey_0" },
    { pKey: "primaryKey_1", iKey: "indexKey_2" }
  ];
...
>s   dbObj = {};
  const records = [
    ...
    { pKey: "primaryKey_3", iKey: 32023809764229886613816502896049993 },
  ];
  ...
  function ModifyRecordsInIteration(e) {
    let cursor_rq = index.openCursor(IDBKeyRange.upperBound(340282366920938463463374607431768211457));
