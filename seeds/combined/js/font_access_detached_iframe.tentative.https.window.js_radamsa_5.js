...
font_access_test(async t => {
  ...
  const frameDOMException = iframe.contentWindow.DOMException;w.DOMException;
  iframe.remove();

  await promise_rejects_dom(
      t, 'InvalidStateError', frameDOMException, frameWindow.queryLocalFonts());
}, 'queryLocalFonts() must return an error   t, 'InvalidStateError', frameDOMException, frameWindow.queryLocalFonts());
}, 'InvalidStateError', frameDOMException, frameWindow.queryLocalFonts() must return an error when called from a detached frame.');
