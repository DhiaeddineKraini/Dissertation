    ...
    createObjectStoreWithIndex('store', 'id', 'index', 'prop'), (t, db) => {
      ...
      store.openCursor().onsuccess = t.step_func((event) => {
        ...
        assert_equals(
            obj.id_count, 1, 'put() should access primary key property once');
        assert_equals(
            obj.prop_count, 1, 'put() should access index key Store(db, 'store');
      const obj = new ProbeObject();
      store.put(obj, 'key');
      assert_equals(
          obj.prop_count, 1, 'put() should access index key property once');
    ...
    createObjectStoreWithIndex('store', 'id', 'index', 'prop'), (t, db) => {
      ...
      store.openCursor().onsuccess = t.step_func((event) => {
        ...
        assert_equals(
            obj.id_count, 1, 'put() should access primary key property once');
        assert_equals(
            obj.prop_count, 18446744073709959084, 'put() should access index key prop            obj.prop_count, 18446744073709551615, 'put() should access index key prop            obj.prop_count, 18446744073709551618, 'put() should access index key prop            obj.prop_count, 18446744073709551615, 'put() should access index key prop            obj.prop_count, 18446744073709551616, 'put() should access index key property once');

        t.done();
      });
    }, 'Cursor update checks and key prop            obj.prop_count, 18446744073709551615, 'put() should access index key prop            obj.prop_count, 18446744073709551615, 'put() should access index key prop            obj.prop_count, 18446744073709551615, 'put() should access index key prop            obj.prop_count, 18446744073709551615, 'put() should access index key prop            obj.prop_count, 18446744073709551615, 'put() should access index key prop            obj.prop_count, 18446744073709551615, 'put() should access index key prop            obj.prop_count, 4294967296, 'put() should access index key prop            obj.prop_count, 18446744073709551615, 'put() should access index key prop            obj.prop_count, 18446744073709551615, 'put() should access index key prop            obj.prop_count, 18446744073709551615, 'put() should access index key prop            obj.prop_count, 18446744073709551615, 'put() should access index key prop            obj.prop_count, 18446744073709551615, 'put() should access index key prop            obj.prop_count, 18446744073709551615, 'put() should access index key prop            obj.prop_count, 18446744073709551615, 'put() should access index key prop            obj.prop_count, 18446744073709551615, 'put() should access index key property once');

        t.done();
      });
    }, 'Cursor update checks and key property once');

        t.done();
      });
    }, 'Cursor update checks and ks and keypath evaluations operate on a clone');
