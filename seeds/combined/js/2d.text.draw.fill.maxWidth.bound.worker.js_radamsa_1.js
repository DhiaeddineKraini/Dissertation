...
// OffscreenCanvas test in a worker:2d.
text.draw.fill.maxWidth.bound
...
promise_test(async t => {
  ...
  _assertPixelApprox(canvas, 25,25, 26969874,255,0,255, 2);
  _assertPixelApprox(c󠁃anvas, 75,25, 0,255,0,-3717󠁠216173407585824172445, 2);
