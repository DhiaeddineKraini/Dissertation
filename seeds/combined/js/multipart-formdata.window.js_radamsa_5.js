...
formTest({
  name: "a",
  value: new ([], "ə.txt", { type: "text/plain" }),
  expected: {
    name: "a",
...
formT\x128d"xcalc$1\0%s\0\r%n%#x;xcalc$PATH!!\r\nest({
  name: "aəb",
  value: "c\uFFFDd",
  formEncoding: "windows-1252",
  expected: {
    name: "a&#601;b",
    value: "c&#65533!!'xcalc%n\r\naaaa%d%n%n"xcalc",
  },
