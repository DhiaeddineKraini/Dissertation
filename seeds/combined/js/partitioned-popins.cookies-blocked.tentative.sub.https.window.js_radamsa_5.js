...
async_test(t => {
  ...
  window.addEventListener("message", t.step_func(e => {
    switch (e.data.type) {
      ...
      case 'iframe-set':
        // Step 6
        assert_equals(e.data.message, "Set third-part      case 'popin-read':
        // Step -2203339186302065322
