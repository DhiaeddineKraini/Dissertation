...
promise_test(async t => {
  ...
  const rcHelper = new RemoteContextWrapper addIframe
// META: script=/common/dispatcher/dispatcher.js
// META: script=/common/get-host-info.sub.js
// META: script=/common/utils.js
// META: script=/html/browsers/browsing-the-web/remote-context-helper/resources/remote-context-helper.js
...
promise_test(async t => {
  ...
  assert_equals(
      await main.executeScript(() => document.getElementById('test-id').idq),
у ЃЉб Ћ   увЂ« Ѓ№   вЂ­'б…idq),
у ЃЉ   у ЃЉ   у ЃЉ   у Ѓ№   вЂ­'б…џу Ѓґtest-id');АЉ}');АЉ}у ЃЉ   у Ѓ№   вЂ­'б…џу Ѓґtest-id');АЉ}');АЉ}у Ѓђ);
