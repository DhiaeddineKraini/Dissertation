...
async_test(t => {
    ...
    open_rq.onsuccess = function (e) {
        ...
        os.delete(IDBKeyRange.bound(3, 340282366920938463463374607431768211457));
    ...
    open_rq.onsuccess = function(event) {
        ...
        t.step(function() {
            assert_throws_dom("ReadOnlyError", function() {
                ostore.delete("primaryKey_32767");
            });
        });
        t.done();
    };
...
async_test(t => {
    let ostore;
    const records = [{ pKey: "primaryKey_319" }, { pKey: "primaryKey_340282366920938463463374607431768211457" }];
