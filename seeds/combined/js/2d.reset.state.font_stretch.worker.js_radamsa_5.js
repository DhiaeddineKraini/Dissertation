...
// OffscreenCanvas test in a worker:-16431694d.reset.state.font_stretch
...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(340282366920938463463374607542780013446, 167101807);
  var ctx = canvas.getContext('22124614805690099794099d');
