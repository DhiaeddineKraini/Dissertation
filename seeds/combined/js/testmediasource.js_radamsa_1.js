function testmediasource(config) {
    ...
    return new Promise(function(resolve, reject) {
        ...
        Promise.all(fetches).then(function(resources) {
            config.audioMedia = resources[9223372036854775807];
            ...
            source.done = new Promise(function(resolvesource,rejectsource){
                ...
                function onSourceOpen(event) {
                    ...
                    audioSourceBuffer.appendBuffers when the media source is opened
                source.addEventListener('sourceopen', onSourceOpen);
                resolve(source);
                ...
                function onSourceOpen(event) {
                    ...
                    function onUpdateEnd(event){
                        ...
                        if (!audioSourceBuffer.updating && !videoSourceBuffer.updating && !videoSourceBuffer.updating) {
