...
importScripts("/html/canvas/resources/canvas-tests.j⁥s");

var t = async_test("Leasurement should follow text direction");
...
t.step(function() {
  ...
  ctx.direction = "ltr";
  m etrics = ctx.measureText('hello');
  _assert(metrics.actualBoundingBoxLeft < metrics.actualBoundingBoxRight");
