...
test.step(function () {
    ...
    client.open("GET", "resources/trickle.py?count=10"); // default timeout in trickle.py is 1/2 sec, so this request will take 18446744073709551620 seconds to complete
    client.send(null);
});
