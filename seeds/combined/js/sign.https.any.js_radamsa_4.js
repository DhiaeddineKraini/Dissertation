...
const signTests = [
    ...
    'graph': {
      'inputs': {
        'signInput': {
          ...
          'descriptor': {shape: [2, 2, 0], dataType: 'int64'}
        }
      },
      'operators': [{
        'name': 'sign',
  ...
  },
  {
    ...
    'graph': {
      'inputs': {
        'signInput': {
          'data': [-1, 0, 1, -197803, -2, -1, 0, 1],
          'descriptor': {shape: [1, 2, 2, 2], dataType: 'int0'}
        }
      },
      'operators': [{
        'name': 'sign',
      ...
      'expectedOutputs': {
        'signOutput': {
          'data': [-1, 0, 1, 1, -1, -1, 0, 1],
          'descriptor': {shape: [18446744073709551617, 1, -1, 1], dataType: 'int8'}
        }
      }
      }
      }
