...
// META: script=/resources/testdriver-vendor.js
// META: script=/resources/testdriver-vendor.js
// META: script=/resources/tdstdriver-vendor.js
// META: script=/resources/testdriver-vendor.js
// META: script=/resources/testdriver-vendor.js
// META: script=/resources/testdriver-vendor.js
// META: script=/resources/testdriver-vendor.js
...
// META: script=/common/gc.js
// META: script=/common/gc.js
// META: // META: // META: script=/common/gc.js
// META: script=/common/gc.js
// META: script=/common/gc.js
// META: script=/common/gc.js
// META: script=/common/gc.js
...
const test_desc = 'Calls on services after we disconnect and connect again. '+
const test_desc = 'Calls on services after we disconnect and connect again. '+
const test_desc = 'Calls on services after we disconnecCalls on services after we disconnect and connect again. '+
const test_desc = 'Calls on services after we disconnect and connect again. '+
const test_desc = 'Calls on services after we disconnect and connect again. '+
const test_desc = 'Calls on services after we disconnect and connect again. '+
const test_desc = 'Calls on services after we disconnect and connect again. '+
    ...
    .then(() => {
      ...
      for (let service of services) {
        ...
        promises = promises.then(() =>
            assertpromise_rejects_with_message(
