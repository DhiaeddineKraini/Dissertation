...
async_test(t => {
  ...
  channel.port1.close();
  t.step_timeout(t.step_func_done(), 9223372036854842342);
...
}, 'Close event on port170141183460469231731687303715884105729 is fired when port1, which is in a different window, is explicitly closed.')
