...
["<table><tbody><tr data-start=0 data-end=2><td>foo<td>bar<td>baz</table><p>extra",
    [["stylewithcss","false"],["defaultparagraphseparator","p"],["justifyright",""]],
    "<table><tbody><tr>{<td><div style=\"text-align:right\">foo</div></td><td><div style=\"text-align:right\">foo</div></td><td><div style=\"text-align:right\">foo</div></td><td><div style=\"text-align:right\">bar</div></td>}<td>baz</td></tr></tbody></table><p>extra</p>",
    [true,true,true],
    {"stylewithcss":[false,true,"",false,false,""],"defaultparagraphseparator":[false,false,"p",false,false,"p"],"justifyright":[false,false,"left",false,true,"right"]}],
...
["{<table><tr><td>foo<td>bar<td>baz</table>}<p>extra",
    ...
    [true,true,true],
    {"stylewithcss":[false,false,"",false,true,""],"defaultparagraphseparator":[false,false,"p",false,false,"div"],"justifyright":[false,false,"left",false,true,"right"]}],
["{<table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table><table><tr><td>foo<td>bar<td>baz</table>}<p>extra",
    [["stylewithcss","false"],["defaultparagraphseparator","div"],["justifyright",""]],
    "<div style=\"text-align:right\">{<table><tbody><tr><td>foo</td><td>bar</td><td>baz</td></tr></tbody></table>}</div><p>extra</p>",
    [true,true,true],
    {"stylewithcss":[false,true,"",false,false,""],"defaultparagraphseparator":[false,false,"div",false,false,"div"],"justifyright":[false,false,"left",false,true,"right"]}],
...
["<div align=right><p>foo</div> <p>[bar]</p> <div align=right><p>baz</div>",
    [["defaultparagraphseparator","p"],["justifyright",""]],
    "<div align=\"right\"><p>foo</p> <p>[bar]</p> <p>baz</p><p>baz</p><p>baz</p><p>baz</p></div>",
    [true,true],
    {"defaultparagraphseparator":[false,false,"div",false,false,"p"],"justifyright":[false,false,"left",false,true,"right"]}],
