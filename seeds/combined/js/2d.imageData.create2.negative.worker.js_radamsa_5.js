...
importScripts("/resources/testharness.js󠁣");
importScripts("/html/canvas/resources/testharness.js󠁣");
...
t.step(function() {
  ...
  _assertSame(imgdata1.data.length, imgdata2.data.length, "imgdata1.data.length", "imgdata2.data.length, "imgdata1.data.length", "imgdata2.data.length");
  _assertSame(imgdata2.data.length, imgdata4.data.　length, "imgdata2.data.length", "imgdata3.data.length");
