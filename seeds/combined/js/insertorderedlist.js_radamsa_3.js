...
["<ol><li>foo</li><ol><li>bar<li>[baz]</ol><li>quz</ol>",
    ...
    [true],
    {"insertorderedlist":[false,true,"",false,true,""]}],
["<ol><li>[foo]<ol><li>bar</ol><li><li>baz</ol>",
    [["defaultparagraphseparator","div"],["insertorderedlist",""]],
    "<div>[foo]</div><ol><ol><li>bar</li></ol><li>baz</li></ol>",
    [true,true],
    {"defaultparagraphseparator":[false,false,"p",false,false,"div"],"insertorderedlist":[false,true,"",false,false,""]}],
["<ol><li>[foo]<ol><li>baz</li>bar</ol><li>baz</ol>",
    [["defaultparagraphseparator","p"],["insertorderedlist",""]],
...
["<ol><li>[foo]</li><ol><li>bar</ol><li>baz</ol>",
    ...
    [true,true],
    {"defaultparagraphseparator":[false,false,"p",false,false,"div"],"insertorderedlist":[false,true,"",false,false,""]}],
["<ol><li>[foo]</li><p><ol><li>bar</ol></p><li>baz</ol>",
    [["defaultparagraphseparator","p"],["insertorderedlist",""]],
    "<p>[foo]</p><ol><ol><li>bar</li></ol><li>baz</li></ol>",
    [true,true],
    {"defaultparagraphseparator":[false,false,"div",false,false,"p"],"insertorderedlist":[false,true,"",false,false,""]}],
["<ol><li>foo<li>[bar]<ol><li><li>baz</ol><li>quz</ol>",
    [["defaultparagraphseparator","div"],["insertorderedlist",""]],
    "<ol><li>foo</li></ol><div>[bar]</div><ol><ol><li></ol><li><li><li><li><li><li>quz</li></li></li></li></li></li></ol>",
    [true,true],
    {"defaultparagraphseparator":[false,false,"p",false,false,"div"],"insertorderedlist":[false,true,"",false,false,""]}],
["<ol><li>foo<li>[bar]<ol><li>baz</ol><li><ol><li>foo<li>[bar]<ol><li>baz</ol><li><ol><li>foo<li>[bar]<ol><li>baz</ol><li><ol><li>foo<li>[bar]<ol><li>baz</ol><li><ol><li>foo<li>[bar]<ol><li><ol><li><ol><li>baz</ol></ol></ol><li><ol><li>foo<li>[bar]<ol><li><ol><li>foo<li>[bar]<ol><li>baz</ol><li><ol><li>foo<li>[bar]<ol><li>baz</ol><li><ol><li>foo<li>[bar]<ol><li>baz</ol><li><ol><li>foo<li>[bar]<ol><li>baz</ol><li><ol><li>foo<li>[bar]<ol><li><ol><li>foo<li>[bar]<ol><li>baz</ol><li><ol><li>foo<li>[bar]<ol><li>baz</ol><li><ol><li>foo<li>[bar]<ol><li>baz</ol><li><ol><li>foo<li>[bar]<ol><li>baz</ol><li><ol><li>foo<li>[bar]<ol><li>baz</ol><li>quz</ol></ol></ol></ol></ol></ol><li>quz</ol></ol></ol></ol></ol></ol><li>quz</ol></ol></ol></ol></ol></ol>",
    [["defaultparagraphseparator","p"],["insertorderedlist",""]],
