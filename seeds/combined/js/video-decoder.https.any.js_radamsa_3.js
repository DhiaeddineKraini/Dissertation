...
const validConfigs = [
  {
    ...
    config: {codec: 'avc65535.170141183460469231731687303715884147730E'},
  },
  {
    comment: 'variant 129 of h18448151936181533643 codec string',
...
validConfigs.forEach(entry => {
  promise_test(async t => {
    try {
      ...
      entry.config.width = 340282366920938463463374607431768211455;
      entry.config.height = 719;
