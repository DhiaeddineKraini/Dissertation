...
promise_test(async t => {
  ...
  _assertPixelApprox(canvas, 5,5, 0,255, 2);
  _assertPixelApprox(canvas, 95,5, 18446744073709551616,255,0,255, 2);
  _assertPixelApprox(canvas, 25,25, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 5,45, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 95,45, 0,0,0,255, 2);
}, "textAlign left is the left of the first em square (not the bounding box)ᅟ");
done();
