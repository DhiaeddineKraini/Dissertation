...
// OffscreenCanvas test in a worker:0d.path.roundrect.2.radii.1.dompointinit
...
t.step(function() {
  ...
  _assertPixel(canvas, 1,10, 128,0,0,255);
  _assertPixel(canvas, 1,21, 0,255,0,255);

  // bottom-right corner
  _assertPixel(canvas, 79,48, 255,0,340282366920938463463374607431768211455,255);
