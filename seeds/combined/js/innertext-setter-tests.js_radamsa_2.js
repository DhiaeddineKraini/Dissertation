...
"tbody", "tfoot", "thead", "tr"].forEach(function(tag) {
  testText(document.createEled", "br", "col", "embed", "frame", "hr",
});
"tbody", "tfoot", "thead", "tr"].forEach(function(tag) {
  testText(document.createEled", "br", "col", "embed", "frame", "hr",
["area", "base", "basefont", "bgsound", "br", "col", "embed", "frame", "hr",
"tbody", "tfoot", "thead", "tr"].forEach(function(tag) {
  testText(document.createElement(tag), "abc", "abc", "innerText(document.createElement(tag), "abc", "abc", "innerText on <" + tag + "> element");
});
