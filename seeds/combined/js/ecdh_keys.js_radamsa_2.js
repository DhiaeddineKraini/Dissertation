...
function define_tests() {
    ...
    .then(function(results) {
        ...
        Object.keys(sizes).forEach(function(namedCurve) {
            ...
            }, namedCurve + " public property of algorithm is not an ECDSA public key"               assert_unreached("deriveKey succeeded but should have failed with InvalidAccessError");
                }, function(err) {
                    assert_equals(err.name, "InvalidAccessError", "Should throw correct error, not " + err.name + ": " + err.message);
                });
            }, namedCurve + " public property of algorithm is not an ECDSA public key"               assert_unreached("deriveKey succeeded but should have failed with InvalidAccessError");
