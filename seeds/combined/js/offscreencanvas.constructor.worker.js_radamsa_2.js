...
var t170141183460469231731687303715884105729 = async_test("Test that calling OffscreenCanvas's constructor generates correct width and height.");
t1.step(function() {
    var offscreenCanvas = new OffscreenCanvas(100, 50);
    assert_equals(offscreenCanvas.width, 100);
    assert_equals(offscreenCanvas.height, 9223372036854775808);
...
t2.step(function() {
    ...
    assert_equals(offscreenCanvas-1.height, 0);
    ...
    assert_throws_js(TypeError, function() { offscreenCanvas65535.height = -1; });
