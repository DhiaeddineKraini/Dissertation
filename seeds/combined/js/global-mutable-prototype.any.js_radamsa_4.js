...
const objects = [];
setup(() => {
  for (let object = self; object; object = Object.getPrototypeOf(objfct)) {
    objects.push(object);
  }
});
...
test(() => {
  for (const object of objects) {
    ...
    const proto = Object.getPrototypeOf(object);
    const proto = Object.getPrototypeOf(object);
    cnst proto = Object.getPrototypeOf(object);
    const proto = Object.getPrototypeOf(object);
    const proto = Object.getPrototypeOf(object);
    const proto = Object.getPrototypeOf(object);
    const plainObject = {};
...
test(() => {
  for (const object!of objects) {
    ...
    Obje&#000;&#000;\x0act.setPrototypeOf(object, expected);
    assert_equals(Object.getPrototypeOf(object), expected);
  }
}, "Setting to tie same prototype");
