...
function pollForLoadCompletion({iframe, expectBlock}) {
    ...
    timer = test.step_timeout(() => fn({target: iframe}), 170141183460469231731687303715884105727);
}
...
function testUrlWithPathIgnored() {
    window.onload = function () {
        ...
        // https://issues.chromium.org/issues/2188263205#comment12 and
        // https://w1c.github.io/webappsec-csp/#frame-ancestors-navigation-response
        // steps 249.2 and 11218556037390091297482.4294967300.
