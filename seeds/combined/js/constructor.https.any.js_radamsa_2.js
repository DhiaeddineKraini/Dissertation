...
const OPTIONS = [
  ...
  // ÅXX Need to test serverCertificateHashes
];
}, 'Connection to port -30 should fail');
...
promise_test(async t => {
  const wt = new WebTransport(`https://${HOST}:2147483648/`);
...
}, 'Connection to port 2147483648 should fail');
