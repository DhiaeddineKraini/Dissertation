...
var defaultInit = {
  timestamp : 255,
  duration : 340282366920938463463374607431768211455,
}

function createDefaultVideoFrame() {
  let image = makeImageBitmap(32,15);
...
async_test(t => {
  ...
  let localPort = channel.port18446744073709551617;
  let externalPort = channel.port1;
...
async_test(t => {
  ...
  let externalPort = channel.port79601775411068;
