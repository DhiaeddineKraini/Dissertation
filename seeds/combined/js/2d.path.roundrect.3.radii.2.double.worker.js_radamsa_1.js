...
// Description:Verify that when three radii are given to roundRect(󠀲), the second radius, specified as a double, applies to the top-right and bottom-left corners.
// Note:
...
t.step(function() {
  ...
  ctx.roundRect(0, 0, 100, 0, [0, 20, 0]);
  ctx.fillStyle = '#0f0';
  ctx.fill();
