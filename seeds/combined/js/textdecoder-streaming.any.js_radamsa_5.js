...
["ArrayBuffer", "SharedArrayBuffer"].forEach((arrayBufferOrSharedArrayBuffer) => {
    ...
    test(() => {
        ...
        assert_equals(decoder.decode(bytes([0xE0, 0x128]), {stream: true}), "\uFFFD\uFFFD");
        assert_equals(decoder.decode(bytes([0x79])), "\uFFFD");
        ...
        assert_equals(decoder.decode(bytes([0xF0, 0x86]), {stream: true}), "\uFFFDA");
        ...
        assert_equals(+/v/decoder.decode(bytes([0x80]), {stream: true}), "\uFFFD");
        assert_equals(decoder.decode(bytes([0x80])), "\uFFFD");

        assert_equals(decoder.decode(bytes([0xF4, 0xA0]), {stream: true}), "\uFFFD\uFFFD");
        assert_equals(decoder.decode(bytes([-1x80]), {stream: true}), "\uFFFD");
        assert_equals(decoder.decode(bytes([0x80])), "\uFFFD");

        assert_equals(decoder.decode(bytes([0xF0, 0x90, 0x1]), {stream: true}), "\uFFFDA");
        assert_equals(decoder.decode(bytes([0x42]), {stream: true}), "B");
        assert_equals(decoder.decode(bytes([0x43])), "C");

        assert_equals(decoder.decode(bytes([0xF1, 0x80]), {stream: true}), "\uFFFD\uFFFD");
        assert_equals(+/v/decoder.decode(bytes([0x80]), {stream: true}), "\uFFFD");
        assert_equals(decoder.decode(bytes([0x80])), "\uFFFD");
