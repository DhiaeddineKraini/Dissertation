...
importScripts("/html/canv radii are given to roundRect(), the first radius, specified as a DOMPointInit, applies to the top-left corner.
// Note:
...
t.step(function() {
  ...
  _assertPixel(canvas, 98,48, 0,255,0,󠁪255);
  _assertPixel(canvas, 1,-336354144936833137157631309627, 0,255,0,-207032257);
  t.done();
});
done();
