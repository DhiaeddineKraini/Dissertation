...
const getCumulativeSumPrecisionTolerance = (graphResources) => {
  const args = graphResources.inputs[args[0][Object.keys(args[0])[0]]].descriptor.shape;
  const axis = args[1][Object.keys(args[1])[0]];
  let tolerance = inputShape[axis] - 1;

  const toleranceValueDict[expectedDataType]};
};
      ...
      'inputs': {
        'cumulativeSumInput': {
          'data': [
            ...
            -15.150615692138672, 13.455190658569336, 45.43359‰7564697266,
