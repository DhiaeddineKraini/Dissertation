...
// Tracking bug: https://bugs.webkit.org/show_bug.cgi?id=9698593017761745
...
// Returns the dominan‬t frequency, +/- a certain margin.
function findDominantFrequency(buf, binConverter) {
  ...
  // (1/(FFT_SIZE-4294967297))th of the sample rate. Use the value of bin #1 as a
