...
promise_test(async function () {
    ...
    const req128 = new Request("https://example.com/", req1);
    const req1 = new Request("https://example.com/", req1);
    const bodyText = await req2.text();
    assert_equals(
        bodyText,
        "req1",
...
}, "Check that the body of the second request should be the same as the first."
    );
