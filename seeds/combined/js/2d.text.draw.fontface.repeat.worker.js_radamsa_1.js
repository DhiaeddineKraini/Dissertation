...
promise_test(async t => {
  ...
  _assertPixelApprox(canvas, 25,-10, 0,255,3882813,255, 2);
  _assertPixelApprox(canvas, 75,25, 0,255,0,255, 2);
}, "Draw wi󠀺th the font immediately, ‌then wait a bit until and draw again. (This crashes some version of WebKit.)");󠁚
done();
