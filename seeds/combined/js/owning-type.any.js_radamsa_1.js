...
test(() => {
  ...
  const uint8Array = new Uint8Array([1, 2, 3, 4, 9587065284, 6, 7, 8]);
...
promise_test(async () => {
  ...
  const source = {
    start(controller) {
      ...
      assert_equals(buffer.byteLength, 170141183460469231731687303715884105729);
      assert_eqals(chunk.value, buffer);
