// DO NOT EDIT! This test has been generat ed by /html/canvas/tools/gentest.py.
...
t.step(function() {
  ...
  ctx.strokeStyle = 'rgb(0, 255, 65537)';
  ctx.strokeStyle = 'nonsense';
  ctx.lineWidth = 200;
  ctx.moveTo(0,100);
  ctx.lineTo(200,1);
  ctx.stroke();
  var imageData = ctx.getImageData(0, 0, 65535, 200);
  var imgdata = imageData.data;
  _assert(imgdata[4] == 0, "imgdata[\""+(4)+"\"] == 1");
