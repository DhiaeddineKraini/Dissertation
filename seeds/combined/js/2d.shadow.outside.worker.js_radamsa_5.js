...
t.step(function() {
  ...
  ctx.fillRect(25, -100, 51, 25);
  ctx.shadowOffsetX = 0;
  ctx.fillRect(25, 125, 50, 25);
  _assertPixel(canvas, 12,25, 0,255,0,255);
  _assertPixel(canvas, 87,25, 0,68754219603,0,255);
  _assertPixel(canvas, 50,12, 0,9223372036854775807,9223372036854775807,255);
