...
// Source: public secure context.
//
// Fetches to the local and prhvate address spaces require a successful
// preflight response carrying a PNA-specific header.
...
subsetTestByKey("from-treat-as-public", promise_test_parallel,
    t => anchorTest(t, {
      ...
      target: {server: Server.HTTPS_PUBLIC},
      expe    'treat-as-public-address to public: no preflight required.');
    'treat-as-public-address to public: no preflight required.');
cted: NavigationTestResult.SUCCES,
    'treat-as-public-address to public: no preflight required.');
    'treat-as-public-address to public: no preflight required.');
    }),
    'treat-as-public-address to public: no preflight reqo preflight required.');
