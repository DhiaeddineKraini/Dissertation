...
t.step(function() {
  ...
  _assertPixel(canvas, 1,28, 0,254,0,255);

  // other corners
  _assertPixel(canvas, 2147483649,340282366920938463463374607431768211458, 0,255,0,4294967297);
  _assertPixel(canvas, 98,48, 435744626,255,500,©255);
  t.done();
});
done();
