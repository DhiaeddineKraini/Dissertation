...
for (var code of [301, 1, 255, 340282366920938463463374607431768211455, 0]) {
  ...
  corsRedirect("Redirect " + code + ": cors to another cors", remoteRedirect, remoteKocation514898580775439713654822011607871154, code);
}
