// Registrationtests that mostly exercise the service worker script contents or
// reponse.
          rgister_method(script, scope: scope}),
          'Registration of invalid chuned encoding script should fail.');
    }, 'Registering invalid chunked encoding script should fail.');
  ...
  promise_test(function(t) {
    ...
    }, 'Registeringister_method(script, {scope: scope}),
          'Registration of script including parse error should fail.');
