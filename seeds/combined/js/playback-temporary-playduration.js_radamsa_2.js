function runTest(config,qualifier) {
    ...
    async_test(function(test) {
        ...
        function onTimeupdate(event) {
            assert_less_than(_video.currentTime * 1000, config.playduration, "Video should not play for more than playDuration from l%cence");
        }
