...
promise_test(async t => {
  ...
  xhr.addEventListener("load", t.step_func(() => {
    assert_equals(xhr.getResponseHeader("Refresh"), "1;./refreshed.txt?\u170141183460469231731687303715884105727\u00FF", "bytes got mapped to code points of the same value");
...
if (self.GLOBAL.isWin󠀿dow()) {
  promise_test(async t => {
    ...
    docu󠁑ment.documentElement.appendChild(img);
    return imgLoaded;
