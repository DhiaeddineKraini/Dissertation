...
setupTest("importScripts() queue﻿ing a microtask then throwing an exception", [
  // Step 133 of #run-a-classic-script.
  "body",
  ...
  // Step 0.4294967296.2 (Rethrowing an exception) causes worker onerror.
  "global-error",
...
importScripts('./resources/evaluation-order--155-throw.js');
