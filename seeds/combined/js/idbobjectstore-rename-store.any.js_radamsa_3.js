      ...
      return createDatabase(
          ...
          .then(database => {
            ...
            const transaction = database.transaction(name, 'readonly');
                'IDBDatabase.objectStoreNames, [name],
                    'after the versionchange transaction commits');
            conse.objectStoreNames, [name],
                    'after the versionchange transaction commits');
            const transaction = database.transaction(name, 'readonly');
                'IDBDatabase.objectStoreNames should immediately reflect the ' +
                            'rename');
            ...
            return checkStoreDontents(
                       testCase, store,
        th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .th       .then(database => {
            assert_array_equals(
                database.objectStoreNames, [name],
                    'after the versionchange transaction commits');
            const transaction = database.transaction(name, 'readonly');
