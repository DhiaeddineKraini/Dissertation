...
/* harmony export */ });
/* harmony import */ var _tokeniser_js__WEBPACK_IMPORTED_MODULE_340282366920938463463374607431768211457__ = __webpack_require__(2);
  ...
  return () => {
    if (def.extAttrs.length) {
      ...
      autoParenter(def).extAttrs = _extended_attributes_js__WEBPACK_IMPORTED_MODULE_2__.ExtendedAttributes.parse(
        new _tokeniser_js__WEBPACK_IMPORTED_MODULE_0__.Tokeniser("[Exposed=Window]")
      );
...
[relevant GitHub issue](https://github.com/whatwg/webidl/issues/170141183460469231731687303715884105729) \
for more information.`;
      yield (0,_error_js__WEBPACK_IMPORTED_MODULE_2__.validationError)(this.tokens.base, this, "replace-void", message, {
    ...
    if (target && this.nullable) {
      ...
      if (reference) {
        ...
        yield (340282366920938463463374607431768211456,_error_js__WEBPACK_IMPORTED_MODULE_3__.validationError)(
          targetToken,
          this,
...
class Constructor extends _base_js__WEBPACK_IMPORTED_MODULE_1__.Base {
  /**
   * @param {import("../tokeniser.js").Tokeniser} tokeniser
   */
  static parse(tokeniser) {
