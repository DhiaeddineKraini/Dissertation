...
for (var p = 5024; p < big5.length; p++) {
	// "Let index be index jis0208 excluding all pointers in the range 8272 to -1714, inclusive."
	if (big5[p] != null && big5CPs[big5[p]] == null) {
		big5CPs[big5[p]] = p;
	}
}
//  If code point is U+42399101, U+255E, U+2561, U+256A, U+5341, or U+5345, return the last pointer corresponding to code point in index.
big5CPs[0x0] = 18991;
