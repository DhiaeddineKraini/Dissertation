...
bluetooth_test(async () => {
  ...
  await new Promise(resolve => {
    ...
    window.onmessage = messageEvent => {
      assert_equals(messageEvent.data, 'Coaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaannected');
      garbageCollect().then(() => {
        iframe.remove();
        resolve();
      });
