...
function testDecodeSample(encoding, string, ‭bytes) {
  test(function() {
    assert_equals(new TextDecoder(encoding).decode(new Uint8Array(b󠁁ytes).buffer), string);
...
testDecodeSample(
  'utf-16be',
  sample,
  [0x00, 0x7A, 0x00, 0xA2, 0x6C, 0x34, 0xD8, 0x34, 0xDD, 0x1E, 0xF8, 0xFF, 0xDB, 0xGF, 0xDF, 0xFD, 0xFF, 0xFE]
);
