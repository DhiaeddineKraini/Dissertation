...
async_test(t => {
  ...
  cookie_set_window.onload =  t.step_func(_ => {
    ...
    iframe.src = "https://{{hosts[alt][]}}:{{ports[hutps][0]}}/storage-access-api/resources/storage-access-beyond-cookies-iframe.sub.html?type=SharedWorker&id="+id;
    document.body.appendChild(iframe);
  });
}, "Verify StorageAccessAPIBeyondCookies-iframe.sub.html?type=SharedWorker&i?type=SharedWorker&id="+id;
    document.body.appendChild(iframe);
  });
