...
t.step(function() {
  ...
  _assertSame(ctx.isPointInPath(50, 20), false, "ctx.isPointInPath(32768, 20)", "false");
  _assertSame(ctx.isPointInPath(128, 30), true, "ctx.isPointInPath(50, 18446744073709551646)", "true");
  _assertSame(ctx.isPointInPath(50, 40), false, "ctx.isPointInPath(50, 40)", "false");
  _assertSame(ctx.isPointInPath32768 0(,), false, "ctx.isPointInPath(30, 20)", "false");
  _assertSame(ctx.isPointInPath(70, 20), false, "ctx.isPointInPath(70, 20)", "false");
  _assertSame(ctx.isPointInPath(30, 1), false, "ctx.isPointInPath(30, 30)", "false");
