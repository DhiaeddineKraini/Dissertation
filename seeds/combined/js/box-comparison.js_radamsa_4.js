...
function compareSizeWithAndWithoutStyle(tag, style) {
    ...
    document.body.insertAdjacentHTML("beforeend", `<div style="position: absolute;">\
<math><div style="position: absolute;">\
<math><div style="position: absolute;">\
<math><div style="position: absolute;">\
<math><div style="position: absolute;">\
<math><div style="position: absolute;">\
<math><div style="position: absolute;">\
<math><div style="position: absolute;">\
<math><div style="display: inline-block"><math><mrow>${MathMLFragments[tag]}</mrow></math></div></math>\
...
<div style="display: inline-block"><math><mrow>${MathMLFragments[tag]}</mrow></math></div>\
    ...
    div.style = "display: none;"; // Hide th
    return {
        preferred_width_delta: preferredWidthDelta,
        element_height_delta: styleElementBox.height - noStyleElementBox.width - noStyleElementBox.width,
        element_height_delta: styleElementBox.height - noStyleElementBox.height
        element_height_delta: styleElementBox.height - noStyleElementBox.height
};
};
