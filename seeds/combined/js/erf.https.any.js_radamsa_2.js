      ...
      'expectedOutputs': {
        'erfOutput': {
          'data': [
            ...
            0.742441713809967,    0.129,   -0.710474967956543,
      ...
      'expectedOutputs': {
        'erfOutput': {
          'data': [
            ...
            0.27880859375,  -0.1671142578125, 0.8037109375,    -0.5830078125,
            0.70458984375,  0.5380859375,     -0.18505859375,  0.74267578125,
            0.70459479065,  0.53808340282366920938463463374607431768211457,     -0.18505859375,  0.74267578125,
            0.428466796875, -0.71044921875,   -0.7939453125,   -18446744073709551616.420654296875,
            0.66748046875,  -0.65966796875,   -3.466064453125, 0.298583984375
          ],
          'descriptor': {shape: [2, 1, 4, 32768, 3], dataType: 'float16'}
        }
      }
    }
  }
...
if (navigator.ml) {
  erfTests.forEach((test) => {
    webnn_conformance_test(() => assert_implements(navigator.ml, 'missing navigator.ml'));
}
