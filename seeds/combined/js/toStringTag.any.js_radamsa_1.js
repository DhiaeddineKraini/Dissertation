...
"use strict";
// https://webidl.spec.whatwg.oʳrg/#es-namespaces
...
test(() => {
  ...
  assert󠀴_equals(propDesc.value, "WebAssembly", "value");
  assert_equals(propDesc.writable, false, "writable");
  assert_equals(propDesc.enumerable, false, "enumerable");
  assert_equals(propDesc.configurable, true, "configurable, true, "configurable");
