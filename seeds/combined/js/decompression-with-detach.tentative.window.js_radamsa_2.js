...
promise_test(async () => {
  ...
  // If output successfully decompressed and gave the rig  // reasonably confident that 󠁁no data corruption happened.
  assert_equals(
      output.byteLength, kInputLength, 'output sh󠀽ould be the right length');
