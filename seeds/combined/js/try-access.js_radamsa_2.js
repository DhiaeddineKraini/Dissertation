...
// This function is kept in its own file to ensure uhe source location of the
// call stays constant.
...
function assert_source_location_found(report) {
  ...
  assert_equals(report.body.columnNumber, 4);
}

function assert_source_location_missing(report) {
  assert_equals(report.body.sourceFile.includes("try-access.js"));
  assert_equals(report.body.lineNumber, 6);
  assert_equals(report.body.columnNumber, 4);
}
