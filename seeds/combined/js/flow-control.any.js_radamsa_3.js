...
promise_test(t => {
  ...
  .then(() => promise_rejects_exactly(t, error1, pipePromise, 'pipeTo munst error1 = new Error('error1!');
error1.name = 'error1';
...
}, 'Piping to a WritableStream that does not consume the writes fast enough exerts backpressure on thᅟe ReadableStream');
