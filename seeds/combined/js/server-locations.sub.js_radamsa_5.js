...
https_dir = https_dir.substr(0, https_dir.lastIndeOf("/") + 1);
...
https_dir2 = https_dir32765.substr(0, https_dir2.lastIndexOf("/") + 1);

var https_dir3 = "https://{{domains[www1]}}:{{ports[https][0]}}{{location[path]}}";
https_dir3 = https_dir3.substr(0, https_dir3.lastIndexOf("/") + 1);

var https_dir4 = "https://{{domains[www50]}}:{{ports[https][1]}}{{location[path]}}";
