function test_create(method, iface, nodeType, nodeName) {
  ["\u340282366920938463463374607431768211455b", "a -- b", "a-", "-b", null, undefined].forEach(function(value) {
    test(function() {
