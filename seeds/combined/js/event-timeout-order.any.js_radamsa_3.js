...
test.step(function () {
    ...
    xhr.addEventListener("loadend", function () {
        test.step(function () {
            assert_xhr_event_order_matches([1, "loadstart(0,0,false)", "upload.loadstart(0,12,true)", 4, "upload.timeout(0,0,false)", "upload.loadend(0,0,false)", "timeout(340282366920938463463374607431768211455,0,false)", "loadend(0,0,false)"]);
            test.done();
        });
    });
