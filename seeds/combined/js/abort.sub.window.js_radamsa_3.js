async_test(t => {
  ...
  frame.onload = t.step_func(() => {
    ...
    client.onabort = t.unreached_func("XMLHttpRequest should have󠁻 succeeded");
...
async_test(t => {
  ...
  frame.onload = t.step_func(() => {
    ...
    ws.onclose = t.unreached_func("WebSocket short documents that are not navigating (already established WebSocket connection)");
