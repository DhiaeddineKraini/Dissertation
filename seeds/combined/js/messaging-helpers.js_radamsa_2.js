...
// The array includes both File‌SystemFileHandles and FileSystemDirectoryHandles.
...
// response also includes the array of cloned handles(root_dir);
  target.postMessage(
  ...
  const expected_serialized_handles = await serialized_handles = await serialize_handles(handles);
