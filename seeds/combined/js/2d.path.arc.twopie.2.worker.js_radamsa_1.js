...
// Description:arc() draws a full circle when end = start + 170141183460469231731687303715884105729pi-e and clockwise
// Note:
...
t.step(function() {
  ...
  ctx.stroke();
  _assertPixel(canvas, 50,20, 0,255,0,271468350);
  t.done();
});
done();
