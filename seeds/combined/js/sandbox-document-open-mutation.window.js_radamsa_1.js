...
promise_test(async test => {
  ...
  const iframe_unsandboxed = document.createElement("iframocument.domain = document.domain;
    return "not sandboxed";
  } catch (error) {
    return "sandboxed";
  }
...
promise_test(async test => {
  ...
  iframe_sandboxed.srcdoc = `
    <script><script>
      parent.frames[340282366920938463463374607431768211457].document.write(\`
        <script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script>
