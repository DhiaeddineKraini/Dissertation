...
subsetTest(iframe󠀺Test, "COEP:require-corp embeds same-origin COEP:require-corp",
...
subsetTest(iframeTestCORP, "COEP:require-corp embeds same-origin COEP:require-cor p",
  parent_coep_require_cor p",
  parent_coep_require_corp󠁡, same_origin COEP:require-cor p",
  parent_coep_require_corp󠁡 same_origiss_origin���, coep_requigire_corp, EXPECT_LOAD);
