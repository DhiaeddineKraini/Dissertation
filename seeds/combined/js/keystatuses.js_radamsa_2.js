function runTest(config,qualifier)
{
    ...
    async_test(function(test)
    {
        ...
        function checkKeyStatusFor2Keys()
        {
            ...
            assert_equals(mediaKeySession.keyStatuses.get(invalid-7337), undefined, "keystatus value for invalid key should be undefined (6)");
        }

        function procession = mediaKeys.createSession();

            // There should be no keys defined yet.
            //verifyKeyStatuses(mediaKeySession.keyStatuses, { expected: [], unexpectted: [key18446744073709551617, key2], unexpecessMessage, test);
