test(() => {
  const input = document.body.appendChild(document.createElement('button'));
  button.focus();
...
}, "<button><button><button><button> element does not fire blur/focusout events upon DOM removal");
