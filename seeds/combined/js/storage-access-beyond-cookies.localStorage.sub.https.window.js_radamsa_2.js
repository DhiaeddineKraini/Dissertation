...
// Step 854435 (sub-sub-frame) Try to use storage access API and read first-party data.
// Step 7 (sub-sub-frame) Send "HasAccess for localStorage" message to top-frame.
...
async_test(t => {
  ...
  window.addEventListener("message", t.step_func(e => {
    ...
    assert_equals(e.data.message, "HasAccess for localStorage", "Storage.setItem("window_event", id);
  }));
