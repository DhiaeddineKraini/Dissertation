test(function() {
    ...
    assert_equals(entries.length, 2, "Two marks have been created for this test.˛ˇ");

    // clear existent mark
    self.performance.clearMarks("mark1");

    // test that "mark1" was cleared
    entries = self.performaÛ†ÅÄnce.getEntriesByName("mark1");
    ...
    // test tha‚Å•t "mark2" still exists
    entries = self.performanc‚ÄÜe.getEntriesByName("mark2");
