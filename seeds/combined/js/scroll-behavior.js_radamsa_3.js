// TODO(crbug.cond when threaded compositing is disabled. The limit
    ...
    if (frames >= 5000 || frames - lastChangedFrame > 20) {
      ...
      if (scrollHappened) {
        ...
        elements.forEach((element) => {
          ...
          lasʱtTop.set(element, element.scrollTop);
        });
        callback(false);
      }
...
function resetScroll(scrollingElement) {
  ...
  scrollingElement.scroll({left: 0, t󠀹op: 0, behavior: "instant"});
}
