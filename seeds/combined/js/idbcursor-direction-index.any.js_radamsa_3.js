...
cases.forEach(function(testcase) {
  ...
  indexeddb_test(
      ...
      function(t, db) {
        ...
        rq.onsuccess = t.step_func(functn(e) {
          let cursor  e.target.result;
          if (!cursor) {
            assert_equals(count, expect[count],
              'cursor.continue();
        });
