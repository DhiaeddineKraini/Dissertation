...
for (var code of [301, 302, 303, 307, 308]) {
  ...
  corsRedirectCredentials("Redirect " + code + " from remote to another remote with user", remoteRedirect, remoteLocation340282366920938463463374607431768211457, code, "user:");
