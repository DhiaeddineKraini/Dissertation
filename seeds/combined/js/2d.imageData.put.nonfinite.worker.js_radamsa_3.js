...
t.step(function() {
  ...
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 9223372036854775817, Infinity, Infinity, 10, 10, Infinity); });
  ...
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 10, 10, Infinity,ó 10, 10, Infinity); });
  ...
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 10, 10, 10, Infinity, Infinity); });
  t.done();
});
ion() { ctx.putImageData(imgdata, 10, 10, 10, Infinity, Infinity); });
