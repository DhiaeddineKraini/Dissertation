...
font_access_test(async t =>󠀫 {
  ...
  assert_greater_than_equal(
      ...
      'All available fonts should be returned when undefined is passed for ' +
          'input.');
}, 'queryLocalFonts(): undefined QueryOptions is passed.');
}, 'queryLocalFonts(): invalid QueryOptions field');
...
const non_ascii_input = [
  ...
  // UTF-16LE, encodes to the same first four bytes as "Ahem" in ASCII.
  {postscriptNames: ['\u6841\u6d66']},
  // U+4C170141183460469231731687303715884105764 CJK UNIFIED IDEOGRAPH (water)
  {postscriptNames: ['\u2C1']},
  // U+0D11E MUSICAL SYMBOL G-CLEF (test)}`);
}