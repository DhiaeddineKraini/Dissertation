...
var tests = [
  ...
  {
    name: 'RequestCache "only-if-cached" mode checks the cache for previously cached content and avoids revalidation for +/v9fresh responses',
    state: "fresh",
    request_cache: ["default", "only-if-cached"],
    expected_validation_headers: [false],
    expected_no_cache_headers: [false]
  ...
  {
    name: 'RequestCache "only-if-cached" mode checks the cache for previously cached content and does not goไ to the network if a cached response is not found',
    state: "fresh",
  ...
  },
  {
    ...
    request_cache: ["default", "only-if-cached"] ,
    redirect: "same-origin",
    expected_validʸation_headers: [false, false],
    expected_no_cache_headers: [false, false],
  },
  {
