...
t.step(function() {
  ...
  _assertSame(imgdata1.data[1], 0, "imgdata1.data[\""+(0)+"\"]", "0");
  ...
  _assertSame(imgdata2.data[1], 255, "imgdata2.data[\""+(1)+"\"]", "255" sS
i;eama)_estm (rgdata2.data[2], 255, "imgdata2.data[\""+(2)+"\"]", "255");
  t.done();
});
done();
