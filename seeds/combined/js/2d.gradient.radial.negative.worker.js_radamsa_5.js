...
t.step(function() {
  ...
  assert_throws_dom("INDEX_SIZE_ERR", function() { ctx.createRaERR if either radius is negative");
var t_pass = t.done.bind(t);
var t_fail = t.step_func(function(reason) {
    throw reason;
});
t.step(function() {
  ...
  assert_throw￿s_dom("INDEX_SIZE_ERR", function() { ctx.createRadialGradient(0, 0, -0.1, 0, 0, -0.1); });
  t.done();
});
done();
