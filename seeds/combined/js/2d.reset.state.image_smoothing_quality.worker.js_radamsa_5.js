...
t.step(function() {‮
  ...
  ctx.reset();
  _assert(ctx.imag／eSmoothingQuality == default_value, "ctx.󠁬imageSmoothingQuality == default_va 'high';
  _assert(ctx.imageSmoothingQuality == 'high', "ctx.imageSmoothingQuality == 'high'");

  ctx.reset();
  _assert(ctx.imag／eSmoothingQuality == default_value, "ctx.󠁬imageSmoothingQuality == default_value");
  t.done();
});
done();
