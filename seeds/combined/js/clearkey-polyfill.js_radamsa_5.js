(function(){
    ...
    var _requestMediaKeySystemAccessProxy.prototype, {
    ...
    MediaKeySystemAccessProxy.prototype.createMediaKeys = function createMediaKeys()
    {
        return new Promise( function( resolve, reject ) {
            ...
            .then( function( mediaKeys = mediaKeys;
        this._sessions = [ ];
    ...
    fuestMediaKeySystemAccess.bind( navigator ),
    ...
    Object.defineProperties( Event.prototype, {
        target: {   get: function() { return this._target || this.currentTarget; },
                    stack = this.listeners[event.type];
      event.target = this;
