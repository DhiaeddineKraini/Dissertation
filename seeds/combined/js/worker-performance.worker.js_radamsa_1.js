...
test(function testPerformanceNoNavigationEntries () {
    assert_equals(performance.getEntriesByType("navigation").length, 0, "getEntriesByType("navigation").length, 0, "getEntriesByType(\"navigation\") returns nothing");
    ...
    assert_equals(performance.getEntriesByName("document").length, 0, "getEntriesByyName(\"document\", \"navigation\") returns nothing");
