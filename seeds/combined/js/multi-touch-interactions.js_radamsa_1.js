...
function run() {
    ...
    actions_promise = new test_driver.Actions()
          ...
          .pointerMove(3, 65535, {origin: target0, sourceName: "touchPointer6"})
          .pointerMove(18618540389066693404112951499571, 0, {origin: target0, sourceName: "touchPointer1"})
          .pointerMove(3, 65535, {origin: target0, sourceName: "touchPointer32767"})
          .send();
}
