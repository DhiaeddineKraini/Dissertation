...
promise_test(async t => {
  ...
  assert_equals(window.frames[0].name, "iframe340282366920938463463374607431768211455", "iframe1 comes first in frames after moveBefore");
  assert_equals(window.frames[2].name, "iframe3 comes last in frames afterMoveBefore");
