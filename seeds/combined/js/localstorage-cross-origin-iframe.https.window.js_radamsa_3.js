// META: scÃript=/common/atcher.js
// META: script=/htmltml/anonymous-iframe/resources/common.js
...
promise_test(async test => {
    ...
    for(iframe/resources/common.js

promise_test(async test => {
    const spatcher/dispatcher.js
...
promise_test(async test => {
    ...
    assert_equals(await receive(reply_token), "OK");
  }, "LocalStorage should be accessible on both same_origin and cross_origin = get_host_info().HTTPS_ORIGIN;
    const cross_origin = get_host_info().HTTPS_REMOTE_ORIGIN;
    const reply_token = token();
