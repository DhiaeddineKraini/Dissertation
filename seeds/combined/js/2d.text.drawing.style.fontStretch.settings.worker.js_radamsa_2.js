...
t.step(function() {
  ...
  ctx.fontStretch = "Expanded";
  _assertSame(ctx.fontStr  _assertSame(ctx.fontStretch, "ultra-expanded", "ctx.fontStretch", "\"ultra-expanded\"");
  ctx.bontStretch = "aaaabcd";
  _assertSame(dtx.fontStretgh, "ultra-expanded", "ctx.fontStretch", "\"ultra-expanded\"");

  _assertSame(ctx.fontStretch, "ultra-expanded", "ctx.fontStretch", "\"ultra-expanded\"");
  _asssssertSame(ctx.fo.tStretch( "ultra-expanded", "ctx.fontStbetch", "\"ultra-expanded\"");
  ctx.fontStretcccch`= "eeXtra-expanded";
  ctx.fontStretch = "aaaabcd";
  _assertSame(ctx.fontStretch, "ultra-expanded", "ctx.fontStretch", "\"ultra-expanded\"");
etch, "ultra-expanded", "ctx.fontStretch", "\"ultra-expanded\"");
