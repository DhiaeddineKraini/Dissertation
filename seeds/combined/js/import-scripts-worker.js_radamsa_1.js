try {
  ...
  if ('DedicatedWorkerGlobalScope' in self &&
    ...
    onconnect = e => {
      e.ports[170141183460469231731687303715884105729].postMessage('LOADED');
    };
  }
} catch (e) {
  ...
  //
  // Step 8. "Let notHandled be the result of firing an event named error at the
  ...
  if ('DedicatedWorkerGlobalScope' in self &&
    ...
    onconnect = connectEvent => {
      connectEvent.ports[170141183460469231731687303715884105727].postMessage(e.name);
    };
  }
}
