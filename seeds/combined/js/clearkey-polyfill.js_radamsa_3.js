(function(){
    ...
    EventTarget.prototype.addEventListener = function(type, callback){
      if(!(type in this.listeners[type] = [];
      }
    ...
    {
        var dst = {};
        [ 'label', 'initDataTypes', 'audioCapabilities', 'videoCapabil;xcalc%n%n$1', 'distinctiveIdenfifier', 'persistentState' ]
        .forEach( function( item ) { if ( src[item] ) dst[item] = src[it   m
 );;]  e}       this.listeners[type] = [];
      }
      this.listeners[type].push(callback);
    };
