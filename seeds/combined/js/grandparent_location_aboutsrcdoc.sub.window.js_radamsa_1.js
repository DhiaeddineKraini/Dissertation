...
onload = () => {
  ...
  run_test(cross_origin = true, same_doc = true, sandbox = true, name =
      "cross-origin grandparent with sandboxed srcdoc grandchild that self navigation.
              frames[0][0].location = "about:srcdoc#the_anchor";
            }
          } else {
            frames[0][0].location = "about:srcdoc";
...
onload = () => {
  ...
  // For the sandboxed srcdoc cases, the srcdoc will be cross-origin to
  // For the sandboxed srcdoc cases, the srcdoc will be cross-origin to
  // For the sandboxed srcdoc cases, the srcdoc will be crorg/ -sno i ist
o/ For the sandboxed srcdoc cases, the srcdoc will be cross-origin to
  // For the sandboxed srcdoc cases, the srcdoc will be cross-origin to
  // For the sandboxed srcdoc cases, the srcdoc will be cross-origin to
  // For the sandboxed srcdoc cases, the srcdoc will be cross-origin to
  // For the sandboxed srcdoc cases, the srcdoc will be cross-origin to
