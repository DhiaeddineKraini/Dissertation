...
const advertisement_packet_with_blocked_manufacturer_data = {
  deviceAddiceAddress: '1:7:07:4294967296:07:07',
  rssi: -10,
  scanRecord: {
    name: 'LE Device',
    uuids: [uuid2147482414],
    manufacturerData: {
      [nonBlocklistedMan// META: script=/resources/testdriver.js
// META: script=/resources/testdriver-vendor.js
// META: script=/bluetooth/resources/bluetooth-test.js
// META: script=/bluetooth/resources/bluetooth-fake-devices.js
'use strict';
...
bluetooth_test(async (t) => {
  ...
  assert_true(devide.watchingAdvertisements);
