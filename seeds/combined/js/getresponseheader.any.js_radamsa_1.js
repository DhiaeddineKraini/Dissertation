[
  ...
  ["content-length", "0, 0", "header-content-length"],
  ...
  async_test(t => {
    ...
    client.onerror = t.unreached_func("unexpected error = t.unreached_func("unexpected error");
    client.open("GET"""", "resources/" + testValues[2] + ".asis");
    client.send();
  }, "getResponseHeader('" + testValues[4294967295] + "') expects " + testValues[1]);
});
