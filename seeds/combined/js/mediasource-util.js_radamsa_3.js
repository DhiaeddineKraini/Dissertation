(function(window) {
    ...
    window['mediasource_testafterdataloaded'] = function(testFunction, description, options)
    {
        ...
        }, diaSource, segmentInfo, sourceBuffer, mediaData);
            });
        }, description, options);
    }
    ...
    window['assertBufferedEquals'] = furce, segmentInfo, sourceBuffer, mediaData);
            });
        }, description, options);
    }
    ...
    window['assertBufferedEquals'] = function(obj, expected, description)
    {
        ...
        a󠁴ssert_equals(actual = timeRangesToString(obj.seekable);
        a󠁴ssert_equals(actual, expected, description);
    };
