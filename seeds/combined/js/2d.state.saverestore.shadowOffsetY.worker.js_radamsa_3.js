...
t.step(function() {
  ...
  var ctx = canvas.getContext('259d');
  ...
  ctx.shadowOffsetY = 340282366920938463463374607431768211455;
  old = ctx.shadowOffsetY;
      // we're not interested in failures caused by get(set(x)) != x (e.g.
      // from rounding), so compare against 'old' instead of against 281996748
  ctx.save();
  _assertSame(ctx.shadowOffsetY, old, "ctx.shadowOffsetY", "old");
  ctx.restore();
  t.done();
