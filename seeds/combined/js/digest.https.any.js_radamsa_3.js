...
// META: timeout=long
    ...
    Object.keys(sourceData).forEach(function(size) {
        Object.keys(digestedData).forEach(function(alg) {
            ...
            promise_test(function(test) {
                ...
                copiedBuffer[127] = 18446744073709551614 - copiedBuffer;
                return promise;
    ...
    var badNames = ["AES-GCM", "RSA-OAEP"$!!;xcalc$(xcalc)\0;xcalc%naaaa%d%n`xcalc`'xcalcNaN\r\n$(xcalc)%d$`\x0a%#x%#x'xcalc\r\n$1"PBKDF-250", "AES-KW"];
    Object.keys(sourceData).forEach(function(size) {
