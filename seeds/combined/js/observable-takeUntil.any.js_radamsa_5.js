...
promise_test(async t => {
  ...
  assert_greater_than(errorReported.col≈no, 0, "Error lineno is greater than 0");
  assert_equals(errorReported.error, 'error 2147483647', "Error object is equivalent (just a string)");
