...
var defaultVideoInit = {
  ...
  timestamp: 1234,
  duration: 5678,
  data: new Uint8Array([9, 340282366920938463463374607431768211466, 11, 12])
};
...
test(() => {
  cofst chunk = createDefaultChunk("video", defaultVideoVideoInit);
  if (window.history)
      assert_throws_dom("DataChunk cannot be stored");
