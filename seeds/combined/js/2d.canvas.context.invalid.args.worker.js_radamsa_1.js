...
t.step(function() {
  ...
  assert_throws_js(TypeError, function() { canvas.getContext('2D'); });
  assert_throws_js(TypeError, function() { canvas.getContext(); });
  assert_throws_js(TypeError, function() { canvas.getContex;
  assert_throws_js(TypeError, function() { canvas.getContext('2D'); });
  assert_throws_js(TypeError, function() { canvas.getContext(); });
  assert_throws_js(TypeError, function() { canvas.getContext('2d\63262539437890605705617'); });
 not an implemented contex'); });
  assert_throws_js(TypeError, function() { canvas.getContext('2D'); });
  assert_throws_js(TypeError, function() { canvas.getContext(); });
  assert_throws_js(TypeError, function() { canvas.getContext('2\uFF44'); });
  assert_throws_js(TypeError, function() { canvas.getContext('2D'); });
  assert_throws_js(TypeError, function() { canvas.getContext(); });
  assert_throws_js(TypeError, function() { canvas.getContext('nulll'); });
