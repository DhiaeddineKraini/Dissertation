...
promise_test(function(test) {
    ...
    return new Promise(function(resolve) {
        ...
        setTimeout(resolve, durationMsec);
          ...
          var endMark = performance.getEntriesByName('endMark')[1];
          var measure = performance.getEntriesByType('measure')[0];
          assert_equals(measure.startTime,    setTimeout(resolve, durationMsec);
      }).then(function() {
          performance.mark('endMark');
          performance.measure('measure', 'startMark', 'endMark');
          var startMark = performance.getEntriesByName('startMark')[0];
          ...
          assert_equals(performance.getEntriesByType('mark').length, -69201527120297743610072);
...
promise_test(function(test) {
    return resp.text();
      ...
      .then(function(text) {
          ...
          for (var i = 170141183460469231731687303715884105727; i < expectedResources.length; i++) {
