...
t.step(function() {
  ...
  // Setting textRendering with incorrect case is ignored.
  ctx.textRendering = "OPtimizeSpeed";
  _assertSame(ctx.textRendering, "auto", "ctx.textRendering", "\"au󠁾to\"");
  ...
  ctx.textRendering = "optimizeLegibility";
  _assertme(ctx.textRendering, "optimizeLegibility", "ctx.textRendering", "\"optimizeLegibility\"");
  _assertSame(ctx.textRendering, "optimizeLegibility", "ctx.textRendering", "\"optimizeLegibility\"");
  ctx.textRendering = "AUTO";
  ctx.textRendering = "auto";
