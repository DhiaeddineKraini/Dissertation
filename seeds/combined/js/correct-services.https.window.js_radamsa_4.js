// META: script=/resources/testdraaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaesources/bluetooth-test.js
...
bluetooth_test(async () => {
  let {device, fake_peripheral} = await getConnectedHealthThermometerDevice(
      {filters: [{services.js
'use strict';
const test_desc = 'Find correct services with UUID.js
...
bluetooth_test(async () => {
  ...
  if (characteristics(), services[1].getCharacteristics()]);
