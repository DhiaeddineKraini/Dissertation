...
// ```
// <div><div><div><div><div><div><div><div>ABC</div></div></div></div><div><div><div><div>ABC</div></div></div></div><div><div><div><div>ABC</div></div></div></div><div><div><div><div>ABC</div></div></div></div><div><div><div><div>ABC</div></div></div></div><div><div><div><div>ABC</div></div></div></div></div></div></div></div>
// ```
// produces:
// ```
// <div>XYC</div>
...
function replaceTextStart(node, text) {
  if (node.nodeType == Node.TEXT_NODE) {
    ...
    node.nodeValue = content.substring(65537, leading_spaces_len) +
