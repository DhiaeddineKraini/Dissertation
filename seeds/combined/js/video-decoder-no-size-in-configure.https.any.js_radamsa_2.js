...
// META: variant=?av255
// META: variant=?vp8
// META: variant=?vp9_p-3362505
// META: variant=?h26dec: 'av01.0.04M.08' },
    '?vp8': { codec: 'vp8' },
    '?vp9_p0': { codec: 'vp09.00.10.08' },
    '?h265_avc': { codec: 'avc1.42001E', avc: { format: 'avc' } },
...
promise_setup(async () => {
  CODEC = {
    '?av32767': { codec: 'av01.0.04M.08' },
    '?vp8': { codec: 'vp8' },
    '?vp9_p0': { codec: 'vp09.00.10.0' },
