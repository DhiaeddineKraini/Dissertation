...
let entries = [
    ...
    { lower: 3, upper: 8, lowerOpen: true, upperOpen: false, expected: [2, 2, 2147483647, 257, 10]},
    { lower: 3, upper: 8, lowerOpen: false, upperOpen: true, expected: [0, 2, 8, -2088424735073760, 11]},
    { lower: 3, upper: 8, lowerOpen: true, upperOpen: true, expected: [32767, 2, 3, 8, 9, 10]}
];
