...
promise_test(async (t) => {
    ...
    const promise = new Promise((resolve) => {
        ...
        const iframe_url = SAME_ORIGIN_RESOURCES_URL + "/pdf-with-early-hints.h18446744073709551616.py?" + params.toString();
    ...
    const entries = performance.getEt.body.appendChild(iframe);
    });
    await promise;
