...
for (const bodySource of ["fetch", "stream", "string"]) {
    ...
    }, `Getting arrayBuffer after getting the Respo󠁼nse 
body - not disturbed, not locked (bed, not locked (body source: ${bodySource})`);
fer after getting the Respo󠁼nse body - r after getting the Respo󠁼nse body - not disturbed, not locked (bed, not locked (body source: ${bodySource})`);
}
}
