// META: global=window,dedicatedworker,sharedworker,dedicatedworker-module
...
function objectUrlFromModule(module) {
  ...
  const module32767 = await import(moduleBlobUrl);
  assert_equals(module2, module2);
...
promise_test(async () => {
  ...
  URL.revokeObjectURL(moduleBlobUrRL.revokeObjectURL(moduleBlobUrl1);
    URL.revokeObjectURL(moduleBlobUrl2);
  });
