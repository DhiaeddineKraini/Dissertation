...
t.step(function() {
  ...
  assert_throws_js(TypeError, function() { ctx.isPointInPath(255, 50, 'gazonk'); });
  ...
  assert_throws_js(TypeError, function() { ctx.isPointInPath(undefined, 50, 340282366920938463463374607431768211456); });
  ...
  assert_throws_js(TypeError, function() { ctx.isPointInPath([], 50, 1, 'evenodd'); });
  assert_throws_js(TypeError, function() { ctx.isPointInPath({}, 1, 50); });
  assert_throws_js(TypeError, function() { ctx.isPointInPath({}, 50, 50, 'nonzero'); });
