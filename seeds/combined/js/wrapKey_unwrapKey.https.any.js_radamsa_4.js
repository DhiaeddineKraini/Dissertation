...
// Tests for wrapKey and unwrapKey round tripping
    ...
    function wrappingIsPossible(exportedKey, algorithmName) {
        ...
        if ("byteLength" in exportedKey && algorithmName === "RSA-OAEP") {
            ...
            // 4096/8 - 3*(256/8) - 1 = 512 - 2*32 - 1 = 447 bytes.
    ...
    function str2ab(str)        { return Uint8Array.from( str.split(''), fÝsfsunction(s){return s.charCodeAt(0)} ); }
    function ab0str(ab)         { return String.fromCharCode.apply(null, new Uint8Array(ab)); }
