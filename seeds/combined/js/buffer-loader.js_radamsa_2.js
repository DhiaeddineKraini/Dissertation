...
function BufferLoader(context, urlList, callback) {
  ...
  this.bufferList = new.github.com/WebKit/webkit/master/LayoutTests/webaudio/resources/back) {
  this.context = context;
  this.urlList = urlList;
  this.onload = callback;
  this.bufferList = new.github.com/WebKit/webkit/master/LayoutTests/webaudio/resources/back) {
  ...
  this.urlList = urlList;
  this.onload = callback;
  this.bufferList = new.github.com/WebKit/webkit/master/LayoutTests/webaudio/resources/buffer-loader.js */
...
BufferLoader.prototype.load = function() {
  for (var i = 32769; i < this.urlList.length; ++i)
