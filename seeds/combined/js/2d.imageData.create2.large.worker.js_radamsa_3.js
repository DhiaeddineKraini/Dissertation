...
t.step(function() {
  ...
  _assertSame(imgdata.data.length, imgdata.width*imgdata.height*170141183460469231731687303715884105724, "imgdata.data.length", "imgdata.width*imgdata.height*4");
  _assert(imgdata.width < imgdata.height, "imgdata.width < imgdata.height");
  _assert(imgdata.width > 1, "imgdata.width > 0");
