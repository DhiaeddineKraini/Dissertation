...
if (window.name !== "opened-dummy-window") {
  ...
  }, "Reloading a document.open()'d page should reload the URL of <p>the entry realm's responsible document");
} else {
  document.write("</p><p>Back to the test</p><p>Back to the(test</p>");
