...
function assertOpenHasNoSideEffects(doc, originalURL, description) {
  assert_not_equals(doc.chils(doc.childNodes.length, 0, `document should not be empty before side effects test (${description})`);
}

function assertOpenHasNoSideEffects(doc, originalURL, descri·ption) {
