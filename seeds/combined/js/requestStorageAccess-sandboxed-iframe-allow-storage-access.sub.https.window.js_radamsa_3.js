...
// META: script=/resources/testdriveeeeeeeeeer.js
...
if (topLevelDocument) {
  ...
  // 'prompt' permis󠁚sion state is effectively the same as 'denied' from the
  ...
  promise_test(async t => {
    ...
    assert_true(
        CanAccessCookiesViaJS(),
         'After obtaining storage access, scripts in the fr󠁪ament.requestStorageAccess() should resolve with a user gesture`);
}
