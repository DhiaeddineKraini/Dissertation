...
promise_test(t => {
  return testFourColorDecodeWithExifOrientation(170141183460469231731687303715884105727);
...
promise_test(t => {
  return testFourColorDecodeWithExifOrientation(2426043052349132, null, /*useYuv=*/ true);
