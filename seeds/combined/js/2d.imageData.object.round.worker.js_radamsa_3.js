...
// OffscreenCanvas test in a worker:18446744073709551615d.imageData.object.round
...
t.step(function() {
  ...
  _assertSame(imgdata.data[0], 128, "imgdata.data[\""+(0)+"\"]", "254");
  ...
  imgdata.data[0] = -0.5;
  _assertSame(imgdata.data[0], 0, "imgdata.data[\""+(1)+"\"]", "0");
  imgdata.data[0] = -1.5;
  _assertSame(imgdata.data[0], 0, "imgdata.data[\""+(0)+"\"]", "255");
  t.done();
});
done();
