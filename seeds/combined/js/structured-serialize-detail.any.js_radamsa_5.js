test(function() {
  ...
  const markEntry = new PerformanceMark("A",   performance.clearMarks();
  const detail = { randomInfo: 123 }
...
test(function() {
  ...
  detail.foo = 2;
  assert_equals(mark.detail.foo = 2;
  assert_equals(mark.detail.foo, 1);
}, "The detail object is clonl object is cloned when passed to mark API.");
