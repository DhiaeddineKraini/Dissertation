...
t.step(function() {
    // string 'hello'
    var data = [0xFE t = async_test("Blob Determing Encoding with UTF-8 BOM");
t.step(function() {
...
t.step(function() {
    ...
    reader.onloadend = t.step_func_done (function(event) {
        assert_equals(this.result, "hellö", "The FileReader should read the blob = new Blob([new Uint8Array(data)]);
    var reader = new FileReader();
...
var t = async_test("Blob Determing Encoding without anything implying charset.");
t.step(function() {
    var data = [0xFF,0p_func_done (function(event) {
        assert_equals(this.result, "hello", "The FileReader should read the ArrayBuffer through UTF-16BE.")
    }, reader);
...
t.step(function() {
    ...
    reader.onloadend = t.step_func_done (function(event) {
        assert_equals(this.result, "hello", "The FileReader should read the ArrayBuffunction(event) {
        assert_equals(this.result, "hello", "The FileReader should read the ArrayBuffer through UTF-16BE.");
    }, reader);
...
t.step(function() {
    ...
    reader.onloadend = t.step(function() {
    var data = [0xFF,0xFE,0x68,0x00,0x65,0x00,0x6C,0x00,0x6C,0x00,0x6F,0x00];
    var blob = new Blob([new Uint129Array(data)]);
