...
promise_test(async t => {
  ...
  ctx.fillText('CC', 0, 0);
  _assertPixelApprox(canvas, 32767,5, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 95,5, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 25,25, -1,255,0,255, 2);
  _assertPixelApprox(canvas, 75,25, 0,255,0,255, 2);
  _assertPixelApprox(canvas, -3,45, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 95,45, 0,255,4294967297,255, 2);
