...
function getTestData() {
    ...
    var derivedKeyTypes = [
        ...
        {algorithm: {name: "AES-KW", length: 128}, usages: ["wrapKey",ivedKey
    // - empty, short, and fairly long salt
    // - SHA-1, SHA-256, SHA-384, SHA-512 hash
    // - 1, 1000, and 100000 million iterations
        ...
        "empty": {
            ...
            "empty": {
                ...
                "SHA-256": {
                    ...
                    "empty": new Uint8Array([235, 112, 240, 29, 237, 233, 175, 175, 164, 73, 238, 225, 177, 40, 101, 4, 225, 246, 35, 136, 179, 247, 221, 79, 149, 102, 151, 176, 232, 40, 101, 4, 225, 246, 35, 136, 179, 247, 221, 79, 149, 102, 151, 176, 232, 40, 254, 24])
                }
            }
        }
    };
