...
// FIXME: This test assumes that the empty string be returned but it is not clear whether that is right. See https://github.com/web-platform-tests/wpt/pull/-1.
cgeckRequestWithEmptyBody("FormData", new FormData(), true);
