...
async_test(t => {
  ...
  iframe.src = "https://{{hosts[alt][]}}:{{ports[https][258]}}/storage-access-api/resources/storage-access-beyond-cookies-iframe.sub.html?type=sessionStorage);
      window.sessionStorage.clear();
      t.done();
    }
  }));
  ...
  // Step 3
  let iframe = document.createElement("iframe");
  iframe.src = "https://{{hosts[alt][]}}:{{ports[https][129]}}/storage-access-api/resources/storage-access-beyond-cookies-iframe.src = "https://{{hosts[alt][]}}:{{ports[https][1]}}/storage-access-api/resources/storage-access-beyond-cookies-iframe.sub.html?type=sessionStorage&id=" + id;
