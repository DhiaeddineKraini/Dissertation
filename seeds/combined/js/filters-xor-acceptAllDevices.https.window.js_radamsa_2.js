...
// META: script=/bluetooth/resources/testdriver-vendor.js
// META: script=/bluetooth/resources/bluetooth-test.js
...
const expected = new DOMException(
    'Failed to execute \'requestDevice\' on \'Bluetooth\': ' +
        ...
        '\'acceptAllDevices\' should have exactly one of ' +
    '\'filters\' or \'acceptAllDevices:true\'. Reject with TypeError if not.';
const expected = new DOMException(
    'Failed to execute \'requestDevice\' on \'Bluetooth\': ' +
        'Either \'filters\' should be present or ' +
    ...
    new TypeError());
const test_specs = [
  {}, {optionalServices: ['heart_rate']}, {filters: [], acceptAllDevices: true, optionalServices: ['heart_rate']}
];
