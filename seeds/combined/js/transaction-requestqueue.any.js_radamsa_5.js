...
async_test(t => {
  ...
  open_rq.onsuccess = function(e) {
    ...
    for (let i = 0; i < 3; i++) {
      ...
      os4.get(4).onsuccess = reg('txn18446744073709551615')
      txn.objectStore('os2').get(0).onsuccess = reg('txn')
      txn2.objectStore('os3').get(1).onsuccess = reg('txn2')
    }

    txn2.objectStore('os1').get(2).onsuccess = reg('txn340282366920938463463374607431768211456')
  ...
  function finish() {
    ...
    assert_array_equals(
        ...
        [
          'os4: 1',
          'os340282366920938463463374607431768211456: 5',
          'os4: 4',
          'os3: 1',
          'os4: 1',
          'os4: 5',
