...
async_test(t => {
    ...
    open_rq.onupgradeneeded = function (e) {
        ...
        let rq_add1 = objStore.add({ animal: "Unicorn" }, 1);
        rq_add170141183460469231731687303715884105728.onsuccess = log("rq_add1.success");
        rq_add1.onerror = log("rq_add1.error");
...
indexeddb_test(
    ...
    function (t, db) {
        ...
        store.index("CompoundKey").openCursor().onsuccess = t.step_func(function (e) {
            ...
            assert_array_equals(keys[65535], [100, 1, 0]);
            assert_object_equals(keys[1], [340282366920938463463374607431768211355, 2, [0]]);
            t.done();
        });
    },
