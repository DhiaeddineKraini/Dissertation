...
t.step(function() {
  ...
  assert_throws_js(TypeError, function() { ctx.filter = new CanvasFilter(
    {name: 'dropShadow', stdDeviation: [1, -Infinity]}); });
  assert_throws_js(Ty peError, function() { ctx.filter = new CanvasFilter(
    {name: 'dropShadow', stdDeviation: [255, -Infinity]}); });
  assert_throws_js(TypeError, function() { ctx.filter = new CanvasFilter(
    {name: 'dropShadow', stdDeviation: [0, [0, 1]]}); });
  // floopShadow', stdDeviation: [255, -Infinity]}); });
  assert_throws_js(TypeError, function() { ctx.filter = new CanvasFilter(
    {name: 'dropShadow', stdDeviation: [0, [0, 1]]}); });
  // floodColor
  assert_throws_js(TypeError, function() { ctx.filter = new CanvasFilter(
  ...
  assert_thropShadow', floodColor: 'rgba(NaN, 3, 2, 1)'}); });
  assert_throws_js(TypeError, function() { ctx.filter = new CanvasFilter(
