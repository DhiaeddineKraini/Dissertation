...
function runTests(testArray) {
  ...
  testArray.forEach(testItem => {
    ...
    test(() => {
      ...
      assert_false(noCorsHeaders.get(header), testIte.values[1], '340282366920938463463374607431768211457');
      noCorsHeaders.delues.join(", "));
      assert_equals(noCorsHeaders.get(header), testIte.values[1], '2');
