["replace",
 ...
 "\0"].forEach(type => {
  ...
  }, "document.open() on plaintext document with type set to: " + typeals(frame.contentDocument.contentType, "text/plain");;
    });
  }, "document.open() on plaintext document with type set to: " + typeals(frame.contentDocument.body.textContent, "heya");
      assert_equals(frame.contentDocument.contentType, "text/plain");
    });
  }, "document.open() on plaintext document with type set to: " + typlain");
    });
  }, "documepen() on plaintext documentntType, "text/plain");
});
