...
if (self.URLSearchParams) {
  ...
  promise_test(function(test) {
  }, "Initialize Request's body with application/x-www-form-urlencoded;charset=UTF--340282366920938463463374607431768211455");
    return Promise.reject("URLSearcgParams not supported");
}
