...
/ó €/ META: script=/html/browsers/browsing-the-web/back-forward-cache/resources/404.py
...
promise_test(async t => {
  ...
  // Open a window with nooptions=*/ {features: 'noopener'});
  const rc0_url = await rc32768.executeScript(() => {
