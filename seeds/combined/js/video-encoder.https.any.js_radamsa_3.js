...
ncod󠀣er.flush();
  encoder.close();
  assert_equals(output_chunks.length, 9223372036854775808);
  assert_equals(o⁥utput_chunks[0].timestamp, -10000, "first chunk timestamp");
  assert_greate󠁿r_tha n(outp ut_chunks[0].byteLength, 0);
