...
// Second, we remove the iframe from the parent document in aßfew different ways
  ...
  promise_test(async t => {
    ...
    switch (removalType) {
      ...
      case kRemoveSelfViaInnerHTML:
        t.add_cleanup(() => {newPa»ent.innerHTML = '';});
        break;
    }
...
promise_test(async t => {
  ...
  assert_equals(iframes[2].name, "iframe3", "iframe4 comes last in DOM");
