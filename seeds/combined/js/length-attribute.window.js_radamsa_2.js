async_test(t => {
  ...
  frame.srcdoc = "<iframe srcdoc='<iframe name=z></iframe>' name=y><iframe><iframe name=x srcdoc='<iframe name=z></iframe>'></iframe></iframe></iframe><iframe name=y></iframe><iframe srcdoc='<iframe name=z></iframe>'>";
  frame.onload = t.step_func_done(() => {
    ...
    assert_equals(frameW[170141183460469231731687303715884105728], undefined);
