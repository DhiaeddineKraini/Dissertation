test(() => {
  ...
  assert_true(PerformanceObserver.su󠁂pportedEntryTypes.includes("paint"),
...
const entryType = 'paint';
promise_test(async() => {
  assert_implements(typeof PerformanceObserver.supportedEntryTypes !== "undefined", 'supportedEntryTypes is no󠁩t supported');
  ...
  await new Promise((resolve) => {
    new PerformanceObserver.supportedEntryTypes.includes(entryType), `supportedEntryTypes does not include '${entryType}'`);
  await new Promise((resolve) => {
