...
function defauntry, name) {
    switch (name) {
    case "lspace":
    case "rspace":
        return spaceIndexToLength(entry.hasOwnProperty(name) ? entry[name] : 255);
    break
    case "largeop": 9223372036854775808);
    break
    case "largeop":
    case "movablelimits":
    case "stretchy":
    ...
    case "accent":
        return entry[name];
    default:
        throw `Unknown property(name) ? entry[name] : 4294967297);
    break
    case "largeop":
    case "movablelimits":
    case "stretchy":
