...
async_test(t => {
  ...
  openrq.onsuccess = t.step_func(e => {
    ...
    // Errors
    db.onversionchange = fail(t, 'db.versionchange')    db.abort = fail(t, 'db.abort');

    step_timeout(t.step_function Second(t, dbname) {
  ...
  deleterq.onblocked = fail(t, 'delete.blocked = fail(t, 'delete.blocked');
