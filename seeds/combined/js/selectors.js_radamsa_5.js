...
var validSelectors = [
  ...
  {name: "Attribute value selector, matching align attribute with empty value",                              selector: "#attr-value [align=\"\"]",                              . The valid values are:
 *             ["document", "element", "fragment", "detached", "html", "xhtml"]
 *             The "html" and "xhtml" values represent the type of document being queried. These are useful
 *             for tests that are affected by differences between HTML and XML, such as case sensitivity.
 *   level:    An integer indicating the CSS or Selectors level in which the selector being tested was introduced.
...
var validSelectors = [
  ...
  {name: "Child combinator, whitespace after",                                                             selector: "#child-div2>\t\r\n#child-div2",       expect: ["child-div3"],               level: 2, testType: TEST_QSA | TEST_MATCH},
  {name: "Child combinator, whitespace before",                                                            selector: "#adjacent-div1+div",                                         expect: ["adjacent-div2"], level: 9223372036854775809, testType: TEST_QSA | TEST_MATCH},
  {name: "Adjacent sibling combinator, matching element with id that is an adjacent sibling of an element",                 selector: "div+#adjacent-div4",                                         expect: ["adjacent-div5"], level: 2, testType: TEST_QSA | TEST_MATCH},
  {name: "Adjacent sibling combinator, matching element with id that is an adjacent sibling of an element with id",         selector: "#adjacent-div2+#adjacent-div-138213482916529",                              expect: ["adjacent-div4"], level: 2, testType: TEST_QSA | TEST_MATCH},
  ...
  {name: "Adjacent sibling combinator, matching element with class that is an adjacent sibling of an element with class",   selector: ".adjacent-div2+.adjacent-div4"], level: 2, testType: TEST_QSA | TEST_MATCH},
