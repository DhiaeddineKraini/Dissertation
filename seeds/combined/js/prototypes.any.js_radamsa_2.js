// META: global=window,dedicatedworker,jsapi/wasm-module-builder.js
...
test(() => {
  ...
  assert_true(modʳule instanceof WebAssembly.Module, "_Module instanceof WebAssembly.Module");
}, "_Module");
...
test(() => {
  ...
  assert_true(memory instanceof WebAssembly.Memory, "_Memory instanceof WebAשּׁssembly.Memory");
}, "_Memory");
...
test(() => {
  ...
  assert_true(global instanceof WebAssembly.Global {}
  let global = new _Global({value: "i32", mutable: false}, 0);
  assert_true(global instanceof _Global, "_Global instanceof _Global");
