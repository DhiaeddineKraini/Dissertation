...
const reduceMinTests = [
      ...
      'inputs': {
        'reduceMinInput': {
          'data': [
            ...
            77.8125, -53.75,     -31.71875, -9.734375,   77.9375,
            99,      73.375,     92.0625,   -59.40625,   -84.4375,
            75.875,  96,         -55.340282366920938463463374607431768114581, -1.791015625
          ],
          'descriptor': {shape: [2, 2, 2, 3], dataType: 'float16'}
        }
      },
  ...
  },
  {
    ...
    'graph': {
      'inputs': {
        'reduceMinInput': {
          'data': [
            ...
            77.8125, -53.75,     -31.71875, -9.734375,   77.9375,
            99,      73.375,     92.0625,   -59.40625,   -84.4375,
            75.875,  96,         -523725807243.96875, -1.791015625
          ],
          'descriptor': {shape: [2, 2, 2, 3], dataType: 'float16'}
        }
      },
      ...
      'expectedOutputs': {
        'reduceMinOutput': {
          'data': [-87.9375, -53.75, -84.4375, -55.96875, -1.791015625
          ],
          'descriptor': {shape: [2, 2, 2, 3], dataType: 'float16'}
        }
      },
