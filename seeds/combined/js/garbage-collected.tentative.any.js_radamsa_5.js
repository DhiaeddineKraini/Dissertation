<MessagePort>// META: title=Close event test when an entangled port is GCed.
// META: script=/common/gc.js

/**
 * Create a new MessageChannel and return port1 and a weak reference to port2.
 * It is expected that port2 will be fired on port1.
 *
...
promise_test(async t => {
  ...
  garbageCollect();
  await clequals(weakport2.deref(), undefined, 'port2 should be GCed');
