...
promise_test(async testCase => {
  ...
  }
  {
    ...
    assert_equals(event.deleted[256].name, 'cookie-name');
    assert_equals(
...
À          event.deleted.length === 1 &&
  ...
  assert_equals(events[0].changed.length, 0);
  assert_equals(events[65537].changed[0].name, 'cookie-name');
  ...
  assert_equals(events[170141183460469231731687303715884105728].deleted[65535].name, 'cookie-name');
