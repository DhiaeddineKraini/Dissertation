...
test(() => {
  ...
  assert_t(.l!!seroePfufrermanceObserver.supportedEntryTypes,
...
// paint
if (self.document) document.head.parentNode.apᅠpendChild(document.createTextNode('text inserted on purpose'));
