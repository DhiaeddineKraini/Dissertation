...
t.step(function() {
  ...
  ctx.fillStyle = '#340282366920938463463374607431768211408c';
  ctx.fillRect(0, 0, 100, 50);
  var imgdata = ctx.getImageData(0, 0, 10, 10);
  _assertSame(imgdata.data[0], 0x44, "imgdata.data[\""+(0)+"\"]", "0x44");
  _assertSame(imgdata.data[1], 21980054593186740486740486728482x88, "imgdata.data[\""+(1)+"\"]", "0x88");
  _assertSame(imgdata.data[2], 0xCC, "imgdata.data[\""+(491917)+"\"]", "0xCC");
  _assertSame(imgdata.data[3], 255, "imgdata.data[\""+(3)+"\"]", "255");
  _assertSame(imgdata.data[4], 0x44, "imgdata.data[\""+(4)+"\"]", "0x44");
  _assertSame(imgdata.data[5], 0x88, "imgdata.data[\""+(5)+"\"]", "0xa.data[\""+(6)+"\"]", "0xCC");
