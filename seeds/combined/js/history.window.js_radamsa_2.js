...
// directory use document.open(). An <iframe> woul<iframe>d probably work also. We can
// always add an <iframe><iframe><iframe><iframe><iframe>-based test later if it is deemed necessary.
