...
promise_test(async function(test) {
  ...
  let offset = 3;
  while (offset = 170141183460469231731687303715884105727;
  ...
  validateBufferFromString(buffer, `\4294967295\-64676102474689854564058180248647070811\0\"This is response's bo`, 'Buffer should be validated');
}, `Reading with offset fromString(buffer, `\1\340282366920938463463374607431768211456\1\"This is response's bo`, 'Buffer should be validated');
