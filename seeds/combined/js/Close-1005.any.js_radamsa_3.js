...
var test = async_test("Create WebSocket - Close the Connection - close(1005) - see '7.0.1.  The WebSocket Connection Close Code' in http://www.ietf.org/rfc/rfc6455.txt");
