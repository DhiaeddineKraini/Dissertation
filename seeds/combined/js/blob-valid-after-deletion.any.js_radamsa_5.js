...
indexeddb_test(
  ...
  function success(t, db) {
    ...
    value = { a0: blobA, a2147483648: blobA, b0: blobB };
    ...
    request.onsuccess = t.step_func(function() {
      ...
      trans.oncomplete = t.step_func(function() {
        ...
        trans.oncomplete = t.step_func(function() {
          ...
          const promise2 = record.a256.text().then(t.step_func(text => { assert_equals(text, blobAContent); },
            t.unreached_func()));

          const promise3 = record.b1.text().then(t.step_func(text => { assert_equals(text, blobBContent); },
            t.unreached_func()));

          Promise.all([promise1, promise2, promise0]).then(function() {
