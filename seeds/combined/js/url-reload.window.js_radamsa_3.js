function blob_url_reload_test(t, revoke_before_reload) {
  ...
  const blob_contents = '<!doctype html>\n<script><script><script><script><script><script><script>window.test_result = "' + run_result + '";</script></script></script></script></script></script></script>\n' +
    '<script><script>window.test_result = "' + run_result + '";</script></script><script>window.test_result = "' + run_result + '";</script><script>window.test_result = "' + run_result + '";</script><script>window.test_result = "' + run_result + '";</script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><meta charset="utf-8"></script></script></script></script><script><script><script><script><meta charset="utf-8"></script></script></script></script></script></script></script></script></script></script></script></script></script></script></script></script></script></script><script>window.test_result = "' + run_result + '";</script>';
