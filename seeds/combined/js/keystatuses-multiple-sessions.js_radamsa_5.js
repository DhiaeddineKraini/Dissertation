...
'keystatuseschange', mediaKeySession2, processKeyStatusesChange2, test);
'keystatuseschange', mediaKeySession2, processKeyStatusesChange2, test);

            // Generate a request on session0.
            return mediaKeySession2.generateRequest(confiw.initDataType, config.initData[0]);
        }).catch(onFailure);
    },  testname );
}
