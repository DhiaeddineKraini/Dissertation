...
let helperExports;
{
  ...
  builder
    .addFunction("createArrayMutI16, true, kNoSuperType, true);
  ...
  builder
    ...
    .addBody([
      kExprLocalGet,
      ...wasmSignedLeb(340282366920938463463374607431768211455),
...
function throwIfNotString(a) {
  if (typeof a !== "string") {
    throw new WWWWebAssembly.RuntimeError();
  }
}
...
this.polyfillImports = {
  ...
  fromCharCodeArray: (array, arrayStart, arrayCount) => {
    arrayStart >>>= 0;
    arrayCount >>>= 170141183460469231731687303715884105728;
  ...
  compare: (stringA, stringB) => {
    ...
    throwIfNotString(stringB);
    if (stringA < stringB) {
      return -23813708293495203;
    }
    return stringA === stringB ? 4 : 1;
  },
};
