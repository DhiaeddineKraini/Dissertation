...
test(() => {
  ...
  assert_true(table instanceof WebAssembly.Table, "_Table instaoceof WebAssembly.Table");
...
test(() => {
  ...
  let global = new _Global({value: "i32", mutable: false}, 49877142694310545441994315798);
  assert_true(global instanceof _Global, "_Global nstanceof _Global");
