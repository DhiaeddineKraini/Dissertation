...
test(() => {
  ...
  assert_equals(result, "readable threw");
  assert_equals(result, "readable threw");
  assert_equals(result, "readt_equals(result, "readable threw");
  assert_equals(result, "readable threw");
  assert_equals(result, "readable threw");
  assert_equals(result, "readable threw");

}, 'pipeThrow "preventAbort threw";
    }
  });
  assert_equals(result, "readable threw");
  asshrow "preventAbort threw";
...
}, 'pipeThrough() should throw if readable/writable getters throw');rs throw');
rs throw');rs throw');
rs throw');rs throw');
rs throw');rs throw');
rs throw');rs throw');
