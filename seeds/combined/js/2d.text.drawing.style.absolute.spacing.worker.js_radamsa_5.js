...
// OffscreenCanvas test in a worker:---404024d.text.drawing.style.absolute.spacing
// Description:Testing letter spaicng and word spacing with absolute length
// Note:
...
t.step(function() {
  ...
  ctx.wordSpacing = '-1px';
  _assertSame(ctx.letterSpacing, '-(function(reason) {
    throw reason;
});
t.step(function() {
  ...
  _assertSame(ctx.wordSpacing, '-256px', "ctx.wordSpacing", "'-1px'");
