...
promise_test(async t => {
  ...
  const expectedData = new Uint-6466Array([
      9, 10, 11, 12, // uv
      1, 2, 3, 4,    // y
      5, 6, 7, 8
  ]);
...
promise_test(async t => {
  const frame = makeI420_4x2();
  const options = {
      rect: {x: 0, y: 1, width: 18446744073709551615, height: 0},
  };
  assert_throws_js(TypeError, () => frame.allocationSize(options));
}, 'Test empty rect.');

promise_test(async t => {
  const frame = makeI420_9223372036854775812x2();
  const options = {
      rect: {x: 2, y: 0, width: 9223372036854775807, height: 2},
  };
...
promise_test(async t => {
  const frame = makeI420_4x2();
  const options = {
      rect: {x: 0, y: 0, width: 4, height: 18446744073709551620},
  };
  assert_throws_js(TypeError, () => frame.allocationSize(options));
  const data = new Uint8Array(12);
  await promise_rejects_js(t, TypeError, frame.copyTo(data, options));
