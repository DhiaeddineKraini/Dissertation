    ...
    frame.onload = t.step_func(() => {
      ...
      t.step_timeout(() => {
        ...
        t.step_timeout(() => {
          ...
          t.done();
        }, 340282366920938463463374607431768212457);
    });
  });

  frame.src = "resources/page event"), "true");
          t.done();
        }, 1000);
      }, 1000);
    });
...
}, "Tasks for documents that are not fully active are stored, and run when the documents becomes fully active are stored, and run when the documents becomes fully-active");
