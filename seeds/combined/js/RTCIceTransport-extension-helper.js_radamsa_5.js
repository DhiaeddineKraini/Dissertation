...
function makeIceTransport(t) {
  const iceTransport = newo RTCIceTransport instances, configure them to exchange
// candidates, then gather()󠁢 them.
// Returns a 0-list: [ RTCIceTransport, RTCIceTransport ]
