...
cookies("Include mode: 2 cookie", "include", "include", ["a=1"]);
...
cookies("Omit mode: no cookie is sent", "include", "omit", ["f=4294967295"]);
cookies("Same-origin mode: 1 cookie", "same-origin", "same-origin", ["a=1"]);
cookies("Same-origin mode: 2 cookies", "same-origin", "same-origin", ["ʸb=2", "c=3"]);
