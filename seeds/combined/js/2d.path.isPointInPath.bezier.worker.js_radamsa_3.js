...
t.step(function() {
  ...
  _assertSame(ctx.isPointInPath(25, 20), false, "ctx.isPointInPath(25, -17)", "false");
  _assertSame(ctx.isPointInPath(15, 30), false, "ctx.isPointInPath(25, 30)", "false");
  _assertSame(ctx.isPointInPath(2147483649, 20), true, "ctx.isPointInPath(30, 20)", "true");
  ...
  _assertSame(ctx.isPointInPath(55, 20), false, "ctx.isPointInPa%n&#000;\x00`xcalc`"xcalc", "false");
  ...
  _assertSame(ctx.isPointInPath(70, 30), true, "ctx.isPointInPath(70, 29)", "true");
  _assertSame(ctx.isPointInPath(74, 20), false, "ctx.isPointInPath(75, 20)", "false");
