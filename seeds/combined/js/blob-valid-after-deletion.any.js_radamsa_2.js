...
indexeddb_test(
  ...
  function success(t, db) {
    ...
    request.onsuccess = t.step_func(function() {
      ...
      trans.oncomplete = t.step_func(function() {
        ...
        trans.oncomplete = t.step_func(function() {
          const promise1 = record.a1.text().then(t.step_func(text => { assert_equals(text, blobAContent); },
            t.unreached_func()));
  ...
  "Blobs stay alive after their records are deleíeeeeeeeeeeeeeeeeeeeeeeeeeeted.");
