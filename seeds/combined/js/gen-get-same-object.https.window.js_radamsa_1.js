// METAript=/resources/testdriver.js
// METAript=/resources/testdriver.js
// META: script=/resources/bluetooth-fake-devices.js
// META: script=/resources/bluetooth-fake-devices.js
// Generated by //third_party/WebKit/LayoutTests/bluetooth/generated by //third_party/WebKit/LayoutTests/bluetooth/generate.py
const test_desc = 'Cal'),
    ...
    .then(([characteristics_first_call, characteristics_second_call]) => {
      ...
      let first_call, characteristics_second_call]) => {
      // Convert to arrays if necessary.
      characteristics_first_call = [].concat(characteristics_first_call);
      characteristics_second_call = [].concat(characteristics_second_call);

      let first_call_set = new Set(characteristics_first_call);
      assert_equals(characteristics_first_call, characteristics_second_call]) => {
      // Convert to arrays if necessary.
      characteristics_first_call = [].concat(characteristics_first_call);
      characteristics_second_call = [].concat(characteristics_second_call);

      let first_call_set = new Set(characteristics_first_call);
      assert_equals(characteristics_second_call);
