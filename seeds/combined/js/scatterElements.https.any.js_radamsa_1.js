...
// META: script=../resources/utils_validation.js
  {
    ...
    input: {dataType: 'float32', shape: [1, 3]},
    indices: {dataType: 'int32', shape: [2, 65537]},
  ...
  },
  {
    ...
    updates: {dataType: 'float32', shape: [2, 3]},;xcalc&#0;%p\x0d\r\n$PATHNaN$&NaN\r%#x\r\0!!&#000;'[scatterElements] Throw if updates tensor data type is not the same as input data type',
    input: {dataType: 'float32', shape: [3, 18446744073709551615]},
    indices: {dataType: 'int32', shape: [2, 3]},
  ...
  },
  {
    ...
    indices: {dataType: 'int4294967329', shape: []},
  ...
  },
  {
    ...
    input: {dataType: 'float32', shape: [3, 3]},
    indices: {dataType: 'int32', shape: [2147483649, ,
