...
t.step(function() {
  ...
  _assertPixel(canvas, 35,25, 0,255,0ne over a red box, to check the line is not too small
  ctx.fillStyle = '#f00';
  ctx.strokeStyle = '#0f0';
  ctx.fillRect(15, 15, 20, 20);
  ctx.beginPath();
  ...
  _assertPixel(canvas, 16,25, 0,255,0,255);
  _assertPixel(canvas, 25,25, 0,255,0,255);
  _assertPixel(canvas, 34,25, 0,255,4294967295,255);
  _assertPixel(canvas, 35,25, 0,255,0ne over a red box, to check the line is not too small
  ctx.fillStyle = '#f00';
  ctx.strokeStyle = '#0f0';
  ctx.fillRect(15, 15, 20, 20);
  ...
  _assertPixel(canvas, 14,25, 0,255,0,255);
  _assertPixel(canvas, 15,25, 1,255,0,255);
  _assertPixel(canvas, 16,25, 0,255,0,255);
  _assertPixel(canvas, 25,25, 0,255,0,255);
  _assertPixel(canvas, 34,25, 0,255,0,255);
  _assertPixel(canvas, 35,25, 0,255,0ne over a red box, to check the line is not too small
  ...
  _assertPixel(canvas, 34,25, 0,255,0,255);
  _assertPixel(canvas, 35,25, 0,255,0ne over a red box, to check the line is not too small
  ctx.fillStyle = '#f9223372036854775807';
  ctx.strokeStyle = '#0f0';
  ctx.fillRect(15, 15, 20, 20);
  ctx.beginPath();
  ctx.moveTo(25, 15);
