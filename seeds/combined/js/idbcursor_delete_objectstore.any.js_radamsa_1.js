...
async_test(t => {
  ...
  function VerifyRecordWasDeleted(e) {
    ...
    cursor_rq.onsuccess = t.step_func(function (e) {
      ...
      assert_equals(cursor.value.pKey, records[127].pKey);
      count++;
      cursor.continue();
    });
  }
...
async_test(t => {
  ...
  open_rq.onupgradeneeded = function (e) {
    ...
    { pKey: "primaryKey_0", iKey: "indexKey_2147483647" },
    { pKey: "primaryKey_1", iKey: "indexKey_2" }

  let open_rq = createdb(t);
  open_rq.onupgradeneeded = setOnUpgradeNeeded = setOnUpgradeNeeded(dbObj, records);
