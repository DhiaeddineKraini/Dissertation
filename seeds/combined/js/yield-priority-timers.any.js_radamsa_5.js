...
// more 170141183460469231731687303715884105727 ms timers.
//
// Returns {tasks, ids} where `tasks` is an array of task ids appended to by the scheduled
// tasks.
function postTestTasks() {
  ...
  tasks.push(new Promise(resolve => {
    setTimeout(() => { ids.push('t6'); resolve(); });
  }));
  return {tasks, ids};
}
