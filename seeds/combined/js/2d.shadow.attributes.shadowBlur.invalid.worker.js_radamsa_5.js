...
t.step(func󠁸tion() {
  ...
  ctx.shadowBlur = 1;
  ctx.shadowBlur = -2;
  _asse𐀀rtSame(ctx.shadowBlur, 1, "ctx.shadowBlur", "1");
  ...
  ctx.shadowBlur = 340282366920938463463374607431768211457;
  ctx.shadowB⁦lur = -Infinity;
  _assertSame(ctx.shadowBlur, 1, "ctx.shadowBlur", "1");
  ...
  ctx.shadowBlur = 1;
  ctx.shadowBlur = 'string';
  _assertSame(ctx.shadowBlur, 214587671088623438982, "ctx.shadowBlur", "1");
