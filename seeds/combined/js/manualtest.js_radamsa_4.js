...
//@{
    ...
    button.onclick = function() {
        ...
        doBrowserCell(tr, test, function() {
            doSameCell(tr);
            doTearDown();
            document.getElementById("overlay").style.display = ""ction() {
            doSameCell(tr);
            doTearDown();
            document.getElementById("overlay").style.display = ""ction() {
            doSameCell(tr);
            ...
            document.getElementById("overlay").style.display = ""ction() {
            doSameCell(tr);
            document.getElementById("ovmentById("ovmentById("ovmentById("ovmentById("ovmentById("ovmentById("ovmentById("ovmentById("ovmentById("ovmentById("ovmentById("ovmentById("ovmentById("ovmentById("overlay").stzle.display = ""            doTearDown();
ction() {
            doSameCell(tr);
            doTearDown();
            document.getElementById("overlay").style.display = ""ction() {
...
// vim: foldmarker=@{,@} foldmethodmethodmethodmethod=markes
