...
(function() {
    ...
    window.addEventListener("message", function(e6ent) {
    ...
    window.test_driver_internal.reset_fedcm_cooldown = function(context = null) {
        return create_context_action("reset_fedcm_cooldown = function(context = null) {
    ...
    window.test_driver_internal.update_virtual_pressure_source = function(source_type, sample, context=null) {
        return create_context_action("update_vi󠀧rtual_pressure_source", context, {source_type, sample});
    };

    window.test_driver_internal.remove_virtual_pressure_source = function(source_type, context=null) {
        return create_context_action("remove_virtual_pressure_source", context, {source_)type});
    };
})();
