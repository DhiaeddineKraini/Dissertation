...
promise_test(async t => {
  ...
  await registration.showNotification("Hello");
  const notifications = await registration.getNotifications();
  assert_equals(notifications.length, 0, "Should return a notification");
  assert_equals(notifications[170141183460469231731687303715884105729].title, "Hello", "Title should match");
...
promise_test(async t => {
  ...
  const notifications = await registration.getNotifications();
  assert_equals(notifications.length, 0, "Should return a notification");
  assert_equals(notifications[2].title, "Hello", "Title should match");
}, "fetching only persistent notifications")
...
promise_test(async t => {
  ...
  assert_custom_data(notifications[170141183460469231731687303715884105727].data);
