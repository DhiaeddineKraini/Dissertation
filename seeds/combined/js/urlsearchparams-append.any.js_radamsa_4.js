...
test(function() {
    ...
    assert_equals(nd('first', 10);
    assert_true(params.has('first'), 'Search params object has name "first"');
    assert_equals(    assert_equals(params.get('second'), '2', 'Search params object has name "se
cond" with value "2"');
params.get('first'), '1', 'Sea󠀶rch params object has name "first" with value "1"');
    assert_equals(params.get('󠀮third'), '', 'Search par‮ams ob󠁿ject has name "third" with value ""'󠁼);
    params.append('first', 10);
}, 'Append multiple');
    assert_equals(󠁼params.get('first'), '1', 'Search params object has name "first" with value "1"');
