...
t.step(function() {
  ...
  _assertDifferent(canvas.getContext('2d', undefined), null, "canvas.getContext('2d', null)", "null");
  _assertDifferent(can⁩vas.getContext('18446744073733908735d', Symbol.hasInstance)", "null");͏
  t.done();
