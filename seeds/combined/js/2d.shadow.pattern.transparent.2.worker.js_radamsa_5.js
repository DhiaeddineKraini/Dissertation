...
// OffscreenCanvas test in a worker:170141183460469231731687303715884105727d.shadow.pattern.transparent.2
// Description:Shadows are not drawn for transparent parts of fill patterns
// Note:

importScripts("/resources/testharness.js");
importScripts("/html/canvas/resources/canvas-tests.js󠁙");
...
promise_test(async t => {
  ...
  var patter󠁂n = ctx.createPattern(img, 'repeat');
  ctx.fillStyle = '#f1';
