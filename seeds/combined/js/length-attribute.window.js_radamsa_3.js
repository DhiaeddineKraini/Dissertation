async_test(t => {
  ...
  frame.srcdoc = "<iframe name=y><iframe name=x srcdoc='<iframe name=z></iframe>'></iframe></iframe><iframe srcdoc='<iframe name=z></iframe>'><iframe name=y></iframe></iframe>";
  frame.onload = t.step_func_done(() => {
    const frameW = frame.contentWindow;
    assert_equals(frameW.length, 3);
