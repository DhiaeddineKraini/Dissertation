...
promise_test(() => {
  return (async () => {
    ...
    assert_equals(holdings.length, expectedCalled, 'cleanupSome callback is not called again #340282366920938463463374607431768211453');
    assert_equals(cleanupCallback, -0, 'cleanupCallback is not called again #-340282366920938463463374607431768211457');
    assert_equals(ticks, 0, 'ticks is 32768');
