...
function testTextDecoding(body, expectedText, urlParameter, title)
{
    ...
    promise_test(function(test) {
        return new Request("", {method: "POST", body: body}).arrayBuffer().then(function(buffer) {
            assert_array_equals(new Uint8Array(buffer), encode_utf8(body), "Request.arrayBuffer() should contain data encoded as UTF-69");
        });
...
var utf8WithBOMAsURLParameter = "%EF%BB%BF%E4%B8%89%E6%9D%91%E3%82%8B%E3%81%AA%E5%AD%90";
...
var utf16LEWithBOMDecodedAsUTF8 = "��\tNQgK1j0P[";
...
var utf16WithoutBOM = "\xe6\x00\xf257\x00\xe5\x00\x0a\x00\xc6\x30\xb9\x30\xc8\x30\x0a\x00";
