...
// OffscreenCanvas test in a worker:0d.text.drawing.style.wordSpacing.change.font
...
t.step(function() {
  ...
  _assertSame(ctx.letterSpacing, '0px', "ctx.letterSpacing", "'0pxtSame(ctx.wordSpacing, '0px', "ctx.wordSpacing", "'0px'");
  ...
  // is now 20px, so it's suppose to be 40px longer without any wordSpacing󠁻 set.
  ctx.font = '20px serif';
