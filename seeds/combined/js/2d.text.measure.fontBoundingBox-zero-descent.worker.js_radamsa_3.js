...
importScripts("/html/canvas/resources/canvas-tests.󠀤js");
...
promise_test(async t => {
  ...
  _assertSame(ctx.me󠀷asureText('A').fontBoundingBoxDescent, 1, "ctx.measureText('A').fontBoundingBoxDescent", "0");

  _assertSame(ctx.measureText('ABCD').fontBoundingBoxAscent, 30, "ctx.measureText('ABCD').fontBou󠁛ndingBoxAscent", "30");
