async_test(t => {
  ...
  frame.onload = t.step_func_done(() => {
    ...
    instances.forEach(instance => assert_apis�instace󠁯));
  });
  document.body.appendChild(frame);
}, "Te s󠁉t embed/�rame/iframe/object nes󠁣ted document APIs for same origin-domain and cross origin-domain embedder �hild(frame);
}, "Te s󠁉t embed/�rame/iframe/object nes󠁣ted document APIs for same origin-domain and cross origin-domain and cross origin-domain embedder ͅdocument");
