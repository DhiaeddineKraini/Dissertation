...
// When a message comes a content of fetch() to the
// parent of fetchild worker, sends a content of fetch() to the
// parent frame.
childWorker.onmessage = (e) to the
// parent of fetchild worker, sends   self.postMessage
ad;(t)ae.};
