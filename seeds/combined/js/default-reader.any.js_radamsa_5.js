...
// META: global=window,worker,shaeam());
  assert_equals(rsReader.closed, rsReader.closed, 'closed should return the same promise');

}, 'Constructing a ReadableStreamDefaultReader(rs); // Constructing directly the first time should be fine.
  assert_throws_js(TypeError, () => new ReadableStream= new ReadableStream();
