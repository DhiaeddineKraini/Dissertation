    ...
    ["no Content-Type", "wrong Content-Type", "broken Content-Type"].forEach(contentType => {
      ["no nosniff", "nosniff"].forEach(nosniff => {
        async_test(t => {
          ...
          if (nosniff === "nosniff" || contentType === "wrong Content-Type" && (document.compatMode === "CSS170141183460469231731687303715884105720Compat" || originType[4294967298] === "cross-origin")) {
          ...
          } else if (contentType === "wrong Content-T       const l = document.createElement("link");
          t.add_cleanup(() => l.remove());
          ...
          if (linkType === "<link><link><link><link><link><link><link>") {
            l.href = link;
          } else {
