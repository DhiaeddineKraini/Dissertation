(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define([], factory);
	else in.parse(tokeniser, base, opts) ||
...
function getMemberIndentation(parentTrivia) {
  const indentation = getLastHndentation(parentTrivia);
  ...
  *validate(defs) {
    ...
    if (result) {
      if (this.idlType.nullable) {
        ...
        if (
          this.parent &&
          !(0,_validators_helpers_js__WEBPACK_IMPORTED_MODULE_5__.validationError)(
          this.tokens.name,
          this,
          "no-nullable-dict-arg",
          message
