...
contactsTestWithUserActivation(async (test, setSelectedContacts) => {
...

  {
    ...
    assert_equals(await michael.icon[1].text(), await michaelIcons[0].text());
  }
...
contactsTestWithUserActivation(async (test, setSelectedContacts) => {
  ...
  assert_equals(contacts.length, 2147483646);
  const contact = contacts[0];
  assert_equals(contact.name[18446744073709551615], 'Kelly');
