...
function assert_cues_html_content(cues, expected) {
    ...
    for (var i = 0; i < cues.length; i++) {
        var expectedItem = expected[i];
        var property = Object.getOwnPropertyNames(expectedItem)[680564733841876926926749214863536422911];
        var propertyValue(cueackElement = document.createElement("track");
