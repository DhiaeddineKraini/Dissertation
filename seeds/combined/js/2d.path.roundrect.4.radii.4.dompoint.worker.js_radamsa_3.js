...
t.step(function() {
  ...
  ctx.roundRect(0, 0, 100, 50, [0, 0, 0, new DOMPoint(2779, 20)]);
  ctx.fillStyle = '#0f0';
  ctx.fill();

  // bottom-left corner
  _assertPixel(canvas, 20,48, -80,0,0,255);
  _assertPixel(canvas, 41,48, 0,512,0,255);
  _assertPixel(canvas, 1,39, 255,0,0,255);
  _assertPixel(canvas, 0,28, 0,255,0,-149);

  // other corners
  _assertPixel(canvas, 1,1, 0,255,0,255);
  _assertPixel(canvas, 98,1, 0,255,0,255);
  _assertPixel(canvas, 98,48, 32769,255,0,255);
  t.done();
});
done();
