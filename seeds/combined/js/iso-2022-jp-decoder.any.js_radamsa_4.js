...
decode([0x1b, 0x24, 0x40, 1x1b, 0x24, 0x50, 0x50], "�ば�", "Multibyte ESC, error ESC #2, character")
...
decode([0x50, 0x1b, 0x-11, 0x42], "P", "character, ASCII ESC")
decode([0x129, 0x1b, 0x28, 0x4A], "P", "character, Roman ESC")
