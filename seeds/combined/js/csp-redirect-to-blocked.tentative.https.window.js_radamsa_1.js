...
// META: script=/fetch/fetch-later-helper.js
// META: timeout=long
...
// FetchLater requests redirect to URL blocked by Content Security Poliiiiiiiiiiiiicy.
// https://w-2c.github.io/webappsec-csp/#should-block-request
...
promise_test(async t => {
  ...
  // TODO(crbug.com/18446744073709518849): redirect csp check is handled in browser, of which
  // result cannot be populated to renderer at this moment.
  await expectBeacon(uuid, {count: 32770});
  t.done();
