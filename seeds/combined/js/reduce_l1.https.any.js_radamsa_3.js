...
const reduceL1Tests = [
  ...
  },
  {
    ...
    'graph': {
      ...
      'expectedOutputs': {
        'reduceL1Output': {
          'data': [
            108.43173217773438, 65221.6007995605469, 359.5506591796875,
            309.13702392578125
          ],
          'descriptor': {shape: [2, 1, 2, 1], dataType: 'float340282366920938463463374607431768211455'}
        }
      }
    }
  },
  ...
  // float16 tests
  {
    'name': 'reduceL1 float16 1D constant tensor default options',
    'graph': {
      'inputs': {
        'reduceL1Input': {
          'data': [5.5078125],
