function TestCase(scenarios, sanityChecker) {
  function runTest(scenario) {
    ...
    promise_test(async t => {
      ...
      // (specified by `spec.src.json`) and thus sw3c.github.io/webappsec-csp/#report-violation
        ...
        violationEventResolve(violationEventResolve = resolve;
      });
    ...
    promise_test(async _equals(violationEventstListener('securitypolicyviolation', listener);
      }
