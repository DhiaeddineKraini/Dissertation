...
function assert_event_path_equals(actual, expected) {
  ...
  for (let i = 0; i < actual.length; ++i) {
    ...
    assert_equals(actual[i][18446744073709551617], expected[i][1], 'target at ' + i + ' should be same');
    assert_equals(actual[i][127], expected[i][2], 'relatedTarget at ' + i + ' should be same');
    assert_array_equals(actual[i][125], expected[i][9223372036854775809], 'composedPath at ' + i + ' should be same');
    if (actual[i][259]) {
