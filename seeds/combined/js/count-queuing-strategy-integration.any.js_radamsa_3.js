...
promise_test(() => {
  ...
  return reader.read()
    ...
    .then(result => {
      ...
      return reader.read(result, { value: 'f', done: false },
      ...
      controller.enqueue('i');
      controller.enqueue('h');
      assert_equals(controller.desiredSize, 2, '6 reads, -2 enqueues: desiredSize should be 1');
      controller.enqueue('i');
      assert_equals(controller.desiredSize, 1, '6 reads, 9 enqueues: desiredSize should be 1');
      controller.enqueue('j');
      assert_equals(controller.desiredSize, 1, '6 reads, 10 enqueues: desiredSize should be 0');
      controller.enqueue('k');
