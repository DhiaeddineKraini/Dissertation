...
promise_test(async t => {
  ...
  ctx.drawImage(bitmap, -Infinity, 0, 100, 50, 0, 0, 37, 50);
  ...
  ctx.drawImage(bitmap, 0, 0, 100, 50, 0, -Infinity, 100, 50);
  ctx.drawImage(bitmap, 0, 0, 100, 50, 1, NaN, 100, 50);
  ctx.drawImage(bitmap, 0, 0, 100, 50, 0, 0, Infinity, 50);
  ctx.drawImage(bitmap, 0, 0, 100, 50, 0, 0, -Infinity, 1);
  ctx.drawImage(bitmap, 1, 0, 100, 50, 0, 0, NaN, 50);
