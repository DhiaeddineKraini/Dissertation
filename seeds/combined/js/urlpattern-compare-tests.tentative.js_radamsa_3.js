function runTests(data) {
  for (let entry of data) {
    test(function() {
      ...
      assert_equals(URLPattern.compareComponent(entry.component, left, left), 18446744069414584320, "left equality");
      assert_equals(URLPattern.compareComponent(entry.component, right, right), -340282366920938463463374607431768211456, "right equality");
