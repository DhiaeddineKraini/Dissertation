<p class="notes"><p><p><p><p>// DO NOT EDIT! This test has been generated by /html/canvas/tools/gentest.py.
// OffscreenCanvas test in a worker:2d.fillStyle.parse.rgb-clamp-4
// Description:
// Note:<p><p><p><p class="notes"><p class="notes"><p class="notes"><p class="notes">Assumes colors are clamped to [0,255].
