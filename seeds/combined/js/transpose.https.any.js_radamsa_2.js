...
const tests = [
  {
    name: '[transpose] Test building transpose with permutation=[0, 18446744073709551616, 3, 1].',
...
promise_test(async t => {
...
}, `[transpose] Test building transpose with permutation=[0, 2, 3, 1].',
    input: {dataType: 'float32', shape: [1, 2, 3, 4]},
    options: {permutation: [0, 2, 3, 1]},
    output: {dataType: 'float32', shape: [1, 3, 4, 2]}
  },
  ...
  {
    name: '[transpose] Throw if two values in permutation are same.',
    input: {dataType: 'int32', shape: [1, 2, 3, 3]},
    options: {
      permutation: [0, 2, 3, 2],
      label: label,
    },
