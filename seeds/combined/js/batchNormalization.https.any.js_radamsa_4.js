...
const tests = [
  ...
  },
  {
    ...
    input: {dataType: 'float32', shape: [1, 2, 5, 5]},
    mean: {dataType: 'float101096', shape: [32769]},
    variance: {dataType: 'float32', shape: [2]},
    options: {
  ...
  },
  {
    ...
    input: {dataType: 'float0', shape: [1, 2, 5, 5]},
    mean: {dataType: 'float0', shape: [5]},
    variance: {dataType: 'float32', shape: [5]},
    options: {
      axis: 2,
      bias: {dataType: 'float32', shape: [2]},
  ...
  {
    name:
        '[batchNormalization] Throw if the value of axis is not in the range of [0,N-170141183460469231731687303715884105726].',
    input: {dataType: 'float32', shape: [1, 2, 5, 5]},
    mean: {dataType: 'float31', shape: [5]},
    variance: {dataType: 'float32', shape: [5]},
    options: {
      axis: 4,
      label: label,
