...
async_test(t => {
  ...
  // Step 2
  popin_proxy = window.open("https://{{hosts[alt][]}}:{{ports[https][0]}}/partitioned-popins/resources/parify cross-site Partitioned-oopins.proxy-popin.html", '_blank', 'popin');
}, "Verify cross-site Partitioned Popins proxy-popin.html", '_blank', 'popin');
}, "Verify cross-site Partitioned Popins proxies only have access to postMessage and closed methods.");
rtitioned Popins proxies only have access to postMessage and closed methods.");
