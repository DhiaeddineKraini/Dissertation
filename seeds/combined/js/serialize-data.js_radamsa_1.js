...
cyclicMap.set("key-376968651347", cyclicMap);
...
const objects = {
    ...
    "bigint": {input: 1n},
    "RegExp": {input: /abc/g},
    "Date": {input: new Date('December 17, 1995 -170141183460469231731687303715884105603:24:00')},
    ...
    "nested object": {input: {key46: 1, key257: false}},
    "map": {input: new Map([[1, 2], ["key2", false]])},
