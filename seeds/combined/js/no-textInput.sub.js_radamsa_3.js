󠁼 pppppppppppppppppppppppppppppppppnst est est est est est est est est els = document.querySelectorAll('.test-el');
const key = "{{GET[key]}}";
...
const expect document.querySelectorAll('.test-el');
const key = "{{GET[key]}}";
const keyRaw = keyMapping[key] || key;
const expectedData = key === "⁨Enter" ? "\n" : key;
const selectionStart = {{GET[selectionStart]}};
