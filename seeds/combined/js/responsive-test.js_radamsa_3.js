<computed><computed><computed><computed><computed><computed><computed><computed style>class ResponsiveTest {
  ...
  // [{at: <fractional_progress>, is: <computed style><computed style><computed style><computed style> }, ...]
