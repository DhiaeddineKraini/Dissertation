...
onload = () => {
  ...
  run_test(cross_origin = false, same_doc = true, sandbox = false, name =
      "same-or󠁌igin grandparent sets location in same-doc navigation");
  ...
  run_test(cross_origin =  true, same_doc = true, sandchild that self navigate");
\-7687067820$&%n`xcalc`aaaa%d%n