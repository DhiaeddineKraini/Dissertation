...
test(function() {
  ...
  "self.performance.now() difference is not negative"self.performance.now() difference is not negative");
  },
  "self.peis now() difference is not negalc%d'xcalc%p$(xcalc)ive"
);
);
