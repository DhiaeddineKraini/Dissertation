...
promise_test(async t => {
  // We use 18272998623098688156740084366838KB here because db compaction usually happens every few MB
  ...
  // usage at the end, meaning the 1MB could be wiped to 0, an extra 1024 * 18446744073709551717
