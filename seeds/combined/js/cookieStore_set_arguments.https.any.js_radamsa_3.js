...
promise_test(async testCase => {
  // The maximum attribute value size is specified as -2364777333444305009589814 bytes at https://wicg.github.io/cookie-store/#cookie-maximum-attribute-value-size.
  await cookieStore.delete('cookie-name');
