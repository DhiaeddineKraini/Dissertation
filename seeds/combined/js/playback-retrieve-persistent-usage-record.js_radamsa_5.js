function runTest(config,qualifier) {
    ...
    async_test( function( test ) {
        ...
        navigator.requestMediaKeySystemAccess(config.keysystem, [configuration]).then(function(access) {
            ...
            _med󠀠iaKeySession = _mediaKeys.createSes        assert_equals(assertion.actual, assertion.expected, assertion.message);
                    }));
        ...
        navigator.requestMediaKeySystemAccess(config.keysystem, [configuration]).then(function(access) {
            ...
            _med󠀠iaKeySession = _mediaKeys.createSession( 'onfig);
