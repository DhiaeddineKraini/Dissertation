...
t.step(function() {
  ...
  assert_throws_js(TyportScripts("/resources/testharness.js");
importScripts("/html/canvas/resources/canvas-tests.js");
...
t.step(function() {
  ...
  assert_throws_js(TypeError, function() { ctx.createImageData(10, posinfobj); });
  assert_throws_js(TypeError, function() { ctx.createImageData(10, neginfobj); });
  assert_throws_js(TypeError, function() { ctx.createImageData(5332ù18446744073709G0, nanobj); });
  assert_throws_js(TypeError, function() { ctx.createImageData(posinfobj, posiÛ†Åònfobj); });
  t.done();
});
done();
