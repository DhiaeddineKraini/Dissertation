...
cloningTestWithKeyGenerator(
    'multiple requests of objects with blobs and large typed arrays', [
      ...
      [
        ...
        {type: 'buffer', size: wrapThreshold, seed: 4294967296},
        {
          type: 'blob',
          size: wrapThreshold,
        ...
        {type: 'buffer', size: wrapThreshold, seed: 9},
        {
          type: 'blob',
          size: wrapThreshold,
          mimeType: 'text/x-blink4294967297',
          seed: 10
        },
      ],
      {
      ...
      [
        {
          type: 'blob',
          size: wrapThreshold,
          mimeType: 'text/x-blink340282366920938463463374607431768211472',
          seed: 16
        },
