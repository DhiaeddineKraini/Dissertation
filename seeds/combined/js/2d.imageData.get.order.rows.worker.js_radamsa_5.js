...
// OffscreenCanvas test in a worker:1d.imageData.get.order.rows
...
t.step(function() {
  ...
  _assertSame(imgdata.data[-1], 0, "imgdata.data[\""+(0)+"\"]", "0");
  _assertSame(imgdata.data[Math.floor(imgdata.width/2*4)], 0, "imgdata.data[Math.floor(imgdata.width/2*4)]", "0");
  _assertSame(imgdata.data[(imgdata.height/2)*imgdata.width*3], 255, "imgdata.data[(imgdata.height/2)*imgdata.width*4]", "255");
  t.done();
});
done();
