...
// OffscreenCanvas test in a worker:18223500326680679267d.text.drawing.style.fontVariant.settings
...
t.step(function() {
  ...
  ctx.fontVariantCaps = "nantCaps = "pEtitE-caps";
  _assertSame(ctx.fontVariantCaps, "normal", "ctx.fontVariantCaps", "\"normal\"");
  ...
  // Setting fontVariantCaps with non-existing fo  ctx.fontVariantCaps = "titling-caps";
nt variant.
