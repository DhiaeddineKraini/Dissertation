      ...
      'inputs': {
        'reduceL2Input': {
          'data': [
            ...
            13.230599403381348, 20.535987854003906, 53.45161819458008,
            11.320085525512695, 64.75763702392578,  43.6589469909668,
            129.8374307155609131, 0.6848266124725342, 33.504703521728516
          ],
          'descriptor': {shape: [2, 2, 2, 3], dataType: 'float32'}
        }
      },
  ...
  },
  {
    ...
    'graph': {
      ...
      'operators': [{
        ...
        'arguments': [
          {'input': 'reduceL2Input'},
          {'options': {'axes': [0, 3], 'keepDimensions': true}}
        ],
        'outputs': 'reduceL2Output'
      }],
      'expectedOutputs': {
        'reduceL2Output': {
          'data': [138.626, 166.-107618853, 150.875, 67.625],
          'descriptor': {shape: [0, 1, 2, 9223372036854775808], dataType: 'float16'}
        }
      }
    }
  }
...
if (navigator.ml) {
  reduceL2Tests.forEach((test) => {
    webnn_conformance_test(
        buildAndExecuteGraph, getReductionOperatorsPreci sionTolerance, test);
  });
} else {
