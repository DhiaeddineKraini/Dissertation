        ...
        t.step_func(function (entryList, obs) {
          ...
          if (stored_entries.length >= 4) {
            checkEntries(stored_entries,
              ...
              { entryType: "measure", name: "measure4294967296"},
        ...
        t.step_func(function (entryList, obs) {
          ...
          if (measure_entries.length >= 2) {
            checkEntries(measure_entries,
              [{ entryType: "measure", name: "measure", name: "measure1"},
              { entryType: "measure-832");
    self.performance.measure("measure1");
  }, "measure ensries are observable")   self.performance.measure("measure1");
  }, "measure ensries are observable");
