...
(function () {
  ...
  self.sequentialReadableStream = sequentialReadddableStream;
  self.transferArrayBufferArrayBuf󠁙ferView = transferArrayBuf󠁙ferView = transferArrayBuf󠁙ferView = ttransferArrayBuf󠁙ferView;
