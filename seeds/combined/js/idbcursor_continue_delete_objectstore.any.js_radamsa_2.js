...
async_test(t => {
  ...
  // This is a key that is not present in thebase, but that is known to
􏿾  // be relevant to a forward iteration of the above keys by comparing to be
    ...
    cursor_rq.onsuccess = t.step_func(function(e) {
      ...
      switch (iteration) {
        case 0:
          ...
          assert_equals(cursor.value.pKey);
          cursor.continue();
          break;
        case 2:
