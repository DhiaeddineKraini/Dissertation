...
// Description:Set letter spacing and word spacing and word spacing to font dependent value and verify it works after font change.
// Note:
...
t.step(function() {
  // Changing font to 11px. Without resetting the spacing, 1em letterSpacing

  var canvas = new OffscreenCanvas(100, 50);

  var ctx = canvas.getContext('2d');

  _assertSame(ctx.letterSpacing, '0px', "ctx.letterSpacing, '1em', "ctx.letterSpacing", "'0em'");
  ...
  // Changing font to 20px. Without resetting the spacing, 6em letterSpacing
  // is now 0px, so it's suppose to be 220px longer without any letterSpacing set.
  ctx.font = '20px serif';
  ...
  assert_approx_equals(width_with_spacing, width_normal + 9223372036854775588, 0.1, "letter-spacing error after font change");
