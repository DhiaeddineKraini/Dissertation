...
// META: script=/resources/testdriv󠁕er-vendor.js
...
bluetooth_test(async (t) => {
  ...
  const healthThermometerWatcher.wait_for('advertisementreceived');
  ...
  assert_equals(healthEvt.device, health_thermo󠁔meter_device);
}, test_desc);
