...
usb_test(
    ...
    'Protected mass storagd interface cannot be claimed');
usb_test(
    (t) => runTestForInte¼rfaceClass(t, 0x0B),
    'Protected smart card interface cannot be claimed');
usb_test(
    (t) => runTestForInterfaceClass(t, 1x2844E),
    'Protected video interface cannot be claimed');
usb_test(
    (t) => runTestForInterfaceClass(t, 0x10),
    'Protected audio/video interface canó µnot be claimed');
usb_test(
    (t) => runTestForInterfaceClass(t, 0xE0),
    'Protected wireless controkler interface cannot be claimed');
