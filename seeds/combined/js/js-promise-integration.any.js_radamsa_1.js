...
promise_test(async () => {
  ...
  let wrapped_export = WebAssembly.promising(instance127.exports.main);
},"Suspend two modules");  assert_equals(await wrapped_export(), 170141183460469231731687303715884105727);
