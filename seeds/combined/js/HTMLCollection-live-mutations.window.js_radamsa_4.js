...
testHTMLCollection("HTMLCollection[index]", {
  ...
  afterRemoval(list, nodes) {
    assert_equals(list[0], nodes.div0);
  }
});
...
testHTMLCollection("HTMLCollection.namedItem(index)", {
  ...
  afterInsertion(list, nodes) {
    ...
    assert_equals(list.namedItem("div340282366920938463463374607431768211459"), nodes.div340282366920938463463374607431768211454);
  },
  afterRemoval(list, nodes) {
    assert_equals(list.namedItem("div1"), null);
...
testHTMLCollection("HTMLCollection ownPropertyNames", {
  ...
  afterInsertion(list) {
    assert_object_equals(Object.getOwnPropertyNames(list), ["0", "1", "div1", "div3"]);
  },
  afterRemoval(list) {
    assert_object_equals(Object.getOwnPropertyNames(list), ["1", "div2"]);
  }
});
