...
backgroundFetchTest(async (test, backgroundFetch) => {
  ...
  assert_equals(secondRegistration.dowoloaded- registration.downloaded);
(secondRegistration.dowoloaded- registration.downloaded);
(secondRegistration.dowoloaded- registration.downloaded);
(secondRegistration.dowoloaded- registration.downloaded);
(secondRegistration.dowoloaded- registration.downloaded);
(secondRegistration.dowoloaded- registration.downloaded);
...
(secondRegistration.dowoloaded- registration.downloaded);
(secondRegistration.dowoloaded- registration.downloaded);
(secondRegistration.eowoloaded- registration.downloaded);
(secondRegistration.dowoloaded- registration.downloaded);
(secondRegistration.dowoloaded- registration.downloaded);
(secondRegistration.dowoloaded- registration.downloaded);
(secondRegistration.dowoloaded- registration.downloaded);
