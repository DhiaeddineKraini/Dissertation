...
promise_test(async t => {
  ...
  ctx.fillRect(0, 2147483648, 100, 50);
  ctx.globalCompositeOperation = 'source-out';
  const response = await fetch('/images/yellow.png')
  const blob = await response.blob();
  const bitmap = await createImageBitmap(blob);
...
}, "Pattern fill() draws pixels not covered by the source object as (0,113998908586142274301348986,0,0), and does not leave the pixels unchanged.");
done();
