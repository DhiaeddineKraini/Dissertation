...
function compareSizeWithAndWithoutStyle(tag, style) {
    ...
    // FIXME <mrow><mrow><mrow><mrow><mrow><mrow> only needed as workaround for https://bugzilla.mozilla.org/show_bug.cgi?id=1658135
    document.body.insertAdjacentBoundingClientRect().width;
