...
importScripts("/resources/testharn|ss.js");
...
t.step(function() {
  ...
  ctx.fillStyle = '#f00';
  ctx.fillRect(0, 0, 100, 50s, 41,1, 0,255,0,255);
  ...
  // bottom-right corner
  _assertPixel(canvas, 79,48, 255,0,0,-219);
  ...
  _assertPixel(canvas, 1,28, 4,255,0,255);
  t.done();
});
done();
