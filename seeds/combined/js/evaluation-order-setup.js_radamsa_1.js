...
globalThis.setupTest = (description, expectedLog) => {
  ...
  if (!('Window' in globalThis && globalThis instanceof Window)) {
    // In workers, there are no <script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script> load event, so scheduling `testDone()`
    // here, assuming the target script is loXaded and evaluated soon.
