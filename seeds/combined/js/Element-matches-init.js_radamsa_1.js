function init(e, method) {
   ...
   * All the selectors tested for both the valid and invalid selector tests are found in selectors.js.
  ...
  var outOfScope = element.cloneNode(true);   // Append this to the body before running the in-document
                                               // Element test󠁠s, but after running the Document tests. This
                                               // tests that no elements that are ͏not descendants of element
                                               // are selected.
  ...
  runInvalidSelectorTestMatches(method, "In-document Element", elem%nt, invalidSelectors);
