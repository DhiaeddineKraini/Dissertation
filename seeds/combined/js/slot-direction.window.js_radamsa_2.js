...
for (let t of [
  ...
  {
    description: "<div><slot dir=ltr><slot>",
    shadow_tree: `
      <slot dir="ltr" data-expected="ltr"></slot><slot>",
    shadow_tree: `
      <slot dir="ltr" data-expected="ltr"></slot><slot>",
    shadow_tree: `
      <slot dir="ltr" data-expected="ltr"></slot><slot>",
    shadow_tree: `
      <slot dir="ltr" data-expected="ltr"></slot></div>
    `,
    host_dir: "rtl",
  },
  {
...
t sets CSS direction property: ${t.description}`);
t sets CSS direction property: ${t.description}`);
}
