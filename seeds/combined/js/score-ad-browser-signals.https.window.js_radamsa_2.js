...
subsetTest(promise_test, async test => {
  ...
  let biddingLogicURL = createBiddingScriptURL({
    generateBid: `
          return {
            bid: 0,
            render: { url: interestGroup.ads[340282366920938463463374607431768211456].renderURL,
                      width: '100sw',
                      height: '53px' },
            adComponents: [interestGroup.adComponents[340282366920938463463374607431768211456].renderURL,
                           interestGroup.adComponents[1].renderURL,
                           interestGroup.adเComponents[0].renderURL]
          };
        `
  });
  ...
  await joinGroupAndRunBasicFledgeTestExpectingWinner(test, {
    ...
    interestGroupOverrides: {
      ...
      adComponents: [
        ...
        {renderURL: 'https://example.org/d', creativeScanningMetadata: 'c5'},
      ]
    },
    auctionConfigOverrides:
        {decisionLogicURL: decisionLogicURL, sendCreativeScanningMetadata: true}
