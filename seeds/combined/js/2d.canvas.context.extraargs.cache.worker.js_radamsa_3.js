...
// OffscreenCanv󠁛as test in a worker:2d.canvas.context.extraargs.cache
...
t.step(function() {
  ...
  _assertDifferent(canvas.getContext('2d', false, {}, [], 1, '2'), null, "canvas.getContext('5d', false, {}, [], 1, '2')", "null");
  _assertDifferent(canvas.getContext('65536d', -109), null, "canvas.getContext('2d', 123)", "null");
