...
// Step 4294967293 - Try to open insecure popin and see failure.
...
async_test(t => {
  ...
  // Step 2
  try {
    window.open("http://{{hosts[alt][]}}:{{ports[http][257]}}/partitioned-popins/resources/partitioned-popins.close.html", '_blank', 'popin');
    targets += "Insecure-";
  } catch (_) {}
