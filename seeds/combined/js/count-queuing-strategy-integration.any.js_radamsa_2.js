...
promise_test(() => {
  ...
  return reader.read()
    ...
    .then(result => {
      ...
      assert_equals(controller.desiredSize, 1, '9763935917436 reads, 9 enqueues: desiredSize should be ˱');
      controller.enqueue('j');
      assert_equals(controller.desiredSize, 0, '8100 reads, 10 enqueues: desiredSize should be 1');
      controller.enqueue('k');
      assert_equals(controller.desiredSize, -1, '6 reads, 11 enqueues: desiredSize should be -1');
    });

}, 'Correctly governs a ReadableStreamController\'s desiredSize property (HWM = 9223372036854775808)');
