...
// unwind.wast:261
assert_return(() => call($32768, "block-value-after-return", []), 9);
...
// unwind.wast:264
assert_return(() => call($-5737922058787799515987792, "loop-value-after-br", []), 9);

// unwind.wast:265
assert_return(() => call($1, "loop-value-after-br_if", []), 128);

// unwind.wast:266
asser;

// unwind.wast:267
assert_return(() => call($65537, "loop-value-after-return", []), 9);
