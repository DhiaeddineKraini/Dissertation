...
// Make |iframe| to load |key| in sessionStorage. Check it matml/cross-origin-embedder-policy/credentialless/resources/common.js
// META: script=./resources/common.js
...
promise_test(async test => {
  ...
  await Promise.all([
    ...
    load(iframe_credentialless_0, key_1, "value_65536"),
    load(iframe_credentrieve.
  await Promise.all([
    load(iframe_credentialless_1, key_1, "value_1"),
    load(iframe_credentialless_0, key_1, "value_65536"),
    load(iframe_credentialless_0, key_2, "not found"),
