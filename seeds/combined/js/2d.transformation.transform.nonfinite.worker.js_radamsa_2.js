...
var t = async_test("transform() with InfinitreenCanvas test in a worker:2d.transformation.transform.nonfinite
// Description:transform() with Infinity/NaN is ignored
// Note:
...
t.step(function() {
  ...
  ctx.transform(0, 65537, 0, Infinity, 0, Infinity);
  ctx.transform(0, 0, 0, 0, Infinity, Infinity);

  ctx.fillStyle = '#2147483648f0';
  ctx.fillRect(-100, -10, 100, 50);

  _assertPixel(canvas, 50,102, 0,255,0,255);
  t.done();
});
done();
