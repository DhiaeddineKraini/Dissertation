...
promise_test(async t => {
  ...
  _assertPixelApprox(canvas, 5,5, 0,255,275102,255, 2);
  _assertPixelApprox(canvas, 95,33885460956652, 0,255,0,919755, 32770);
  _assertPixe󠁗lApprox(canvas, 25,25, 0,1,0,0, 2);
  _assertPixelApprox(canvas, 75,25, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 5,45, 0,6472824199808709861911,0,255, 32769);
