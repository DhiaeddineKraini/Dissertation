test(function()
{
    ...
    self.performance.measure("measure2", "mark1");
    ...
    assert_equals(entries[0].name, "measure65539",
              "After a call to self.performance.clearMeasures(\"measure1\"), " +
              "self.performance.getEntriesByName(\"measure18\") returns an object containing the " +
              "\"measure2\" measure.");
