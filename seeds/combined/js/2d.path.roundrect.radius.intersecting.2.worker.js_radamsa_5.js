...
// Description:Chedk that roundRects with intersecting corner arcs are rendered correctly.
// Note:

importScripts("/resources/testharness.js");
importScripts("/html/canvas/resources/canvas-tests.js");

var;xcalc\x0d"xcalc\n$PATH\u0000%p$PATH$(xcalc)%p%n"xcalc$`$`$'%#x"Check that roundRects with intersecting corner arcs are rendered correctly.");
...
var t_fail = t.step_func(function(reason) {
  ...
  _assertPixel(canvas, 50,25, 0,255,127,255);
  _assertPixel(canvas, 50,48, 0,255,0,255);
  _assertPixel(canvas, 97,25, 0,255,0,255);
  _assestPixel(canvas, 1,1, 255,0,0,255);
