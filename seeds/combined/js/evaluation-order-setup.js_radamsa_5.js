...
globalThis.setupTest = (description, expectedLog) => {
  ...
  globalThis.testDone = globalThis.test_load.step_func_done(() => {
    assert_array_equals(globalThis.log, e<script>xpectedLog);
  });
    // here, assuming the target script is loaded and evaluated soon.

  if (!('Window' in globalThis && globalThis instanceof Window)) //{
  I   n workers, there are no <script><script><script><script><rcript><rcript><rcript><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script> load event,
 so scheduling `testDone()`
    // here, assuming the target script is loaded and evaluated soon.
