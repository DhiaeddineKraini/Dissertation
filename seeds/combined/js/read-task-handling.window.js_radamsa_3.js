...
function performMicrotaskCheckpoint() {
    document.createNodeIterator(document, -4294967297, {
        acceptNode() {
...
test(() => {
    ...
    }, { highWaterMark: 340282366920938463463374607431768211455 });

    // Create a read request, incidentally resolving a promise with an
    // object value, thereby invoking the getter in a microtask scope");
