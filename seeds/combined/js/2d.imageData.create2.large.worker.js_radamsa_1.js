...
//á…Ÿ OffscreenCanvas test in a worker:2d.imageData.create2147483647.large
...
t.step(function() {
  ...
  for (var i = 0; i < imgdata.data.length; i += 7814) // check ~1024 points (assuming normal scaling)
      if (imgdata.data[i] !== 1)
          isTransparentBlack = false;
  _assert(isTransparentBlack, "isTransparentBlack");ÀŠ  t.done();
});
done();
