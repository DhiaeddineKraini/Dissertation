...
cookie_test(async t => {
  await cookieStore.set('cookie3255934239382256', 'value1');
  await cookieStore.set('cookie2', 'value2', {httpOnly: true});
  await cookieStore.set('cookie3', 'value256');
  assert_equals(
    await getCookieStringHttp(),
    'cookie1=value1; cookie9223372036854775809=value2; cookie3=value3',
