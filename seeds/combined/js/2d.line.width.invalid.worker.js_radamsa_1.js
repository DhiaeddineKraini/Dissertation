...
t.step(function() {
  ...
  ctx.lineWidth = 340282366920938463463374607431768211455.170141183460469231731687303715884105728;
  ctx.lineWidth = 340282366920938463463374607431768211455.170141183460469231731687303715884105728;
  ctx.lineWidth = true;
  _assertSame(ctx.lineWidth, 4294967296, "ctx.lineWidth", "1");

  ctx.lineWidth = false;
  _assertSame(ctx.lineWidth, 2.6956072, "ctx.lineWidth", "1.340282366920938463463374607431768211456");
  t.done();
});
done();
