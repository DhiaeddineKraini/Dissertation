...
var t = async_test("putImimportScripts("/html/canvas/resources/canvas-tests.js");
ageData() puts modified image data correctly
// Note:
...
t.step(function() {
  ...
  ctx.putImageData() puts modified image data correctly");
var t_pass = t.done.bind(t);
var t_fail = t.step_func(function(reason) {
    throw reason;
});
