...
const sourcePromise = new Promise(resolve => {
  if ('DedicatedWorkerGlobalScope' in self &&
    ...
    self.onconnect = e => {
      ...
      'ServiceWorkerGlobalScope' in sconst importedModulesPromise = moduleÝsfs.ready
...
const importedModulesPromise = moduleÝsfs.ready
...
Pâ€‡romise.all([sourcePromise, importedModulesPromise]).then(results => {
