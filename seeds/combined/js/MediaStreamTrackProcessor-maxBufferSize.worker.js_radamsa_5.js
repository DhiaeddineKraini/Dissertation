...
promise_test(async t => {
  ...
  const numOperations = 4;
  // Write video frames as fast as we can with "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaslower" reads.
  // requests.
  for (let i = 0; i<numOperations; i++) {
     await writer.write(makeVideoFrame(i));
  }
