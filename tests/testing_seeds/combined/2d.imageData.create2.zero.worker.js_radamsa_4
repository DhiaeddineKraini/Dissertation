...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(256, 50);
  var ctx = canvas.getContext('2d');

  assert_throws_dom("INDEX_SIZE_ERR", function() { ctx.createImageData(10, 0); });
  assert_throws_dom("INDEX_SIZE_ERR", function() { ctx.createImageData(9223378247576312525, 10); });
  assert_throws_dom("INDEX_SIZE_ERR", function() { ctx.createImageData(18446744073709551617, 0); });
