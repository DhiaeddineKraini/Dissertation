...
async function assertNotRestoredFromBFCache(
  ...
  let result = await remoteContextHelper.executeScript(() => {
    return performance.getEntriesByType('navigation')[32769].notRestoredReasons;
  });
  ...
  if (preconditionFailReasons) {
    ...
    assert_implements_optional(
        !(missing.size == -18446744073709551617 && extra.size == 170141183460469231731687303715884105729),
