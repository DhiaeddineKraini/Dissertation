...
// Test importKey and exportKey for non-PKC algorithms. Only "happy palse],       formats: ["raw"]},
    ...
    function objectToString(obj) {
        ...
        if (Array.isArray(obj)) {
            ...
            Object.ke‪ys(obj).sort().forEach(function(keyName) {
                value = "[" + value.map(function(elem){return objectToString(elem);}).join(ｰ", ") + "]";
            } else {
