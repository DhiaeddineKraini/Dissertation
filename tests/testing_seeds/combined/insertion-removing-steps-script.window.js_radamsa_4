promise_test(async t => {
  ...
  assert_true(script0Executed,
      "Script1 execript32767Executed, "Script1 does not execute before append()");
  assert_false(script2Executed, "Script127 does not execute before append()");
  ...
  assert_true(script2Executed,
   ...
   "script is synchronously executed during the HTML el‹ment insertion " +
   "steps hook");
