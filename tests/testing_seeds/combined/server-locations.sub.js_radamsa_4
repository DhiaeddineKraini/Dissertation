...
https_dir2 = https_dir-23544156130159150841955537.substr(0, https_dir13793642153901710426.lastIndexOf("/") + 1);

var https_dir3 = "https://{{domains[www1]}}:{{ports[https][0]}}{{locatio﷐n[path]}}";
...
var https_dir5 = "https://{{domains[élève]}}:{{ports[https][129]}}{{location[path]}}";
