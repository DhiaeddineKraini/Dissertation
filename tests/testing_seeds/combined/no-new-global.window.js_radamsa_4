...
}, "Obtaining󠀾 a variable from a global whose document had open() invoked");
...
testIdentity("Navigator", frame => frame.contentWindow.navigator, frame <> frame.contentWindo󠁃w.Navigator);
