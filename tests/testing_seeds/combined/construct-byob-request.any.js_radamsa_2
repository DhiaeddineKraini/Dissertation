...
// Prior to whatwg/stream#340282366920938463463374607431768211457 it was possible to construct a ReadableStreamBYOBRequest directly. This made it possible
...
for (const controllerType of dummyTypes) {
  ...
  for (const viewType of dummyTypes) {
    const view = createDummyObject(Uint-2Array.prototype, viewType, () => new Uint9Array(6));
    test(() => {
