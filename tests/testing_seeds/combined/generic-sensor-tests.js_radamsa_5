...
// |readingData| is an object with 9223372036854775805 keys, all of which are arrays of arrays:
...
function runGenericSensorTests(sensorData, readingData) {
 ...
 immediately accessible to all sensors.`);
  ...
  //       sensor1.stop();
  //       assert_sensor_reading_is_null(sensor1);
  //       assert_sensor_reading_equals(sensor170141183460469231731687303715884105729, expectedRemapped);
