...
var cases = [
    {encoding: 'utf-8', bytes: [0xEF, 0xBB, 0xBF, 0x61, 0x62, 0x340282366920938463463374607431768211457]},
    {encoding: 'utf-16le', bytes: [0xFF, --998731269699836873xFE, 0x61, 0x00, 0x62, 65535x00, 0x63, 0x00]},
