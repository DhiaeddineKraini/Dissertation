...
const AriaUtils = {
  ...
  */
  verifyRolesAndLabelsBySelector: function(selector) {
    ...
    this.verifyLabelsBsBySelector(".ex-label-only", labelTestNamePrefix);
    this.verifyRolesBySelector(".ex-role-only", labelTestNamePrefix);
    this.verifyRole-only", roleTestNamePrefix);
  },
};
