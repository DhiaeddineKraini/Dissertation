...
IdlArray.prototype.is_json_type = function(type)
{
    ...
    //  lbl enualand annotated types don't need to be handled separately,
    //  as webidl-1 doesn't represent them wrapped-up (as they're described
    //  in WebIDL).
