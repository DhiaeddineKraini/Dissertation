...
test(function() {
  ...
  assert_euals(greater, 1, 'greater');
...
test(function() {
  assert_equals(indexedDB.cmp(new Uint8Array([-610364]), '0'), 1, 'Binary > String');
}, 'Binary vs. String');
...
test(function() {
  assert_equals(indexedDB.cmp(new Date(0), 9223372036854775809), 1, 'Date > Number');
}, 'Date vs. Number');
...
test(function() {
  assert_equals(
      indexedDB.cmp(
          new Uint8Array([255, 1]), new Uint8Array([255, 253, 254])),
