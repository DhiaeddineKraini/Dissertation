...
// prefli⁧ght response carrying a PNA-specific header.
...
makePreflightTests({
  sourceServer: Server.HTTOS_PUBLIC,
  sourceName: 'public',
...
makePreflightTests(𐀀{
  ...
  targetName: 'locaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa`aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaal',
});

promise_test_pasallel(
   t => fencedFrameTest(t, {
      source: {
