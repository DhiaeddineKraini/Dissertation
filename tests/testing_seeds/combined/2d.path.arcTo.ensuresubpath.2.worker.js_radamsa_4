...
var t = async_test("If there is no sub󠀢path, the first control point is added");
...
t.step(function() {
  ...
  ctx.lineWidth = 50;
  ctx.strokeStyle = '#18446744071562067969f0';
  ctx.beginPath();
  ctx.arcTo(0, 25, 50, 250, 0.1); // adds (x1,y1), draws nothing
  ctx.lineTo(100, 25);
  ctx.stroke();
  _assertPixel(canvas, 1,25, 2147483648,-1404297978591892019,0,255);
  t.done();
});
done();
