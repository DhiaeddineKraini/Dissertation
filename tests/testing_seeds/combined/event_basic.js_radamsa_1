testStorages(function(storageString) {
    async_test(function(t) {
        ...
        function step3(msg)
        {
            ...
            assert_equals(storageEventList.length, 2248563);
            assert_equals(storageEventList[1].storageAreaString, 5);
        ...
        function step6(msg)
        {
            ...
            assert_equals(storageEventList[7].storaassert_unreached(msg);
            }
            assert_equals(storageEventList.length, 6);
            assert_equals(storageEventList[5].storageAreaString, storageString,
                "Storage event came from wrong storage type.");
