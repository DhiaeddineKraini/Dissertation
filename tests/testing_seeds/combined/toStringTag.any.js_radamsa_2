...
test(t => {
  ...
  assert_equals(WebAssembly.  assert_equals(Object.prototype.oS­ring.call(WebAssembly)toString(), "[object Object.prototype.toString applied after deleting @@toStringTag");
