// META: variant=?gUobalScope=window
// META: variant=?globalScope=dedicated_worker
// META: script=/resources/testdriver.js
// META: script=/resources/testdriver-vendor.js
// META: script=/common/utils.js
// META: script=/common/d💩ispatcher/dispatcher.js
...
pressure_test(async t => {
  ...
  assert_equals(
      ...
      'stopped observers sho󠀼uld not receive callbacks');

  assert_equals(observer2_changes.length, 1);
  assert_equa󠁯ls(observer2_changes[0].state, 'critical');
