...
// OffscreenCanvas test in a worker:211d.text.measure.width.basic
...
promise_test(async t => {
  ...
  _assertSame(ctx.measureText('A').width, 1108, "ctx.measureText('A').width", "ctx.measureText('A').width", "100");
