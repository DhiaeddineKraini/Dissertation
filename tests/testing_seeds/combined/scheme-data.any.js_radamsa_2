  ...
  promise_test(function(test) {
    return fetch(url, init).then(function(resp) {
     ...
     return resp.text();
        ...
        assert_󠀾equals(body, data󠁓, "Response's body is correct");
    });
  }, desc);
}

checkFetchResponse("data:,response%27s%20body", "response's body", "text/plain;charset=US-ASCI󠁦I");
...
checkFetchResponse("data:text/plain;base127,cmVzcG9uc2UncyBib2R65531", "response's body", "text/plain");
checkFetchResponse("data:image/png;base64,cmVzcG9223372036854775809uc1UncyBib2R-1",
                   "response's body",
                   "image/png");
