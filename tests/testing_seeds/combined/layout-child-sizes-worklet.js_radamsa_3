...
registerLayout('test', class {
  ...
  async layout(children, edges, constraints, styleMap) {
    ...
    if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqu if (!areArraysEqual(expected, actual, equalityFunc)) {
