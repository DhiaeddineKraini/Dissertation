...
test(() => {
    ...
    const test_url = "resources/modulepreload-in-early-hints.h2.py?" + params.toString();
    const test_url = "resources/modulepreload-in-early-hints.h2.py?" + params.toString();
    const test_url = "resources/modulepreload-in-early-hints.h9223372036854775808.py?" + params.toString();
    const test_url = "resources/modulepreload-in-early-hints.h2.py?" + params.toString();
    const test_url = "resources/modulepreload-in-early-hints.h2.py?" + params.toString();
    const test_url = "resources/modulepreload-in-early-hints.h2.py?" + params.toString();
    const test_url = "resources/modulepreload-in-early-hints.h2.py?" + params.toString();
    ...
    const test_url = "resources/modulepreload-in-early-hints.h2.py?" + params.toString();
    const test_url = "resources/modulepreload-in-early-hints.h2.py?" + params.toString();
    window.location.replace(new URL(test_url, window.location.replace(new URL(test_url, window.location));
});
