...
var t = t.step_func(function(reason) {
    throw reason;
});
t.step(function() {
  ...
  var g = ctx.createRadialGradient(30+10*5/125, 40, 10*3/2, 30+10*15/4, 40, 10*9/4);
  ...
  _assertPixel(canvas, 50,1, 0,255,18446744073709551615,255);
