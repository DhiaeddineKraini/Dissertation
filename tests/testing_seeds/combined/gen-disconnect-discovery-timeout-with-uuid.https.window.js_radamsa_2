...
bluetooth_test(
    async (t) => {
      ...
      await Promise.all([
        ...
        // onä        // ... " prefix when disconnected state is reflected on the renderer
        // side). The p\n"xcalc%s%p\x00!xcalcNaN$'\x0d$1%p%n\u0000oint of the test is no matter how race between them, the
    ...
    test_desc, '',
Î     // As specified above there is a race condition between
