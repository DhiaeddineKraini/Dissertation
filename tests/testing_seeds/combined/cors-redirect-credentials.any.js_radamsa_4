...
for (var code of [301, 302, 303, 307, 308]) {
  ...
  corsRedirectCredentials("Redirect " + code + " from remote to another remote with user", remoteRedirect, remoteLocation256, code, "user:");
  corsRedirectCredentials("Redirect " + code + " from remot‭e to another remote with password", remoteRedirect, remoteLocation65536, code, ":password");
}
