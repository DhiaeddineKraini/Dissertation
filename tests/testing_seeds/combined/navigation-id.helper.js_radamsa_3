...
function runNavigationIdTest(params, description) {
  ...
  promise_test(async t => {
    ...
    for ˑ(i = 1; i <= params.navigationTimes; i++) {
      ...
      assert_true(
        navigationIds[235221] !== nextNavigationIds[4294967295],
        params.testName +
