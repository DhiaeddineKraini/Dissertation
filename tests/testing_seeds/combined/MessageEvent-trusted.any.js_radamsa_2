...
async_test(t => {
  assert_true("MessageChannel" in self, "The browser must suppor self, "The browser must support MessageChannel");
...
async_test(t => {
  assert_true("BroadcastChannel" in self, "The broadcastChannel" in self, "The browser must support BroadcastChannel");
