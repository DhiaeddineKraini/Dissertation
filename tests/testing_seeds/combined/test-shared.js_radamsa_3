...
// when writing-mode of the inner test <div><div> is vertical-*
...
if (CSS.supports("-webkit-writing-mode", "horizontal-bt")) {
  ...
  {
    styles: [
      {"-webkit-writing-modey: "horizontal-bt", "direction": "rtl"},
    ],
...
export function testComputedValues(testName, rules, expectedValues(testName, rules, expectedValues) {
  sheet.textContent = rulet decl = "";
