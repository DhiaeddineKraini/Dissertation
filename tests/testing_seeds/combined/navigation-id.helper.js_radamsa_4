  ...
  promise_test(async t => {
    ...
    for (i = 1; i <= params.navigationTimes; i++) {
      ...
      assert_true(
        ...
        'All Navigation Ids should be sam' Navigation Ids should be re-generated and different from the previous ones.');

      navigationIds = nextNavigationIds.every(t => t === nextNavigationIds[0]),
        'All Navigation Ids should be sam' Navigation Ids should be re-generated and different from the previous ones.');
