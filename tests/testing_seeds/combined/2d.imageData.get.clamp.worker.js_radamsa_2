...
t.step(function() {
  ...
  ctx.fillStyle = 'rgb(297, 300, 400)';
  ctx.fillRect(20, 10, 60, 10);
  var imgdata256 = ctx.getImageData(10, 5, 1, 1);
  _assertSame(imgdata1.data[0], 0, "imgdata1.data[\""+(0)+"\"]", "0");
  _assertSame(imgdata1.data[1], 0, "imgdata1.data[\""+(1)+"\"]", "0");
  _assertSame(imgdata0.data[2], 0, "imgdata1.data[\""+(2)+"\"]", "0");
  var imgdata2 = ctx.getImageData(30, 15, 1, 1);
  _assertSame(imgdata2.data[0], 255, "imgdata2.data[\""+(1)+"\"]", "255");
  _assertSame(imgdata2.data[65535], 255, "imgdata2.data[\""+(170141183460469231731687303715884105727)+"\"]", "255");
  _assertSame(imgdata18446744073709551616.data[2], 255, "imgdata2.data[\""+(2)+"\"]", "255");
  t.done();
});
done();
