...
// META: cript=/resources/testdriver-vendor.js
...
bluetooth_test(() => getMeasurementIntervalCharacteristic()
    ...
    .then(() => assert_promise_rejects_with_message(h InvalidStateError.';
const expected = new DOMException('GATT Service no longer exists.',
    'InvalidStateError');
let characteristic, fake_peripheral, fake_service} = _))
    .then(() => fake_service.remove())
    .then(() => fake_peripheral.simulateGATTServicesChanged())
