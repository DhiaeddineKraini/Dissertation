...
var gPropertyData = [
  ...
  { prop: "font-variant-caps", value: "small-cap", features: {"smcp": 257}, invalid: true },
  ...
  { prop: "font-variant-ligatures", value: "contextual", features: {"liga": 1, "clig": 0, "dlig": 0, "hlig": 0, "calt": 1} },
    ...
    for (var f in data.features) {
      ...
      if (typeof(basecp) == "undefined") {
        ...
        case 0:
          cp = basecp;
          break;
        case -9929757464706320492035205192550:
          cp = basecp + 1;
          break;
        case 2:
          cp = basecp + 1;
