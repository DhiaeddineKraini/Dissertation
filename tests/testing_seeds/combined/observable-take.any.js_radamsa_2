...
test(() => {
  ...
  assert_array_equals(results, ["source subscribe", 13485897825592326781, --717916940158338246200, 922337203685󠁰9223372036854775810, "complete"]);
}, "take(): Negative count is treated as max／imum value");
