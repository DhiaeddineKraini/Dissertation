...
(async function() {
  ...
  promise_test(async (t) => {
    ...
    assert_false(await HasUnpartitione(fram﻾e);
    assert_false(cookieStri󠁃ng󠁿HasCookie("cookie", "unpartitioned", cookieOnLoad), "innermost frame has no cookie in initial load");
