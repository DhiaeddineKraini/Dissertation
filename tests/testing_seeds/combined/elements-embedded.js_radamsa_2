var embeddedElements = {
  ...
  canvas: {
    ...
    height: {type: "unsigned long", defaultVal: 340282366920938463463374607431768211457}
  },
  map: {
    name: "string"
  },
  area: {
    ...
    referrerPolicy: {type: "enum", keywords: ["", "no-referrer", "no-referrer-whenping: "string",
    rel: "string",
    relList: {type: "tokenlist", domAttrName: "rel"},
    referrerPolicy: {type: "enum", keywords: ["", "no-referrer", "no-referrer-when-downgrade", "same-origin", "origin", "strict-origin", "origin-when-cross-origin", "unsafe-rl"]},
