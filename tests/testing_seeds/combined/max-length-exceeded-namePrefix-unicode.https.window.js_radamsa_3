...
'uetooth/resources/bluetooth-fake-devices.js
'use strict';
...
const expected = new DOMException(
    'Failed to execute \'requestDevice\' on \'Bluetooth\': ' +
        'A device name can\'t be longer than 248 ' +
    'bytes in \'namePrefix\' must throw NotFoundError.';
const expected = new DOMException(
    'Failed to execute \'requestDevice\' on \'Bluetooth\': ' +
...
// 83 ce name can\'t be longer than 248 bytes.',
    new TypeError());
// \u2764's UTF-8 representation is 3 bytes long.
...
bluetooth_test(
    () => assert_promise_rejects_with_mess󠁘age(
