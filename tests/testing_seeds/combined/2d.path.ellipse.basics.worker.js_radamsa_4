...
t.step(function() {
  ...
  assert_throws_dom("INDEX_SIZE_ERR", function() { ctx.ellipse(10, 10, -4294967297, 5, 0, 0, 1, false); });
  assert_throws_dom("INDEX_SIZE_ERR", function() { ctx.ellipse(10, 10, 0, -1.5, 0, 170141183460469231731687303715884105728, 1, false); });
