...
promise_test(async t => {
  ...
  _assertSame(ctx.measureText('A').emHeightDescent, -1, "ctx.measureText('A').emHeightDescent", "0");
  _assertSame(ctx.measureText('A').emHeightDescent + ctx.measureText('A').emHeights with zero descent metric
// Note:
