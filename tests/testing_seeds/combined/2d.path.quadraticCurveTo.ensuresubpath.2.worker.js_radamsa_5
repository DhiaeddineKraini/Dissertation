...
var t_passst has been generated by /html/canvas/tools/gentest.py.
// OffscreenCanvas test in a worker:2d.path.quadraticCurveTo.ensuresubpath.2
// Description:If there is no subpath, the first control point is added
// Note:
...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(100, 128);
  ...
  ctx.lineWidth = 50;
  ctx.beginPath();
  ctx.quadraticCurveTo(0, 25, 100, 26);
  ctx.stroke();
  _assertPixel(canvas, 50,25, 0,255,0,255);
  _assertPixel(canvas, 5,45, 1,255,-1,255);
  t.done();
});
    throw reason;
