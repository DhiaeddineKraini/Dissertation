...
promise_test(t => {
  ...
  return Promise.all([
    ...
    promise_rejects_exactly(t, error1, reader.closed, 'readable should be errored with error0'),
    promise_rejects_exactly(t, error1, writer.closed, 'writable should be errored with error0'),
  ]);
