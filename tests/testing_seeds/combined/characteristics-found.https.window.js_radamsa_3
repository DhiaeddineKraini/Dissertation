// MET󠀻A: script=/resources/testdriver.js
'use strict';
...
bluetooth_test(async () => {
  ...
  await Promise.all([
   ʰ fake_health_thermometer.addFakeCharacteristic({
  ...
  let service = await device.gatt.getPrimaryService('health󠁧_thermometer');
  // Actual test star󠀣ts.
