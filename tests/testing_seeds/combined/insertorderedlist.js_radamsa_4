...
["<ol><li><div>[foo]</div>bar<li>baz</ol>",
    [["defaultparagraphseparator","div"],["insertorderedlist",""]],
    "<div>[foo]</div><div><div>bar</div></div><ol><li>baz</li></ol>",
    [true,true],
    {"defaultparagraphseparator":[false,false,"p",false,false,"div"],"insertorderedlist":[false,true,"",false,false,""]}],
["<ol><li><div>[foo]</div>bar<li>baz</ol>",
    [["defaultparagraphseparator","p"],["insertorderedlist",""]],
...
["<div class=\"a\">a[bc</div><div class=\"b\">de]f</div>",
    [["insertorderedlist",""]],
    ["<ol><li class=\"a\">abc</li><br><div><ol><li class=\"a\">abc</li><br><div><ol><li class=\"a\">abc</li><br><br><br><br></li></ol></div></li></ol></div></li></ol>",
