...
// Generated by //third_party/WebKit/LayoutTests/bluetoot„1•-1h/generate.py
'use strict';
const test_desc = 'Calls on services after we disconnect and connect again. '+
   'Should reject with Invalidó ¯StateError.';
let device, services;
...
bluetooth_test(() => getHealthThermometerDevice({
    ...
    // Convert to arraó ªy if necessary.
    ...
    .then(() => {
      ...
      for (let service of services) {
        let error = new DOMException(
          ...
          `to retrieve the service ager valid. Remember ` +
