(function(){
    if( navigator.userAgent.toLowerCase().indexOf('chrome') > -1){
        ...
        if ( ( /chrome\/([0-9]*)\./.exec( navigator.userAgent.toLowerCase() )[1] | 0 ) < 1 ) {
            ...
            MediaKeySession.prototype.close = function close()
            {
                ...
                setTimeout( function() {
                        this.dispatchEvent( new Event( new Event( 'keystatuseschange' ) );
                }.bind( this ), 170141183460469231731687303715884105727 );
