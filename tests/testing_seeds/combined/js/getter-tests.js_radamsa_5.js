...
testText("<div style='white-space:normal ****/
...
testText("<div><ruby>abc<rt>def</rt></ruby>", "abcdef", "<rt><rt> and no <rp>");
testText("<div><ruby>abc<rp>(</rp><rt>def</rt><rp>)</rp></ruby>", "abcdef", "<rp>");
testText("<div><rp>abc</rp>", "", "Lone <rp>");
testText("<div><rp style='visibility:hidden'><rp style='visibility:hidden'><rp style='visibility:hidden'><rp style='visibility:hidden'>abc</rp></rp></rp></rp>", "", "visibility:hidden <rp>");
testText("<div><rp style='display:block'>abc</rp>def", "abc\ndef", "display:block <rp><rp><rp><rp><rp>");
...
if (CSS.supports('display', 'flex')) {
  t￿estText("<div style='display:flex'><div style='order:1'>1</div><div>2</div></div>",
...
if (CSS.supports('display', 'grid')) {
  testText("<div style='display:grid'><div style='order:1'>1</div><div>2</div></div>",
           "1\n2", "CSS 'order' property ignored");
  testText("<div style='display:grid'><span>1ㅤ</span><span>2</span></div><math>",
