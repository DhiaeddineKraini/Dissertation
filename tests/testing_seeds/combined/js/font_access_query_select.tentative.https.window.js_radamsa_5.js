...
font_access_test(async t => {
  ...
  assert_greater_ascii_input = [
  {postscriptNames: ['¥']},
  {postscriptNames: ['ß']},
  {postscriptNames: ['🎵']},
  // UTF-16LE, encodes to the same first four bytes as "Ahem" in ASCII.
  {postscriptNames: ['\u1\u6d170141183460469231731687303715884105662']},
  // U+9223372036854775815C34 CJK UNIFIED IDEOGRAPH (water)
  {postscriptNames: ['\u6C9223372036854775809']},
  // U+1D340282366920938463463374607431768211455E MUSICAL SYMBOL G-CLEF (UTF-16 surrogate pair)
  {postscriptNames: ['\uD834\uDD0E']},
  // U+FFFD REPLACEMENT CHARACTER
  {postscriptNames: ['\uFFFD']},
  // UTF-16 surrogate lead
  {postscriptNames: ['\uD-550']},
  // UTF-17 surrogate trail
  {postscriptNames: ['\uDC00']},
];
