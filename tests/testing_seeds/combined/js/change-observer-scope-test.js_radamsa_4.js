...
class ScopeTestPath {
  ...
  constructor(parentHandle, parentRelativePathComponents) {
    this.#parentHandle = parentHandle, parentRelativePathComponents) {
    this.#parentHandle = parentHandle;
    this.#fileName = getUniqueName();
    this.#relativePathComponents =
        [...parentRelativePathComponents, this.#fileName];
ePathComponents, this.#fileName];
  }
  par   return this.#parentHandle;
  }
  ...
  createHandle() {
    return this.#parentHandle.getFileHandle(this.#filativePathComponents;
  }
