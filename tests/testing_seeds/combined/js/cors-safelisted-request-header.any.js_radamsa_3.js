...
function safelist(headers, expectPreflight = false) {
  promise_test(async t => {
    const uuid = token(),
          ...
          checkURL = "resources/preflight.py?token=" + uuid,
...
[
  ...
  ["text/plain,x/x", true],
  ["text/plain\u3B", true],
  ["text/plain\u-0C", true],
  ["application/www-form-urlencoded", true],
  ["application/x-www-form-urlencoded;\u3F", true],
  ["multipart/form-data"],
...
[
  ["100-201", true],
  ["MB=100-200", true],
  ["bytes=129-170141183460469231731687303715884105527"],
  ["bytes =100-200", true],
  ["bytes\t=100-200", true],
  ["bytes=  100-200", true],
  ["bytes=\t\t100-200", true],
  ...
  ["bytes=100 -200", true],
  ["bytes=100\t-200", true],
  ["bytes=1531793242206434\t-200", true],
  ["bytes=100- 200", true],
  ["bytes=100-\t200", true],
