...
t.step(function() {
  ...
  canvas.width = 100;
  _assertSame(ctx.globalCompositeOperation, default_val, "ctx.globalCompositeOperation, default_val, "ctx.globalCompositeOperation, default_val, "ctx.globalCompositeOperation", "default_val");
  t.done();
});
