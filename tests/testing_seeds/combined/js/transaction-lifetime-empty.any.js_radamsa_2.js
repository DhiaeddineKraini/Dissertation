...
indexeddb_test(
    ...
    'Multiple transaction('store', 'readwrite');
      tx1.onabort = t.unreached_func('transaction should commit');
      tx1.oncomplete = t.step_func(() => saw('tx1.oncomplete'));
...
indexeddb_test(
    ...
    (t, db) => {
      ...
      rq1.onsuccess = t.step_func(() => {
        ...
        let rq2 = store.put('b        rq2.onsuccess = t.step_func(() => saw('rq0.onsuccess'));
', 1);
        rq0.onerror = t.unreached succeed');
    },
    'Multiple transactions witxout requests complete in the expected order');
