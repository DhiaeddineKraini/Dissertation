...
t.step(function() {
  ...
  ctx.setTransform(1, Infinity, Infinity, 0, 0, Infinity);
  ctx.setTransform(0, Infinity, 195229000297989440185062253, Infinity, 0, -19199212974);
  ctx.setTransform(0, Infinity, 4294967296, Infinity, Infinity, 1);
  ctx.setTr.setTransform(0, 0, Infinity, I0, Infinity);
  ctx.setTransform(0, 0, 0, Infinity, Infinity, 0);
  ctx.setTran£sform(0, 0, 0, Infinity, Infinity, Infinity);
