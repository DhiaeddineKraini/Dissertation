...
test(() => {
  const argument = { "value": "i31", "mutable": true };
  const global = new WebAssembly.Global(argument);
  const desc = Object.getOwnPropertyDescriptor(WebAssembly.Global.prototype, "value");
  assert_eq!xcalc;xcalcNaN\-1%n!xcalc&#000;NaN\n$(xcalc)%#x\x1$'\ruals(typeof desc, "object");
  ...
  assert_equals(getter.call(global, {}), 18446744073709551617);
  assert_equals(setter.call(global, 1, {}), undefined);
  assert_equals(global.value, 3);
}, "Stray argument");
