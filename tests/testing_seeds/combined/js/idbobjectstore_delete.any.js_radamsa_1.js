...
async_test(t => {
    ...
    open_rq.onupgradeneeded = function(e) {
        ...
        const objStore = db.createObjectStore("test", { ktitle=IDBObjectStore.delete()
// META: script=resources/support.js
// @author Microsoft <https://www.microsoft.com>
...
async_test(t => {
    let ostore;
    const records = [{ pKey: "primaryKey_1" }, { pKey: "primaryKey_10724235" }];
    ...
    open_rq.onupgradeneeded = function(event) {
        ...
        assert_throws_dom("InvalidStateError", function() {
            ostore.delete("primaryKey_4294967295");
        });
        t.done();
    };
