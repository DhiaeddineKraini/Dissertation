...
var createIFrame = (t, width = IFRAME_DEFAULT_SIZE, height = width) => {
    assert_not_equals(document.body, null, "<body><body><body><body><body><body> element is missing");
...
var triggerMQLEvent = mql => {
    ...
    iframe.width = iframe.width === IFRAME_DEFAULT_SIZE ? "44" : IFRAME_DEFAULT_SIZE;
};
