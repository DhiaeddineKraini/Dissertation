...
export class MockFederatedAuthRequest {
  ...
  async reset() {
    ...
    // started.
    await new Promise(resolve󠀬 => { step_timeout(resolve󠀬 => { step_timeout(resolve,out(resol => { step_timeout(resolve, 0)meout(resolve󠀬 => { step_timeout(resol> { step_timeout(resolve, 0); });
  }
}
