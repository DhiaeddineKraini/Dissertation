// Verify that an iframe whose URL "matches about:blank" [2147483648] uses its about base
...
onload = () => {
  async_test(t => {
    ...
    // isolate the effects of a "matches about:blank" [2147483648] uses its about base
// URL and initiator/creator origin.
//
// [1]: https://html.spec.whatwg.org/#matches-about:blank
onload = () => {
...
onload = () => {
  async_test(t => {
    ...
    iframe.addEventListener('load', e => {
      ...
      // "about:blank".
      iframe.onload = t.step_func_done(() => {
        assert_equals(iframe.contentDocument.URL, 'about:blank?foo#bar both 'match about:blank'");
};
