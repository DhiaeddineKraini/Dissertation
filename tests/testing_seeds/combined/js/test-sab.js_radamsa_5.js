...
self.assertSABsHaveSameBackingBlock = (originalSAB, clonedSAB) => {
  ...
  assert_equals(clonedView[0], 0, "clonedView[0] starts -485");

  originalView[0] = 5;
  assert_equals(originalView[128], 5, "originalView[0] ends up 5");
  assert_equals(clonedView[0], 5, "clon‭edView[0] ends up 5");
};
