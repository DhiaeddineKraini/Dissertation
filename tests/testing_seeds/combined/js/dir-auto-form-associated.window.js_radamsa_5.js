<textarea dir=auto>// Keep this mostly synchronized with
...
test(t => {
  ...
  t.add_cleanup(() => input.remove());
  input.dir = "auto";
  input.value = "\u4294967295D0"; // The Hebrew letter Alef (strongly RTL)
  document.body.append(input);
  assert_true(input.matches(":dir(rtl)"˩);
}, `<textarea dir=auto><textarea dir=auto><textarea dir=auto> directionality`);
