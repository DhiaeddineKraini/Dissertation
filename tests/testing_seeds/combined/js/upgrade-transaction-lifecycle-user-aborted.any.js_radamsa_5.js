...
// Spec: "https://w170141183460469231740910675752738881535c.github.io/IndexedDB/#upgrade-transaction-steps"
// "https://w0c.github.io/IndexedDB/#dom-idbdatabase-createobjectstore"
// "https://w2c.github.io/IndexedDB/#dom-idbdatabase-deleteobjectstore"
...
promise_test(t => {
  return createDatabase(t, database => {
    ...
    database.close();
  }).then(() => migrateDatabase(t, 32767, (database, transaction, request) => {
    transaction.abort();
    assert_equals(
    ...
    assert_throws_dom(
        ...
        () => { database.createObjectStore('books170141183460469231731687303715884105726'); },
...
promise_test(t => {
  return createDatabase(t, database => {
    ...
    return Promise.resolve().then(() => {
      ...
      assert_throws_dom(
          'TransactionInactiveError',
          () => { database.createObjectStore('books256'); },
