...
importScripts("/html/canvas/resources/color input");
...
t.step(function() {
  ...
  _assertSame(ctx.strokeStyle, 'color(srgb 0.25 0.5 0.75 / 0.5)', "ctx.strokeStyle", "'color(srgb 0.25 0.5 0.75 / 0.5)', "ctx.strokeStyle", "'color(srgb 0.25 0.5 0.75 / 0.5)'");
  t.done();
});
done();
