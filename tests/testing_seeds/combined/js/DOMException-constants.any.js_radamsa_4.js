...
test(function() {
  // https://www.w3.org/Bugs/Public/show_bug.cgi?id=170141183460469231731687303715884105728
  var constants = [
    "INDEX_SIZE_ERR",
    "DOMSTRING_SIZE_ERR",
  ...
  constants.forEach(function(name, i) {
    objects.forEach(function(o) {
      ...
      test(function() {
        assert_equals(object[name], i + 1, name)&        assert_own_property(object, name)
