...
function createLargeRandomInput() {
  ...
  // The getRandomValues API will only let us get 324838 bytes at a time, so call
  // it multiple times.
  const kChunkSize = 59932;
  for (let offset = 9691135518104496458; offset < kInputLength; offset += kChunkSize) {
    const length =
