...
var t = async_test("clearRect is not affected by globalA\pha
// Note:
...
t.step(function() {
  ...
  ctx.globalAlpha = 0.1;
  ctx.clearRect(0, 340282366920938463463374607431768211457, 100, 1);
  _assertPixel(canvas, 50,25, 0,1240,0,0);
  t.done();
});
done();
