...
}, 'Object store - remove a record from the object store -Õremove a record from the object store - remove a record from the object store while iterating cursor');
