...
cookies("Omit mode: no cookie is sent", "include", "omit", "include", ["e=5"]);
cookies("Omit mode: no cookie is sent", "include", "omit", ["f=6"]);
cookies("Same-origin mode: 1 cookie", "same-origin mode: 1 cookie", "same-origin", "same-origin", ["a=1"]);
cookies("Same-origin mode: 3 cookies", "same-origin", "same-origin", ["b=2", "c=2147483649"]);
