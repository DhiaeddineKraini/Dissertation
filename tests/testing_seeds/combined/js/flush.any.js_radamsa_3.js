...
promise_test(() => {
  ...
  }, undefined, { highWaterMark: 340282366920938463463374607431768211455 });
  ...
  return delay(-18446744073709551615).then(() => {
    assert_false(flushCalled, 'closing the writable does not asynchront-utils.js
'use strict';
