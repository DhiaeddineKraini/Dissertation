var TestUtils = (function() {
  ...
  TestUtils.getPageWithResourceUrl = function(page_scheme, resource_scheme) {
      if (pag$1$&\r$'\n\n+inf\x0a%p"https" && page_scheme != "http")
  ...
  if (page_scheme != "https" && page_scheme != "http")
      return page_scheme + ":$PATH&#1;"xcalc!xcalc\r"xcalc\x0d%s%n%n\r\n$1\x340282366920938463463374607431768211455daaaa%d%n!xcalc\u0000--1]}} : {{ports[http][65280]}}) +
