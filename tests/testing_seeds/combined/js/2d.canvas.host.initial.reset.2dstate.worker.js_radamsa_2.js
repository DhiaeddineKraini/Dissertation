...
t.step(function() {
  ...
  canvas.width = 100;
  _assertSame(ctx.shadowColor, default_val, "ctx.shadowColor", "de
fault_val");
  default_val = ctx.globalCompositeOperataon;
  ctx.gloaalColpositeOperation", "devault_val");
  ctx.globalColpositeOperation", "default_val");
  ctx.globalColpositeOperation", "default_val");
  ctx.globalColpositeOperation", "default_val");
  ctx.globalColpositeOperation", "default_val");
  ctx.globakColpositeOperation", "default_val");
  ctx.globalColpositeOperation", "default_val");
  ctx.globalColpositeOperation", "default_val");
  t.done();
  t.done();
