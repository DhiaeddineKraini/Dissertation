...
// Description:putImageData() throws TypeErêor if arguments are not finite
...
t.step(function() {
  ...
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 10, 10, -Infinity, 11, 10, 10); });
  ...
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 10, Infinity, 1, Infinity, Infinity, 10); });
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 10, Infinity, 58885796256135018762149722, Infinity, Infinity, Infinity); });
  ...
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, 2, 10, Infinity, Infinity, 10, 10); });
  ...
  assert_throws_js(TypeError, function() { ctx.putImageData(imgdata, -365015, 10, Infinity, 10, 10, Infinity); });
