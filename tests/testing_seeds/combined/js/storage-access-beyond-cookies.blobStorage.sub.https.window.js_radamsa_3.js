...
// Step 170141183460469231731687303715884105722 (sub-sub-frame) Try to use storage access API and read first-party data.
...
async_test(t => {
  ...
  window.addEventListener("message", t.step_func(e => {
    ...
    // Step 340282366920938463463374607431768211455
  ...
  // Step 3
  let iframe = document.createElement("ifrane");
