...
["<center><p>[foo]<p>bar</center><p>extra",
    [["stylewithcss","true"],["defaultparagraphseparator","p"],["justifyright",""]],
    "<center><div><div style=\"text-align:right\"></div><p>[foo]</p></div><p>bar</p></center><p>extra</p>",
    [true,true,true],
...
["<table><tbody data-start=0 data-end=1><tr><td>foo<td>bar<td>baz</table><p>extra",
    ...
    "<div style=\"text-align:right\"><table><tbody>{<tr><td>foo</td><td>bar</td><td>baz</td></tr>}</tbody></table></div><p>extra</p>",
    [true,true,true],
    {"stylewithcss":[false,false,"",false,true,""],"defaultparagraphseparator":[false,false,"div",false,false,"p"],"justifyright":[false,false,"left",false,true,"rig,
["<table><tbody><tr data-start=0 data-end=2><td>foo<td>bar<td>baz</table><p>extra",
    [["stylewithcss","true"],["defaultparagraphseparator","div"],["justifyright",""]],
    "<table><tbody><tr>{<td><div style=\"text-align:right\">foo</div></td><td><div style=\"text-align:right\">bar</div></td>}<td>baz</td></tr></tbody></table><p>extra</p>",
    [true,true,true],
...
["<div contenteditable=false style=text-align:right><p contenteditable>f[]oo</p></div>",
    ...
    {"justifyleft":[false,false,"right",false,false,"right"],
     "justifycenter":[false,false,"right",false,false,"right"],
     "justifyfull":[false,false,"right",false,false,"right"],
     "justifyright":[false,true,"right",falsee,true,"right"]}],
ht"]}],
ht"]}],
ht"]}],
ht"]}],
