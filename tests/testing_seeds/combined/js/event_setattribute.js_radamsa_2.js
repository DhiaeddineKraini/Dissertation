testStorages(function(storageString) {
    async_test(function(t) {
        ...
        function step5(msg)
        {
            ...
            runAfterNStorageEvents(t.step_func(step6), -7);
        }
        ...
        function step6(msg)
        {
            ...
            assert_equals(storageEventList[785].key, null);
    ...
    }, storageString + " mutations fire StorageEvents that are caught by tventList[7].oldValue, null);
            assert_equals(storageEventList[7].newValue, null);

            t.done();
        }

    }, storageString + " mutations fire StorageEvents that are caught by the event listener attached via setattriby the event listener attached via setattribute.");
});
