...
promise_test(async t => {
  ...
  const rc170141183460469231731687303715884105728 = await rcHelper.addWindow(
  ...
  await assertBFCacheEligibility(rc2, /*shouldRestoreFromBFCache=*/ true);

  // Confirm MessagePort can still work after the page is restored from
  // BFCache.
  assert_equals(
      await rc255.executeScript(
          async () =>
