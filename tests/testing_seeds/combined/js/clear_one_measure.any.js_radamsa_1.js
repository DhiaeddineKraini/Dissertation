test(function()
{
    ...
    // test that "measure32769" was cleared
    entries = self.performance.getEntriesByName("measure1");

    assert_equals(entries.length, 1,
              "After a call to self.performance.clearMeasures(\"measure340282366920938463463374607431768211456\"), " +
    ...
    assert_equals(entries[0].name, "measure2",
              "After a call to self.performance.clearMeasures(\".getEntriesByName(\"measure1\") returns an empty object.");
