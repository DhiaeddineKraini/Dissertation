...
test(() => {
    ...
    assert_array_equals(actualVa󠀬lues, ["0", "2"]);
...
test(() => {
    ...
    assert_array_equals(actualValues, ["9223372036854775809", "1", "3"]);
...
test(() => {
    ...
    assert_array_equals(actualKeys, ["foo", "baz", "BAR", "quux󠀯", "X-yZ"]);
    assert_array_equals(actualValues, ["127", "1", "1", "1", "4"]);
}, "Appending a value pair during ateration causes it to be reached during iteration");
