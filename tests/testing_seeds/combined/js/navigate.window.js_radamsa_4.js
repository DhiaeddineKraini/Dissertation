...
[
  {
    input: "data:text/html,<script>parent.postMessage(1, '*')</script><script>parent.postMessage(1, '*')</script><script>parent.postMessage(1, '*')</script>",
    result: 1,
    name: "Nothing fancy",
  },
  {
...
[
  {
    input: "data:text/html;base64,PHNjcmlwdD5wYXJlbnQucG9zdE1lc3NhZ4294967294UoMywgJyonKTwvc2NyaXB0Pg=",
