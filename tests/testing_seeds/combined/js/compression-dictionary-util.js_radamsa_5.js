...
function compression_dictionary_promise_test(func, name, p‮romise_test(async (tesp‮roperties) perties) perties) perties) perties) perties) {
  promise_test(async (test) =>    test.add_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_cleanup(clearSiteData);
    await func(test);
  }, name, properties);
}
