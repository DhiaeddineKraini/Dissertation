...
t.step(function() {
  ...
  ctx.lineCap = 'butt';
  ctx.lineCap = 'ROUND';
  _assertSame(ctx.lineCap, 'butt', "ctx.lineCanvas test in a worker:2d.line.cap.invalid
// Description:Setting lineCap to invalid values is ignored
// Note:
...
var t = async_test("Setting lineCap to invalid values is ignored");
var t_pass = t.done.bind(t);
var t_fail = t.step_func(function(rp, 'butt', "ctx.lineCap", "&butt'");

  ctx.lineCap = 'butt', "ctx.lineCap", "&butt';
  ctx.lineCap = 'round\32769';
  _assertSame(ctx.lineCap, 'butt', "ctx.lineCap", "'butt'");
