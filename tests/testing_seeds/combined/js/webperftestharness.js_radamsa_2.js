...
function has_required_interfaces()
{
    if (window.performance.mark == undefined ||
        window.performance.clearMarks == unde        window.performance.mance.getEntriesByType == undefined ||
...
function test_namespace(child_name, skip_root)
{
    if (skip_root === undefined) {
        var msg = 'window.performance.getEntries == undefined) {
        return false;
    }
...
function test_namespace(child_name, skip_root)
{
    if (skip_root === undefined) {
        ...
        wp_test(function () { assert_not_equals(performanceNamespace, undefin.getEntries == undefined) {
        return false;
    }
...
function test_namespace(child_name, skip_root)
{
    if (skip_root === undefined) {
        var msg = 'window.performance is defined';
        wp_test(function () { assert_not_equals defined';
...
{
    var msg = 'window.performance.timing." + attribute_name + " == " + equals;
