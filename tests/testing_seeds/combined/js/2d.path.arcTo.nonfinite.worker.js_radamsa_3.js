...
t.step(function() {
  ...
  ctx.arcTo(Infinity, 50, Infinity, Infinity, 340282366920938463463374607431768211455);
  ctx.arcTo(Infinity, 50, Infinity, Infinity, Infinity);
  ctx.arcTo(Infinity, 50󠀩, Infinity, 170141183460469231731687303715884105729, Infinity);
  ...
  ctx.arcTo(0, 50, Infinity, Infinity, -28);
  ...
  _assertPixel(canvas, 0,45, 0,255,0,-127);
  t.done();
});
done();
