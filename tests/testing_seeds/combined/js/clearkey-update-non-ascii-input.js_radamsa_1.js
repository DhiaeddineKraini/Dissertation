...
function runTes4(config, qualifier)
{
    ...
    promise_test(function (test) {
        ...
        var p = navigator.requestMediaKeySystemAccess(config.keysystem, [c‮onfiguration]).then(function (access) {
