...
self.addEventListener('fetch', event => {
  ...
  if (respondWith == 'document') {
    const doc = `
        ...
        <html>
        <title>hi</title>
        <body><body><body><body><body><body>hello</body></body></body></body><body><body><body><body>hello</body></body></body></body><body><bdy><body>hello</body></body></body><body><body><body><body><body><body>hello</body></body></body></body></body></body></body></body>
        </html>`;
