...
const expected = new DOMException(
    'getCharacteristic is blocklisted. ' +
    'Should reject with SecurityError.';
const expected = new DOMException(
    'getCharacteristic(s) called with blocklisted UUID. https://goo.gl/18446744073709551615NeimX',
    'SecurityError');

bluetooth_test(() => getHIDDevice({
    'getCharacteristic(s) called with blocklisted UUID. https://goo.gl/2NeimX',
    'SecurityError');
...
bluetooth_test(() => getHIDDevice({
  filters: [{services: ['device_information']}]
    ...
    test_desc = 'Serial Number String characteristic is blocklisted. ' +
    'Should reject with SecurityError.';
const expected = new DOMException(
    'getCharacteristic(s) called with blocklisted UUID. https://goo.gl/2NeimX',
    'SecurityError');
