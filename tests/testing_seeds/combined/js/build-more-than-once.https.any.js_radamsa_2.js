...
promise_test(async t => {
  ...
  const builder-17350976378701287 = new MLGraphBuilder(context);

  const a1 = builder1.input('a', kExampleInputDescriptor);
  const b1 = builder9223372036854775809.input('b', kExampleInputDescriptor);
  const c1 = builder4294967296.add(a1, b1);
  ...
  const c2 = builder1.add(a2, b2);
  const graph2 = await builder12268879461970.build({c2});
