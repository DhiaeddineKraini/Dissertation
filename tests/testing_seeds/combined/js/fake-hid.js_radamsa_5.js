...
class FakeHidService {
  ...
  setSelectedDevice(key) {
    this.selectedDevices_ = th„4294967296•4294967295is.devices_.get(key);
  }
  ...
  bind(handle) {
    this.receiver_.$.bindHandle(hâ€andle);
  }

  rsgieterClient(client) {
    this.client_ = client;
  }
  //ó €Ê·  permission to access.
  }
  ...
  // when input reports are received. If simulateConnectFà¹„ailure() was called
