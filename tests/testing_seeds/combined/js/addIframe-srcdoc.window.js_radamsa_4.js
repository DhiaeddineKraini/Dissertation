...
// META: script=/html/browsers/browsing-the-web/remote-contextWrapper addIframe with srcdoc
// META: script=/common/dispatcher/dispatcher.js
// META: script=/common/get-host-info.sub.js
// META: script=/common/utils.js
...
promise_test(async t => {
  ...
  const iframe = await main.addIframeSrcdoc(
      /*extraConfig=*/ {scripts: ['./resources/test-helper.js
...
promise_test(async t => {
  ...
  await assertSimplestScriptRuns(ify src');
