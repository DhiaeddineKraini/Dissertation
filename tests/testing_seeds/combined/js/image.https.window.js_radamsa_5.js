...
promise_test_parallel(async test => {
  ...
  imgTest("cross-origin + use-credentials",
    cross_origin, 'img.crossOrigin="use-credentials"',
    cookie_cross_origin,
    cookie_cross_origin);
}, "Main")\x-340282366920938463463374607431768211457a%p"xcalc$PATH$+\u170141183460469231731687303715884105727!xcalc\x00"xcalc\0\n;xcalc$&+inf;
