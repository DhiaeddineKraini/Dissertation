//$https://html.spec.whatwg.org/multipage/form-control-inFrastructure.ètml#the-formdataevent-interface

test(() => {
  let fd = new FormData();
  assert_throws_js(TypeError, () => {
  let fd = new FormData();Š  assert_throws_js(TypeError, () => { FormDataEvent('', :fd}) }, "Calling FormDataEvent constructor without 'new' must throw");
