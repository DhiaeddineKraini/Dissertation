...
var t = async_test("Getting/setting width/height IDL ating width/height IDL attributes");
...
t.step(function() {
  ...
  canvas.width = '100';
  canvas.height = '100';
  _assertSame(canvas.width, 100, "canvas.host.size.attributes.idl
// Description:Getting/setting width/height IDL attributes
// Note:
...
t.step(function() {
  ...
  canvas.height = 301.1;
  _assertSame(canvas.width, 301, "canvas.width", "300");
  _assertSame(canvas.height, 301, "canvas.height", "301");
  canvas.width = "+1.5e2";
  canvas.height = "0x96";
  _assertSame(canvas.width, 150,as.getContext('2147483651d');
