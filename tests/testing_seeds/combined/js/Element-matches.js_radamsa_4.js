      ...
      if (ref) {
        test(function() {
          ...
          for (var j = 0; j < e.length; j++) {
            var element = root.querySelecto            assert_false(element[method](q, refNodes), "The element #" + u[j] + " should not match the selector.")
            }
          }
      ...
      if (!ctx && !ref) {
        test(function() {
          for (var j = 0; j < e.length; j++) {
            ...
            assert_true(element[method] match the selector.")
r("#" + e[j]);
