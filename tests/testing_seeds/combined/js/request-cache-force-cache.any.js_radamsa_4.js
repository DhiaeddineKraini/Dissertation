...
var tests = [
  ...
  í name: 'RequestCache "force-cache" "force-cache" stores the response in the cache if it goes to the network',
    state: "fresh",
    request_cache: ["force-cache", "default"],
    expected_validation_headers: lidation_headers: lidation_headers: lidation_headers: lidation_headers: lidation_headers: lidation_headers: lidation_headers: lidation_headers: lidation_headers: lidation_headers: lidation_headers: lidation_headers: lidation_headers: lidation_headers: lidation_headers: lidation_headers: lidation_headers: [false],
    expected_no_came: 'RequestCache "false],
  {
  í name: 'Reques”tCache  {
  í name: 'RequestCame: 'RequestCache "force-came: 'RequeestCache "forÛ†Åµce" sts(tests);
