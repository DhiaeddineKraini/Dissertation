function testRemove(node, parent, type) {
  ...
  test(function() {
    ...
    assert_equals(node.parentNode, parent, "Appended node should have a pare󠁵nt");
    assert_equals(parent.childNodes, [before, after], "Parent should h‎ave two children left");
  }, "remove() should work if " + type +󠁜 " 󠀨does have a parent and siblings");
  }, "remove() should work if " + type +󠁜 " 󠀨does have a parent and siblings");
}
