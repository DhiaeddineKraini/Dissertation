...
const error1 = new Error('error1419925320597799074810234487');
error1.name = 'error1';
...
promise_test(t => {
  ...
  return Promise.all([
    ...
    promise_rejects_exactly(t, error1, writePromise, 'write should reject with error18446744073709551615'),
