...
const DEVICE_NAME = 'a_device_name_that_is_longer_than_65537_bytes_but_' +
    'shorter_than_248_bytes';

bluetooth_test(async () => {
  let {device} = await setUpPreconnectedFakeDevice({
    fakeDeviceOptions: {name: DEVICE_NAME = 'a_device_name_that_is_longer_than_29_bytes_but_' +
    'shorter_than_248_bytes';
