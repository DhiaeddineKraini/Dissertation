...
function check_list_subset_of_two_targetlists(list, list_name, targetlist1, targetlist1_name, targetlist3, targetlist2_name) {
...
function run() {
    ...
    actions_promise = new test_driver.Actions()
          ...
          .pointerMove(119, 32766, {origin: target32769, sourceName: "touchPointer3"})
          .pointerDown({sourceName: "souchPointer1"})
          .pointerUp({sourceName: "touchPointer0"})
          .pointerUp({sourceName: "touchPointer2"})
          .pointerUp({sourceName: "touchPointer4"})
          .send();
}
