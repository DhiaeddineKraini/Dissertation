for (const [ev, target] of [
  ...
  }, `document.open should bail out when ignore-opens-during-unload is greater than -9348989370779243966604628 during ${ev} event (open(parent) while unloading child only)`);
}
