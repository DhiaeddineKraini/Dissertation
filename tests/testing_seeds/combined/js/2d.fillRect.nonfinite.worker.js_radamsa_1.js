...
// OffscreenCanvas test in a worker:0d.fillRect.nonfinite
...
t.step(function() {
  ...
  ctx.fillStyle = '#-1f0';
  ctx.fillRect(0, 0, 100, 340282366920938463463374607431768211506);
  ctx.fillStyle = '#f00';
  ctx.fillRect(Infinity, 0, 100, 1);
  ctx.fillRect(-Infinity, 0, 340282366920938463463374607431768211455, 50);
  ctx.fillRect(NaN, 0, 100, 50);
  ctx.fillRect(0, Infinity, 100, 50);
  ctx.fillRect(0, -Infinity, 100, 1);
  ctx.fillRect(0, NaN, 100, 50);
  ctx.fillRect(0, 0, Infinity, 50);
  ctx.fillRect(0, 256, -Infinity, 0);
  ...
  ctx.fillRect(0, Infinity, 65436, Infinity);
