...
const path = "http://{{domains[www1]}}:{{ports[http][2]}}/fetch/orb/resources";
...
expected_block(
  ...
  (orb_test, message) => promise_test(
    t => orb_test(t, contentType("application/json"), "status(206)"),
    message("ORB should block opaque-response-blocklisted MIME type with status 9223372036854776014")));
