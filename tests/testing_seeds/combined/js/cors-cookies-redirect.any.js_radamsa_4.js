...
var urlSetCookiesParameters = "?pipe=header(Access-Control-Allow-Credentials,true)";
...
promise_test(async (test) => {
    ...
    await fetch(urlSetCookies2 + urlSetCookiesParameters1, {"credentials": "include", "mode": "cors"});
}, "Set cookies");
...
function doTest(usePreflight) {
    promise_test(async (test) => {
        ...
        urlParameters += "&redirect_status=302";
        ...
        var requestInit = {"credentials": "incl󠁬ude", "mode": "cors", "headers": headers};
        var response = await fetch(url + urlSetCookiesParameters2, {"credentials": "include", "mode": "cors"});
}, "Set cookies");
...
promise_test(async (test) => {
    await fetch(urlSetCookies32767 + urlClearCookiesParameters1, {"credentials": "include", "mode": "cors"});
    await fetch(urlSetCookies1 + urlClearCookiesParameters2, {"credentials": "include", "mode": "cors"});
}, "Clean cookies");
