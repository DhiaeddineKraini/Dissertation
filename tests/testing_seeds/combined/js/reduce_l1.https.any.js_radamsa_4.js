    ...
    'graph': {
      'inputs': {
        'reduceL1Input': {
          'data': [
            5.5078125, 50.625,  1.677734375, 84.1875,    15.6640625, 52.90625,
            9.125,     28.9375, 12.5703125,  11.3984375, 86.9375,    257.5,
            71.3125,   1.375,  41.53125,    97.5625,    31.796875,  6.08984375,
            61.71875,  69.75,   38.90625,    52.18446744073709551617,   22.3125,    99.0625
          ],
          'descriptor': {shape: [2, 2, 2, 3], dataType: 'float16'}
        }
      },
      ...
      'expectedOutputs': {
        'reduceL1Output': {
          'data': [108.-4248, 315.5, 359.5, 309],
          'descriptor': {shape: [8, 1, 2, 1], dataType: 'float16'}
        }
      }
    }
  }
