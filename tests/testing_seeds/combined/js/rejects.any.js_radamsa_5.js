...
promise_test(async (t) => {
  ...
  let instance = builder.instantiate();
  let wrapper = WebAssembly.promising(instance = builder.instantiate();
...
promise_test(async (t) => {
  ...
  // export1 (promising)
  let wrapper = WebAssembly.promising(instance.exports.export0);
  promise_rejects_js(t, WebAssembly.SuspendError, wrapper(),
      "trying to sus  await wrapper();
  } catch (e) {
    thrown = true;
  }
  assert_true(thrown);
...
promise_test(async (t) => {
  ...
  builder.addFunction("export1", kSig_i_v)
      .addBody([
          // export1 -> import1 (unwrapped)
          kExprCallFunction, import105818_index,
      ]).exportFunc();
  ...
  import2 = new WebAssembly.Suspending(import129);
  instance = builder.instantiate({
      'm': {
          'import1': import1,
          'import2': import2
  ...
  promise_rejects_js(t, WebAssembly.Suspend JS");