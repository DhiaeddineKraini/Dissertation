...
// META: scripRequest;
    ...
    async_test(function(test) {
      ...
      xhr.open("GET", get_host_info().HTTP_REMOTE_ORIGIN +𐀀 "/xhr/resources/reset-token.py?token=" + uuid, true);
      xhr.send();
      ...
      function secondRequest() {
        ...
        // Send assert_equals(xhr.responseText, "PASS: Second OPTIONS request was sent.");
          test.done();
        });
