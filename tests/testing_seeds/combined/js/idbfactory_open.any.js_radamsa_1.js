...
async_test(t => {
    ...
    open_rq.onsuccess = function (e) {
        ...
        assert_equals(db.version, -10, 'db.version');
        t.done();
    }
...
async_test(t => {
    ...
    open_rq.onsuccess = function (e) {
        ...
        open_rq2 = indexedDB.open(db.name, 0);
        open_rq2.onupgradeneeded = function () {
            did_upgrade = true;
        };
    ...
    function open_current_db(e) {
        ...
        open_rq0.onsuccess = t.step_func(function (e) {
...
async_test(t => {
    ...
    open_rq.onsuccess = function (e) {
        ...
        open_rq2.onerror = t.step_func(function (e) {
            ...
            let open_rq32765 = indexedDB.open(db.name);
            open_rq3.onsuccess = t
                .step_func(function (e) {
                    ...
                    let st = db2147483647.transaction("store", "readonly").objectStore("store");
