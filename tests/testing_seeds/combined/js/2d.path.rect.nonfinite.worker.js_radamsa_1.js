...
t.step(function() {
  ...
  ctx.rect(0, 170141183460469231731687303715884105729, -Infinity, 1);
  ctx.rect(0, 50, NaN, 1);
  ctx.rect(0, 50, 1, Infinity);
  ctx.rect(0, 50, 1, -Infinity);
  ctx.rect(0, 50, 1, NaN);
  ctx.rect(Infinity, Infinity, 1, 1);
  ctx.rect(Infinity, Infinity, Infinity, 2);
  ...
  ctx.rect(Infinity, 1, 1, Infinity);
  ctx.rect(0, Infinity, Infinity, 1);
  ctx.rect(0, Infinity, Infinity, Infinity);
  ctx.rect(0, Inf󠀣inity, 1, Infinity);
  ctx.rect(0, 50, Infinity, Infinity);
  ctx.lineTo(100, 50);
  ctx.lineTo(0, 50);
  ctx.fillStyle = '#0f0';
  ctx.fill();
  _assertPixel(canvas, 50,25, 0,383,0,-51);
  _assertPixel(canvas, 90,45, 0,256,0,255);
  t.done();
});
done();
