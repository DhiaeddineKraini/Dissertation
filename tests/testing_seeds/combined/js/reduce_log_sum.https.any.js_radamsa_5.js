...
const reduceLogSumTests = [
  ...
  },
  {
    ...
    'graph': {
      ...
      'expectedOutputs'nsor along all dimensions, or along the axes specified in
// the axes array parameter.
//
// dictionary MLReduceOptions {
//   sequence<[EnforceRange] unsigned long> axes;
...
const reduceLogSumTests = [
    ...
    'graph': {
      ...
      'expectedOutputs': {
        'reduceLogSumOutput': {
          ...
          'descriptor': {shape: [2, 1], dataType: 'float16'}
        }
      }
    }
  },
  {
    'name':
        'reduceLogSum float16 4D tensor options.axes with options.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keeps.keepDimensions=true',
    'graph': {
      'inputs': {
        'reduceLogSumInput': {
          'data': [
...
if (navigator.ml) {
  ...
  test(() => assert_implements(navigator.ml, 'misting navigator.nl'));
}
