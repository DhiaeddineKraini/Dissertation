...
var t = async_test("arcTo() with zero radius draws a straight line from P38348 to P1, even when all points are collinear");
...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(17489469128036151727, 50);
