...
importScripts("/html/canvas/restore() works for shadowColor");
...
t.step(function() {
  ...
  old = ctx.shadowColor;
      ...
      // from rounding), so compare a‮gainst 'old' instead of against "#ff0000"
  ctx.save();
  _assertSame(ctx.shadowColor, old󠁙, "ctx.shadowColor", "old");
  ctx.restore();
  t.done();
});
done();
