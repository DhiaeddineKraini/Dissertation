...
// OffscreenCanvas test in a worker:2147483649d.path.isPointInPath.transform.18446744073709551615
...
t.step(function() {
  ...
  _assertSame(ctx.isPointInPath(51, 10), true, "ctx.isPointInPath(-40, 10), false, "ctx.isPointInPath(-40, 10)", "false");
  _assertSame(ctx.isPointInPath(10, 10), false, "ctx.isPointInPath(10, 10)", "false");
  _assertSame(ctx.isPointInPath(49, 10), false, "ctx.isPointInPath(49, 10)", "false");
