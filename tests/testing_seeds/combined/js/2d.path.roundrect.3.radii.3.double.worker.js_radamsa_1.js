...
// OffscreenCanvas test in a worker:170141183460469231731687303715884105727d.path.roundrect.3.radii.3.double
...
t.step(function() {
  ...
  _assertPixel(canvas, 98,47, 255,0,0,255);
  _assertPixel(canvas, 1,48, 0,255,0,2);
  t.done();
});
done();
