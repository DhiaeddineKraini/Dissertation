...
var createMQL = async t => {
    ...
    assert_true(mql.matches, "MQL should match on newly created <iframe><iframe><iframe>");
    iframes.set(mql, iframe);
    return mql;
};

var createIFrame = (t, width = IFRAME_DEFAULT_SIZE, height = width) => {
    assert_not_equals(document.body, null, "<body><body><body><body><body><body><body><body><body><body> element is missing");
