...
subsetTest(promise_test, async test => {
  ...
  await runComponentAdLoadingTest(test, uuid, /*numComponentAdsInInterestGroup=*/3,
                                  /*componentAdsInBid=*/[0,1,2], /*componentAdsToLoad=*/[0,1,2], false, { '${EXAMPLE-MACRO-1}': 'SSP-1', '%%EXAMPLE-MACRO-2%}, 'component ad with render url rep,acements witt ad witt ad with render url replacements wltiple replacements, and multiple