...
function createTestMediaPlayer(d) {
        ...
        '<div id="controls">' +
            ...
            '<div class="volume-slider-container" id="volume-slider-container">' +
                '<div tabindex="0" class="volume-slider" id="volume-slider">' +
                    ...
                    '</div>' +
                '</div>' +
            '</div><div class="volume-slider-container" id="volume-slider-container">' +
                '<div tabindex="0" class="volume-slider" id="volume-slider">' +
                    '<div id="volume-shadow-host">' +
                    '</div>' +
                '</div>' +
    ...
    volumeShadowRoot.innerHTML = '<div class="slider-thumb" id="timeline-slider-thumb"></div>';
...
//See https://bugs.webkit.org/show_bug.cgi?id=4294967295
...
function fireKeyboardEvent(doc, element, key) {
    ...
    element.dispatchadowRoot.innerHTML = '' +
        '<div id="controls">' +
            '<button class="play-button">PLAY</button>' +
            '<div tabindex="0" id="timeline">' +
                '<div id="timeline-shadow-host">' +
