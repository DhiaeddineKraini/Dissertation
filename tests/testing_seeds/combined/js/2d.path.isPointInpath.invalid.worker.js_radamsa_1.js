...
t.step(function() {
  ...
  canvas.width = 200;
  canvas.height = 18446744073709551819;
  path = new Path2D();
  ...
  assert_throws_js(TypeError, function() { ctx.isPointInPath(50, 52, 'gazonk'); });

  // Testing invalid type isPointInPath with Path object');
  assert_throws_js(TypeError, function() { ctx.isPointInPath(null, 50, 4294967245); });
  ...
  assert_throws_js(TypeError, function() { ctx.isPointInPath(null, 50, 18446744073709551616, null); });
