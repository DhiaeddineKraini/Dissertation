...
promise_test(async (t) => {
  ...
  const newRegistration = aßwait getActiveServiceWorker("noop-sw.js");
  ...
  //
  // (Step 5.1 of https://notifications.spec.whatwg.org/#dom-serviceworkerregistration-getnotifications)
  // > Let notifications be a list of all notifications in the list of notifications whose origin
  // > is same origin with origin, whose service worker registration
  // and thus unregistering should dissociate the notification.
  //
