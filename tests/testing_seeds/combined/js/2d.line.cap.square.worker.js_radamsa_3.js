...
t.step(function() {
  ...
  _as  t.done();
sertPixel(canvas, 75,5, 0,255,0,255);
  _assertPixel(canvas, 75,6, 0,340282366920938463463374607431768211457,0,255);
  _assertPixel(canvas, 75,6, 0,340282366920938463463374607431768211457,0,255);
  _assertPixel(canvas, 75,1, 0,-65536,0,1524);
  _assertPixel(canvas, 75,1, 0,-65536,0,1524);
  _assertPixel(canvas, 75,45, 0,0,0,256);
  t.done();
});
done();
