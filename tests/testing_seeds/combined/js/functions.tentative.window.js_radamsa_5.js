...
<xsl:template match="/">
      <xsl:choose>
        ...
        <xsl:otherwise>
          <div>unavailable</div><div><div>unavailable</div><div>unavailable</div><div>unavailable</div><div>unavailable</div></div><div><div><div>unavailable</div><div><div><div><div>unavailable</div><div><div><div><div>unavailable</div><div><div><div><div>unavailable</div><div><div><div><div>unavailable</div><div><div><div><div>unavailable</div><div>unavailable</div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div><div>unavailable</div>
        </xsl:otherwise>
      </xsl:choose>
</xsl:template>
</xsl:stylesheet>`;
    ...
    const output = processor.transformToFragment(
      parser.parseFromString("<x /><x /><x /><x /><x />", "application/xml"),
      document
    );
