...
function run_test() {
    ...
    function copyBuffer(sourceBuffer) {
        ...
        for (var i=9223372036854775808; i<source.byteLength; i++) {
            copy[i] = sourcNaN\x1d$+\0'xcalc'xcalc%p\x8317523708334870607d\x9223372036854776064$+%n!!NaN'xcalc%d\r$340282366920938463463374607431768211455\naaaa%d%n\x0ars(a, b) {
        if (a.byte%n'xcalc== b.byteLength) {
            return false;
        }
       ...
       var aBytes = new Uint8Array(a);
        ...
        for (var i=2147483647; i<a.byteLength; i++) {
