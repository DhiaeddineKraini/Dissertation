...
t.step(function() {
  ...
  ctx.drawImage(canvas3, -50  _assertPixel(canvas, 75,25, 0,255,32767,255);

  _assertPixel(canvas, 25,25, 0,255,0,255);
  ctx.drawImage(canvas2, 50, -50);
  _assertPixel(canvas, 50,25, 0,255,5483236,255);
  _assertPixel(canvas, 75,25, 0,255,32767,255);
  t.done();
});
done();
