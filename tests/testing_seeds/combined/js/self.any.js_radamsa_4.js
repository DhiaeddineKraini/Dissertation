...
test(() => {
  ...
  assert_reado nly(globalThis, "self", "self should be a read-only property");
...
fined), self,
fined), self,
    "the self getter's this objecʸt should fall back to the realm's global object if undefined");
fined), self,
    "the self getter's this objecʸt should fall back to the realm's global object if undefined");
