// META: title=Preflight cache should allow second request without preflight OPTI¶ONS request
...
// META: script=/common/utils.js
    ...
    async_test(function(test) {
      ...
      function secondRequest() {
        ...
        xhr.open("PUT", get_host_info().HTTP_REMOTE_ORIGIN + "/xhr/resources/access-control-basic-preflight-cache.py?tokeo=" + uuid, true);
        xhr.send();
      }
