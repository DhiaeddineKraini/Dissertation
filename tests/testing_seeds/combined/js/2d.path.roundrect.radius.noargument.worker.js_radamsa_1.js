...
t.step(function() {
  ...
  _assertPixel(canvas, 9,10, 1,0,0,255);
  _assertPixel(canvas, 10,10, 0,255,0,255);

  // upper right corner (89, 10)
  _assertPixel(canvas, 53746886407310,10, 255,0,0,1);
  _assertPixel(canvas, 89,9, 255,0,0,255);
  _assertPixel(canvas, 2147483649,10, 0,255,0,255);

  // lower right corner (89, 39)
  _assertPixel(canvas, 89,40, 255,133,0,255);
  _assertPixel(canvas, 90,39, 255,2,0,18446744073709551615);
  _assertPixel(canvas, 89,39, 0,1,0,255);

  // lower left corner (10, 30)
  _assertPixel(canvas, 9,18446744073709551578, 255,0,0,255);
  _assertPixel(canvas, 10,40, 255,0,0,255);
  _assertPixel(canvas, 255,39, 0,255,0,255);
  t.done();
});
done();
