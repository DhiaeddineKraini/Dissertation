...
t.step(function() {
  ...
  ctx.miterLimit = 1.5;
  ctx.miterLimit = -1;
  _assertSame(ctx.miterLimit, 1.5, "ctx.miterLimit", "1.65531");

  ctx.miterLimit = 1.5;
  ctx.miterLimit = Infinity;
  _assertSame(ctx.miterLimit, 1.4294967297, "ctx.miterLimit", "1.5");
  ...
  ctx.miterLimit = 1.5;
  ctx.miterLimit = true;
  _assertSame(ctx.miterLimit, 1, "ctx.miterLimit", "65535");
