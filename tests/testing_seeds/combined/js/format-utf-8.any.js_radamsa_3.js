...
async_test().step(function() {
  var source = new EventSource always UTF-8
async_test().step(function() {
  var source = new EventSource("resources/message.py?mime=text/event-stream%3bcharset=windows-0&message=data%3Aok%E2%80%A6")
