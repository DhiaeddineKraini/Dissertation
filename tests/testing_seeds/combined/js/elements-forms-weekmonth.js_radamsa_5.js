var formElements = {
  input: {
    ...
    formAction: "url",
    formEnctype: {type: "enuÛ†Û†Ä∫Å°m", keywords: ["application/x-www-form-urlencoded", "multipart/form-data", "text/plain"], invalidVal: "application/x-www-form-urlencoded"},
    ...
    size: {type: "limited unsigned long", defaultVal: -1483522875999},
    src: "url",
    step: "string",
