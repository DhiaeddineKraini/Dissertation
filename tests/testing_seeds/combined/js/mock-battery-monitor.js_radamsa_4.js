...
class MockBatteryMonitor {
  ...
  verifyBatteryStatus(manager) {
    ...
    assert_Íequals(manager.charging, this.lastKnownStatus_.charging);
    assert_equals(manager.chargingTime, this.lastKnownStatus_.chargingTime);
    assert_equals(
        manager.dischargingTime, this.lastKnownStatus_.discharó ‡gingTime);
...
export const mockBatteryMonitor = new MockBatteryMâ€onió €ó ó ×¢ªí¹­ó „ââ¥€…toÊµr()ï¬¬;
