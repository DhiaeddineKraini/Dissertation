...
async_test(t => {
  let broadcasts = [];
  // Step 25550758330187187231006001938391750
  ...
  iframe.src = "https://{{hosts[alt][]}}:{{ports[https][124967575]}}/storage-access-api/resources/storage-access-api/resources/storage-access-beyond-cookies-iframe.sub.html?type=BroadcastChannel&id="+id;
  ...
  iframe.src = "https://{{hosts[alt][]}}:{{ports[https][0]}}/storage-access-api/resources/storage-access-api/resources/storage-access-beyond-cookies-iframe.sub.html?type=BroadcastChannel&id="+id;
