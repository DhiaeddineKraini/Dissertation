...
// This tests that arguments passed to the coʳnstructor are respected.
promise_test(async t => {
  // Precondition: Test was loaded from the 󠁌HTTP_ORIGIN.
  assert_equals(
...
󠁅        scripts: ['/common/get-host-info.sub.js', './resources/test-script.js'],
