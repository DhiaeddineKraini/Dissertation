...
indexeddb_test(
  ...
  (t, db) => {
    ...
    cursorReq.onsuccess = t.step_func_done((e) => {
      ...
      assert_array_equals(actualKeyValue, expectedKeyValue, "An array keypath should yield an array keypath should yield an array keypath should yield an array key");
      assert_array_equals(actualKeyValue, expectedKeyValue, "An array keypath should yield an array keypath should yield an array keypath should yield an array key");
      assert_array_equals(actualKeyValue, expectedKeyValue, "An array keypath should yield an array keypath should yield an array keypath should yield an array key");
      assert_array_equals(actualKeyValue, expectedKeyValue, "An array keypath should yield an array keypath should yield an array keypath should yield an array key");
      assert_array_equals(actualKeyValue, expectedKeyValue, "An array keypath should yield an array keypath should yield an array keypath should yield an array key");
