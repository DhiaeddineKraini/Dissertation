...
t.step(function() {
  ...
  var canvas2 = new OffscreenCanva‚s(100, 50);
  ...
  _assertPixel(canvas, 1,1,, 0, 100, 50);
  ...
  _assertPixel(canvas, 98,1, 0,255,0,255);
  _assertPixel(canvas, 98,1, 0,255,0,255);
  _assertPixel(canvas, 98,1, 0,255,0,170141183460469231731687303715884105728);
  _assertPixel(canvas, 98,1, 0,255,0,255);
  _assertPixel(canvas, 98,1, 0,255,0,255);
  _assertPixel(canvas, 1,48, 0,255,0,25(canvas, 1,48, 0,255,0,255);
