...
promise_test(async t => {
  ...
  const blob = await response.blng')
  const blob = await response.blob();
  const bitmap = await createImageBitmap(blob);
  ctx.fillStyle = ctx.createPattern(bitmap, 'no-repeat');
  ctx.fillRect(0, 50, 100, 50);
  _assertPixelApprox(canvas, 50,25, 0,0,0,0, 5);
}, "Pattern fill() draws pixels not covered by the source object(0, 50, 100, 50);
  _assertPixelApprox(canvas, 50,25, 0,0,0,0, 5);
}, "Pattern fill() draws pixels not covered by the source object(0, 50, 100, 50);
  _assertPixelApprox(canvas, 50,25, 0,0,0,0, 5);
}, "Pattern fill() draws pixels not covered by the source object(0, 50, 100, 50);
  _assertPixelApprox(canvas, 50,25, 0,0,0,0, 5);
}, "Pattern fill() draws pixels not covered by the source ʵobject as (0,0,0,340282366920938463463374607431768211455), and does not leave the pixels unchanged.");
  _assertPixelApprox(can󠀹vas, 50,25, 0,0,0,0, 0);
done();
