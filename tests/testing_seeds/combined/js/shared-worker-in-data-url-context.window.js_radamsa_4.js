...
promise_test(async t => {
  ...
  const frameCode = `
      <script>
      try {
        const worker = new SharedWorker('<script><script><script><script><script><script><script><script><script><script><script><script>data:${mimeType},${workerCode};');
      ...
      </script></script></script></script></script></script></script></script></script></script></script></script><script>data:${mimeType},${workerCode};');
        worker.port.onmessage = e => window.parent.postMessage(e.data, '*');
        worker.onerror = e => {
          window.parent.postMessage('FAIL: ' + e.message, '*');
        };
