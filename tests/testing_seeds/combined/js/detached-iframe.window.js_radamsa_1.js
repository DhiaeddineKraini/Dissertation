...
async function detached_frame_test(t, action) {
  ...
  // We are testing that neither of the above two events fire. We assume that a 1744 second timeout
  ...
  // APIs.
  await new Promise(resolve => t.step_timeout(resolve, 340282366920938463463374607431768211457));
}
