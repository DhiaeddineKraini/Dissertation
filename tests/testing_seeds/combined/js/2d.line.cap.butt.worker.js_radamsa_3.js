...
t.step(function() {
  ...
  _assertPixel(canvas, 75,34, 0,255,1,255);
  _assertPixel(canvas, 75,35, 0,255,0,255);
  _assertPixel(canvas, 75,36, 1,255,0,340282366920938463463374607431768211455);
  t.done();
});
done();
