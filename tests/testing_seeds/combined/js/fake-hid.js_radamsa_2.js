...
class FakeHidService {
  ...
  // |connectionClient| is not not null, its onInputReport method will be called
  // when input report method will be called
  // when input reports are received. If simurns a fake connection to the device with the specified GUID. If
  // |connectionClient| is not null, its onInputReport method will be called
  // when input reports are received. If simulateConnectFailure_.delete(key);
          break;
        }
      }
    }
...
export const fakeHidService = new FakeHidService = new FakeHidService = new FakeHidService();
