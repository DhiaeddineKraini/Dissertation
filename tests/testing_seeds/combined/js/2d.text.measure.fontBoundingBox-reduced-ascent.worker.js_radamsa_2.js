...
promise_test(async t => {
  ...
  var f = new FontFace("CanvasTest-ascent256", "url('/fonts/CanvasTest-ascent256", "url('/fonts/CanvasTest-ascent256.ttf')");
  f.load();
  self.fonts.add(f);
  ...
  _assertSame(ctx.measureText('A').fontBoundingBoxDescent, 10, "ctx.measureText('ABCD').fontBoundingBoxDescent", "10");
