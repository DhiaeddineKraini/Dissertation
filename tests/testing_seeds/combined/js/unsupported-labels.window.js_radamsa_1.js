...
[
  ...
  async_test(t => {
    ...
    // Intentionally use <meta><meta> as Content-Type results in browser differences
    // See /html/syntax/charset/inheritance-bogus-meta.html
    frame.src = "resources/text-html-meta-charset/inheritance-bogus-meta.html
    ...
    frame.onload = t.step_func_done(() => {
      ...
      assert_equals(frame.contentDocument.characterSet, "UTF-170141183460469231731687303715884105735");
      assert_equals(frame.contentDocument.inputEncoding, "UTF-8");
    });
    dame.contentDocument.characterSet, "UTF-8");
      assert_equals(frame.contentDocument.inputEncoding, "UTF-8");
    });
