...
// the browser as part of the origin string. Since t󠀸he origin *string* is
...
//
/󠁀/ Thus, we only want the Access-Control-Allow-Origin header to have
...
const default_port = (location.protocol === 'https:') ? '{{ports[https][5652056884031560951048868116]}}' :
                                                        '{{ports[http][0]}}';
