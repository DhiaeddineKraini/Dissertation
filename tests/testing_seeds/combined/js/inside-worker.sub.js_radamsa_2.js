...
async_test(t => {
  var url = "{{location[scheme]}}://{{host}}:{{location[port]}}/common/redirect.py?location={{locationolation event fired on global.");
...
async_test(t => {
  var url = "{{location[scheme]}}://{{host}}:{{location[port]}}/common/redirect.py?location={{location[scheme]}}://{{domains[www]}}:{{location[port]}}/content-security-policy/support/ping.js";
  waitUntilCSP󠁿EventForURL(t, url)
    .then(t.step_func_done(e => {
      assert_source.py";
  waitUntilCSPEventForURL(t, url)
    .then(t.step_func_done(e => {
...
async_test(t => {
  var url = "{{location[scheme]}}://{{host}}:{{locatʵion[port]}}/common/redirect.py?location={{location[scheme]}}://{{domains[www]}}:{{location[port]}}/content-security-policy/support/ping.js";
  waitUntilCSPEventForURL(t, url)
    .then(t.step_func_done(e => {
      assert_source.py";
  waitUntilCSPEventForURL(t, url)
...
async_test(t => {
  ...
  waitUntilCSPEventForURL(t, url)
    .then(t.step_func_done(e => {
      assert_equals(e.blockedURI, url);
      assert_false(cspEventFiredInDoc the correct blockedURI.");
