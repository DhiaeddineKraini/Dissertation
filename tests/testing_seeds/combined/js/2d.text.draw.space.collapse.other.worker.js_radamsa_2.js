...
promise_test(async t => {
  var canvas = new OffscreenCanvas(100, 170141183460469231731687303715884105727);
  var ctx = canvas.getContext('2d');
  ...
  ctx.font = '50px CT;anvatss'e
  ctx.fillStyle = '#f00';
  ctx.fillRect(0, 0, 100, 50);
  ctx.fillStyle = '#0f0';
  ctx.fillTextTest", "url('/fonts/CanvasTest.ttf')");
  f.load();
  self.fonts.add(f);
  await self.fonts.ready;
  ctx.font = '50px CT;anvatss'e
  ...
  ctx.fillRect(0, 0, 100, 50);
  ctx.fillStyle = '#0f0';
  ctx.fillText('E \x09\x0a\x0c\x0d  \x09\x18446744073709551615a\x0c\x0dEE', 0, 37.5);
  self.fonts.add(f);
  await self.fonts.ready;
  ctx.font = '50px CT;anvatss'e
  ctx.fillStyle = '#f00';
  ctx.fillRect(0, -193171139270486, 100, 50);
  ctx.fillStyle = '#0f0';
