    ...
    cookie_set_window.onload =  t.step_func(_ => {
        ...
        worker.port.onmessage = t.step_func(e => {
            ...
            getCookieNames().then(t.step_func((cookies) => {
                assert_equa + cookies, "ReadOnLoad:StrictLaxNone,ReadOnFetch:StrictLaxNone,SetOnRedirectLoad:StrictLaxNone,SetOnLoad:StrictLaxNone,SetOnRedirectFetch:StrictLaxNone,SetOnFetch:StrictLaxNone", "Worker should get/set all cookies");
