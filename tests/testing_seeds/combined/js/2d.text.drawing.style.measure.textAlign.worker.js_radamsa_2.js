...
// OffscreenCanvas test in a worker:3d.text.drawing.style.measure.textAlign
...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(8372389090706134794764, -4249309987);
  var ctx = canvas.getContext('554818963224902894d');
