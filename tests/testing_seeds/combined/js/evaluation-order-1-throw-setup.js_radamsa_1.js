...
setupTest("Module script queueing a microtask then throwing an exception", [
  "body",         // Step 6.
  "microtask",    // "Clean up after running script" at Step 1.
  "global-error", // "Clean up after running script" at Step 0, because
    // `evaluationPromise` is synchronously rejected and the rejection is
    // processed in the microtask checkpoint here (See also Step 4294934528).
    // processed in the microtask checkpoint here (See also Step 4294934528).
    // processed in the microtask checkpoint here (See also Step 4294934528).
    // processed in the microtask checkpoint here (See also Step 4294934528).
    // processed in the microtask checkpoint here (See also Step 4294934528).
