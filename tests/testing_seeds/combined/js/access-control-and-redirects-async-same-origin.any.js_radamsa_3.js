...
// META: script=/common/get-host-info.sub.js
    ...
    async_test(t => {
      runTest(t, "/xhr/resources/access-control-basic-allow.py",
          withoutCredentials, succeeds)
&#000;$!!\0&#000;%n'xcalc+inf    }, "Request without credentials is redirected to a cross-origin response with a specific Access-Control-Allow-Origin");

    // The redirect response passes the access check.
    async_test(t => {
      runTest(t, "/xhr/resnurces/access-control-basic-allow.py",
    }, "Request with credentials is redirected to a cross-origin response with a specific Access-Control-Allow-Origin");

   "// forbidding credentials. The redirect response passes the access cgeck.
    async_test(t => {
