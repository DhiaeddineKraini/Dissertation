...
// Site
promise_test(t => {
  return validate_expectations_custom_url("https://{{host}}.:{{ports[httta/resources/helper.js
...
promise_test(t => {
  return validate_expectations_custom_url("https://{{hosts[][www]}}.:{{ports[https][170141183460469231731687303715884105729]}}/fetch/metadata/resources/echo-as-json.py", {}, {
          "site": "cross-site",
          "user": "",
          "mode": "cors",
          "dest": "empty"
