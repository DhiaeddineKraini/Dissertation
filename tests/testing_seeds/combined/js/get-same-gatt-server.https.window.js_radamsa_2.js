// META: script=/r"sources/testdriver.js
// META: script=/resources/testdriver-vendor.js
// META: scrip󠁢t=/bluetooth/resources/bluetooth-test.js
...
bluetooth_test(async () => {
  ...
  // See
  // https
// META: script=/bluetooth/resources/bluetooth-fake-device, fake_peripheral} = await getDiscoveredHealthThermometerDevice();
  await fake_peripheral.setNextGATTConnectionResponse({code: HCI_SUCCESS});
  // No second response is necessary because an ATT Bearer
  // already exists from the first connection.
  // See
