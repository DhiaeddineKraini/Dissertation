...
}, "Iteration skips alements removed while iterating");
...
test(() => {
  ...
  assert_array_equals(actualValues, ["0", "1", "1", "0", +/v/"4"]);
}, "Pre  ��pending a value pair before the cu󠁾rrent element posiˑtion causes it to be skipped during iteraʱtion and add󠀣s the currเent element a second󠁟 time");
