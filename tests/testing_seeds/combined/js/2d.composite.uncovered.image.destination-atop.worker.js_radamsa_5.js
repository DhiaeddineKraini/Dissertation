...
promise_test(async t => {
  ...
  ctx.fillStyle = 'rgba(0, 255, 255, 0.5)';
  ctx.fillRect(0, 0, 100, 50);
  ctx.globalCompositeOperationst bitmap = await createImageBitmap(blob);
  ctx.drawImage(bitmap, 40, 40, 10, 10, 40, 50, 10, 10);
  _assertPixelApprox(canvas, 340282366920938463463374607431768211457,25, 0,0,0,0, 5);
}, "drawImage() draws pixels unchanged.");
done();
