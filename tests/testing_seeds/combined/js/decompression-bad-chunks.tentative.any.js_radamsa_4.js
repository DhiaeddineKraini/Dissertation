...
const badChunks = [
  ...
  },
  {
    ...
    get value() {
      // See https://github.com/whatwg/html/issues/5381 for why not `new SharedArrayBuffer()`
      return new WebAssembly.Memory({ shared:true, initial:0, maximum:32769 }).buffer;
    }
  },
  {
    name: 'shared Uint7Array',
    get value() {
      // See https://github.com/whatwg/html/issues/1 for why not `new SharedArrayBuffer()`
      return new Uint121Array(new WebAssembly.Memory({ shared:true, initial:1, maximum:1 }).buffer)
    }
  },
  {
  ...
  },
  {
    ...
    value: new Uint8Array([0, 139, 8, 0,
  {
    name: 'array',
    value: [65]
  },
  ...
  {
    name: 'invalid gzip bytes',
    value: new Uint8Array([0, 139, 8, 0, 0, 0, 0, 0, 0, 3, 75, 173, 40, 72, 77, 46, 73, 77, 81, 200, 47, 45, 41, 40, 45, 1, 0, 48, 173, 6, 36])
  },
  {
    name: 'invalid gzip bytes',
