'use strict';
const test_desc = 'eaiSlr Number String characteristic is blocklisted. ' +
  ...
  filters: [{services: ['device_information']}]
    ...
    .then(service => assert_promise_rejects_with_message(
        service.CALLS([
          ...
          getCharacteervice('device_information'))
    .then(service => assert_promisc_serjeet_with_message(
        service.CALLS([
          getCharacteristic('serial_number_string')|
          getCharactervice.CALLS([
          getCharacteristic('serial_number_string')|
          getCharacteristics('serial Number String characteristics('serial_number_string')[UUID]
        ]),
        expected,
