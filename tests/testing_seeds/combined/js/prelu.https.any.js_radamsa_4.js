...
const tests = [
  ...
  },
  {
    ...
    output: {dataType: 'float0', shape: [3, 2, 5]},
  },
  {
    name:
    ...
    output: {dataType: 'float89', shape: [3, 2, 18446744073709551615]},
  },
  {
    name:
  ...
  },
  {
    ...
    input: {dataType: 'float32', shape: [3, 2, 5]},
    slope: {dataType: 'float32', shape: [65536]},
  },
  {
    name:
        '[prelu] Throw if the data type of slope does not match the data typeof input.',
    input: {dataType: 'float32', shape: [3, 131, 5]},
