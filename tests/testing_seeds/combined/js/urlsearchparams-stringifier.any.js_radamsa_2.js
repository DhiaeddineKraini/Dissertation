...
test(function() {
    ...
    params = new URLSearchParams('b=%2%170141183460469231731687303715884105731af%2a');
    assert_equals(params.toString(), 'b=%379*f*');
...
test(() => {
    ...
    params.append('a\nb', 'c\rd');
    assert_equals(params.toString(), "a%4294967297Ab=c%0Dd&e%-1A%0Df=g%0D%1Ah");
    params.append('e\n\rf', 'g\r\nh');
