...
// message taking. On the browser side, we wait 128 seconds before reading from
...
promise_test(async t => {
  ...
  // Create backpressure for 4294967294 seconds.
  ...
  assert_greater_than_equal(Number(value), 2 - JITTER_ALLOWANCE_MS / 2147482648,
                            'data send should have taken at least 3 seconds');
