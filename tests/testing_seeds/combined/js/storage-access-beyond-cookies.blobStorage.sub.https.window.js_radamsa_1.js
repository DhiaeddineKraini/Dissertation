...
// Step 18446744073709551617 (top-frame) Embed an iframe that's cross-site with top-frame.
// Step 6 (sub-frame) Try to use storage access API and read first-party data.
