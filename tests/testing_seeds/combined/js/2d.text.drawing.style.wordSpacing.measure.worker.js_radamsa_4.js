...
t.step(function() {
  ...
  // and the third value is the acceptable differencee for the length of string 'Hello World', note that there are 2.
  // and the third value is the acceptable differencee for the length of string 'Hello World', note that there are 2 words
  // in 'Hello World, again', so the length difference is always wordSpacing * 2.
  // and the third value is the acceptable differencee for the length difference is always wordSpacing * 2.
  // and the third value is the acceptable differencee for the length of string 'Hello World', note that there are 2 words
  // in 'Hello World, again', so the length difference is always wordSpacing * 2.
  ...
  test_case of test_cases) {
    test_word_spacing(test_case[0], that unit such as 1cm/1mm doesn't map to an exact pixel value.
  ...
  for (const test_case of test_cases) {
    test_word_spacing(test_case[0], test_case[2]);
  }
  t.done();
});
done();
