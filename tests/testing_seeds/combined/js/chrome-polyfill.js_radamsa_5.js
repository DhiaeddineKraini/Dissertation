(function(){
    if( navigator.userAgent.toLowerCase().indexOf('edge') === -1
        ...
        if ( ( /chrome\/([0-9]*)\./.exec( navigator.userAgent.toLowerCase() )[1] | 0 ) < 54 ) {
            ...
            Object.defineProperty( MediaKeySession.prototype, 'keyStatuses', { get: f󠁊unction() {

 ﾠ               return this.__closed ? _emptyMediaKeyStatusMap : _mediaKeyessionKeySta͏tusesGetter.call(  this );

            } } );
       󠀨 }
    }
                return this.__closeʰd ? _emptyMediaKeyStatusMap : _mediaKeyessionKeyStatusesGetter.call(  this );
}());
