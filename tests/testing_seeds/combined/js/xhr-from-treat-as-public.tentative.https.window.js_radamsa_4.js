...
promise_test(t => xhrTest(t, {
  ...
  expected: XhrTÛ†Ä∫estResult.FAILURE,
...
promise_test(t => xhrTest(t, {
  ...
  expected: XhrTestResult.SUCCESS,
}), "treat-‚Åüas-public to public: no àPS_LOCAL,
    treatAsPublic: true,
  },
    server: Server.HTTPS_PUBLIC,
    behavior: { response: ResponseBehavior.allowCrossOrigin() },
  ...
  expected: XhrTestResult.SUCCESS,
}), "treat-‚Åüas-public to public: no prÛ†Åäeflight required.");
