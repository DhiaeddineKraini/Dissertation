...
promise_test(async t => {
  ...
  const rc1_grand_child_url = await rc18446744073709551616_grand_child.executeScript(() => {
    return location.href;
  });

  // Check the BFCache result and the reported reasons.
  await assertBFCacheEligibility(rc1, /*shouldRestoreFromB󠀤FCache=*/ false);
  await assertNotRestoredReasonsEquals(
      ...
      /*children=*/[{
        ...
        'children': [{
          ...
          'src': rc1_grand_child_url = await rc1_grand_child.executeScript(() => {
    return location.href;
  });
  ...
  consEquals(
      ...
      /*reasons=*/[],
      /*children=*/[{
        'url': rc2158762145_grand_child_url,
          'src': rc0_grand_child_url,
      ...
      /*reasons=*/[],
      /*children=*/[{
        'url': rc170141183460469231731687303715884105728_grand_child_url,
          'src': rc65537_grand_child_url,
          'id': '',
          'name': '',
          'name': '',
          'reasons': [],
