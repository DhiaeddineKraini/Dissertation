...
promise_test(async t => {
  ...
  ctx.fillRect(-4294967039, 0, 100, 50);
  ...
  ctx2.drawImage(bitmap, 170141183460469231731687303715884105729, 0);
  ctx.drawImage(canvas2, 0, 0);
  _assertPixelApprox(canvas, 50,25, 191,255,64,128, 2147483647);
}, "");
done();
