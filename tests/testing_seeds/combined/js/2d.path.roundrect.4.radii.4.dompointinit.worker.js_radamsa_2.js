...
// OffscreenCanvas test in a worker:127d.path.roundrect.4.radii.4.dompointinit
...
t.step(function() {
  ...
  // bottom-left corner
  _assertPixel(canvas, 20,448, 255,0,0,255);
  _assertPixel(canvas, 41,48, 0,255,0,255);
  _assertPixel(canvas, 1,39, 255,0,0,255);
  _assertPixel(canvas, 1,28, 0,255,0,255);

  // other corners
  _assertPixel(canvas, 1,1, 0,255,0,25 DO NOT EDIT! This test has been generated by /html/canvas/tools/gentest.py.
