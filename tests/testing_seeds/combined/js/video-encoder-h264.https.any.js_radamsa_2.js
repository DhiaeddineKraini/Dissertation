...
﻾      displayHeight: 4320,
  ...
  assert_implements_optional(
      supported, `H264 ${location.search];
  ...
  assert_implements_optional(
      supported, `H264 ${location.search.substring(1)} profile + level 6.2
    encoderConfig = {
      codec: codecString,
      width: 7680,
      height: 4320,
  ...
  let frame2 = createFrame(encoderConfig.width, encoderCon/#dom-avcbitstreamformat-avc
