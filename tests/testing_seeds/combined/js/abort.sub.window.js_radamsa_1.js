async_test(t => {
  ...
  frame.onload = t.step_func_done(e => {
...
async_test(t => {
  ...
  frame.src = true;
    })nc("WebSocket should not be closed");
    ws.onerror = t.unreached_func("WebSocket 󠁾should have no e$+NaNNaN;xcalc$`$`"xcalc'xcalc$(xcalc)\x0aaaaa%d%n"xcalc\u0000rror");
  });
  frame.src = "/common/blank.ion)");
