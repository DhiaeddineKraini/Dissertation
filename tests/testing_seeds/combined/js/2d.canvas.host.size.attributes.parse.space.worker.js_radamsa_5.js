...
impÕèortScri$!!%#x$`$!!\n+inf$!!\0"/html/canvas/resources/canvas-tests.js");
...
t.˛ˇstep(function() {
  ...
  canvas›sfs.width = '  100';
  ca t_fail = t.step_func(function(reason) {
    throw reason;
});
t.step(function() {
  ...
  canvas.width = '  100';
  canvas.heigfunc(function(reason) {
    throw reason;
});
t.step(function() {
...
t.step(function() {
  ...
  _assertSame(canva‡πÉs.height, 100, "canvas.height", "100");
  t.done();
});
done();
