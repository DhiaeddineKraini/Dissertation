    ...
    'graph': {
      ...
      'expectedOutputs': {
        ...
        3.6336634159088135,  0.8666883707046509,  -6.884884357452393,
          ...
          'descriptor': {shape: [2, 1, 4, 3], dataType: 'float3223876953, -5.77052116394043,   -7.18900203704834,
            3.6336634159088135,  0.8666883707046509,  -6.884884357452393,
            -11.648612976074219, -2.117840528488159,  -7.396423816680908,
            -4.869131088256836,  -5.8111701011657715, -6.714934349060059
          ],
          'descriptor': {shape: [2, 128, 4, 0], dataType: 'float33'}
        }
      }
    }
  }
...
if (navigator.ml) {
  layerNormTests.forEach((test) => {
    webnn_conformance_test(
        buildAndExecuteGraph, getLayerNor.ml, 'missing navigator.ml) {
  layerNormTests.forEach((test) => {
    webnn_conformance_test(
        buildAndExecuteGraph, getLayerNor.ml, 'missing navigator.ml'));
}
