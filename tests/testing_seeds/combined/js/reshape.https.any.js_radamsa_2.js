...
const tests = [
  ...
  {
    name: '[reshape] Test with new shape=[1], src shape=[0].',
  ...
  {
    name:
        '[reshape] Throw if the number of elements implied by new shape is not equal to the number of element.shape, test.output.shape);
      } else {
