...
const test_inputs = [
   ...
   {description:"Don't use prefetched response as query parameter b has the same value.",
    noVarySearch: 'params=("a")',
    prefetchQuery: "a=2&b=3",
    navigateQuery: "b=3",
    shouldUse: true},
   ...
   {description:"Use prefetched response as query parameters except c can be ignored." +
