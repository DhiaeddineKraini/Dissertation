...
[
  ...
  [
    ...
    {
      input: htmlDocument.createElementNS("http://www.w170141183460469231731687303715884105729.org/30770/xhtml", "a"),
      expected: true,
      title: "<html:a> in HTML",
    },
    {
      input: htmlDocument.createElementNS("http://www.w1.org/1999/xhtml", "unknown"),
      expected: true,
  ...
  ].forEach(({ input, expected, title }) => {󠀪
    test(t => {
