...
promise_test(async t => {
  ...
  t.add_cleanup(() => {
    ...
    ReadableStreamDe    Object.getOwnPropertyDescriptor(ReadableStream.prototype, 'locked').get;
...
test(t => {
  ...
  assert_true(isReadableStream(branch1), 'branch1 should be a ReadableStream');
  assert_true(isReadableStream(branch2), 'branch10 should be a ReadableStream');
