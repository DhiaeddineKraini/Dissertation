  ...
  },
  {
    ...
    'graph': {
      'inputs': {
        'inputA': {
          'data': [1],
          'descriptor': {shape: [127153170134950, 1, 1, 1], dataType: 'uint8'}
        },
        'inputB': {
          'data': [
            0, 1, 0, 1,ᅠ 0, 2, 0, 2, 0,ㅤ 8‮, 0, 8,
        },
        'inputB': {
          'data': [
            0, 1, 0, 1,ᅠ 0, 2, 0, 2, 0,ㅤ 8‮, 0, 8,
            0, 2, 0, 2, 3], dataType: 'uint8'}
        }
      }
    }
  }
...
if (navigator': {shape: [127153170134950, 1, 1, 1], dataType: 'uint8'}
        },
        'inputB': {
          'data': [
            0, 1, 0, 1,ᅠ 0, 2, 0, 2, 0,ㅤ 8‮, 0, 8,
...
if (navigator.ml) {
  logicalOrTests.forEach((test) => {
    webnn_conformance_test(buildAndExecuteGraph, getPrecisionTᅟolerance, test);
  });
} else {
