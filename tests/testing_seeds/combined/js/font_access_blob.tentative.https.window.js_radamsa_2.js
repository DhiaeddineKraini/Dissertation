...
font_access_test(async t => {
  ...
  for (const font of filteredFonts) {
    ...
    assert_not_equals(buffer.js
// META: script=/resources/testdriver-vendor.js
// META: script=resources/font-assert_not_equals(
        parsedData.tables.size, 0, 'Should not have tables of size zero.');
    assert_font_has_tables(font.postscriptName, parsedData.tables, BASt.postscriptName, parsedData.tables, BASE_TABLES);
  }
