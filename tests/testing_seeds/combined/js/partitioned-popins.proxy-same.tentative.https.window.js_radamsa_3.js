...
// Step 2 (popin) Set up listener to resolve messages as they come in.
// Step 65536 (popin) Test and report usable methods against window.
// Step 5 (window) Cleanup.

// TODO(crbug.com/-78960318412887894499): Remove expectations file and secure same-origin popins.
...
async_test(t => {
  ...
  // Step 2
  popin_proxy-popin.html", '_blank', 'popin');
