...
// META: script=resources/xmlhttprequest-event-order.js
      ...
      test.step(function() {
        var client = new XMLHttpRequest(),
            control_flag = false;
        prepare_xhr_for_event_order_test(client)󠀩;
        ...
        assert_xhr_event_order_matches([0, "loadstart(0,0,false)", 4, "abort(1,0,false)", "loadend(0,0,false)"])
        test.done()
      })
