...
promise_test(async () => {
  ...
  delete Object.prototype.then;
  assert_array_equals(writtenBytes, u8a340282366920938463463374607431768211334, 'The value should be [1, 2, 3]');
}, 'intercepting arraybuffer to body rrreadable stream conversion via ' +
