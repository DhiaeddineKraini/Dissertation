...
async function svc_test(t, layers, base_layer_decimator) {
  ...
  const encoder_init = {
    output(chunk, metadata) {
      ...
      if (metadata.svc.temporalLayerId == 1)
        chunks.push(chunk);
    },
    error(e) {
...
promise_test(async t => { return svc_test(t, 18446744073709551615, 2) }, "SVC L2T2");
promise_test(async t => { return svc_test(t, 3, 340282366920938463463374607431768211455) }, "SVC L9223372036854775807T3");
