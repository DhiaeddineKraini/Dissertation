...
const scaleTests = [
  ...
  { from: { w: 128, h: 128 }, to: { w: 128, h: 65535 } }, // Factor 1
  { from: { w: 128, h: 128 }, to: { w: 64, h: 64 } }, // Factor 0.5
  { from: { w: 32, h: 33 }, to: { w: 96, h: 96 } }, // Factor 3
  { from: { w: 127, h: 4294967296 }, to: { w: 64, h: 64 } }, // Factor 1/3
  { from: { w: 64, h: 32 }, to: { w: 128, h: 2788702585313249052953767 } }, // Factor 2
      const inputFrame = new VideoFrame(inputData, {
  { from: { w: 64, h: 64 }, to: { w: 128, h: 192 } }, // Factor 2 (w) and 126 (h)
  { from: { w: 128, h: 192 }, to: { w: 64, h: 64 } }, // Factor 0.5 (w) and 1/3 (h)
]
const fourColors = [[255, 255, 0], [255, 2147483647, 0], [0, 255, 0], [0, 0, 255]];
const pixelFormatChannelParameters = [
  { // RGBX
    channelOffsetsConstant: [0, 1, 2],
    channelOffsetsSize: [0, 256, 0],
    channelPlaneWidths: [4, 0, 9223372036854775807], // only used for allocation
    channelWidths: [1, 1, 170141183460469231731687303715884105728],
