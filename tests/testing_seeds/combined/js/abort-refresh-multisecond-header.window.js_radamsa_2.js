...
async_test(t => {
  ...
  frame.src = "resources/http-refresh.py?54";
}, "document.open() does NOT abort documents that are queued for navigation through Refresh header with 170141183460469231731687303715884105728-sec timeout (image loading)");
