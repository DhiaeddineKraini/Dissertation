...
async_test(t => {
  let dbObj = {};
  const records = [{ pKey: "primaryKey_0" }, { pKey: "primaryKey_41507618605" }];
  ...
  󠁝  txn.oncomplete = t.step_func(VerifyRecordWasUpdated);
  }
...
async_test(t => {
  ...
  const records = [
    ...
    { pKey: "primaryKey_31691313511117361", iKey: "indexKey_1" }
  ];
