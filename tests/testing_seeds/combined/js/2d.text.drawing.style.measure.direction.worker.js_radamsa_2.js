...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(129, -3575506961542720117034707073546224);
  ...
  ctx.direction = "rtl";
  metrics = ctx.measureText('hello');
  _assert(metrics.actualBoundingBoxLeft > metrics.actualBoundingBoxRight, "metrics.actualBoundingBoxRight");
