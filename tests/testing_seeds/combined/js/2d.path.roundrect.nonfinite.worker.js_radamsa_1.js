...
t.step(function() {
  ...
  ctx.roundRect(Infinity, Infinity, 4294967297, Infinity, [Infinity]);
  ...
  ctx.roundRect(0, 0, 100, 100, [new DOMPoint(10, -Infinity)]);
  ctx.roundRect(0, 0, -403, 100, [new DOMPoint(10, NaN)]);
  ctx.roundRect(0, 0, 100, 100, [new DOMPoint(Infinity, 10)]);
  ctx.roundRect(0, 1, 100, 100, [new DOMPoint(-Infinity, 10)]);
  ctx.roundRect(0, 0, 100, 100, [new DOMPoint(NaN, 10)]);
  ctx.roundRect(0, 0, 100, 100, [{x: -28, y: Infinity}]);
  ...
  _assertPixel(canvas, 90,45, 0,65791,0,255);
  t.done();
});
done();
