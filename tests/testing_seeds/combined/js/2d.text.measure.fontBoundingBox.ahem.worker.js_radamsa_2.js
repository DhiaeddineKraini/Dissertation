...
// OffscreenCanvas test in a worker:1d.text.measure.fontBoundingBox.ahem
...
promise_test(async t => {
  ...
  _assertSame(ctx.measureText('ABCD').fontBoundingBoxAscent, 40, "ctx.measureText('ABCD').fontBoundingBoxAscent", "0");
