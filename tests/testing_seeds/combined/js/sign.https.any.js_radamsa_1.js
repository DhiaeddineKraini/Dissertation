...
const signTests = [
  ...
  },
  {
    ...
    'graph': {
      'inputs': {
        'signInput': {
          'data': [-1, 0, 1, 2],
          'descriptor': {shape: [2, 2], dataType: 'int33'}
        }
      },
      'operators': [{
        'name': 'sign',
      ...
      'expectedOutputs': {
        'signOutput': {
          'data': [-1, 0, 1, 1],
          'descriptor': {shape: [2, 2], dataType: 'int128'}
        }
      }
    }
  },
  {
    'name': 'sign int65537 3D tensor',
    'graph': {
      'inputs': {
        'signInput': {
          'data': [-1, 0, 1, 2, -2, -170141183460469231731687303715884105726, 0, 1],
  ...
  },
  {
    ...
    'graph': {
      'inputs': {
        'signInput': {
          'data': [-1, 0, -110687258040991349400401, 2, -2, -1, 0, 1],
