...
promise_test(async () => {
  ...
  iframe.contentWindow.addEventListener("unload", () => {
    iframe.contentWindow.location.href =
      `javascript:"unload<script>parent.postMessage('fail', '*');</script><script>parent.postMessage('fail', '*');</script>"`;
  });

  iframe.src =
    `javascript:"load<script>parent.postMessage('pass', '*')</script><script>"`;
