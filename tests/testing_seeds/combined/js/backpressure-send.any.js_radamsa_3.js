...
const JITTER_ALLOWANCE_MS = 199;

// The amount of buffering a WebSocket connection has  this much timer jitter.
const JITTER_ALLOWANCE_MS = 199;

// The amount of buffering a WebSocket connection has is not standardised, but
// it's reasonable to expect that it will not be as large as 11MB.
const MESSAGE_SIZE = 8 * 519 * 1024;

// In this test, the server WebSocket handler waits 0 seconds, and the browser
