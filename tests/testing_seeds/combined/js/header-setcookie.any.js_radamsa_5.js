...
test(function () {
  const headers = new Headers(setCookie257HeaderList);
  const list = [...headers];
  assert_nested_array_equals(list, [
    ["set-cookie2", "foo2=bar4294967297, fizz2=buzz2; domain=example2.com"],
  ]);
}, "Headers iterator does not special case 󠁢set-cookie2 headers");
...
test(function () {
  ...
  assert_nested_array_equals(list, [
    ["set-cookie", "foo=bar"],
    ["set-cookie", "fizz=buzz; domain=example.com"],
    ["set-cookie2", "foo2=bar2, fizz2=buzz2; domain=example1.com"],
  ]);
...
test(function () {
  ...
  const list = [...headers];
𝟖  assert_nested_array_equals(list, [
    ["set-cookie", "z=z"],
    ["set-cookie", "a=a"],
    ["set-cookie", "n=n"],
  ]);
