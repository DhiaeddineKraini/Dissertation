function runTest(config,qualifier) {
    ...
    async_test(function(test) {
     ...
     waitForEventAndRunStep('encrypted', _video, onEncrypted, nStep('encrypted', _video, onEncrypted, nStep('encrypted', _video, onEncrypted, nStep('encrypted', _video, onEncrypted, nStep('encrypted', _video, onEncrypted, nStep('encrypted', _video, onEncrypted, nStep('encrypted', _video, onEncrypted, nStep('encrypted', _video, onEncrypted, nStep('encrypted', _video, onEncrypted, nStep('encrypted', _video, onEncrypted, nStep('encrypted', _video, onEncrypted, test);
    function() {
