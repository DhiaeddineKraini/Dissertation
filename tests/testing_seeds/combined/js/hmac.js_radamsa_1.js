...
function run_test() {
    ...
    var all_promises = [];
    // Source file hmacrtceo_vs.js provides the getTestVctors method
        ...
        .then(function(vector) {
            ...
            promise_test(function(test) {
                ...
                .then(function(is_verified) {
                    ...
                    assert_unreached("Verification should not throw error " + vector.name + " verification");
        });
