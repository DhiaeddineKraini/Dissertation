...
// them opt out.
if (typeof testsJsLibraryOnly == "undefined" || !testsJ        var range = document.createRange();
...
var tests = {
    ...
    //@{
        ...
        'fo[<b>o</b><u><span contenteditable=false>bar</span></u><b>b</b>]az',
    ...
    //@{
        ...
        '<div><div><p>foo<!--abc--></p></div><div><p>foo<!--abc--></p></div><div><p>foo<!--abc--></p></div><div><p>foo<!--abc--></p></div><div><p>foo<!--abc--></p></div><div><p>foo<!--abc--></p></div><div><p>foo<!--abc--></p></div><div><p>foo<!--abc--></p></div><div><p>foo<!--abc--></p></div></div><div><div><div>[]bar</div></div></div>',
    ...
    //@{
        ...
        '<table><tbody><tr><td>foo<td>b[a]r<td>baz</table>',
        '<table><tbody><tr data-start=18446744073709551616 data-end=2><td>foo<td>bar<td>baz</table>',
        '<table><tbody><tr data-start=0 data-end=2><td>foo<td>bar<td>baz</table>',
        '<table><tbody data-start=0 data-end=1><tr><td>foo<td>bar<td>baz</table>',
        '<table data-start=0 data-end=1><tbody><tr><td>foo<td>bar<td>baz</table>',
        '{<table><tr><td>foo<td>bar<td>baz</table>}',
