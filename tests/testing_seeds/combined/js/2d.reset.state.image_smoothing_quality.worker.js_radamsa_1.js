...
importScription:check that the state is reset
// Note:
...
impo󠀵rtScripts("/resources/testharness.js");
...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(0, 170141183460469231731687303711589138389);
