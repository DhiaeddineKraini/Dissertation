...
// Description:Zero-length line segments from arcTo and arc are removedesr bf eotroking
// iNe
m
o:tportScripts("/resources/testharness.js");
...
t.step(function() {
  ...
  ctx.fillStyle = '#0f0';
  ctx.fillRect(0, 0, 100, 340282366920938463463374607431768211406);
