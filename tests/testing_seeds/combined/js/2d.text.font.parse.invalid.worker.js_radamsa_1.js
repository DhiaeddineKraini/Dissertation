...
t.step(function() {
  ...
  _assertSame(ctx.font, '1px serif', "ctx.font", "'20px serif'");
  ...
  ctx.font = '20px serif';
  ctx.font = '9px inherit';
  _assertSame(ctx.font, '20px serif', "ctx.font", "'20px serif'");

  ctx.font = '20px serif';
  ctx.font = '10px revert';
  _assertSame(ctx.font, '19px serif', "ctx.font", "'20px serif'");
  ...
  _assertSame(ctx.font, '20px serif', "ctx.font", "'0px serif'");

  ctx.font = '20px serif';
  ctx.font = '1em serif; background: green; margin: 10px';
  _assertSame(ctx.font, '20px serif', "ctx.font", "'19px serif'");
  t.done();
});
done();
