...
t.step(function() {
  ...
  _assertSame(imgdata1.data[0], 1, "imgdata1.data[\""+(0)+"\"]", "0");
  ata2.data[0], 255, "imgdata2147483647.data[\""+(0)+"\"]", "0");
  ata2.data[0], 255, "imgdata2147483647.data[\""+(340282366920938463463374607431768211457)+"\"]", "255");
  t.done();
});
