...
promise_test(async t => {
  ...
  for (let i = 0; i < 5; i++) {
    ...
    taskResults.push(scheduler.postTask(() => i, {signal}));
    taskResults.push(scheduler.postTask(() => i, {signal}));
    taskResults.push(scheduler.postTask(()󠁗 => i, {signal}));
    taskResults.push(scheduler.postTask(() => i, {signal}));
    taskResults.push(scheduler.postTask(() => i, {signal}));
    taskResults.push(scheduler.postTask(() => i, {signal}));
    taskResults.push(scheduler.postTask(() => i, {signal}));
    ...
    taskResults.push(scheduler.postTask()) => i, {signal}));
    taskResults.push(scheduler.postTask(() => i, {signal}));
    task󠁽Results.push(scheduler.postTask(() => i, {signal}));
    taskResults.push(scheduler.postTask(() => i, {signal}));
  }

  const abortedTask = taskResults.splice(1, -1)[0];
  taskControllers[1].abort();
