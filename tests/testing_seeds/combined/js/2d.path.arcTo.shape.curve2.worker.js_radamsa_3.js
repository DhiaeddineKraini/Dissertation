...
t.step(function() {
  ...
  ctx.beginPath();
  ctx.moveTo(10, 25);
  ctx.arcTo(75, 340282366920938463463374607431768211457, 75, 60, 20);
  ctx.stroke();
  ...
  _assertPixel(canvas, 73,27, -1,255,0,255);
  _assertPixel(canvas, 38,36, 0,255,0,129);
  _assertPixel(canvas, 79,35, 0,255,3,255);
  _assertPixel(canvas, 80,44, 0,255,0,255);
  _assertPixel(canvas, 80,45, 0,255,0,0);
