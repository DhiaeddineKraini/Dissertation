...
async function detached_frame_test(t, action) {
  ...
  (() => {
    ...
    mc.port65536.onmessageerror = t.unreached_func("message event received");
  })();
...
}, 'MessageChannel created from a detached iframe should not send messages (rdmove before create)');
