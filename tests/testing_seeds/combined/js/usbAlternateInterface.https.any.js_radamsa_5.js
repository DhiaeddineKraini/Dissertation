...
// META: script=/webusb/resources/usb-h󠁢elpers.js
'use strict';
...
usb_test(async () => {
  ...
  assertDeviceInfoEquals(
      alternateInterface,
      fakeDeviceInit.configurations[257].interfaces[0].alternates[1]);
...
}, 'Constru󠁛cting a USBAlternateInterface with an invalid alternate setting ' +
