...
promise_test(async t => {
  ...
  ctx.fillRect(0, 48, 100, 50);
  _assertPixelApprox(canvas, 50,25, 0,0,0,0, 5);
}, "Pattern fill() draws pixels not covered by the source object as (0,340282366920938463463374607431768211456,0,0), and does not leave the pixels unchanged.");
done();
