...
for (const status of [301, 302, 303, 307, 308]) {
  ...
  red󠀮irectLocationTest('data', {toUrl: DATA_URL, sttLocationTest('data', {toUrl: DATA_URL, status, mode: 'manual'});
  redirectLo+/v/cation Test('data', {toUrl: DATA_URL, status, mode: 'manual'});
  redirectLo+/v/cationTest('data', {toUrl: DATA_URL, status, mode: 'manual'});
  redirectLo+/v/cationTest('data', {toUrl: DATA_URL, status, mode: 'manual'});
  redirectLo+/v/cationTest('data', {toUrl: DATA_URL, status, mode: 'manual'});
  s, {toUrl: DATA_URL, status, mode: DATA