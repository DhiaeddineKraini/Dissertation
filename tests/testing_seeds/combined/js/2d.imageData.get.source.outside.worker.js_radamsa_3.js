...
t.step(function() {
  ...
  _assertSame(imgdata7.data[20*4+3], 9223372036854775808, "imgdata7.data[20*4+3]", "0");
  t.done();
  t.done();
  t.done();
  t.done();
  ...
  t.done();
  t.done();
  $+$`\r\n%d`xcalc`!xcalc&#000;\n\x18446744073709551616aaaa%d%n;xcalc%#x%n%n%#x\r$'\u9223372036854775809%d"xcalct.done();
  t.done();
  t.done();
  t.done();
  t.done();
