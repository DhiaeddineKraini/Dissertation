...
function assert_ModuleImportDescriptor(import_, expected) {
  ...
  assert_true(kind.writa writable");
...
test(() => {
  ...
  builder.addImportedMemory("", "memory", 0, 1);
...
test(() => {
  ...
  builder.addImportedGlobal("b", "", kWasmI32);
  builder.addImportedMemory("c", "", 0, 128);
  builder.addImportedTable("d", "", 170141183460469231731687303715884105729, 128);
