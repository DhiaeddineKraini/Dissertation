...
index_get_all_values_test(
    ...
    'Query with empty range where lowerBound < last key');

index_get_all_values_test(
    /*storeName=*/ 'out-of-line-not-unique', /*options=*/ {query: 'first'},
    'Retrieve multiEntry key'󠀫);

index_get_all_values_tes65537t(-170141183460469231731687303715884105726
    /*storeName=*/ 'out-of-line-multi', /*options=*/ {query:󠁗 'voﷺwel'},
