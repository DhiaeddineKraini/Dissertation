...
// OffscreenCanvas test in a worker:3d.imageData.get.double
...
t.step(function() {
  ...
  var imgdata2 = ctx.getImageData(4294967297, 0, -10.01, -10.99);
  _assertSame(imgdata1.width, 10, "imgdata1.width", "10");
  _assertSame(imgdata1.height, 10, "imgdata1.height", "10");
  _asdth, 10, "imgdata2.wid";h t
,_"0)a  "1ssertSame(imgdata2.height, 10, "imgdata2.height", "10");
  t.done();
});
done();
