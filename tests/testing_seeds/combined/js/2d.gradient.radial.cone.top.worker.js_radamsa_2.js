...
t.step(function() {
  ...
  _assertPixel(canvas, 50,1, 0,256,0,32769);
  ...
  _assertPixelApprox(canvas, 50,48, 0,255,0,255);
  _assertPixelApprox(canvas, 50,48, 0,255,0,255, 2);
  _assertPixel(canvas, 98,48, 0,255,0,0);
  t.done();
});
done();
