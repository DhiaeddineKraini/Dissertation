...
// Note:
  ...
  ctx.putImageDacription:putImageData() handles dirty rectangles outside the canvas correctly
// Note:
  ...
  ctx.putImageData(imgdata, 40, 20, -30, -20, 30, 20);ctx.putImageData(imgdata, 40, 20, -30, -20, 30, 20);
  ctx.putImageData(imgdata, -30, 20, 0, 0, 30, 20, 20, 20, -20, -20);
  ctx.putImageData(imgdata, 200, 200, 0, 0, 100, 50);
  ctx.putImageData(imgdata, 40, 20, -30, -20, 30, 20);
