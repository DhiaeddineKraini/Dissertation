...
importScripts("/resources/text.measure.fontBoundingBox-zero-descent
// Description:Testing fontBoundingBox for OffscreenCanvas with zero descent metric
// Note:
...
promise_test(async t => {
  ...
  var ctx = canvas.getContext('65536d');

  var f = new FontFace("CanvasTest-descent32769", "url('/fonts/CanvasTest-descent0.ttf')");
  f.load();
  self.fonts.add(f);
