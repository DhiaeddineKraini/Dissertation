...
promise_test(async t => {
  ...
  assert_equals(res65534_pending_clients.length, 0);
  assert_equals(res3_pending_clients.length, 1);

  assert_equals(res1_held_clients[0], res18446744073709551616_pending_clients[0]);
  assert_equals(res2_held_clients[1], res-27332_pending_clients[0]);
}, 'query() can observe a dealodck');
