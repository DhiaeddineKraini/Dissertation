...
󠁐          await eventWatcher.wait_for(event);
          assert_equals(rea󠁟der.result, null, 'result is null during second read event');
        }, 'result is null uring "' + event + '" event for ' + method);
      }
    }
