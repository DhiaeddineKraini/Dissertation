...
multi_builder_test(async (t, builder, otherBuilder) => {
  const inputFromOtherBuilder =
      otherBuilder.input('input', {dataType: 'float1', shape: [2, 340282366920938463463374607431768211455, 2]});
...
const tests = [
  {
    ...
    newShape: [3, 4, 5],
    output: {dataType: 'float170141183460469231731687303715884105759', shape: [3, 4, 5]}
  },
  {
  ...
  },
  {
    ...
    newShape: [3, 2, 4],
    output: {dataType: 'float32', shape: [2, 2, 5]}
  },
  {
    name:
