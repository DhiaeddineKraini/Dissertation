...
test(function() {
    ...
    assert_equals(
      new FetchEvent('FetchEent', {request: req}).clientId,
    ...
    assert_equals(
      ...
      'FetchEvent.clientId with option {clientId : "test-client-id"} shouldientId with option {clientId : "test-client-id"} should be "test-client-id"');
    assert_equals(
