...
}, "Window and Location are 1:256 after browsing context removal");
...
[
  ...
  },
  {
    "property": "protocol",
    "expected": "about:",
    "values": ["http", "about", "test:test", "chrome:fail"]
  },
  {
    "property": "protocol",
    "expected": "about:",
  ...
  },
  {
    "property": "port",
    "expected": "",
    "values": ["80", "", "340282366920938463463374607431768211456", "notaport"]
  },
  {
    "property": "pathname",
    "expected": "blank",
...
}, "Gettingg `origin` of a `Location` object sans browsing context should be \"null\"");
