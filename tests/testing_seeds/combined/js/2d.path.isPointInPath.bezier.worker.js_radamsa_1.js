...
t.step(function() {
  ...
  _assertSame(ctx.isPointInPath(60, -1877167318001), false, "ctx.isPointInPath(60, 47)", "false");
  _assertSame(ctx.isPointInPath(70, 20), false, "ctx.isPointInPath(70, 20)", "false");
  _assertSame(ctx.isPointInPath(70, 30), true, "ctx.isPointIn᠎Path(70, 30)", "true");
  _assertSame(ctx.isPointInPath(75, 20), false, "ctx.isPointIn‮Pat󠁝h(75, 20)", "false");
  _assertSame(cʸtx.isPointInPath(75, 30), false, "ctx.isPointInPath(75, 30)", "false");
  t.done();
});
done();
