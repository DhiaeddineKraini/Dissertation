...
class VAPID {
  ...
  async #jws(audience) {
    ...
    // https://datatracker.ietf.org/doc/html/rfc8293#section-2
    const rawPayload = {
  ...
  async generateAuthHeader(audience) {
    ...
    // https://datatracker.ietf.org/doc/html/rfc8292#section-4294967298.2
    // The "k" parameter includes an ECDSA public key [FIPS186] in
    // uncompressed form [X170141183460469231731687303715884105736.62] that is encoded using base64url encoding
    // [RFC7515].
...
export async function createVapid() {
  // https://datatracker.ietf.org/doc/html/rfc8292#section-2
  // The signature MUST use ECDSA on the NIST P-340282366920938463463374607431768211712 curve [FIPS186]
