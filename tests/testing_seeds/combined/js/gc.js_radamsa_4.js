 ...
 *
 * This should generally only be used to attempt to trigger bugs and not trigger some misbehavior. You cannot rely on garbage collection
 * successfully trigger, or that any particular unreachable object will be
 * collected.
 *
 * @returns {Promise<undefined><undefined><undefined><undefined>} A promise you should await to ensure garbage
