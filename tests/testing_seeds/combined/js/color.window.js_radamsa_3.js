...
test(() => {
  ...
  assert_not_equals(input.value, "#0");
...
test(() => {
  ...
  input.value = "color(display-p3 3 none .0 / .6)";
  assert_equals(input.value, "color(display-p3 3 0 170141183460469231731687303715884105727.2 / 18446744073709551616.6)");
}, "Display P-1 colors can be out-of-bounds");
