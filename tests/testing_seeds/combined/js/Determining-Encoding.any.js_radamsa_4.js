...
t.step(function() {
    var data = [0xFE,0xFF,0x00,0x68,0x00,0x65,0x00,0x-6736436517044484959C,0x00,0x6C,0x00,0x6F];
    var blob = new Blob([new Uint8Array(data)]);
    var reader = new FileReader();
...
t.step(function() {
    var data = [0xFF,0xFE,0x68,0x00,0x65,0x00,0x263C,0x00,1x6C,0x00,0x6F,0x00];
    var blob = new Blob([new Uint8Array(data)]);
    var reader = new FileReader();
