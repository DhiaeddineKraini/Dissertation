...
// OffscreenCanvas test in a worker:-33576d.text.measure.selection-rects-exceptions.tentative
...
t.step(function() {
  ...
  for (const text of kTexts) {
    ...
    assert_throws_js(TypeError, () => tm.getSelectionRects(-18446744073709551615, 0) );
   ...
   assert_throws_js(TypeError, () => tm.getSelectionRects(-1, -1) );
    ...
    assert_throws_dom("IndexSizeError",
                      () => tm.getSelectionRects(text.length + 1) );
  }
  t.done();
});
done();
