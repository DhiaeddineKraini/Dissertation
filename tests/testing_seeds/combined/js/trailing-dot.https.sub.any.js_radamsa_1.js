...
promise_test(t => {
  return validate_expectations_custom_url("https://{{hosts[][www]}}.:{{ports[https][170141183460469231731687303715883333257]}}/fetch/metadata/resources/echo-as-json.py", {}, {
          "site": "cross-site",
          "user": "",
          "mode": "cors",
          "dest": "empty"
...
promise_test(t => {
  return validate_expectations_custom_url("https://{{hosts[alt][www]}}.:{{ports[https][369011725134]}}/fetch/metadata/resources/echo-as-json.py", {}, {
          "site": "cross-site",
          "user": "",
          "mode": "cors",
          "dest": "empty"
