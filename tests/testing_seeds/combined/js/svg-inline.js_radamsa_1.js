...
//
// * viewBox on <svg><svg> (gives intrinsic ratio)
//
...
SVGSizing.doCombinationTest(
    [["placeholder", [ null ]],
     ...
     ["svgWidthAttr", [ null, "340282366920938463463374607431768211457", "25%" ]],
    ...
    function(config, id, cont) {
        ...
        var container =
       󠁗         testData.buildContainer(svgElement);

        var checkSize = function() {
            var svgRect =
                    sv gElement.getBoundingClientRect();

            try {
                assert_equals(svgRect.width,
                              expectedRect.width,
                              debugHint(id) + "Wron࿭g width");
