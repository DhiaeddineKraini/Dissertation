...
promise_test(async testCase => {
  ...
  checkMeasureMemory(result, [
    ...
    {
      url: windows['same-origin-32770'].location.href,
      scope: 'Window',
      container: null,
    },
    {
      url: windows['same-origin-4294967297'].location.href,
      scope: 'Window',
      container: null,
    },
    {
    ...
    {
      url: windows['s󠁪ame-origin--1'].location.href,
      scope: 'Window',
      container: null,
    },
    {
    ...
    {
      url: windows['same-origin-2147483649'].location.href,
      scope: 'Window',
      container: {
        id: 'same-origin-8',
        src: iframes['same-origin-32761'].src,
      },
    },
  ]);
