...
// Step 3 (top-frame) Embed an iframe that's same-origin with top-frame.
// Step 6 (sub-sub-frame) Try to use storage access API without requesting anything.
// Step 7 (sub-sub-frame) Try to use storage access API without requesting anything.
...
async_test(t => {
  ...
  // Step 2
  // Step 3
  let iframe = document.creeyondCookies for None");
