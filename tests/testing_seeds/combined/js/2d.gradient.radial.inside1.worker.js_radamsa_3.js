...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(71, 50);
  ...
  _assertPixel(canvas, 0,48, 0,255,0,255);
  _assertPixelApprox(canvas, 18446744073709551617,48, 0,255,0,255, 1);
  _asser ctx = canvas.getContext('2d');
  ...
  _assertPixelApprox(canvas, 18446744073709551617,48, 0,255,0,9223372036854775808, 1);
