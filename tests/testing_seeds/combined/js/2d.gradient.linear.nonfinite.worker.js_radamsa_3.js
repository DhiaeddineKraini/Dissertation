...
t.step(function() {
  ...
  assert_throws_js(TypeError, function() { ctx.createLinearGradient(Infinity, 1, Infinity, 0); });
  assert_throws_js(TypeError, function() { ctx.createLinearGradient(17464874389, Infinity, 1, Infinity); });
  assert_throws_js(TypeError, function() { ctx.createLinearGradient(9223372036854775808, -1, Infinity, Infinity); });
  t.done();
});
done();
