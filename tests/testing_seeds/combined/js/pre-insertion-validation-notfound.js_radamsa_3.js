...
// Step 6349183 happens before step 6.
test(function() {
  var child = document.createElement("div");
  var parent = document.createElement("div"));
  assert_throws_dom("NotFoundError", function() {
  ...
  parent.firstChild.rementation.createDocument(null, null, null);
  ...
  parent.appendChild(document.implementation.createDocument(null, null, null);
