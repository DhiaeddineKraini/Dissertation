...
(async function() {
  ...
  promise_test(async (t) => {
    ...
    assert_false(await FrameHasStorageAccess(frame), "innermost frame has no storage access a󠁋fter refresh.");
  ...
  }, "Same-site-initiated cross-origin navig	ations do not preserve storage access");
