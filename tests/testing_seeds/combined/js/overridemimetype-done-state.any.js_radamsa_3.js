...
client.onreadystatechange = test.step_func( function() {
  ...
  if (GLOBAL.isWindow()) {
    assert_equals(client.respon { client.overrideMimeType('application/xml;charset=Shift-JIS'); });
  if (GLOBAL.isWindow()) {
    assert_equals(client.responseXML, null);
  }
  assert_equals(client('text/plain;charset=Shift-JIS'); });
  if (GLOBAL.isWindow()) {
    assert_equals(client.responseXML, null);
  }
  assert_equals(client.responsection() { client.overrideMimeType('application/xml;charset=Shift-JIS'); });
  if (GLOBAL.isWindow()) {
    assert_equals(client.responseXML, null);
  }
