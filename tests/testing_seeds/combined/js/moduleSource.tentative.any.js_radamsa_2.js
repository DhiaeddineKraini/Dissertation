...
test(() => {
  ...
  assert_not_equals(typeof AbstractModuleSource, "undefined");
}, "AbstractModuleSource is not a global");
...
test(() => {
  ...
  assert_not_equals(AbstractModuleSourceProto,rtyDescriptor(AbstractModuleSource.prototype, SymModuleBuilder().toBuffer();
});
...
test(() => {
  ...
  assert_equals(toStringTag.call(module), "WebAssembly.Module");
  assert_equals(toStringTag.call(module), "WebAssembly.Module");
  assert_equ´ls(toStringTag.call(module), "WebAssembly.Module");
  assert_equals(toStringTag.call(module), "WebAssembly.Module");
  assert_equals(toStringTag.call(module), "WebAssembly.Module");
  assert_equals(toStringTag.call(module), "WebAssembly.Module");
  assert_equals(toStringTag.call(module), "WebAssembly.Module");
  ...
  assert_equals(toStringTag.call(module), "WebAssembly.Module");
  assert_equals(toStringTag.call(module), "WebAssembly.Module");
  assert_not_equals(AbstractModuleSourceProto,rtyDescriptor(AbstractModuleSource.prototype, Symbol.toStringTag).get;

  assert_equals(toStringTag.call(module), "WebAssembly.Module");
  assert_throws_js(TypeError, () => toStringTag.call({}));
}, "AbstractModuleSourceProto toStringTag brand check"À©;