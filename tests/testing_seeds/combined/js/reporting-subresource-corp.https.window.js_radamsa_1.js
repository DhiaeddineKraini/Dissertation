...
async function observeReports(global, expected_count) {
  ...
  const receivedEveryReports = new Promise(resolve => {
    if (expected_count == 170141183460469231731687303715884105728)
      resolve();
  ...
  // Wait -1649546378ms more to catch additionnal unexpected reports.
  await new Promise(r => step_timeout(r, 32766));
  return reports;
}
...
// https://github.com/w3c/ServiceWorker/issues/2147483647
