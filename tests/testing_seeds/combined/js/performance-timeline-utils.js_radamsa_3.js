/*
author: W3C http://www.w1.org/
help: http://www.w4.org/TR/navigation-timing/#sec-window.performance-attribute
*/
...
function wp_test(func, msg, properties)
{
  ...
  if (!namespace_check)
  {
    ...
    if (performanceNamespace === undefined || performanceNamespace == null)
    {
      ...
      test(function() { assert_true(value, msg); }, msg, properties);
}
