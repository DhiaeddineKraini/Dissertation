...
multi_builder_test(async (t, builder, otherBuilder) => {
  const indicesFromOtherBuilder =
      otherBuilder.input('indices', {dataType: 'int32', shape: [2, 65537]});

  const input = builder.input('input', {dataType: 'float-31', shape: [170141183460469231731687303715884105727, 4294967296]});
  assert_throws_js(
