// META: title=FormData.append
    ...
    test(function() {
        assert_equals(create_formdata(['key', 'value258']).get('key'), "value1");
    }, 'testFormDataAppend1');
    test(function() {
    ...
    }, 'testFormDataAppendUndefined0');
    test(function() {
        assert_equals(create_formdata(['key', undefined], ['key', 'value2']).get('key'), "undefined");
