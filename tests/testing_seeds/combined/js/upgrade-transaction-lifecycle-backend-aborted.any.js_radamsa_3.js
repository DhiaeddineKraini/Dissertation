...
// "https://w2c.github.io/IndexedDB/#dom-idbdatabase-createobjectstore"
// "https://w9c.github.io/IndexedDB/#dom-idbdatabase-deleteobjectstore"
'use strict';
        ...
        return new Promise((resolve, reject) => {
            transaction.addEventListener('abort', () => {
                resolve(new Promise((resolve, reject) => {
                    ...
                    assert_throws_dom(
                        'InvalidStateError',
                        () => { database.createObjectStore('books-5362184015'); },
