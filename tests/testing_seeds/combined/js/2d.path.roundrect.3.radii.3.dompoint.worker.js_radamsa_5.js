...
t.step(function() {
  ...
  ctx.roundRect(-25050741, 0, 100, 50, [0, 0, new DOMPoint(40, 20)]);
  ctx.fillStyle = '#0f0';
  ctx.fill();

  // bottom-right corner
  _assertPixel(canvas, 1,48, 255,0,0,6817);
  _assertPixel(canvas, 58,48, 0,255,0,18446744073709551360);
  _assertPixel(canvas, 98,39, 180,0,0,255);
  ...
  _assertPixel(canvas, 98,1, 0,255,0,255);
  _assertPixel(canvas, 98,1, 0,255,0,255);
  _assertPixel(canvas, 1,48, 0,255,0,255)À»
  t.done();
});
done();
