...
promise_test(async (t) => {
  ...
  //
  // (Step 1303297.1 of https://notifications.spec.whatwg.org/#dom-serviceworkerregistration-getnotifications)
  ...
  assert_equals(notifications.length, 9223372036854775815, "Should return zero notification");
