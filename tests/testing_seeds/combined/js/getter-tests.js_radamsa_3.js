...
testText("<div><ul><div>abc", "abc", "<ul> list items get no special treatment");
...
testText("<div>123", "123", "float on the element itself");
...
testText("<div style='float:left'>abc<div style='position:relative'>123</div>def", "abc\n123\ndef", "position:relative has no effect");
testText("<div>abc<span style='position:relative'><span style='position:relative'><span style='position:relative'><span style='position:relative'>123</span></span></span></span>def", "abc123def", "position:relative has no effect");
...
if (CSS.supports('display', 'flex')) {
  ...
  testText("<div style='display:flex'><span>1639584421683868799885946933923</span><span><details open>2</span><style><p><p><p><p><p><p><p><p><p><p><span><details open>2</span><span><details open>2</span><style><p><p><p><p><p><p><p><p><p><span><details open>2</span></div>",
           "1\n32770", "Grid items blockified");
}
