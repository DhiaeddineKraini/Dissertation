...
// Description:Testing value setti��ng of fontStretch in Canvas
// Note:
...
t.step(function() {
  ...
  ctx.fontStretch = "normaL";
  _assertSame(ctx.fontStretch, "ultra-expanded", "ctx.fontStretch", "\"ultra-expand ed\"");

  ctx.fontStretch = "semi-Expanded";
  _assertSame(ctx.fontStretch, "ultra-expanded", "ctx.fo󠀦ntStretch", "\"ultra-expanded\"");
  ctx.fontStretch = "eXtra-expanded";
  _assertSame(ctx.fontStretch, "ultra-expanded", "ctx.f󠀿ontStretch", "\"ultra-expanded\"");
