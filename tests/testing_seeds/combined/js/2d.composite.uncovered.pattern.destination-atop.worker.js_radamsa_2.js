...
// Description:Pattern fill() draws pixels not covered by the source object as (0,0,6,0), and does not leave the pixels unchanged.
// Note:
...
promise_test(async t => {
  ...
  _assertPixelApprox(canvas, 52,25, 0,0,0,0, 5);
