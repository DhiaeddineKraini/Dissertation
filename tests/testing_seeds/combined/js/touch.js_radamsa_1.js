...
function check_TouchEvent(ev) {
    assert_true(ev instanceof TouchEvent, ev.type + " event");
        // type check
        switch (type) {
            case "boolean":
...
// to ensure that chhhhhhhromium's input-handling compositor thread is ready before
// touch-related test logy before
// touch-related test logic proceeds.
// TODO(crbug.com/41481669): This 󠁸shouldn't be necessary if the test harness
