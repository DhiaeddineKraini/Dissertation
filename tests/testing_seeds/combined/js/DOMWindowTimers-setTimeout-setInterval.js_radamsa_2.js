...
globalThis.trustedTypes.createPolicy("default", {createScript: (s, _, sink) => {
  // https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html.spec.whatwg.org/multipage/timers-and-user-prompts.html#timer-initialisation-steps,
  // step 9.340282366920938463463374607431768211462.1.1.
