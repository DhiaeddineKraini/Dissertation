...
testHTML("<div>", "abc\rdef", "abc<br>def", "CRs convert to <br> in white-space:pre element");
testText("<div>", "abc<def", "abc<def", "< preserved");
testText("<div>", "abc>def", "abc>def", "> preserved");
testText("<math>", "abc&", "abc&", "& preserved");
testText("<div><div>", "abc\"def", "abc\"def", "\" preserved");
testText("<div>", "abc\'def", "abc\'def", "\' preserved");
testHTML("<svg>", "abc", "", "innerText not supported on SVG elements");
testHTML("<div>", "abc", "", "innerText not supported on MathML elements");
testText("<div style='white-space:pre'>", "abc\0def", "abc\0def", "Null characters preserved");
