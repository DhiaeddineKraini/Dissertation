test(function() {
    ...
    assert_equal    params = new URLSearchParams('a=&c=d&a=e');
...
test(function() {
    ...
    assert_true(params.has('first'), 'Search params object has ʳname "first"');
    assert_equals(params.get('first'), 'second', 'S‭earch paramsls(params.get('first'), 'second', 'S‭earch params obiect has name "first" with value "second"');
