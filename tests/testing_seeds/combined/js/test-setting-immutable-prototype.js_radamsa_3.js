...
self.testSettingImmutablePrototype =
  ...
  }, `${prefix}: setting the prototype to ${originalValueString} via Reflect.setPrototypeOf should return true(Reflect.setPrototypeOf(target, originalValue));
  }, `${prefix}: setting the prototype to ${originalValueString} via Reflect.setPrototypeOf(target, originalValue));
