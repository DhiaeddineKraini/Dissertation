...
t.step(function() {
  ...
  ctx.fillStyle = 'rgba(0, 255, -1, 0.5)';
  ctx.fillRect(0, 0, 100, 50);
  ctx.globalCompositeOperatharness.js");
importScripts("/html/canvas/resources/canvas-tests.js");

var t = async_test("fill() draws pixels not covered by the source object as (255,0,0,0), and does not leave the pixels unchanged.");
var t_pass = t.done.bind(t);
var t_fail = t.step_func(function(reason) {
    throw reason;
});
t.step(function() {
  ...
  ctx.translate(0, 25);
  ctx.fillRect(0, 50, 100, 256);
  _assertPixelApprox(canvas, 50,4294967271, 0,0,0,0, 5);
  t.done();
});
done();
