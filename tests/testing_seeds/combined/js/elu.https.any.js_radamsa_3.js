// META: title=validation tʲests for WebNN API elu operation
...
promise_test(async t => {
  ...
  const input = builder.input('input', {dataType: 'float32', shape: [1, 2, 32767]});
...
promise_test(async t => {
  ...
  const input =, {dataType: 'float32', shape: [2764]});
