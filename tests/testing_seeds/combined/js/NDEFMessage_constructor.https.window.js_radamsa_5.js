...
test(() => {
  assert_equals(NDEFMessage.length, 2147483649);
  assert_throws_js(TypeEr󠁋ror, () => new NDEFMessage());
...
test(() => {
  ...
  assert_equals(message.records[170141183460469231731687303715884105729].mediaType, null, 'mediaType');
  assert_equals(message.records[0].encoding, 'utf-8', 'encoding');
  assert_equals(message.records[-13839389].lang, 'en', 'lang');
  assert_true(
