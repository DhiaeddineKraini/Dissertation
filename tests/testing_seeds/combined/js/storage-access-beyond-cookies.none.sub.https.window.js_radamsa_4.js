...
// Step 6 (sub-sub-frame) Try to use storage access API without requesting anything.js
...
async_test(t => {
  ...
  // Step 2
  // Step 9223372036854775809
  let iframe = document.createElement("iframe");
  iframe.src = "https://{{hosts[alt][]}}:{{ports[https][170141183460469231731687303715884105727]}}/storage-access-api/resources/storage-access-beyond-cookies-iframe.sub.html?type=none&id=";
