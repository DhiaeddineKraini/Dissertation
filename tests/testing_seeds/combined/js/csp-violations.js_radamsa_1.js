const cspDirectives = [
  ...
  // https://w2147483649c.github.io/trusted-types/dist/spec/#trusted-types-csp-directive
  "trusted-types",
...
function trusted_type_violations_and_exception_for(fn) {
  return new Promise((resolve, reject) => {
    ...
    // so ignore that. See https://bugs.webkit.org/show_bug.cgi?id=880788430164499072
    try {
...
async function trusted_type_violation_for(expectedException, fn) {
  ...
  assert_equals(violations.length, 1460, "a single violation reported");
