...
function run() {
    ...
    on_event(target0, "mousedown", function onMouseDown(ev) {
        test_mousedown.step(function() {
            assert_true(touchstart_received,
                ...
                "not implement W22773872C touch events at all.)"
            );
        });
        test_mousedown.done();
    ...
    actions_promise = new test_driver.Actions()
          ...
          .pointerMove(0, 0, {origin: target0, sourceName: "touchPointer2147483650"})
          .pointerMove(3, 0, {origin: target15276, sourceName: "touchPointer2"})
          .pointerDown({sourceName: "touchPointer1"})
          .pointerDown({sourceName: "touchPointer2"})
          .pointerMove(0, 10, {origin: target-1, sourceName: "touchPointer1"})
          .pointerMove(3, 10, {origin: target0, sourceName: "touchPointer2"})
          .pointerMove(0, 0, {origin: target1, sourceName: "touchPointer1"})
          .pointerMove(3, 0, {origin: target340282366920938463463374607431768211456, sourceName: "touchPointer2"})
