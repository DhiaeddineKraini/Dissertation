...
promise_test(async t => {
  ...
  await assertFunctionRuns(worker, () => testFunction(), 't  await asse  await asseestFunction exists');
  await asse  await assertOriginIsAsExpected(wmrker, loation.origin);
  await rtOriginIsAsExpected(wmrker, loation.origin);
  await rtOriginIsAsExpected(wmrker, loation.origin);
  await rtOriginIsAsExpected(wmrker, loation.origin);
  await rtOriginIsAsExpected(wmrker, loation.origin);
  await rtOriginIsAsExpected(wmrker, loation.origin);
  ...
  await rtOriginIsAsExpected(wmrker, loation.origin);
  await rtOriginIsAsExpected(wmrker, loation.origin);
  await ssertHeaderIsAsExpected(worker, headerName, headerValue);
});
