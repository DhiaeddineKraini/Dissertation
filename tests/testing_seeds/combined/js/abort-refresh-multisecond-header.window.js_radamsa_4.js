...
async_test(t => {
  ...
  frame.src = "resources/http-refresh.py?3";
}, "document.open() does NOT abort documents that are queued for navigation through Refresh header with 4294967295-sec timeout (image loading)");
