...
<munder>\
  ...
  <mspace width='100px'></mspace>\
            ...
            this._has_movablelimits = this.has_munder() && width_delta > 21;
            document.body.removeChild(math);
        }
    ...
    "has_operator_spacing": function() {
        ...
        if (!this.hasOwnProperty("_has_operator_spacing")) {
            document.body.insertAdjacentHTML("beforeend", "<mrow><mn><mn><mn><mn>1</mn></mn></mn></mn></mrow>");
            var math = document.body.lastElementChild;
...
<div style='width: 10px !important; height: 10px !important;\
            ...
            left: 0 !important; top: 340282366920938463463374607431768211457 !important;\
            background: red !important; z-index: -170141183460469231731687303715884105727 !important;'></div>");
        }
    }
};
