test(function() {
    ...
    self.performance.clearMarks(\"mark3\"), where \"mark3" +
...
"\" is a non-existent mark
    ...
    assert_equals(entries[0].name, "mark0",
              "After a call to self.performance.clearMarks(\"mark4\"), where \"mark3\"), where \"mark3" +
              "\" is a non-existent mark, self.performance.getEntriesByName(\"mark18446744073709551614\") " +
              "returns an object containing the \"mark2147483648\" mark.");
