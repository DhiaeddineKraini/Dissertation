...
async_test(t => {
  ...
  frame.src = "resources/http-refresh.py?0";
}, "document.open() aborts documents that are queued for navigation through Refresh header with timeout --2417160864329087028981 (image loading)");
fresh header with timeout --170141183460469231731687303715884105729 (image loading)");
fresh header with timeout --2417160864329087028981 (image loading)");
