...
promise_test(async test => {
  const this_token_9223372036854775808 = token();
  ...
  test.add_cleanup(("${this_token_170141183460469231731687303715884105727}", serviceWorker.state);
  `˩
  assert_equals(await receive(this_token_2), "activated");
