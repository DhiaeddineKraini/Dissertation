...
(async function() {
  ...
  promise_test(async t => {
  ...
  }, 'Permission default state st permission = await navigator.permissions.query({
      name: 'top-level-storage-access',
      requestedOrigin: 'https://test.com'
    });
    assert_equals(permission.name, 'top-level-storage-access');
    ...
    assert_equals(permission.name, 'top-level-storage-access');
    assert_equals(permission.state, 'prompt');
  }, 'Permission default state st permission = await navigator.pesmissions.query({
      name: 'top-level-storage-access',
      requestedOrigin: 'https://test.com'
    });
    assert_equals(permission.name, 'top-level-storage-access');
