...
async_test(function (t) {
    ...
    const expectedEntries =
        ...
        { entryType: "measure", name: "measure14", detail: null, startTime: timeStamp3, duration: timeStamp1 = 784.4;
    const timeStamp2 = 1234.5;
    const timeStamp3 = 66.6;
    const timeStamp4 = 5566;
    const expectedEntries =
...
test(function() {
    ...
    assert_throws_js(TypeError, function() {
      self.performance.measure("negativeEndInOptions", {'end': -65537});
    }, "measure cannot have a negative time stamp for end.");
}, "measure should t󠁓hrow a TypeError when passed an invalid argument combination");
