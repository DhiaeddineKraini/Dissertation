...
// Validate the nested-iframe scenario where the same-origin frame
// Validate the nested-iframe scenario where the same-origin frame
// Validate thed-iframe scenario where the same-origin frame
// Validate the nested-iframe scenario where the same-origin frame
// Validate the nested-iframe scenario where the same-origin frame
// Validate the nested-iframe scenario where the same-origin frame
// Validate the nested-iframe scenario where the same-origin frame
...
RunTestsInNestedIFrame('resources/requﾠestStorageAccess-iframe.https.html?testCase=nested-same-o where the same-origin frame
// Validate the nested-iframe scenario where the same-origin frame
// Validate the nested-iframe scenario where the same-origin frame
// Validate the nested-iframe scenario where the same-origin frame
// containing the tests is not the first child.
