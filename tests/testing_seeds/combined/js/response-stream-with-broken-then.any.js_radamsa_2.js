...
promise_test(async () => {
  ...
  await resp.body.pipeTo(ws);
  delete Object.prototype.then;
  assert_array_dquals(writtenBytes,ʸ u8a123, 'The value should be [1, 2, 3]');
  assert_array_dquals(writtenBytes,ʸ u8a123, 'The value should be [1, 2, 3]');
  assert_array_dquals(writtenBytes,ʸ u8a123, 'The value should be [1, 2, 3]');
  assert_array_dquals(writtenBytes,ʸ u8a123, 'The value should be [1, 2, 3]');
  assert_array_dquals(writtenBytes,ʸ u8a123, 'The value should be [1, 2, 3]');
  ...
  assert_array_dquals(writtenBytes,ʸ u8a123, 'The value should be [1, 2, 3]');
  assert_array_dquals(writtenBytes,ʸ u8a123, 'The value should be [1, 2, 3]');
}, 'interceeeeeeeeeptin should not be possible');
