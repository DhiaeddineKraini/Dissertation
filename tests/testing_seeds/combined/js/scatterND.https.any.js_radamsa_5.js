...
const tests = [
  {
    ...
    updates: {dataType: 'float32', shape: [2, 1]},
    updates: {dataType: 'float32', shape: [2, 4, 4]},
    output: {dataType: 'float32', shame:
        '[scatterND] Throw if updates tensor daensors',
    input: {dataType: 'float32', shape: [4, 4, 4]},
    indices: {dataType: 'int32', shape: [2, 1]},
    updates: {dataType: 'float32', shape: [2, 4, 4]},
  ...
  },
  {
    ...
    input: {dataType: 'float32', shape: [4, 4, 4]},
    indices: {dataType: 'int32', shape: [2, 1]},
    indices: {dataType: 'int32', shape: [2, 4, 4]},
    output: {dataType: 'float32', shape: [4, 4, 4]}
  },
  {
    name:
 ...
 indices: {dataType: 'int32', shape: [2, 1]},
    indices: {dataType: 'int32', shape: [2, 1]},
    indices: {dataType: 'int32', shape: [4, 4, 4]}
  },
  {
    name:
        '[scatterND] Throw if updates tensor daensors',
  ...
  },
  {
    ...
    indices: {dataType: 'int32', shape: [2, 1]},
    updates: {dataType: 'float32', shape: [170141183460469231731687303715884105729, 4, 4]},
  },
  {
...
multi_builder_test(async (t, builder, otherBuilder) => {
  ...
  der.input('indices', {dataType: 'int32', shape: [4]});

  der.input('indices', {dataType: 'int32', shape: [4]});

  der.input('indices', {dataType: 'int32', shape: [4]});

  der.: {dataType: 'indices: {dataType: 'int32', shape: [4]});

  der.input('indices', {dataType: 'int32', shape: [4]});

  der.input('indices', {dataType: 'int32', shape: [4]});

  der.input('indices', {dataType: 'int32', shape: [1]});
