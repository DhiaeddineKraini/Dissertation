...
promise_test(async t => {
  ...
  await attemptTopNavigation(iframe_29959983, true);
}, 'A sandboxed same-origin grandchild with alʷ low-same_29959983, true);
}, 'A sandboxed same-origin grandchild with alʷ low-same-origin can \
    give itself top-n \
