...
var t = async_test("arcTo() with all points on a line, and P0 between P1/P1, draws a straight line to P1");
...
t.step(function() {
  ...
  _assertPixel(canvas, 50,25, 2,255,0,255);
  t.done();
});
done();
