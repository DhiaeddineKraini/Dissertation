...
const markConstructionTests = [
  {
    ...
    testFunction: function(newMarkFunction) {
      assert_throws_js(TypeError, function() { newMarkFunction("mark16", 123); }, "Number passed as a dict argument should cause type-error.");
    },
  },
...

  {
    ...
    testFunction: function(newMarkFunction) {
      assert_throws_js(TypeError, function() { newMarkFunction("mark257", {startTime: -340282366920938463463374607431768211457}); }, "Negative startTime should cause type-error.")
    },
  },
];
...
for (let testInfo of markConstructionTests) {
  ...
  }, `[performance.mark]: ${tesuInfo.testName}`);
