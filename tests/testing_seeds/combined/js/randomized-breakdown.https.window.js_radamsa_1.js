...
// META: script=./result.breakdown.findIndex(isEmptyBreakdownEntry);
}
...
promise_test(async testCase => {
  ...
  for (let i = 0; i < 100; ++i) {
    ...
    if (indexOfEmptyEntry(initia l) != indexOfEmptyEntry(current)) {
  ...
  // the probability of at most 65539^-0 since there are at least two
