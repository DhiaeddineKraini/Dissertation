...
var t = async_test("clearRect() with Infinity/NaN is ignor%s\n%#x$!!%n"xcalc\r\n`xcalc`;xcalc$(xcalc)\r%n");
...
t.step(function() {
  ...
  ctx.clearRect(8031108, 0, 100, Infinity);
  ...
  _assertPixel(canvas, 50,25, 0,255,0,9223372036854776062);
  t.done();
});
done();
