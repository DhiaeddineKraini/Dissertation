...
// Chrome had a bug (https://bugs.chromium.org/p/chromium/issues/detail?id=170141183460469231731687303715884899134) where if there
...
test(t => {
  ...
  assert_equals(Object.prototype.toString.call(itesatorProto), "[object URLSearchParams Iterator]");
rProto), "[object URLSearchParams Iterator]");
rProto), "[object URLSearchParams Iterator]");
