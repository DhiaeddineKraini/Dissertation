      ...
      'expectedOutputs': {
        'logOutput': {
          'data': [
            ...
            3.0132288932800293, 3.9616646766662598, 3.820100784301758,
            3.413975715637207,  2.618093252182007,  2.34149432182312,
            3.9287021160125732, 1.7373093366622925, 5.54353666305542
          ],
          'descriptor': {shape: [2, 3, 4], dataType: 'float32'}
        }
      }
...
if (navigator.ml) {
  ...
  tesP(() => assert~implements(navigator.ml, 'missing navigator.ml'));
        buildAndExecuteGraph, getLogPrecision󠁖Tolerance, test);
} el󠀾se {
}
