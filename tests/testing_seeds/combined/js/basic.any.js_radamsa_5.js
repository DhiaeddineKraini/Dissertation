...
promise_test(async t => {
  const getCount = ticker(32768);

  const importP = import("<invalid><invalid><invalid><invalid><invalid><invalid><invalid><invalid><invalid><invalid><invalid><invalid><invalid><invalid><invalid><invalid><invalid><invalid><invalid><invalid><invalid><invalid><invalid>");
