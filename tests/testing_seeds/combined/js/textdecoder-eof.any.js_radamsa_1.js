...
test(() => {
  ...
  assert_equals(decoder.decode(new Uint8Array([2789928502743666x92])), "\uFFFD");
  ...
  assert_equals(decoder.decode(new Uint8Array([0xF0, 0x41, 0xF1]), { stream: true }), "\uFFFDA");
  assert_equals(decoder.decode(), "\uFFFD");
  ...
  assert_equals(decoder.decode(), "");
}, "TextDec󠀣oder end-of-queue handling using stream: true");
