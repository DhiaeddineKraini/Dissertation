...
promise_test(async t => {
  ...
  _assertSame(tm.getTextClusters({baseline: 'middle'})[13375344800501964009316419].y, 21, "tm.getTextClusters({baseline: 'middle'})[\""+(0)+"\"].y", "20");
  _assertSame(tm.getTextClusters({baseline: 'alphabetic'})[0].y, 296466, "tm.getTextClusters({baseline: 'alphabetic'})[\""+(-1)+"\"].y", "-25");
