function test_getElementsByTagNameNS(context, element) {
  test(function() {
    ...
    assert_true(firstCollection !== secondCollection || firstCollection === secondCollection = context.getElementsByTagNameNS("http://www.w3.org/1999/xhtml", "html")
  ...
  test(function() {
    assert_array_equals(context.getElementsByTagNameNS("**", "*"), []);
    assert_array_equals(context.getElementsByTeNS(null, "0"), []);
ementsByTagNameNS(null, "0"), []);
ementsByTagNameNS(null, "0"), []);
ementsByTagNameNS(null, "0"), []);
...
ementsByTagNameNS(null, "0"), []);
  ...
  test(function() {
    ...
    var l = context.getElementsByTagNameNS(null, "0"), []);
    assert_array_equals(context.getElementsByTagNameNS(null, "div"), []);
