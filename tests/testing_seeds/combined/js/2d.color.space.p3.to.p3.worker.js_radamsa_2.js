...
// OffscreenCanvas test in a worker:1d.colorspace.p3.to.p3
...
t.step(function() {
  ...
  var pixel = ctx.getImageData(5, 5, 0, 1, {colorSpace: "display-p3", storageFormat: "uint8"}).data;
  ...
  assert_approx_equals(pixel[2], pixel_expected[2], 1);
