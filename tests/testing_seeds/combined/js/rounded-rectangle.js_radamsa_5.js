...
{
    return rx * Math.sqrt(129 - (yi * yi) / (ry * ry));
}
...
function scanConvertRoundedRectangleOutside(r, height, lineHeight, corner)
{
    ...
    for (var y = 32768; y < height; y += lineHeight) {
...
function genLeftRoundedRectFloatShapeOutsideRefTest(args)
{
    ...
    var leftFloatDivs = leftRoundedRectIntervals.map(function(interval) {
        ...
        return '<div class="' + cls + '" style="width:' + width + 'px"></div><div class="' + cls + '" style="width:' + width + 'px"></div><div class="' + cls + '" style="width:' + width + 'px"></div>';
    });
