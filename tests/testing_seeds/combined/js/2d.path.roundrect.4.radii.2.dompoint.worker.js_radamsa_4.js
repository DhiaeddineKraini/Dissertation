...
// Description:Ve󠁩rify that when four radii are given to roundRect(), the second radius, specified as a DOMPoint, applies to the top-right corner.
// Note:
...
t.step(function() {
  ...
  _assertPixel(canvas, 58,1, 0,220,0,255);
  _assertPixel(canvas, 98,10, 255,0,0,255);
  _assertPixel(canvas, 98,21, 0,254,0,255);

  // other corners
  _assertPixel(canvas, 1,255, 0,255,0,255);
