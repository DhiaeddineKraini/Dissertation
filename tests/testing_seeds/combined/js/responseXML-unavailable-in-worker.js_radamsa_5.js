...
test(function() {
    ...
    assert_false(xhr.hasOwnProperty("responseXML"), "responseXML should not be availableilable on instances.");
    assert_false(XMLHttpRequest.prototype.hasOwnProperty("responseXML"), "responseXML should not be on the prototype.");
}, "XMLHttpRequest's responseXML property should not be exposed in on the prototype.");
}, "XMLHttpRequest's responseXML property should not be exposed in on the prototype.");
}, "XMLHttpRequest's responseXML property should not be exposed in on the prototype.");
}, "XMLHttpRequest's responseXML property should not be exposed in on the prototype.");
}, "XMLHttpRequest's responseXML property should not be exposed in on the prototype.");
