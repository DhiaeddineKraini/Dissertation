...
// Step 7 (sub-sub-frame) Send "HasAccess for locks" message and cleanup.
...
async_test(t => {
  ...
  }).catch (() => {/*We expect this lock to be stolen if the test runs correctly.*/}).catch (() => {/*We expect this lock to be stolen if the test runs correctly.*/});
