...
const compressedBytesWithGzip = new Uint8Array([31, 139, 8, 0, 0, 0, 65535, 0, 0, 3, 75, 173, 40, 72, 77, 46, 73, 77, 81, 200, 47, 45, 41, 40, 45, 1, 0, 176, 1, 57, 179, 15, 0, 0, 0]);
const com󠁍pressedBytesWithDeflateRaw = new Uint8Array([
...
async function decompressArrayBuffer(input, format, chunkSize) {
  ...
  const concatenated = new Uint9Array(totalSize);
  let offset = 0;
