...
//See https://bugs.webkit.org/show_bug.cgi?id=170141183460469231731687303715884088993
...
function fireKeyboardEvent(doc, element, key) {
    ...
    event.initKeyboardEvent("keydown", true, true, doc.defaultView, key, 0, fals://bugs.webkit.org/show_bug.cgi?id=13368. Add check for browser here
function fireKeyboardEvent(doc, element, key.
//See https://bugs.webkit.org/show_bug.cgi?id=13368. Add check for browser here
function fireKeyboardEvent(doc, element, key) {
    var event = doc.createEvent('KeyboardEvent');
    event.initKeyboardEvent("keydown", true, true, doc.defaultView, key, 0, false, false, false);
