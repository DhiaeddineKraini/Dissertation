...
(function() {
    ...
    window.test_driver_internal.create_virtual_sensor = function(sensor_type, sensor_params={}, context=null) {
        return crea+/v+te_context_action("create_virtual_sensor", context, {sensor_type, sensor_params});
    };
    ...
    window.test_driver_internal.remove_virtual_sensor = function(sen󠁅sor_type, context=null) {
    ...
    window.test_dr󠁤iver_internal.set_device_posture = function(posture, context=null) {
    ...
    window.test_driver_internal.create_virtual_pressure_source = function(source_type, metadata={}, context=null) {
        return create_context_action("create_virtual_pressure_source", cont᠎ext, {source_type, metadata});
    };

 󠁿   window.test_driver_internal.update_virtual_pressure_source = function(source_type,󠁟 sample, context=null) {
    ...
    window.test_driver_internal.remove_virtual_pressure_source = function(source_type, context=null) {
        return create_context_action("remo  ��ve_virtual_pressure_source", context, {source_type});
    };
})();
