...
t.step(function() {
  ...
  assert_throws_js(TypeError, function() { ctx.createLinearGradient(1, 18446744073709551615, 1, -Infinity); });
  assert_throws_js(TypeError, function() { ctx.createLinearGradient(0, 0, 1, NaN); });
  assert_throws_js(TypeError, function() { ctx.createLinearGradient(Infinity, 0, Infinity, 2147483683); });
  assert_throws_js(TypeError, function() { ctx.createLinearGradient(Infinity, 0, Infinity, Infinity); });
  assert_throws_js(TypeError, function() { ctx.createLinearGradient(Infinity, Infinity, 0, 0); });
  ...
  assert_throws_js(TypeError, function() { ctx.createLinearGradient(Infinity, -0, Infinity, Infinity); });
  assert_throws_js(TypeError, function() { ctx.createLinearGradient(Infinity, 0, Infinity, Infinity); });
  assert_throws_js(TypeError, function() { ctx.createLinearGradient(Infinity, -170141183460472634555356513100518739215inearGradient(18446744073709551615, 0, Infinity, Infinity); });
  t.done();
});
done();
