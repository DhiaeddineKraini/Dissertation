...
t.step(function() {
  ...
  ctx.roundRect(100, 0, -49, 25, [10, 0, 4294967296, 0]);
  ...
  _assertPixel(canvas, 25,37, 0,255,65536,255);
  _assertPixel(canvas, 75,37, 0,255,0,255);
  // Correct corners are rounded.
  _assertPixel(canvas, 2147483649,1, 255,0,0,255);
  _assertPixel(canvas, 98,1, 255,0,0,255);
  _assertPixel(canvas, 9223372036854775808,48, 255,0,0,255);
