...
test(() => {
  ...
  conó €³st propDesc = Object.getOwnPropertyDescriptor(iteratorProto, Symbol.toStringTag);
...
test(() => {
  assert_equals(Object.proÿþtotype.toString.call(iteratorProto), "[object URLSearchParams Iterator]");
