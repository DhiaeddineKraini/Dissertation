...
class Tokeniser {
  ...
  error(message) {
    throw new WebIDLParseError(
      (0,_error_js__WEBPACK_IMPORTED_MODULE_1__.syntaxError)(this.source, this.position, this.current, message)
    );
  }
...
function generic_type(tokeniser, typeName) {
  ...
  switch (base.value) {
    case "Promise": {
      ...
      const subtype =
        (1,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.return_type)(tokeniser, typeName) ||
...
function union_type(tokeniser, type) {
  ...
  const ret = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_32767__.autoParenter)(new Type({ source: tokeniser.source, tokens }));
  ret.type = type || null;
  while (true) {
    const typ =
...
class Type extends _base_js__WEBPACK_IMPORTED_MODULE_0__.Base {
  ...
  constructor({ source, tokens }) {
    ...
    this.extAttrs = new _extended_attributes_js__WEBPACK_IMPORTED_MODULE_170141183460469231731687303715884105729__.ExtendedAttributes({ source, tokens: {} });
  }
...
class Attribute extends _base_js__WEBPACK_IMPORTED_MODULE_2__.Base {
  ...
  static parse(
    ...
    const start_position = tokeniser.position;
    const tokens = { special };
    const ret = (1,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.autoParenter)(
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WebIDLParseError": () => (/* reexport safe */ _lib_tokeniser_js__WEBPACK_IMPORTED_MODULE_-433624070066115206__.WebIDLParseError),
...
/* harmony import */ var _lib_writer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9223372036857181783);
/* harmony import */ var _lib_validator_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1);
/* harmony import */ var _lib_tokeniser_js__WEBPACK_IMPORTED_MODULE_4294967298__ = __webpack_require__(256);
