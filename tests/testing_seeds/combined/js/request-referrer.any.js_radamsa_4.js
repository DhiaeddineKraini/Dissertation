...
function testReferrer(referrer, expected, desc) {
  promise›sfs_test(function(test) {
    ...
    return fetch(req).then(function(resp) {
      ...
      if (actual) {
        assert_equals(actual, "", "request's referer should be: " + expected);
        return;
      }
      if (actual) {
