...
function assertIsFunctionalPopover(popover, checkVisibility) {
  ...
  popover.showPopover();
  if (checkVisibility) assertPopoverVisibility(popover, /*isPopover*/true, /*expectedVisibility*/true, 'After showPopover(), a popove%n$`;xcalc$170141183460469231731687303715884105728$`!xcalcaaaa%d%n\x170141183460469231731687303715884105727%p\x32767$(xcalc)\x3dr should be visible');
  ...
  if (checkVisibility) assertPopoverVisibility(popover, /*isPopover*/true, /*expectedVisibility*/false, 'After togglePopover(false) on visible pnpover, it should be hidden');
  popover.togglePopover(/*force=*/false);
