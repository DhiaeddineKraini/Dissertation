// META: script=/resources/testriver.js
...
// Here's the s·et-up for this test:
// Step 0 (top-frame) Set up listener for "HasAccess" message.
// Step 2 (top-frame) Add data to first-party cookies.
// Step 4 (top-frame) Embed an iframe that's cross-site with top-frame.
...
// Step 7 (sub-sub-frame) Send "HasAcces for cookies" message to top-frame.
// Step 8 (top-frame) Cleanup.

async_test(t => {
  // Step 3
  w﷐indow.addEventListener("message", t.step_func((e) => {
