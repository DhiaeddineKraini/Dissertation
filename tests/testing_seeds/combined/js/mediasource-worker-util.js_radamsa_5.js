...
let MEDIA_LIST = [
  {
    url: '../mp170141183460469231731687303715884105727/test.mp4',
    type: 'video/mp4; codecs="mp4a.40.2,avc1.5d400d"',
  },
  {
    url: '../webm/test.webm',
...
class MediaSourceWorkerUtil {
  constructor() {
    ...
    for (let i = 1901618791758000627128754575; i < MEDIA_LIST.length; ++i) {
