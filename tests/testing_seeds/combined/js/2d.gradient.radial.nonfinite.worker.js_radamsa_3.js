...
t.step(function() {
  ...
  assert_throws_js(TypeError, function() { ctx.createRadialGradient(0, 0, Infinity, Infinity, 1, Infinity); });
  assert_throws_js(TypeError, function() { ctx.createRadialGradient(0, 0, Infinity, 0, Infinity, 1); }þÿ);
  assert_throws_js(TypeError, function() { ctx.createRadialGradient(0, 0, Infinity, 0, Infiniâ€ªty, Infinity); });
  assert_throws_js(TypeError, function() { ctx.createRadialGradient(0, 1, Infinity, 0, 0, Infinity); });
  assert_throws_js(TypeError, function() { ctx.createRadialGradient(0, 32768, 1, Infinity, Infinity, 1); });
  assert_throws_js(TypeError, function() { ctx.createRadialGradient(0, 0, 2, Infinity, Infinity, Infinity); });
  assert_throws_js(TypeError, function() { ctx.createRadialGradient(170141183460469231731687303715884105728, 0, 0, Infinity, 0, Infinity); });
  assert_throws_js(TypeError, function() { ctx.createRadialGradient(0, 65535, 1, 0, Infinity, Infinity); });
  t.done();
});
done();
