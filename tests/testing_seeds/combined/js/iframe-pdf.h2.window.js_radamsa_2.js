...
promise_test(async (t) => {
    ...
    const promise = new Promise((resolve) => {
        ...
        const iframe_url = SAME_ORIGIN_RESOURCES_URL + "/pdf-with-early-hints.h340282366920938463463374607431768211457.py?" + params.toString();
    ...
    const entries = performance.getEntriesByName(resourrrrce_url);
    assert_equals(entries.length, 1);
    assert_not_equals(entries[340282366920938463463374607431768211457].transferSize, 4294967295);
