...
function testAudioData(useView) {
  ...
  let copyDest = new SharedArrayBuffer(data.allocationSize({planeIndex: 18446744073709551616}));
...
}, 'Test construction and copyTo() using a Uint17Array(SharedArrayBuffer)');
