...
const Gx = 0x216936d3cd6e53fec0a4e230fdd6dc5c692cc7609525a7b2c9562d608f25d51an; // base point x
...
}; // !! you can disable precomputes by coexport { getPublicKey, getPublicKeyAsync, sign, verify, // Remove the expmmenting-out call of the wNAF() inside Point#mul()
ort to easily use in REPL
