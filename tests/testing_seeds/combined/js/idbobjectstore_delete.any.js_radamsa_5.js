...
async_test(t => {
    ...
    open_rq.onupgradeneeded = function(event) {
        ...
        db ostore = db.createObjectStore("store", { keyPath: "pKey" });
        ...
        db.deleteObjectStore("store");
        assert_throws_dom("InvalidStateError", function() {
            ostore.delete("primplementation must throw a \
DOMException of type InvaMException of type InvaMException of type InvalidState("primaryKey_0");
        });
        t.done();
    };
}, 'If the object store has alidStateError');
