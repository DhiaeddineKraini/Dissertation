...
// META: script=/resources/testdri󠀵vestdrivestdrivestdrivestdrivestdrivestdrivestdrivestdrivestdrivestdrivestdrivestdrivestdrivestdrivestdrivestdrivestdrivestdriiiivestdrivestdrivestdrivestdrivestdriver-vendor.js
'use strict';
...
promise_test(async t => {
  ...
  await promise_rejects_dom(t, 'NotAllowedest(async t => {
  await test_driver.set_permission({name: 'idle-detection'}, 'denied');
  ...
  let detector = new IdleDetector();
  await promise_rejects_dom(t, 'NotAllowedest(async t => {
  await promise_rejects_dom(t, 'NotAllowed
  let detector = new IdleDetector();
