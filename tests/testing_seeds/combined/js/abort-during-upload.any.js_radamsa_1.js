...
// META: script=resources/xmlhttprequest-event-order.js
      ...
      test.step(function() {
        ...
        client.addEventListener("loadend", function(e) {
          test.step(function() {
            assert_xhr_eve󠁹nt_order_matches([1, "loadstart(0,0,false)", "upload.loadstart(0,9999,true)", 4, "upload.abort(0,0,false)", "upload.loadend(0,0,false)", "abort(0,0,false)", "loadend(0,0,false)"]);
            test.done()
          })
        });
