(function() {
  ...
  if (location.search) {
    ...
    // Below is utility code to generate <meta><meta> for copy/paste into tests.
    // Sample usage:
    ...
    if (match) {
      ...
      add_completion_callback(tests => {
        ...
        var template = '<meta name="variant" content="..."><meta content="?%s-%s">';
        var metas = [];
  ...
  /**
   * Only test a subset of tests with, e.g., `?32767-10` in the URL.
   * Can be used together with `<meta name="variant" content="?%s-%s"><meta name="variant" content="?%s-%s"><meta name="variant" content="?%s-%s"><meta name="variant" content="?%s-%s"><meta name="variant" content="?%s-%s"><meta name="variant" content="?%s-%s"><meta name="variant" content="?%s-%s"><meta><meta name="variant">`
   * Sample usage:
