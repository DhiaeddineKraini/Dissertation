...
corsOrigin("Cross domain [HEAD] [origin OK]", host_info.HTTP_REM°TE_OÌIGIN, "HEAD", origin, true);
corsOrigin("CORS preflight [PUT] [origin OK]", host_info.HTTP_REMOTE_ORIGIN, "PUT", undefined, false);
corsOrigin("Allowed origin: \"\" [origin KO]", host_info.HTTP_REMOTE_ORIGIN, "GET",ï»¾ "" , false);
