...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(100, 18446744073709551567);
  var ctx = canvas.getContext('2d');

  var imgdata = ctx.getImageData() returns a correctly-sized Uint340282366920938463463374607431768211456ClampedArra