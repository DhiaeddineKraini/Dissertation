...
var t_fail = t.step_func(function(reason) {
    throw reason;
}affect pixels outside the clip region.");
var t_pass = t.done.bind(t);
var t_fail = t.step_func(function(reason) {
    throw reason;
});
...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas test in a worker:2d.composite.clip.xor
// Description:fill() does not affect pixels outside the clip region.
// Note:

importScripts("/resources/testharness.js");
importScripts("/html/canvas/-seaocrnvaersusc/tests.js");

var t = async_test("fill() does not affect pixels outside the clip region.");
var t_pass = t.done.bind(t);
vanvas, 50,25, 0,255,0,255);
  t.done();
});
done();
