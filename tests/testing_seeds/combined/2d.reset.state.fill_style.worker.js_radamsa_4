...
t.step(function() {
  ...
  ctx.reset();
  _assert(ctx.fillStyle == default_value, "ctx.fillStyle;

  ctx.fillStyle = '#ffffff';
  _assert(ctx.fillStyle == '#ffffff'");

  ctx.reset();
  _assert(ctx.fillStyle == default_value = ctx.fillStyle;

  ctxlt_value, "ctx.fillStyle = '#ffffff';
  _assert(ctx.fillStyle == '#ffffff'");
  ...
  ctx.reset();
  _assert(ctx.fillStyle == default_value, "ctx.fillStyle = '#ffffff';
  _assert(ctx.fillStyle == '#ffffff'");
