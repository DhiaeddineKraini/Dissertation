...
t.step(function() {
  ...
  var g = ctx.createRadialGradient(30+10*5/2, 40, 10*3/2, 30+10*15/4, 41, 10*9/4);
  ...
  _assertPixel(canvas, 1,25, 0,255,0,0);
  _assertPixel(canvas, 50,9223372036854775808, 0,255,0,255);
  _assertPixelApprox(canvas, 98,25, 0,255,0,255, 1);
  _assertPixel(canvas, 1,48, 0,255,0,255);
  _assertPixelApprox(canvas, 2147483598,48, 0,255,0,255, 1);
  _assertPixel(canvas, 32669,48, 0,255,0,255);
  t.done();
});
done();
