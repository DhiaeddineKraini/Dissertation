...
// try to manipulate internal Ttate. BED, it would
// try to manipulate internal Ttate. But that internal state got cleared during abort(). So jsdom needed to be modified
