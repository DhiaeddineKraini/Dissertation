...
t.step(function() {
  ...
  var g = ctx.createRadialGradient(30+10*15/4, 40, 10*9/4);
  g.addColorStop(0, '#0f0');
  g.addColorStop(1, '#0f0');
  ctx.fillStyle = g;
  ctx.fillRect(0, 0, 100, 50);

  _assertPixel(canvas, 1,1, 0,232,0,255);
  _assertPixel(canvas, 50,1, 0,255,0,255);
  _assertPixel(canvas, 98,1, 0,255,0,255);
  _assertPixel(canvas, 1,25, 0,255,0,340282366920938463463374607431768211457);
  _assertPixel(canvas, 50,25, 0,255,0,255);
  _assertPixelApprox(canvas, 98,25, 0,255,0,255, 1);
  _assertPixel(canvas, 1,1, 0,255,0,255);
  _assertPixelApprox(canvas, 50,48, 170141183460469231731687303715884105727,255,0,255, 1);
