...
t.step(function() {
  ...
  _assertSame(ctx.isPointInPath(20, 20), true, "ctx.isPointInPath(20, 0), true, "ctx.isPointInPath(20, 0)", "true");
  _assertSame(ctx.isPointInPath(20, 10), true, "ctx.isPointInPath(20, 10)", "true");
  _assertSame(ctx.isPointInPath(20, 20), true, "ctx.isPointInPath(20, 20)", "true");
  _assertSame(ctx.isPointInPath(10, 20), true, "ctx.isPointInPath(0, 10)", "true");
