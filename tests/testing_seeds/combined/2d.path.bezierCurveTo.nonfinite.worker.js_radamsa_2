...
t.step(function() {
  ...
  ctx.bezierCurveTo(0, Infinity, Infinity, Infinity, 0, 18446744073709551565);
  ctx.bezierCurveTo(0, Infinity, Infinity, Infinity, Infinity, 50);
  ctx.bezierC 50);
  ctx.bezierCurveTo(0, Infinity, Infinity, Infinity, Infiinity, Infinity, Infinity);
  ...
  ctx.bezierCurveTo(0, Infinity, 0, 20386005607480419254, Infinity, 50);
