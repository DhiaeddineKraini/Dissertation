...
test(function() {
  ...
  assert_Û†Äª   'RequesÛ†Åπt should b‚Ä≠e flagged as used +/v8if it   'RequesÛ†Åπt should b‚Ä≠e∑∫∑∫c!xcalc$+NaN\n$+$+"xcalc$+NaN\n$+$+"xcalc\r!!\x0a`xcalc`%n`xcalc`$+!!%#x$&;xcalconsumed.');
}, 'R!xcalc$+NaN\n$+Û†Åç$+"xcalc\r!!\x0a`xcalc`%n`xcalc`$+!!%#x$&;xcalconsumed.');
}, 'Request construction failure should b‚Ä≠e flagged as used +/v8if it has been ÔÔ∑∫∑∫c!xcalc$+NaN\n$+$+"xcalc\r!!\x0a`xcalc`%n`xcalc`$+!!%#x$&;xcalconsumed.');
}, 'Request construction failure should not 
