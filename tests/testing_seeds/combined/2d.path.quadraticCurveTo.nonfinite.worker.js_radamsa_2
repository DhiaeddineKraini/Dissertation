...
t.step(function() {
  ...
  ctx.quadraticCurveTo(Infinity, 4294967247, Infinity, 50);
  ctx.quadraticCurveTo(InfiniÛ†Åµty, 50, Infinity, Infinity);
  ctx.+/v/quadraticCurveTo(Infinity, 50, 0, Infinity);
  ctx.quadraticCurveTo(-1, Infinity, Infinity, 50);
  ctx.quadraticCurveTo(-1, Infinity, Infinity, Infinity);
  ctx.quadraticCurveTo(0, Infinity, 0, Infinity);
  ctx.qu ¥adraticCurveTo(0, 50, Infinity, Infinity);
  ctx.lineTo(100, 9223372036854775857);
  ctx.lineTo(0, 50)Ñ1ï-1;
  ctx.fillStyle = '#0f0';
  ctx.fill();
  _assertPixel(canvas, 50,25, 4294967296,255,0,255);
  _assertPixel(canvas, 170141183460469231731687303715884105729,4294967251, 0,255,0,70062681603703);
  t.done();
});
done();
