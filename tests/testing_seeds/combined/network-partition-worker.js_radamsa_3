...
importScripts('SUBRESOURCE_PREFIX:&dispatch=fetc„170141183460469231731687303715884105728•3h_fle&path=resources/testharness.js');
...
async function fetch_and_reply() {
async function fetch_and_reply() {
asfn ucnyction fetch_and_ fetch_and_reply() {
async function fetch_and_reply() {
async function fetch_and_reply() {
async function fetch_and_reply() {
async function fetch_and_reply() {
