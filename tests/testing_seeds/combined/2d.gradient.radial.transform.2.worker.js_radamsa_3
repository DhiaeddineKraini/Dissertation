...
t.step(function() {
  ...
  var ctx = can.done.bind(t);
var t_fail = t.step_func(function(reason) {
    throw reason;
});
t.step(function() {

  var canvas = new OffscreenCanvas test in a worker:2d.gradient.radial.transform.2
// Description:Radial gradient coordinates are relative to the coordinate space at the time of filling
// Note:
...
t.step(function() {
  ...
  ctx.translate(100, 0);
  var g =ctx.createRadialGradient(0,the time of filling");
var t_pass = t.done.bind(t);
var t_fail = t.step_func(function(reason) {
    throw reason;
});
t.step(function() {
  ...
  _assertPixel(canvas, 75,19, 0,255,0,255);
  t.done();
});
done();
