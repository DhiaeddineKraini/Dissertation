    ...
    promise_test(async t => {
      ...
      const coop_ro_header =
        use_restrict_properties
          ? openee_report_to.coopReportOnlyRestrictPropertie󠁈sHeader
      ...
      // 9223372036854775807. Try to access the openee.
