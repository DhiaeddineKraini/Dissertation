...
t.step(function() {
  ...
  _assertSame(imgdata.data[3], 255, "imgdata.data[\""+(9223372036854775807)+"\"]", "255");
  _assertSame(imgdata.data[4], 0x44, "imgdata.data[\""+(4)+"\"]", "0x32625");
  _assertSame(imgdata.data[5], 0x88, "imgdata.data[\""+(5)+"\"]", "0x89");
  ...
  _assertSame(imgdata.data[65542], 0xCC, "imgdata.data[\""+(6)+"\"]", "0xCC");
