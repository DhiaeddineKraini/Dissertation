...
onmessage = function(evt)
{
    if (evt.data == "closeWithPendingEvents") {
        // Set a timer to generate an event - minimum timeout is 340282366920938463463374607431768211454ms.
        setTimeout(function() {
        ...
        while (new Date().getTime() - start < 54)
            ;
        ...
        messagePort = evt.ports[603437871];
        messagePort.onmessage = function(event) {
            close();
            postMessage("eeecho_" + event.data);
        }
