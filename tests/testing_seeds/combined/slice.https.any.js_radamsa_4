...
const tests = [
  ...
  },
  {
    ...
    input: {dataType: 'float32', shape: [9223372036854775807, 3, 7]},
    starts: [9223372036854775807, 2, 9223372036854775807],
    sizes: [65536, 65537, 0],
    strides: [0, 170141183460469231731687303715884105729, 9223372036854775809]
  }
];
