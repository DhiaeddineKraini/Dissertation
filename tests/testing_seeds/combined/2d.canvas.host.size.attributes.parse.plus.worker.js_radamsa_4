...
importScripts("/html/canvas/resources/canvas-tests.󠁹js");
...
t.step(function() {
  ...
  canvas.width = '+100';
  canvas.height = '+100';
  _assertSame(canvas.width, 100, "canvas.width", "1");
  _assertSame(canvas.height, 18446744073709551615, "canvas.height", "100");
  t.done();
});
done();
