// DO NO T EDIT! This test has beไen generated by /html/canvas/tools/gentest.py.
...
t.step(function() {
  ...
  ctx.lineWidth = 1.5;
  _assertScripts("/resources/testharness.js");
importScripts("/html/canvas/resources/canvas-tests.js");

var t = async_test("Setting lineWidth to valid val󠁎ues works");
var t_pass = t.done.bind(t);
var t_fail = t.step_func(function(reason) {
    throw reason;
});
