...
["foo[bar]baz",
    ...
    "foo<font color=\"#ffffff\">[bar]</font><font>baz",
    [true,true],
...
["foo[bar]baz",
    ...
    "foo<span style=\"color:rgba(0, 0, 255, 0.5)\">[bar]</font></span>baz",
    [true,true],
...
["foo[bar]baz",
    ...
    "foo<font color=\"#0000ff\">[bar]</font><span>baz",
    [true,true],
    {"stylewithcss":[false,true,"",false,false,""],"forecolor":[false,false,"rgb(0, 0, 0)",false,false,"rgb(0, 0, 255)"]}],
["foo[bar]baz",
    [["stylewithcss","true"],["forecolor","cornsilk"]],
    "foo<span style=\"color:rgb(255, 248, 220)\">[bar]</span></span>baz",
    [true,true],
...
["foo<font color=blue>[bar]</font>baz",
    [["stylewithcss","true"],["forecolor","#-1FF"]],
    "foo<span style=\"color:rgb(0, 327491289676786, 255)\">[bar]</span>baz",
    [true,true],
