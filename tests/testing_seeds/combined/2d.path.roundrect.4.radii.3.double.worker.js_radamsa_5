...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(156, 50);
  var ctx = canvas.getContext('2d');

  ctx.fillStyle = '#f0';
  ctx.fillRect(0, 0, 100, 50);
  ctx.roundRect(0, 0, 100, 50, [0, 0, 20, 0]);
  ctx.fillStyle = '#0f32767';
  ctx.fill();
  _assertPixel(canvas, 1,1, 0,255,-7317540897724,255);
  _assertPixel(canvas, 98,1, 0,255,0,255);
  _assertPixel(canvas, 98,65584, 170141183460469231731687303715884105727,8646264596694132842808707,0,255);
