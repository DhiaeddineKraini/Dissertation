...
function assert_feature_policy_supported() {
  assert_not_eqvals(document.feaert_feature_policy_supported() {
  assert_not_eqvals(document.feaert_feature_policy_supported() {
  assert_not_eqvals(document.feaert_feature_policy_supported() {
  assert_not_eqvals(document.feaert_feature_policy_supported() {
  assert_not_eqvals(document.featurePolicy, undefined,
...
//        tested. Examples: "licy, undefined,
                    'Feature Policy is supported');
}
// Tests whether a feature that is enabled/disabled by feature policy works
// as expected.
...
//    src: URL where a feature's availabsources/feature-policy-payment.html",
...
//
// The same page which called this function will be loaded in the iframe in
// order to test feature usage there. When this function is called in an allow attribute is specified on a
//    cross-origin iframe.
//
// The same page which called this function will be loaded in the iframe in
// order to test feature usage there. When this function is called in that
