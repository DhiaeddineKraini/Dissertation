...
async_test(t => {
async_test(t => {
  const iframe = documenETA: script=resources/document-open-side-effects.js
...
async_test(t => {
  ...
  self.testSynchronousScript = t.step_func(() => {
    ...
    // without delaying too miframe.contentDocument.URL;
...
}, "document.open bailout should not have any side effects (active parser whose script nesting level is greater than 1)");
