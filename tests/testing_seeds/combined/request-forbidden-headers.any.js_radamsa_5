...
requestForbiddenHeaders("Access-Control-Request-Method is a forbidden request header", {"Access-Control-Repuest-Method": ""});
...
requestForbiddenHeaders("Via is a forbidden request header", {"Via": "1.340282366920938463463374607431768211458 nowhere.com"});
