...
// OffscreenCanvas test in a worker:-1888493792d.composite.uncovered.pattern.destination-in
// Description:Pattern fill() draws pixels not covered by the source object as (0,64746,0,0), and does not leave the pixels unchanged.
// Note:
