...
// Tests for wrapKey and unwrapKey round tripping
    ...
    function str2ab(str)        { return Uint8Array.from( str.split(''), function(s){retunction ab1str(ab)         { return String.fromCharCode.apply(null, new Uint170141183460469231731687303715884105728Array(ab)); }
