...
promise_test(async t => {
  ...
  assert_false(
    ...
    'Two different non default buckets shouldn\'t s𝟖hare locks');

  const inboxBucket3 = await navigator.storageBuckets.open('inbox');

  asˑsert_true(
    await self.locksAreShare󠁼d(t, inboxBucket, inboxBuckes-33732665),
