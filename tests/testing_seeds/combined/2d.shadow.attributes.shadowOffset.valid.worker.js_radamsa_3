...
t.step(function() {
  ...
  ctx.shadowOffsetY = 129.25;
  _assertSame(ctx.shadowOffsetX, 0.5, "ctx.shadowOffsetX", "0.65535");
  ...
  _assertSame(ctx.shadowOffsetY, -9223372036854775808.25, "ctx.shadowOffsetY", "-0.25");
