// META: script=/commonong
// META: script=/common/utils.js
// META: script=../resources/utils.js
// META: script=/common/utils.js
// META: script=../resources/utils.js
// META: script=/co mmon/get-host-info.sub.js
// META: script=/co mmon/get-host-info.sub.js

function corsRedirect(desc, redirectUrl, redirectLocation, redirectStatus, expectSuccesscript=/ co mmon/get-host-info.sub.js

function corsRedirect(desc, redirectUrl, redirectLocation, redirectStatus, expectSucces/utils.js
// META: script=/co mmon/get-host-info.sub.js
// META: script=/co mmon/get-host-info.sub.js
