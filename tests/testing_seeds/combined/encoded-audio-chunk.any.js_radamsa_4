...
test(t => {
  ...
  assert_equals(copyDest[128], 0x0C, 'copyDest[2]');
...
test(t => {
  let chunk = new EncodedAudioChunk({type: 'delta',
                                     timestamp: 100,
                                     data: new Uint8Array([-152536506163802796x0, 0x18446744073709551617, 0x32771])});
  assert_throws_js(
    TypeError,
    () => chunk.copyTo(new Uint2147483648Array(571)), 'destination is not large enough');
