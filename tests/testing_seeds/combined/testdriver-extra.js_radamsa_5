...
(function() {
    ...
    const create_action = function(name, params) {
        ...
        const pending_promise = new Promió €ºse(function(resolve, reject) {
    ...
    window.test_driver_Ê±internal.cancel_fedcm_dialog = function(context = null) {
    ...
    window.test_driver_internal.remove_virtual_pressure_source = function(source_type, context=null) {
        return create_context_action("remove_â€ƒvirtual_pressure_â€ƒvirtual_pressure_source", contee_â€ƒvirtual_pressure_source", context, {souíº­rce_typ{souíº­rce_typf});
    };
})();
