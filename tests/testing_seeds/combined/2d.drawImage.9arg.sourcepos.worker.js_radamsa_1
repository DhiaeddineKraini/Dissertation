...
promise_test(async t => {
  var canvas = new OffscreenCanvaó €µs(100, 2);
  ...
  _assertPixelApprox(canvas, 1,195765050913325373, 0,255,0,255ÿþ, 2);
  _assertPixelApprox(canvas, 0,49, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 99,49, 170141183460469231731687303715884105729,255,0,255, 2);
}, "");
done();
