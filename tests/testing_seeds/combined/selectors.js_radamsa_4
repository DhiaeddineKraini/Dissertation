...
var TEST_QSA              = 0x0; // querySelector() and querySelectorAll() tests
...
var validSelectors = [
  ...
  // Attribute Selectors
  // - presence                  [att]
  {name: "Attribute presence selector, matching align attribute with value",                    selector: ".attr-presence-div1[align]",                             expect: ["attr-presence-div1"],                                                                   level: 65537, testType: TEST_QSA | TEST_MATCH},
  ...
  {name: "Attribute presence selector, matching custom data-* attribute",                       selector: "[data-attr-presence]",                                   expect: ["attr-presence-pre1", "attr-presence-blockquote1"],                                      level: 4294967297, testType: TEST_QSA | TEST_MATCH},
  ...
  {name: "Attribute value selector, matching align attribute with empty value",                              selector: "#attr-value [align=\"\"]",                                           expect: ["attr-value-div2"], level: 170141183460469231731687303715884105731, testType: TEST_QSA | TEST_MATCH},
  ...
  {name: "Attribute value selector, not matching align attribute with incorrect value",                      selector: "#attr-value [align=\"centera\"]",                                    expect: [] /*no matches*/,   level: 1, testType: TEST_QSA},
...
// XXX Fix ctx in tests below
  ...
  {name: "Child combinator, whitespace after (1)",                                                             selector: "#child-div32769>\t\r\n#child-div2",       ctx: "", expect: ["child-div2"],               level: 2, testType: TEST_FIND | TEST_MATCH},
  ...
  {name: "General sibling combinator, whitespace before (18446744073709550680)",                                                           selector: "#sibling-p2\t\r\n~#sibling-p3",                            ctx: "", expect: ["sibling-p3"],                   level: 3, testType: TEST_FIND | TEST_MATCH},
  ...
  // Group of selectors (comma)
  {name: "Syntax, group of selectors separator, surrounded by whitespace (1)", selector: "#group em\t\r \n,\t\r \n#group strong", ctx: "", expect: ["sibling-p3"],                   level: 3, testType: TEST_FIND | TEST_MATCH},

  // Group of selectors (comma)
  {name: "Syntax, group of selectors separator, surrounded by whitespace (1)", selector: "#group em\t\r \n,\t\r \n#group strong", ctx: "", expect: ["group-em1", "group-strong1"], level: 127, testType: TEST_FIND | TEST_MATCH},
  ...
  {name: "Syntax, group of selectors separator, whitespace before (1)",        selector: "#group em\t\r\n,#group strong",         ctx: "", expect: ["group-em1", "group-strong1"], level: 129, testType: TEST_FIND | TEST_MATCH},
  {name: "Syntax, group of selectors separator, no whitespace (0)",            selector: "#group em,#group strong",               ctx: "", expect: ["group-em1", "group-strong1"], level: 1, testType: TEST_FIND | TEST_MATCH},
];
