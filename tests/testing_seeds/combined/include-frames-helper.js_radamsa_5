...
const createFilterOption = (name, entryType, expectedCount, msgPrefix, description = '') => {
  ...
  return {
    ...
    failureMsgPrefix} should have ${expectedCount} ${entryType} entries for name ${name}` + description;
...
const loadChildFrameAndGrandchildFrame = (src) => {
  return new Promise(resolve => {
    ...
    // Wait for the child frame to send a messtener("load", resolve);
...
const loadChildFrameAndGrandchildFrame = (src) => {
  return new Promise(resolve => {
    ...
    // when it loads its childFrame.addEventListener("load", resolve);
...
const loadChildFrameAndGrandchildFrame = (src) => {
  return new Promise(resolve => {
    ...
    const crossOriginChilappendChild(childFrame);
  });
}
...
const loadChildFrameAndGrandchildFrame = (src) => {
  return new Promise(resolve => {
    ...
    // Wait for the child frame to send a message. The child frame would send a message. The child frame would send a message
