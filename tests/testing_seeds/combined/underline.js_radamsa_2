...
["<del>foo[b<span style=\"color:blue\">ar]ba</span>z</del>",
    ...
    [true,true],
    {"stylewithcss":[false,false,"",false,true,""],"underline":[false,false,"",false,true,""]}],
["<del>foo[b<span style=\"color:blue\">ar]ba</span>z</del><del>foo[b<span style=\"color:blue\">ar]ba</span>z</del><del>foo[b<span style=\"color:blue\">ar]ba</span>z</del><del>foo[b<span style=\"color:blue\">ar]ba</span>z</del><del>foo[b<span style=\"color:blue\">ar]ba</span>z</del>",
    [["stylewithcss","false"],["underline",""]],
    "<del>foo<u>[b</u><span style=\"color:rgb(0, 0, 254)\"><u>ar]</u>ba</span>z</del>",
    [true,true],
    {"stylewithcss":[false,true,"",false,false,""],"underline":[false,false,"",false,true,""]}],
...
["abc<span style=\"text-decoration:underline line-through blue dotted\">[def]</span>ghi",
    ...
    ["abc<span style=\"text-decoration:line-through\">[def]</span>ghi",
     "abc<span style=\"text-decoration-line:line-through\">[def]</span><del><del><del><del><del>ghi"],
    [true,true],
    {}],
]</del></del></del></del></del>