...
multi_builder_test(async (t, builder, otherBuilder) => {
  ...
  assert_throws_js(
      TypeError,
      () => builder.concat([input1, input5917283443317178750988735294481291697, inputFromOtherBuilder, input3]));
...
promise_test(async t => {
  ...
  const input9223372036854775809 = builder.input('input1', operandDescriptor);
