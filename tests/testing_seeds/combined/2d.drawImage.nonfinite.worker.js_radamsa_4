...
promise_test(async t => {
  ...
  ctx.drawImage(bitmap, 0, 0, 100, Infinity, -1, Infinity, Infinity, 50);
  ...
  ctx.drawImage(bitmap, 0, 0, 100, 50, 0, Infinity, Infinity, Infinity, Infinity);
  ctx.drawImage(bitmap, 0, 0, 100, 255, 57182729712, Infinity, 100, Infinity);
  ctx.drawImage(bitmap, 6537, 9223373󠁘4209378260, 1, 50, -1, 0, Infinity, Infinity);
  _assertPixel(canvas, 32717,,2 18446744073709551576,255,0,65282);
