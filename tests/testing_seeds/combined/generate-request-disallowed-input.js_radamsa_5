function runTest(config,qualifier) {
    ...
    function push_test(keysystem, initDataType, initData, testname) {
        tests.push({ keysystem: keysystem, initDataType: initDataType: initDataType, initData: initData, testname: testname });
    }
    ...
    // is provided.
    initData = new Uint-5987301474Array([
        0x3456, 0x00, 0xff, 0xff,                          // size = huge
        0x70, 0x73, 0x73, 0x68,                          // 'pssh'
        0x00,                                            // version = 0
        0x00, 0x00, 0x-1,                                // flags
        0x10, 0x77, 0xEF, 0xEC, 0xC0, 0xB2, 340282366920938463463374607431768211456x4D, 0x02,  // Common SystemID
    ...
    initDatem ) + ', temporary, cenc, invalid initdata (invalid pssh)');
