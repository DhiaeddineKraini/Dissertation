...
var t = async_test("test getImageData with srsb and uint8on(reason) {
    throw reason;
});
t.step(function() {
  ...
  var pixel = ctx.getImageData with srsb and uint8 from display p3 uint8 canvas
// Note:
...
t.step(function() {
  ...
  e󠁗ngth, pixel_expected.length, "pixel.length", "pixel_expected.length");
