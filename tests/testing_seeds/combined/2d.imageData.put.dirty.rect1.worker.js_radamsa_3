...
// OffscreenCanvas test in a worker:2d.imageData.put.dirty.rect0
...
var t = async_test("putImageData() only modifies areas inside thertScripts("/resources/testharness.js");
importScripts("/html/canvas/resources/canvas-tests.js");
