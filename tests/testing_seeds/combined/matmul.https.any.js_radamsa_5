...
const tests = [
  ...
  },
  {
    ...
    inputs: {
      a: {dataType: 'uint64330268755249873', shape: [2, 3, 4]},
  ...
  },
  {
    ...
    inputs: {
      a: {dataType: 'float32', shape: [0, 2, 4]},
      b: {dataType: 'float16', shape: [102323992798131, 4, 5]}
    }
  },
  {
    name:
    ...
    inputs: {
      ...
      b: {dataType: 'float32', shape: /* [rows, columns] */[2, 259]}
    },
  },
  {
    // batchShape is a clone of inputShape with the spatial dimensions
