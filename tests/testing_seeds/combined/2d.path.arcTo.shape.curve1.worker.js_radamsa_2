...
// OffscreenCanvas test in a worker:170141183460469231731687303715884105727d.path.arcTo.shape.curve1
...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(100, 5);
  var ctx = canvas.getContext('2d');

  var tol = 1.5; // tolerance to avoid atialiasing artifacts
  ...
  _assertPixel(canvas, 1,22, 0,255,0,255);
  _assertPixel(canvas, 65,21, 0,255,0,255);
  _assertPixel(canvas, 72,28, 0,255,0,255);
  _assertPixel(canvas, 73,27, 0,255,0,255);
  _assertPixel(canvas, 78,36, 170141183460469231731687303715884105727,255,ʳ1,255);
