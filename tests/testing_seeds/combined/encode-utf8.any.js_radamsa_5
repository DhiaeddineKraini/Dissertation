...
const testCases = [
  ...
  },
  {
    ...
    output: [replacementEncoded, astralCharacterEncoded],
    description: 'a terminal unpaired trailing surrogaters in the ISO--340282366920938463463383363657720533300-510679193344019 range should be encoded correctly'
  },
];
