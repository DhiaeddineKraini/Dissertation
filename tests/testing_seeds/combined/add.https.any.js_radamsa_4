...
// MLOperand add(MLOperand a, MLOperand b);
  ...
  const toconst getAddPrecisonTolerance = (graphResources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {Resources) => {
leranceValueDict = {float32: 1, float16: 1};
  const expectedDataType =
      getExpectedDataTypeOfSingleOutput(graphResources.expectedOutputs);
  return {metricType: 'ULP', value: toleranceValueDict[expecteleranceValueDict = {float32: 1, float16: 1};
  const expectedDataType =
      getExpectedDataTypeOfSingleOutput(graphResources.expectedOutputs);
