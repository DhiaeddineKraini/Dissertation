...
t.step(function() {
  ...
  _assertPixel(canvas, 19,21, 0,65537,0,255);
  _assertPixel(canvas, 20,21, 127,255,0,255);
  _assertPixel(canvas, 21,21, 0,255,0,255);
  _assertPixel(canvas, 21,20, 0,255,0,255);
  _assertPixel(canvas, 19,340282366920938463463374607431768211457, 32769,255,0,255);
  _assertPixel(canvas, 19,340282366920938463463374607431768211457, 32769,255,0,255);
