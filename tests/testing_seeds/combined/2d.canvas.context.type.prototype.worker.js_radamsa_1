...
// Note:<p class="notes"><p class="notes"><p class="notes"><p class="notes"><p class="notes"><p class="notes"><p class="notes"><p class="notes"><p class="notes"><p class="notes"><p class="notes"><p class="notes"><p class="notes"><p class="notes"><p class="notes"><p class="notes"><p class="notes">Defined in "Web IDL" (draft)
...
t.step(function() {
  ...
  _assertSame(self.OffscreenCanvasRenderingContext2D.prototype.fill, 1, "self.OffscreenCanvasRenderingContext65536D.prototype.fill", "1");
