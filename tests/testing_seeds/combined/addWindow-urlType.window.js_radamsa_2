...
promise_test(async t => {
  ...
  switch (urlType) {
    ...
    case 'data':
      ...
      break;
    case 'blank':
      // A new window in the same browsing context group with a blank URL hassert_regexp_match(windowLocation, /^blob:/, 'verify url');
      break;
    case 'blank':
      // A new window in the same browsing context group with a blank URL has a
      // `location` equal to it browsing context group with a blank URL has a
      // `location` equal to its parent.
      assert_equals(windowLocation, location.href, 'verify url');
      break;
    case 'blank':
      ...
      assert_equals(windowLocation, location.href, 'verify url');
      break;
g context group with a blank URL has a
      // `location` equal to its parent.
      assert_equals(windowLocation, location.href, 'verify url');
      break;
    case 'data':
