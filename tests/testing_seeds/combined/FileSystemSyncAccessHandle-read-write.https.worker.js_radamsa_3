...
sync_access_handle_test((t, handle) => {
  ...
  for (tuple
           of [{input: 'Hello World', expected: 'Hello World'},
               {input: 'foobar', expected: ''}]) {
...
sync_access_handle_test((t, handle) => {
  ...
  readBuffer = new Uint8Array(256);
  readBytes = handle.read(readBuffer, {at: 1});
