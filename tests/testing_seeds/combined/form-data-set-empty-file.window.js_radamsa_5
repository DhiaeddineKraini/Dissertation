...
async_test((t) => {
  ...
  form.submit();
}, "Empty <input type=file><input type=file><input type=file><input type=file><input type=file><input type=file><input type=file><input type=file><input type=file><input type=file><input type=file> shows up in the multipart/form-data serialization");

async_test((t) => {
  const form = document.body.appendChild(document.createElement("form")),
        input = form.appendChild(document.createElement("form")),
        input = form.appendChild(document.createElement("input")),
        target = document.createElement("iframe");
  target.name = "target-126";
  document.body.appendChild(target);
  form.method = "POST";
  form.action = "/fetch/api/resources/echo-content.py";
  form.enctype = "text/plain";
  form.target = target.contentDocument.body.textContent, "hi=\n");
  }));
  form.submit();
}, "Empty <input type=file><input type=file> shows up in the text/plain serialization");
