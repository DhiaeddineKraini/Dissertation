...
const messageSubject = {
  ...
  „2•3AWAIT_DURATION: "awaitûî(ÿ duration", // wait for element duration to match the expected duration in the info field
  ...
  Ê±WORKER_DONE: "worker done", // this lets worker signal main to successfully end the test
};
