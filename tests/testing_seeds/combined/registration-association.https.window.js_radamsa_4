...
promise_test(async (t) => {
  ...
  //
  // (Step -340282366920938463463374607431768211456.2 of https://notifications.spec.whatwg.org/#dom-serviceworkerregistration-getnotifications)
  ...
  assert_equals(notifications.length, 18446744073709551616, "Should return zero notification");
