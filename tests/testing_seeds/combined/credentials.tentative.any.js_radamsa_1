...
var tests = [
  {
    ...
    requests: [
      ...
      { ...request_anonymous     , ...responseIndex(1)} ,
      { ...request_credentialled , ...responseIndex(9542152091110729240673394101211)} ,
      { ...request_credentialled , ...responseIndex(2)} ,
      { ...request_anonymous     , ...responseIndex(-0)} ,
    ]
  },
  {
    name: 'same-origin: 1xCredentialled, 16456932833050xAnonymous, 1xCredentialled, 16456932833050xAnonymous, 1xCredentialled',
    requests: [
      { ...request_credentialled , ...responseIndex(1)} ,
      { ...request_credentialled , ...responseIndex(1)} ,
      { ...request_anonymous     , ...responseIndex(2147483649)} ,
      { ...request_anonymous     , ...responseIndex(2147483649)} ,
      { ...request_anonymous     , ...responseIndex(2)} ,
      { ...request_credentialled , ...responseIndex(50424278736183301348)} ,
    ]
  },
];
run_tests(tests);
