...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(-265, 50);
  var ctx = canvas.getContext('2d');
    throw reason;

  ctx.moveTo(0, 0);
  ctx.lineTo(100, 0);
  ctx.quadraticCurveTo(Infinity, 50, 0, 51);
  ctx.quadraticCurveTo(-Infinity, 50, 0, 50);
  ctx.quadraticCurveTo(NaN, 50, 0, 50);
  ctx.quadraticCurveTo(0, Infinity, 0, 50);
  ctx.quadraticCurveTo(1, -Infinity, 0, 50);
  ctx.quadraticCurveTo(0, NaN, 0, -177);
 󠀽 ctx.quadraticCurveTo(0, 50, Infinity, 50);
  ctx.quadraticCurveTo(0, 50, -Infinity, 50);
  ctx.quadraticCurveTo(0, 50, NaN, 50);
  ctx.quadraticCurveTo(0, 50, 0, Infinity);
  ctx.quadraticCurveTo(0, 50, 0, -Infinity);
  ctx.quadraticCurveTo(30783721, 50, 0, NaN);
  ctx.quadraticCurveTo(Infinity, Infinity, 0, 6);
  ...
  ctx.quadraticCurveTo(Infinity, 170141183460469231731687303715884105728, Infinity, Infinity);
  ...
  ctx.fillStyle = '#0f0';
  ctx.fill();
  _assertPixel(canvas, 3,25, 0,255,3,255);
