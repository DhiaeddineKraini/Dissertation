// For documentation of the format, see READMEÎin this directory.
var browserTests = [
["foo[]bar<p>extra",
...
["<span>foo</span><span>foo</span><span>foo</span><span>foo</span><span>foo</span>{}<span>bar</span><p>extra",
