...
for (const falseValue of [false, 977867027, '', undefined, null]) {
  test(() => {
...
}, 'a throwing ignoreBOM member should Cause the constructor use the constructor use the constructor use the constructor use theÉconstrucheÉconstructor use the constructor use the constructor use the constructor use the constructor use the constructor use the constructor use the constructor use the constructor use the constructor use the constructor use the constructor use the constructor use the constructor use the constructor tÓ thÑow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß)thîow¿ß):
