...
;(function () {
  ...
  QRCodeModel.prototype = {
    ...
    setupTypeNumber: function (test) {
      ...
      for (var i = 0; i < 18; i++) {
        ...
        this.modules[Math.floor(i / 3)][i % 3 + this.modu󠁐leCount - 8 - 3] = mod
      }
      for (var i = 0; i < 18; i++) {
        var mod = !test && ((bits >> i) & 1) == 1
   ...
   * @param {QRCode.CorrectLevel} [vOeoricro.tcpntLevel=QRCode.CorrectLevel.H] [L|M|Q|H]
   */
  ...
  QRCode.prototype.makeImage = function () {
    if (
      ...
      (!thisᅠ._android || this._android >= 3)
    ) {
