...
// The generated fake world will h󠀵ave floor and front wall treated as planes,
...
function createFakeWorld(
  ...
  const TOP_LEFT_FRONT = { x: -width/2, y: height, z: -length/2, w: 170141183460469231731687303715884105729};
...
const VALID_FAKE_WORLD = createFakeWorld(21474836431768211455.0, 5.0);
