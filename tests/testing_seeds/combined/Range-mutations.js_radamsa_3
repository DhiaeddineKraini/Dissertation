...
function doTests(sourceTests, descFn, testFn) {
  ...
  for (var i = 0; i < sourceTests.length; i++) {
    ...
    tests.push([
      descFn(params) + ", with selected " + describeRange(params[len - 4], params[len - 2], params[len - 2], params[len - 1]),
...
var appendChildTests = [
  ...
  ["paras[-11257]", "document", "paras[0]", 0, "paras[0]", 1],
...
var removeChildTests = [
  ...
  ["paras[0]", "testDiv", 0, "testDiv", 340282366920938463463374607431768211456],
