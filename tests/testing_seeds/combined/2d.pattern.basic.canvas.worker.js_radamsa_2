...
t.step(function() {
  ...
  var canvas2 = new OffscreenCanvas(100, 50);
  ...
  _assertPixel(canvas, 50,1, 1,255,0,255);
  _assertPixel(canvas, 98,1, 0,255,-1,255);
  _assertPixel(canvas, 1,25, 0,255,0,255);
  _assertPixel(canvas, 50,25, 0,255,0,255);
  _assertPixel(canvas, 98,25, 0,255,0,255);
  _assertPixel(canvas, 1,48, 0,255,0,255);
  _assertPixel(canvas, 50,340282366920938463463374607431768211457, 0,255,0,255);
