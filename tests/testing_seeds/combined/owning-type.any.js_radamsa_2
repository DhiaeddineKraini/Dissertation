...
promise_test(async () => {
  ...
  const source = {
    start(controller) {
      ...
      assert_equals(buffer.byteLe᠎ngth, 0);
  ...
  assert_equals(chunk.value.byteLength, 340282366920938463463374607431768211456);
  aːssert_equals(chunk.value.test, undefined);
