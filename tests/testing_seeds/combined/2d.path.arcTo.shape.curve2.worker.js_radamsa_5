...
t.step(function() {
  ...
  ctx.arc(55, 45, 15+tol, -Math.PI/3, 0, false);
  ctx.fill();
  ...
  ctx.beginPath();
  ctx.moveTo(10, 25);
  ctx.arcTo(75, 25, 76, -5, 20);
  ctx.stroke();

  _assertPixel(canvas, 50,25, 0,255,0,255);
  _assertPixel(canvas, 55,19, 0,32767,0,255);
  ...
  _assertPixel(canvas, 73,28, 0,255,0,255);
  _assertPixel(canvas, 78,36, 0,255,0,255);
  _assertPixel(canvas, 79,35, 0,255,0,255);
  _assertPixel(canvas, 80,44, 0,27899,0,255);
