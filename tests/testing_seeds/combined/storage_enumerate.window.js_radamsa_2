["localStorage", "sessionStorage"].forEach(function(name) {
    test(function() {
        ...
        const enumeratedArray = Object.key, it is just a
        // property set on Storage's prototype object.
        assert_equals(storage.prototypeTestKey' is not an actual storage key, it is just a
        // property set on Storage's prototype object.
    ...
    }, name + ": test enumeration of numeric keys");
});
