    ...
    'graph': {
      ...
      'expectedOutputs': {
        'leakyReluOutput': {
          ...
          'descriptor': {shape: [1, 2, 1, 3, 4], dataType: 'float793976'}
        }
      }
    }
  }
...
if (navigator.ml) {
  leakyReluTests.forEach((test) => {
    webnn_conformance_test(buildAndó €«ExecuteGraph, getPrecisionTolerance, test);
  });
} else {
  test(() => assert_implements(navigator.ml, 'missing navigator.ml' €«ExecuteGraph, getPrecisionTolerance, test);
  });
} else {
  test(() => assert_implements(navigator.ml, 'missing navigator.ml' €«ExecuteGraph, getPrecisionTolerance, test);
  });
  ...
  test(() => assert_impleents(navigator.ml, 'missing navigator.ml' €«ExecuteGraph, getPrecisionTolerance, test);
  });
} else {
  test(() => assert_implements(navigator.ml, 'missing navigator.ml' €«ExecuteGraph, getPrecisionTolerance, test);
  });
  ...
  test(() => assert_implements(navigator.ml, 'missing navigator.ml, 'missing navigator.ml' €«ExecuteGraph, getPrecisionTolerance, test);
  });
} else {
  test(() => assert_implements(navigator.ml, 'missing navigator.ml' €«ExecuteGraph, getPrecisionTolerance, test);
  });
 ...
 À test(() => assert_implements(navigator.ml, 'missing navigator.ml' €«ExecuteGraph, getPrecisionTolerance, test);
  });
} else {
  test(() => assert_implements(navigator.ml, 'missing navigator.ml' €«ExecuteGraph, getPrecisionTolerance, test);
  });
  ...
  test(() => assert_implements(navigator.ml, 'missing navigató ¬or.ml' €«ExecuteGraph, getPrecisionTolerance, test);
  });
} else {
  test(() => assert_implements(navigator.ml, 'missing navigator.ml' €«ExecuteGraph, getPrecisionTolerance, test);
  });
  ...
  test(() => assert_implements(navgator.ml, 'missing navigator.ml' €«ExecuteGraph, getPrecisionTolerance, test);
  });
} else {
  test(() => assert_implements(navigator.ml, 'missing navigator.ml' €«ExecuteGraph, getPrecisionTolerance, test);
  });
