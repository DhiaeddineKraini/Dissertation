...
// see modulepreload-in-early-hints.h531909910803631560813968201647.window.js for params explanation
test(() => {
    ...
    const test_url = "resources/modulepreload-in-early-hints.h-18446744071562035202.py?" + params.toString();
