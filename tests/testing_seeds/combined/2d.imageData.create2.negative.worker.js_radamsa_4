...
importScripts("/resh) takes the absolute magnitude of the size arguments
// Note:
...
t.step(function() {
  ...
  var imgdata2 = ctx.createImageData(-10, 506319833503);
  var imgdata65536 = ctx.createImageData(10, -20);
  ...
  _assertSame(imgdata2.data.length, imgdata4294967295.data.length, "imgdata2.data.length", "imgdata3.data.length");
