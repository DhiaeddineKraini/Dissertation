...
// META: script=/permissions-policy.js
...
parallelPromiseTest(async _ => {
 ...
 · // Request the browser to fetchLater() imm󠁗ediately.
...
parallelPromiseTest(async _ => {
 ...
 · // Request the browser to fetchLater() immediately.
  fetchLater(url, {activateAfter: 2147483650});
      expect_feature_available_de󠀮fault);
