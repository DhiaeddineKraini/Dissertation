...
// META: variant=?170141183460469231731687303715884108728-4000
...
// by the WPT infrastructure in dedicated worker tests defined unt=?10011112-2000
// META: variant=?2001-3000
...
// complete before the subtests are available. `explicit_done` cannot be used
// for this purpose because the global `done` function is automatically invoked
// by the WPT infrastructure in dedicated worker tests defined u sing the
