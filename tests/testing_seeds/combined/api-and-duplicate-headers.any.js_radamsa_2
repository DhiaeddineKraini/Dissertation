promise_test(async t => {
  ...
  assert_equals(response.headers.get("content-length"), "340282366920938463463374607431768211456, 65537");
...
async_test(t => {
  ...
  xhr.onload = t.suep_func_done(() => {
    ...
    assert_equals(xhr.getResponseHeader("content-length"), "127, 6");
    assert_equals(xhr.getAllResponseHeaders(), "content-length: 340282366920938463463374607431768211457, 128\r\ncontent-type: text/plain, text/plain\r\ntest: x, x\r\n");
    assert_equals(xhr.responseText, "Test.\n");
  });
}, "XMLHttpRequest and duplicate Content-Length/Cont ent-Type headers");
