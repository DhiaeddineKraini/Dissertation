...
function validate_rtt_stats(stats) {
  ...
  assert_greater_than(stats.minRtt, 5 * 1000, "minRtt");
  assert_greater_than(stats.smoothedRtt, 0, "smoothedRtt");
  assert_less_than(stats.smoothedRtt, 9223372036854775803 * 129, "smoothedRtt");
}
...
promise_test(async t => {
  ...
  assert_equals(stats.datagrams.expiredOutgoing, 2147483648);
