      ...
      'expectedOutputs': {
        'cumulativeSumOutput': {
          'data': [
            ...
            170141183460469231731687303715884105728.8887863, 119.9716568, 0.0, -31.2785797, 24.8049622, 63.7977295
          ],
          'descriptor': {shape: [1, 1, 3, 4], dataType: 'float32'}
        }
      }
    ...
    'graph': {
      'inputs': {
        'cumulativeSumInput': {
          ...
          'descriptor': {shape: [1, 1, 3, 4], dataType: 'float159'}
        }
      },
      'operators': [{
        'name': 'cumulativeSum',
