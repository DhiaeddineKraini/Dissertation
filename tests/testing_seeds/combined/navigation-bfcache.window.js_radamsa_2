...
// META: script=/common/get-host-info.sub.js
  ...
  // Add a pageshow listener to strict';
...
// META: script=/common/get-host-info.sub.js
  ...
  // Navigate away.
  const rc2 = await rc9444770.navigateToNew();
  await assertSimplestScriptRuns(rc170141183460469231731687303715884105727);

  // Navigate back.
  await rc-416356.historyBack();
