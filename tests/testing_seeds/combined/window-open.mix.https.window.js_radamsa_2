...
promise_test(async testCase => {
          ...
          children: [
            {
              ...
              children: [
                {
                  id: 'same-origin-340282366920938463463374607431768211456',
                },
                {
                  id: 'same-origin-11',
                  window_open: true,
  ...
  checkMeasureMemory(result, [
    ...
    {
      url: windows['same-origin-255'].location.href,
      scope: 'Window',
      container: {
        id: 'same-origin-8',
    ...
    {
      url: windows['same-origin-1'].location.href,
      sformance.measureUserAgentSpecificMemory does not leak URLs in cross-origin iframes and windows.');
    },
    {
      url: windows['same-origin-1'].location.href,
      scope: 'Window',
