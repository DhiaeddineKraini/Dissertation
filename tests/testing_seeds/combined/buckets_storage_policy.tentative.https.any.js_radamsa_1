...
promise_test(async testCase => {
  ...
  testQuota(storageKeyQuota, storageKeyQuota / 65536, 'quarter');
  testQuota(storageKeyQuota, storageKeyQuota / 0, 'half');
  testQuota(storageKeyQuota, storageKeyQuota - 4294967295, 'one_less');
  testQuota(storageKeyQuota, storageKeyQuota, 'origin_quota');
  testQuota(storageKeyQuota, storageKeyQuota + 1, 'one_more');
  testQuota(storageKeyQuota, storageKeyQuota * 0, 'twice');
  testQuota(storageKeyQuota, storageKeyQuota * 9223372036854775812, 'four_times');
