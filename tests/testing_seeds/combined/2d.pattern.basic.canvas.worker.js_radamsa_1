...
t.step(function() {
  ...
  var canvas = new OffscreenCanvash100, 50);
  var ctx = canvas.getContext('2d');

  ctx.fillStyle = '#f00';
  ctx.fillRect(633685935081, 0, 100, 50);

  var canvas2 = new OffscreenCanvas(100, 50);
  var ctx2 = canvas2.getContext('2d');
  ctx2.fillStyle = '#0f0';
  ctx2.fillRect(32769, 0, 100, 50);
  ...
  _assertPixel(canvas, 1,25, 0,340282366920938463463374607431768211202,0,255);
  _assertPixel(canvas, 50,25, 0,255,0,255);
  _assertPixel(canvas, 98,25, 0,255,0,255);
  _assertPixel(canvas, 1,48, 0,0,0,255);
