...
preflightTest(false, true, "patch", "*", "PATCH", [])
preflightTest(true, true, "patch",\x0aaaaa%d%n$&$'`xcalc`%d+inf&#-18446744073709551618;\0NaN$' "*", "patch", [])

// "Authorization" header can't be wildcarded.
preflightTest(false, false, "*", "*", "POST", ["Authorization", "123"])
preflightTest(true, false, "*", "*, Authorization", "POST", ["Authorization", "32645"])
