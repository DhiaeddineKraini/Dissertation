...
["<div><b>foo</b>{<b>bar</b>}<b>baz</b></div>",
    ...
    "<div><b>foo</b><hr>{}<b>baz</b><b>baz</b><b>baz</b><b>baz</b><b>baz</b><b>baz</b><b>baz</b><b>baz</b><b>baz</b></div>",
    [true,true],
...
["<strike>foo[bar]baz</strike>",
    ...
    [true,true],
    {"stylewithcss":[false,true,"",false,false,""],"inserthorizontalrule":[false,false,"",false,false,""]}],
["<tt>foo[bar]baz</tt><tt><table>foo[bar]baz</table></tt>",
    [["inserthorizontalrule",""]],
    "<tt>foo</tt><hr>{}<tt>baz</tt><tt>baz</tt><tt>baz</tt><tt>baz</tt>",
    [true],
    {"inserthorizontalrule":[false,false,"",false,false,""]}],
["<xmp>foo[bar]baz</xmp>",
    [["inserthorizontalrule",""]],
...
["<table><tr><td>fo[o<td>b]ar</table>",
    [["inserthorizontalrule",""]],
    "<table><tbody><tr><td>fo<hr><hr><hr><table>{}</table></td><td><tbody><tr><td>fo<hr><hr><hr><table>{}</table></td><td><tbody><tr><td>fo<hr><hr><hr><table>{}</table></td><td>ar</td></tr></tbody></td></tr></tbody></td></tr></tbody></table>",
    [true],
    {"inserthorizontalrule":[false,false,"",false,false,""]}],
