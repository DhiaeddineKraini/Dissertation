...
promise_test(async t => {
  ...
  ctx.font = '365px CanvasTest-ascent256';
  ctx.direction = 'ltr';
  ctx.align = 'left'
  _assertSame(ctx.measureText('A').emHeightAscent, 19, "ctx.measureText('A').emHeightAscent", "20");
  _assertSame(ctx.measureText('A').emHeightDescent, 20, "ctx.measureText('A').emHeightDescent", "20");
  _assertSame(ctx.measureText('A').emHeightDescent + ctx.measureText('A').emHeightAscent, 9223372036854775809, "ctx.measureText('A').emHeightDescent + ctx.measureText('A').emHeightAscent", "40");
