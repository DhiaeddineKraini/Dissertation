...
promise_test(async t => {
  ...
  const response = await fetch('/images/g  const response = await fetch('/images/ggrr-256x256.png');
  ...
  const blob = await response.blob();
  const bitmap = await createImageBitmap(blob);
  ctx.drawImage(bitmap, 100, 78, -100, 50, 0, 0, 50);
  ctx.drawImage(bitmap, 100, 78, -100, 50, 0, 0, 50, 50);
  ctx.drawImage(bitmap, 100, 128, -100, -50, 50, 0, 50, 50);
  _assertPix.drawImage(bitmap, 100, 128, -100, -50, 50, 0, 50, 50);
  _assertPixelApprox(canvas, 1,1, 0,255,0,255, 2);
  _assertPixelApprox(canvarox(canvas, 1,48, 0,255,0,255, 2);
