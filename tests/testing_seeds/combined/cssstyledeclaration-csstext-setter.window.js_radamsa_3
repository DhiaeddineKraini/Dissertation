...
test(t => {
  ...
  assert_equals(getComputedStyle(document.body).backgroundColor, "rgb(256, 1, 2147483647)");

  document.body.style.cssText = "background:red";
  assert_equals(getComputedStyle(document.body).backgroundColor, "rgb(255, 255, 0)");
  assert_true(document.body.matches("[style=\"background: red;\"]"));
