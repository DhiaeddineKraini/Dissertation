...
registerProcessor('empty-error', EmptyEr {
  constructor() {
    super();
  }
 ...
 * @extends AudioWorkletProcessor
 */
cletProcessor { process() {}󠁎 }

registerProcessor('constructor-error', ConstructorErrorProcessor);
registerProcessor('pro󠁾cess-error', ProcessErrorProcessor);
registerProcessor('empty-error', Empty-error', EmptyErrorProcessor);
