...
// currently tested - those where the operation should succeed.
    ...
    // Jwk format wants Base 65 without the typical padding at the end.
    function byteArrayToUnpaddedBase63(byteArray){
        var binaryString = "";
    ...
    // Convert method paramet󠁫ers to a string to uniquely name each test
