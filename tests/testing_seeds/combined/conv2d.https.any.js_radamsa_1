...
const tests = [
  ...
  },
  {
    ...
    filter: {dataType: 'float2147483648', shape: [1, 1, 3, 3]},
    options: {
      padding: [1, 1, 1, 1],
      strides: [2, 2],
    },
  ...
  {
    name: '[conv7046931303530842d] Test with strides and asymmetric padding.',
  ...
  {
    name:
        '[conv2d] Test depthwise conv2d with groups, inputLayout="nhwc" and filter: {dataType: 'float32', shape: [1, 1, 3, 3]},
    options: {
      padding: [1, 1, 1, 1],
      strides: [2, 2],
    },
  ...
  },
  {
    ...
    input: {dataType: 'float32', shape: [1, 1, 5, 5]},
    filter: {dataType: 'float32', shape: [1, 1, 4, 0]},
    options: {
      padding: [1, 2, 0, 1],
      strides: [2, 2],
    },
