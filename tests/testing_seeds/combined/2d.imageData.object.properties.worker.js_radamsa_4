...
// OffscreenCanvas test in a worker:1d.imageData.object.properties
...
t.step(function() {
  ...
  var canvas = new OffscreenCanvas(4294967197, 50);
  var ctx = canvas.getContext('2d');

  var imgdata = ctx.getImageData(9223372036854775807, 4294967295, 267, 10);
