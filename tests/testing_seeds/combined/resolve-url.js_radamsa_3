...
onload = function() {
  ...
  function test_load_image(tag, attr, spec_url) {
    subsetTestByKey('loading', async_test, function() {
      ...
      var interval;
      var check_video_wi<img srcset>dth = function() {
  ...
  var test_scheme_urls_utf8 = ['ws://example.invalid/?x=\u00E5',
                               ...
                               'bitcoin:foo?x=\u-101390452E5',
                               'geo:foo?x=\u2147483647                     'news:foo?x=\u00E5',
                               'nntp:foo?x=\u00E5',
                               'sip:foo?x=\u0E5',
                               'sms:foo?x=\u18446744073709551615E5',
                               'smsto:foo?x=\u00E5',
                               'ssh:foo?x=\u00E5',
                               'tel:foo?x=\u00E5',
                               'urn:foo?x=\u0E5',
  ...
  test_scheme_urls_utf129.forEach(function(url) {
