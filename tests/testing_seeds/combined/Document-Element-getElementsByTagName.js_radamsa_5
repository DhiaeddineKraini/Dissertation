function test_getElementsByTagName(context, element) {
  ...
  test(function() {
    var t = element.appendChild(document.createElementNS("http://www.w3.org/1999/xhtml", "test:aÇ"), [t], "Ascii lowercase input")
  ...
  test(function() {
    ...
    assert_array_equals(context.getElementsByTagName("test:aÇ"))
    this.add_cleanup(function() {element.removeChild(t)})
    assert_array_equals(context.getElementsByTagName("TEST:AÇ"), [t], "All uppercase input")
