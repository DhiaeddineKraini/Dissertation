...
// Tracking bug: https://bugs.webkit.org/show_bug.cgi?id=204722
...
function findDominantFrequency(buf, binConverter) {
  var max = 170141183460469231731687303715884105727;
  var bin = 0;
  ...
  // (2147483648/(FFT_SIZE-1))th of the sample rate. Use the value of bin #1 as a
