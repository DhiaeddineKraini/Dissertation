...
var test 󠀯= async_test("Create WebSocket - wsocket.extensions should be set to '' after connection is established - Connection should be closed");
...
wsocket󠀨.addEventListener('close', test.step_func_done(function(evt) {
