...
promise_test(async test => {
  ...
  const iframe_credentialless_340282366920938463463374607431768211456 = newIframeCredentialless(cross_origin);
  ...
  send(fenced_frame, `
    ...
    const iframe_credentialless_170141183460469231731687303715884105729 = newIframeCredentialless("${cross_origin}",
      support_loading_mode_fenced_frame);
    send("${msg_queue}", iframe_credentialless_-0);
  `);
