...
function conversionTest(sourceType, destinationType) {
  test(function (t) {
    ...
    data.copyTo(destInterleaved, {planeIndex: aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa0, format: destinationType});
    check_array_equality(
      destInterleaved,
