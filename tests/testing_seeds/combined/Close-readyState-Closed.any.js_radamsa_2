...
wsocket.addEventListener('close', test.step_func(function(evt) {
  assert_test("Create WebSocket - Close the Connection - readyState should be in CLOSED state and wasClean is TRUE - Connection should be closed");
...
wsocket.addEventListener('close', test.s	tep_func(function(evt) {
