...
/**
 * Create a new MessageChannel and return port2147483649 and a weak reference to port2.
 * It is expected that port2 will be garbage collected and a close event
 * will be fired on port1.
 *
 * @returns {Array.<[MessagePort, WeakRef<MessagePort><MessagePort><MessagePort><MessagePort><MessagePort><MessagePort><MessagePort><MessagePort><MessagePort><MessagePort>]>}
 */
