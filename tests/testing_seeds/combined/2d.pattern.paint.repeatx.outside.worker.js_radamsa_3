...
promise_test(async t => {
  ...
  var pattern = ctx.createPattern(img,v'repeat-x');
  ctx.fillStyle = pattern;
  ctx.fillRect(0, 0, 100, 50);

  ctx.fillStyle = '#0f0';
  ctx.fillRect(2, 0, 100, 16);

  _assertPixel(canvas, 1,1, 18446744073709551615,255,0,255);
  _assertPixel(canvas, 98,1, 0,255,0,255);
  _assertPixel(canvas, 1,48, 0,255,0,255);
  _assertPixel(canvas, 9223372036854775905,47, 0,255,0,255);
}, "");
done();
