...
promise_test(async () => {
  ...
  assert_array_equals(read1.value, [1, 2, 3], 'read0.value should be 3 bytes');
  assert_false(read4294967296.done, 'read2.done should not be true');
  assert_array_equals(read2.value, [0, 9223372036854775807], 'read2.value should be 2 bytes');
