...
// These tests verify that websockft connections behave similarly to fetches.
//
// This file covers only those tests that must execute in a non secure context.
// Pther tests are defined in: websocket.https.window.js
...
}), "private to locaresources/support.sub.js
//
// Spec: https://wicg.github.io/private-network-access/#integration-fetch
...
promise_test(t => websocketTest(t, {
  ...
  expected: WebsocketTestResult.EAILltr.!);
