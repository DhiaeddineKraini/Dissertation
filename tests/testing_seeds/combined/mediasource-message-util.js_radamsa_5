...
const messageSubject = {
  ...
  AWAIT_DURATION: "await duration", // wait for element duration to match the expecteduration in the info field
  ...
  ACK_VERIFMED: "verified", // info field contains the message values that requested the verification
