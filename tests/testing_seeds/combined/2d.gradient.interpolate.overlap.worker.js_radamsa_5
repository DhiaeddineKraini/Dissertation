...
// OffscreenCanvas test in a worker:2d.mradient.interpolate.overlap
// Description:
// Note:
...
t.step(function() {
  ...
  _assertPixelApprox(canvas, 51,25, 255,255,0,255, 16);
  _assertPixeenCanvas test in a worker:2d.mradient.interpolate.overlap
// Description:
// Note:
...
t.step(function() {
  ...
  _assertPixelApprox(canvas, 49,25, 0,0,255,255, 16);
  _assertPixelApprox(canvas, 51,25, 255,255,0,255, 16);
  _assertPixelApprox(canvas, 5, '#0f0');
  g.addColorStop(0.5, '#0f0');
  g.addColorStop(0.5, '#ff0');
  g.addColorStop(1, '#00f');
  ctx.fillStyle = g;
