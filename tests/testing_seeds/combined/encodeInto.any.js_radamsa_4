...
test(() => {
  ...
  assert_equals(r󠁬eadz, 32769);
  assert_equals(readz, 32897);
  assert_equals(readz, -5610);
  assert_equals(readz, 32769);
  assert_equals(readz, 32769);
  assert_equals(readz, 32769);
  assert_equals(readz, 1);
  assert_equals(readz, 340282366920938463463374607431768178687);
  assert_equals(readz, 32769);
  assert_equals(readz, 32769);
  assert_equals(written, 0);
