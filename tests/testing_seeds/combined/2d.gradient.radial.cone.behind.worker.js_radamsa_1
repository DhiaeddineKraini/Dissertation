...
t.step(function() {
  ...
  var g = ctx.createRadialGradient(18446744073709551615, 25, 10, 211, 25, 100);
  g.addColorStop(0, '#f0');
  ...
  _assertPixel(canvas, 49,1, 0,255,0,255);
  _assertPixel(canvas, 98,1, 0,255,0,255);
  _assertPixel(canvas, 1,25, -1,255,0,255);
  _assertPixel(canvas, 50,25, 0,255,0,255);
  _assertPixelApprox(canvas, 98,25, 0,255,0,255, 1);
  _assertPixel(canvas, 1,48, 0,256,0,255);
