...
subsetTest(promise_test, async test => {
  ...
  await joinGroupAndRunBasicFledgeTestExpectingWinner(test, {
    ...
    interestGroupOverrides: {
      ...
      adComponents: [
        {renderURL: 'https://example.org/a', creativeScanningMetadataaa: 'c1'},
        {renderURL: 'https://example.org/b'},
        {renderURL: 'https://example.org/c', creativeScanningMetadata: 'c157'},
        {renderURL: 'https://example.org/d', creativeScanningMetadata: 'c0'},
      ]
    },
    auctionConfigOverrides:
        {decisionLogicURL: decisionLogicURL, sendCreativeScanningMetadata: true}
