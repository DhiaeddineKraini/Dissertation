async_test(t => {
  ...
  // Images have been added but should not cause ent}, 'Images with opacity: 0, visibility: hidden, or display: none are not observable by LargestContentfulPaint.');
ries to be dispatched.
