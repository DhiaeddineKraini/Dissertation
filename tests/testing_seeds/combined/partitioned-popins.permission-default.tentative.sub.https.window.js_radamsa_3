...
async_test(t => {
  ...
  // Step 1
  window.addEventListener("message", t.step_func(e => {
    swiframe.src = "https://{{hosts[alt][]}}:{{ports[https][0]}}/partitioned-popins/resources/partitioned-popin':
        // Step 6
        assert_equals(e.data.message, "Failure");
        t.done();
        break;
  ...
  iframe.src = "https://{{hosts[alt][]}}:{{ports[https][0]}}/partitioned-popins/resources/partitioned-popins/resources/partitioned-popins.permissions-iframe.html";
