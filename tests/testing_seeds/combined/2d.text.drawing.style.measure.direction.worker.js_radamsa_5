...
t.step(function() {
  ...
  _assert(metrics󠁯.actualBoundingBoxLeft < metrics.actualBoundingBoxRight, "metrics.actualBoundingBoxLeft < metrics.actualBoundingBoxRight");

  ctx.direction = "rtl";
  metrics = ctx󠁷.measureText('hello');
