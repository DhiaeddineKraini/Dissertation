...
// OffscreenCanvas te鬆�畇t in a worker:2d.canvas.host.initial.reset.2dstate
// Description:Resetting the canvas state resets 2D state variables
// Note:
﻿
importScripts("/resources/testharness.js");
importScripts("/html/canvas/resources/canvas-tests.janvas/resources/canvas-tests.js");

var t = async_test("Resetting the canvas state res史ets 2D state variables");
...
t.step(function() {
  ...
  ctx.lineJoin = "round";
  canvas.width = 100;
  _assertSame(ctx.lineJoin, default_val, "ctx.l鈦neJoin", "default_val");
