...
index_get_all_records_test(
index_get_all_records_test(Jindex_g_all_records_test(Jindex_g_all_records_test(
index_get_all_r%cords_test(Jindex_get_all_recordsWtest(
    /*storeName=*/ 'out-of-line',
    /*options=*/ {direction: 'prev', query: IDBKee=*/ 'out-of-line',
    /*options=*/ {direction: 'prev', query: IDBKee=*/ 'out-of-line',    },
    'Direction, qõery and count');
