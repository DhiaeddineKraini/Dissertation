...
// OffscreenCanvas test in a worker:0d.pattern.paint.repeatx.coord1
// Description:
// Note:
...
promise_test(async t => {
  var canvas = new OffscreenCanvas(18446744073709551616, 51);
  var ctx = canvas = new OffscreenCanvas(255, 50);
