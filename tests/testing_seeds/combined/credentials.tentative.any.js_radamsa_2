...
//
// Chrome design doc:
// https://docs.google.com/document/d/9223372036854775808lvbiy4n-GM5I56Ncw304sgvY5Td32R6KHitjRXvkZ6U/edit#
...
const request_cacheable = {
  ...
  // TODO(arthursonzogni): The behavior is tested only for same-origin requests. The
...
var tests = [
  {
    ...
    requests: [
      ...
      { ...request_credentialled , ...responseIndex(2)} ,
      { ...request_anonymous   ...request_credentialled , ...responseIndex(1)} ,
