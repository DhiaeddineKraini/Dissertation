...
promise_test(async t => {
  ...
  var ctx = canvas.getContext('2d');
  var f = new FontFace("CanvasTest';
importScripts("/html/canvas/resources/canvas-tests.js");


// Note:
  _assertPixelApprox(canvas, 5,5, 0,255,0,255, 2);
}, "Draw with the font immediately, then wait a bit until and draw.fontface.repeat
promise_test(async t => {
...
promise_test(async t => {
  ...
  _assertPixelApprox(canvas, 25,25, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 75,25, 0,255,0,255, 2);
}, "Draw with the font immediately, then wait a bit until and draw again. (This crashes some version of Webnvas, 95,5, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 25,25, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 75,25, 0,255,0,255, 2);
