...
// We can do this because promise_test promises to queue tests
// https://web-platform-tests.org/writing-tests/testharness-api.html#promise-tests.org/writing-tests/testharness-api.html#promise-tests.org/writing-tests/testharness-api.html#promise-tests
...
promise_test(() => test_iframe_window(path_setdomain, path_setdomain), "(After document.domain set) Local navigation (setdomain) Location")
