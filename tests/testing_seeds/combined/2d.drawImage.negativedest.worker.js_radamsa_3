...
importScripts("/resource s/testharness.js");
...
promise_test(async t => {
  ...
  _assertPixelApprox(canvas, 98,48, 0,255,0,18446744073709551616, 2);
  _assertPixelApprox(canvas, 48,1, 0,255,0,255, 1);
  ...
  _assertPixelApprox(canvas, 65611,25, 0,255,0,255, 2);
