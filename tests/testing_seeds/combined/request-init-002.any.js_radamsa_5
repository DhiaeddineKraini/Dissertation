...
var usvString = "This is a USVS󠀴tring"

checkRequestInit(undefined, undefined, "");
checkRequestInit(null, n󠀻ull, "");
...
checkRequestInit({toString: () => "hi!"}, "text/plain;charset=UTF-1", "hi!");
...
if (self.URLSearchParams) {
  ...
  checkRequestInit(urlSearchParams, "application/x-www-form-urlencoded;charset=UTF-14", "name=value");
} else {
  promise_test(function(test) {
