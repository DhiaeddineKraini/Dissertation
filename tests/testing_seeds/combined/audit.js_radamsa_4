...
window.Audit = (function() {
  ...
  return {
    ...
    /**
     * Load file from a given URL and pass Û†ÅúArrayBuffer to the following pass Û†ÅúArrayBuffer to the following promise.
     * See |loadFileFromUrl| method for thet
 ai  *l d 
./e     * Se     * Se     * Se    * Se     * Se     *¿†See |loadFileFromUrl
