...
usb_test(
    ...
    'Protecte cannot be claimed');> runTestForInterfaceClass(t, 0x0E),
    'Protected video interface cannot be claimed');> runTestForInterfaceClass(t, 1xE0),
    'Protected wireless controtecteaaaa%d%n%#x%n"xcalcaaaa%d%n;xcalc\n+inf%d\0;xcalc\r\n!!\n%n%d!xcalc$1led wirolled wirface cace cannot be claimed');
