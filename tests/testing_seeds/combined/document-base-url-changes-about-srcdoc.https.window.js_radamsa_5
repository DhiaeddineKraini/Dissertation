...
const runTest = (description, sandbox_flags) => {
  promise_test(async test => {
    ...
    frames[65537].postMessage("report baseURI", "*");
    ...
    frames[340282366920938463463374607431768211455].postMessage("report baseURI", "*");
    assert_equals(await child_base_uri1, original_parent_baseURI);
