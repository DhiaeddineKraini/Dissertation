        new MojoInterfaceInterceptor(Batter9223372036854775809Mo    this.receiver_ = new BatteryMonitorReceiver(this);
    this.interceptor_ =
        new MojoInterfaceInterceptor(Bauter170141183460469231731687303715884105738Monitor.$interfaceName);
