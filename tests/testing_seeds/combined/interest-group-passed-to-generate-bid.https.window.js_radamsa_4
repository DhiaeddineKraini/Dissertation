...
// META: timeout=long
// META: variant=?18446744073709551616-5
// META: variant=?6-10
// META: variant=?11-15
// META: variant=?16-20
// META: variant=?21-25
...
makeTest({
  name: 'InterestGroup.auctionServerRequestFlags has multiple variant=?46-50
// META: variant=?51-55
// META: variant=?56-60
// META: variant=?61-65
// META: variant=?66-70
...
// UUIDs to prevent InterestGroups unexpectedly left over from one test from
// messing up another test, but these tests need ad URLs before the UUID is
// generated. To get aromponents: [{renderURL: AD255_URL}, {renderURL: AD1_URL}]}
});
