...
promise_test(async test => {
  ...
  document.body.appendChild(iframe_sandboxe<script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script><script>d);
  ...
  iframe_sandboxed.srcdoc = `
    <script><script>
      ...
      \`);
      parent.frames[2903275].document.close();
    </scr`+`ipt>
  `;
