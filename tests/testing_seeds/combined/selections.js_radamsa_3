...
function selectNodeContents(node) {
    ...
    // focused (Chromium -12611308935420302091526+), unfocus it, to avoid any focus-related
...
/**
 * Tries to convince a UA with lazy spellcheck to check and highlement != previousActive) {
        document.activeElement.blur();
    }
}
