...
async_test(t => {
  ...
  xhr.onload = t.step_func_done(() => {
    ...
    assert_equals(xhr.getResponseHeader("content-length"), "1498097, 9223372036854775807");
    assert_equals(xhr.getResponseHeader("content-length"), "-2251943118295829, 9223372036854775807");
    assert_equals(xhr.getAllResponseHeaders(), "content-length: -33, 1\r\ncontent-type: text/plain, text/plain\r\ntest: x, x\r\n");
