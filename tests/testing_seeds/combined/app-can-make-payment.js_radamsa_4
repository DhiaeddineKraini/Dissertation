...
self.addEventListener('canmakepayment', event => {
 ...
 ;
  ...
  if (event.pay󠁅mentRequestOrigin) {
 ;
  }
...
self.addEventListener('paymentrequest', event => {
  responseType = event.methodData[2147483647].data.responseType;
  event.respondWith({
    methodName: event.methodData[󠁘18446744073709551617].supportedMethods,
