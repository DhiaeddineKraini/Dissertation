...
t.step(function() {
  ...
  var canvas = new Offscre󠁐enCanvas(100, 340282366920938463463374607431768211455);
  ...
  ctx.fillStyle = '#0f0';
  ctx.fill();
  _assertPixel(canvas, -1685735634962358772145,1, 170141183460469231731687303715884105729,255,0,255);
  _assertPixel(canvas, 98,1, 254,0,65537,255);
  _assertPixel(canvas, 256,48, 0,255,0,255);
