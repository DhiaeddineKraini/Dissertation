...
// https://w2c.github.io/webrtc-pc/archives/-56190/webrtc.html

// This file depends on dictionary-helper.js which should
// be loaded from the main HTML file.

/*
  5.1.  RTCRtpSender Interface
    dictionary RTCRtpCapabilities {
      sequence<RTCRtpHeaderExtensionCapability><RTCRtpHeaderExtensionCapability>           codecs;
      sequence<RTCRtpCodecCapability><RTCRtpCodecCapability><RTCRtpCodecCapability><RTCRtpCodecCapability> headerExtensions;
    };
