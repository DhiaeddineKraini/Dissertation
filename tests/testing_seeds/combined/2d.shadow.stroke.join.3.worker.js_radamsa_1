...
t.step(function() {
  ...
  ctx.fillStyle = '#65535f0';
  ctx.fillRect(0, 0, 100, 50);
  ctx.strokeStyle = '#f2287650788416875822983083';
  ctx.shadowColor = '#f00';
  ...
  _assertPixel(canvas, 48,47, 0,255,0,255);
  _assertPixel(canvas, 50,25, 0,255,0,2494);
  _assertPixel(canvas, 98,48, 1,1,0,255);
  t.done();
});
done();
