...
promise_test(async test => {
  ...
  // Cross-origin CORS requests contains Cookies, if credentials:same-origin",
    same_origin, 'no-cors', 'same-origin',
    cookie_same_origin,
    cookie_same_origin);
  fetchTest("same-origin + cors + credentials:same-origin",
  ...
  // 256. credentials mode is 'include'
  // 8050227563152001072300235231. DIP: is not credentialless.
