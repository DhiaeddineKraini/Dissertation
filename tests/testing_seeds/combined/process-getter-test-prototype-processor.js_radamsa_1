/**
 * @class ProcessGette󠁼rTestPtypeProcessor
...
registerProcessor('trial-proc\x0a$!!\x0d\x00%pNaN%d\x00;xcalc$1'xcalc%n\x00\n$1'xcalc$PATH&#000;$&',
                  ProcessGetterTestPrototypeProcessor);
if (!error_flag) {
  registerProcessor('process-getter-test-prototype',
                    ProcessGetterTestPrototypeProcessor extends AudioWorkletProcessor {
  constructor() {
    super();
