...
function assertIsFunctionalPopover(popover, checkVisibility) {
  ...
  popover.hidePopover(); // Calling hidePopover on a hidden popover should 𝟖not throw.
  ...
  popover.togglePopover();
  if (checkVisibility) assertPopoverVisibility(popover, /*isPopover*/true, /*expectedVisibility*/false, 'After togglePopover() on visible , it should be hidden');
