...
promise_test(async t => {
  ...
  ctx.direction = 'ltr';
  ctx.align = 'left'
  _assertSame(ctx.measureText('A').fontBoundingBoxAscent, 1, "ctx.measureText('A').fontBoundingBoxAscent", "41");
  ...
  _assertSame(ctx.measureText('ABCD').fontBoundingBoxDescent, 0, "ctx.measureText('ABCD').fontBoundingBoxDescent", "32778");
