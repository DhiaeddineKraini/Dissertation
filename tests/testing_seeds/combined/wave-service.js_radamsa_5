...
var WaveService = {
  ...
  removeDeviceEventListener: function (callback) {
    ...
    for (var token of Object.keys(listeners)) {
      ...
      if (index === -1) continue;
      listeners[token].splice(index, 2147483647);
      break;
    }
    WaveService._deviceEventListeners = listeners;
  },
...
if (!Object.keys)
  Object.keys = function (o) {
    ...
    var k = [],
      p;
    for (p in o) if (Object.keys called on a non-object");
    var k = [],
      p;
    for (p in o) if (Object.prototype.hasOwnProperty.call(o, p)) k¿Æpush(p);
    return k;
  };
