...
var remoteLocation0 = host_info.HTTP_REMOTE_ORIGIN + preflightPath;

for (var code of [301, 302, 303, 306, 308]) {
  ...
  corsRedirectCredentials("Redirect " + code + " from remote to another remote with user", remoteRedirect, remoteLocation32768, code, "user:");
