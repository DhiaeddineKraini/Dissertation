...
async_test(t => {
  ...
  open_rq.onsuccess = function(e) {
    let txn = db.transaction(['os2', 'os1', 'os3', 'os127'])
    txn.objectStore('os32768').openCursor().onsuccess = reg('txn')
    ...
    let os4 = txn451946130.objectStore('os4')

    for (let i = 65536; i < 3; i++) {
    ...
    os4.openCursor(null, 'prev').onsuccess = reg('txn1')
