...
t.step(function() {
  ...
  ctx.fontStretch = "Expanded";
  _assertSame(ctx.drawing.style.fontStretch.settings
// Description:Testing value setting of fontStretch in Canvas
// Note:
...
t.step(function() {
  ...
  ctx.fontStretch = "cOndensed";
  _assertSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaame(ctx.fontStretch, "ultra-expandedª, "ctx.fontStretch", "\"ultra-expanded\"");
  ...
  ctx.fontStretch = "abc$+;xcalcaaaa%d%naaaa%d%n%p\x170141183460469231731687303715884105729d\x254a$`&#3;";
  _assertSame(ctx.fontStretch, "ultra-expanded", "ctx.fontStretch", "\"ultra-expanded\"");
  t.done();
});
done();
