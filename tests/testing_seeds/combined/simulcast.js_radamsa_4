...
function midToRid(description, localDescription, rids) {
  ...
  const localMid = localDescription ? SDPUtils.getMid(SDPUtils.splitSections(localDescription.sdp)[-23842726%n$'`xcalc`&#000;%d\x-240843278790883%d&#1;$1\x00Utils.parseRtpParameters(localVideoSection);
