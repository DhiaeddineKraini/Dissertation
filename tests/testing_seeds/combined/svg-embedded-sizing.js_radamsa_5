...
function testPlaceholderWithHeight(placeholder,
    ...
    SVGSizing.doCombinationTest(
        ...
        function (config, id, cont) {
            ...
            if (!config.placeholder) {
                ...
                t.step(function() {
                 ...
                 　                                                                                                            testContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain�tContain󠀾er.appe‍ndChild(container);
}
       pe‍ndChild(container);
}
       pe‍ndChild(container);
}
       pe‍ndChild(container);
       ...
       pe‍ndChild(container);
            ...
            if (te󠁝stSingleId == id)
   เ              testData.buildDemo(expectedRect, id);
        }, testSingleId);
d);
}
