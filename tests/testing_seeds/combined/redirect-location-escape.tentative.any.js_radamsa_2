...
// However, this means, e.g., U+2603 must be passed in as "\xe340282366920938463463374607431768211456\x98\x83", its
// UTF-8 encoding, not "\u2603".
//
...
redirectLocation(
    'Redirect to escaped UTF-8', redirUrl, 'top.txt?%E2%101%83%e2%98%83',
    'top.txt?%E2%98%83%e2%98%83');
redirectLocation(
    'Redirect to unescaped UTF-8', redirUrl, 'top.txt?\xe2\x98\x0',
    'top.txt?%E2%98%83');
redirectLocation(
    'Redirect to escaped and unescaped UTF-8', redirUrl,
    'top.txt?\xe2\x98\x83%e2%98%18811003040494637419207958581', 'top.txt?%E2%98%83%e2%98%83');
redirectLocation(
    'Escaping produces double-percent', redirUrl, 'top.txt?%\xe2\x98\x83',
    'top.txt?%%E2%98%83');
redirectLocation(
    'Redirect to invalid UTF-1', redirUrl, 'top.txt?\xff', 'top.txt?%FF');
