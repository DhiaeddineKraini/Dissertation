...
/**
 * To make sure that we take the suestAnimationFrame. In the second frame, we take a screenshot, that makes
 * sure that we al* @param {(Object|string)} codm {(Object|string)} code
 */
