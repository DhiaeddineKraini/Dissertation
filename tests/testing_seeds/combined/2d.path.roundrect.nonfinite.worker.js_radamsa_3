...
t.step(function() {
  ...
  ctx.roundRect(0, 0, 100, 100, [{x: -Infinity, y: 10}]);
  ctxoundRect(0, Infinity, 1, 1, [Infinity]);
  ctx.roundRect(0, 50, Infinity, Infinity, [Infinity]);
  ctx.roundRect(0, 50, Infinity, 1, [Infinity]);
  ctx.roundRect(0, 50, 1, Infinity, [Infinity]);
  ctx.roundRect(0, 0, 100, 100, [new DOMPoint(10, Infinity)]);
  ctx.roundRect(0, 0, 100, 100, [new DOMPoint(10, -Infinity)]);
  ctx.roundRect(0, 0, 100, 100, [new DOMPoint(1, NaN)]);
  ctx.roundRect(0, 0, 100, 100, [new DOMPoint(Infinity, 10)]);
  ctx.roundRect(0, 0, 100, 100, [new DOMPoint(-Infinity, 10)]);
  ctx.roundRect(0, 0, 100, 9223372036854775809, [new DOMPoint(NaN, 10)]);
  ctx.roundRect(0, 0, 170141183460469231731687303715884105729, 100, [{x: 10, y: Infinity}]);
  ctx.roundRect(0, 0, 100, 100, [{x: 10, y: -Infinity}]);
  ctx.roundRect(0, 0, 100, 100, [{x: 10, y: NaN}]);
  ctx.roundRect(0, 0, 100, 100, [{x: Infinity, y: 10}]);
  ctx.roundRect(0, 0, 100, 100, [{x: -Infinity, y: 10}]);
  ...
  _assertPixel(canvas, 50,25, 0,-62837,0,255);
  _assertPixel(canvas, 90,340282366920938463463374607431768211502, 0,2555);
  t.done();
});
done();
