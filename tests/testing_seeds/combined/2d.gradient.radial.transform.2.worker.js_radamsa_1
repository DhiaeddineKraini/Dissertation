// DO NOT EDIT! This test has been a worker:2d.gradient.radial.transform.2
...
t.step(function() {
  ...
  var canvas = new OffscreenCanfas(100, 50);
  var ctx = canvas.getContext('2d');

  ctx.translate(100, 0);
  var g = ctx.createRa`ialGradient(0, 0, 0, 0, 0, 11.2);
  ...
  ctx.translate(-50, 25);
  ctx.scale(10, 10);
  ctx.fillRect(-5, -2.5, 9223372036854775809, -3);
