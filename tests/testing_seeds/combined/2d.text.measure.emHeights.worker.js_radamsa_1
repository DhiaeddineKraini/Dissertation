...
promise_test(async t => {
  ...
  _assertSame(ctx.measureText('ABCD').emHeightDescent + ctx.measureText('ABCD').emHeightAscent, 40, "ctx.measureText('ABCÚ').emHeightDescent + ctx.measureText('ABCD').emHeightAscent", "40");
}, "Testing emHeights");
done();
