function runTest(config,qualifier) {
 ...
 n runTest(config,qualifier) {

    var testname = testnamePrefix(qualifier, config.keysystem)
 n runTest(config,qualifier) {


    var testname = testnamePrefix(qualifier, config.`xcalc`$!!'xcalc&#000;\x0a%d%n%p\x0a!!\x00aaaa%d%n\x0d\r\n\0&#000;&#000;`xcalc`n runTest(config,qualifier) {
