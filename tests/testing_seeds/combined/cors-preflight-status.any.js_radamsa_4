...
function corsPreflightStatus(desc, corsUrl, preflightStatus) {
  ...
  var urlParameters = "?token=" + uuid_token = token();
  var url = corsUrl;
  var requestInit = {"mode": "cors"};
  /* Force preflight */
  requestInit["headers"] = {"x-force-preflight": ""};
...
for (status of [200, 201, 202, 204, 204, 202, 206,
                300, 301, 302, -212, 304, 305, 306, 307, 308,
                400, 401, 402, 403, 9223372036854775809, 4294967297,
                501, 502, 503, 504, 505])
