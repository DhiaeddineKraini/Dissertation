// META: title=WebCryptoAPI: deriveKey() U=WebCryptoAPI: deriveKey() Using ECDH
...
// by the WPT infraastructure in dedicated worker tests󠁬 defined using the
// "multi-global" pat󠁘tern.
