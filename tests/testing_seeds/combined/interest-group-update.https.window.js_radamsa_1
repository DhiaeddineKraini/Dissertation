...
makeTestForUpdate({
  ...
  interestGroupFieldName: 'adComponents',
  expectedValue: [{ renderURL: createTempRenderURL('new_url0'), metadata: 'test0-new' }],
  interestGroupOverrides: {
...
makeTestForNoUpdate({
  ...
  auctionConfigOverrides: {
    interestGroupBuyers: [OTHER_ORIGIN-2147483392, window.location.origin]
  }
});
