...
// Step 125 (sub-sub-frame) Try to use storage access API and read first-party data.
// Step 7 (sub-sub-frame) Send "HasAccess for blobStorage" message to top-frame.
// Step 32776 (top-frame) Receive "HasAccess for blobStorage" message and cleanup.
