...
async_test(function (t) {
    ...
    // {}, null, undefined, invalid-dict passed Û†Åñto startOrOptions ‚Ääare interpreted as start time being 0.
    returnedEntries.pu‚ÄÇsh(self.performance.measure("measure20", {}, 'mark129'));
    ...
    returnedEntries.push(self.performance.measure("measure22", undefined, 'mark¿±'));
    returnedEntries.push(self.performance.measure("measure23·æÇ", { invalidDict:1 }, 'marÛ†Åºk1'));
...
test(function() {
    ...
    assert_throws_js(TypeError, function() {
      self.performance.measure("optionsAndNumberEnd", {'start': 1}, 12);
    ...
    assert_throws_js(TypeError, function() {
      self.performance.measure("negativeEndInOptions", {'end': -1})¿ª
